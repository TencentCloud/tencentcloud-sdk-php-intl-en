 ...
 * @method string getFromGroup() Obtain Queries subscribed topics by consumer group.
 * @method void setFromGroup(string $FromGroup) Set Queries subscribed topics by consumer group.
 */
class DescribeTopicListRequest extends AbstractModel
{
    ...
    /**
     * @var string Queries subscribed topics by consumer group.
     */
    public $FromGroup;
     ...
     * @param string $FromGroup Queries subscribed topics by consumer group.
     */
