 ...
 * @method string getType() Obtain The logical relationship between conditions. Values: `AND` and `OR`.
 * @method void setType(string $Type) Set The logical relationship between conditions. Values: `AND` and `OR`.
 * @method array getFilters() Obtain LogFilters array
 * @method void setFilters(array $Filters) Set LogFilters array
 */
class LogFilter extends AbstractModel
{
    ...
    /**
     * @var string The logical relationship between conditions. Values: `AND` and `OR`.
     */
    public $Type;

    /**
     * @var array LogFilters array
     */
    public $Filters;
     ...
     * @param string $Type The logical relationship between conditions. Values: `AND` and `OR`.
     * @param array $Filters LogFilters array
     */
