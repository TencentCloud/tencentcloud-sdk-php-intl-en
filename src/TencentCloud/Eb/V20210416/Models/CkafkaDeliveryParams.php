 ...
 * @method string getResourceDescription() Obtain Six-Segment QCS description of CKafka resource
 * @method void setResourceDescription(string $ResourceDescription) Set Six-Segment QCS description of CKafka resource
 */
class CkafkaDeliveryParams extends AbstractModel
{
    ...
    /**
     * @var string Six-Segment QCS description of CKafka resource
     */
    public $ResourceDescription;

    /**
     * @param string $TopicName ckafka topic name
     * @param string $ResourceDescription Six-Segment QCS description of CKafka resource
     */
