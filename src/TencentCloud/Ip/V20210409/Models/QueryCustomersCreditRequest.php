 ...
 *
 * @method string getFilterType() Obtain Search condition type. You can only search by UIN, name, or remarks.
 * @method void setFilterType(string $FilterType) Set Search condition type. You can only search by UIN, name, or remarks.
...
{
    /**
     * @var string Search condition type. You can only search by UIN, name, or remarks.
     */
    public $FilterType;
    ...
    /**
     * @param string $FilterType Search condition type. You can only search by UIN, name, or remarks.
