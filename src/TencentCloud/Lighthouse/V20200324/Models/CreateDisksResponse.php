 ...
 *
 * @method array getDiskIdSet() Obtain List of IDs created by using this API. The returning of IDs does not mean that the instances are created successfully.
 ...
 * @method void setDiskIdSet(array $DiskIdSet) Set List of IDs created by using this API. The returning of IDs does not mean that the instances are created successfully.
...
You can call `DescribeDisks` API, and find the disk ID in the `DiskSet` returned to check its status. If the status changes from `PENDING` to `UNATTACHED` or `ATTACHED`, the instance is created successfully.
    ...
    /**
     * @param array $DiskIdSet List of IDs created by using this API. The returning of IDs does not mean that the instances are created successfully.
