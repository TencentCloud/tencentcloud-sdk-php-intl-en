 ...
 *
 * @method string getBlueprintId() Obtain Custom image ID.
 * @method void setBlueprintId(string $BlueprintId) Set Custom image ID.
...
class CreateBlueprintResponse extends AbstractModel
{
    ...
    /**
     * @param string $BlueprintId Custom image ID.
