 ...
 * @method string getInstanceName() Obtain Instance name, which is customizable and can contain up to 60 characters.
 * @method void setInstanceName(string $InstanceName) Set Instance name, which is customizable and can contain up to 60 characters.
 */
class ModifyInstancesAttributeRequest extends AbstractModel
{
    ...
    /**
     * @var string Instance name, which is customizable and can contain up to 60 characters.
     */
    public $InstanceName;
     ...
     * @param string $InstanceName Instance name, which is customizable and can contain up to 60 characters.
     */
