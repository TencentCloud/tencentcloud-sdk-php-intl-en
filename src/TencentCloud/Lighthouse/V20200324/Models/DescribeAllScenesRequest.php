 ...
 *
 * @method array getSceneIds() Obtain List of scene IDs
 * @method void setSceneIds(array $SceneIds) Set List of scene IDs
...
class DescribeAllScenesRequest extends AbstractModel
{
    ...
    /**
     * @param array $SceneIds List of scene IDs
