 ...
 *
 * @method array getInfos() Obtain Channel list information.
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setInfos(array $Infos) Set Channel list information.
Note: this field may return null, indicating that no valid values can be obtained.
...
{
    /**
     * @var array Channel list information.
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public $Infos;
    ...
    /**
     * @param array $Infos Channel list information.
Note: this field may return null, indicating that no valid values can be obtained.
