 ...
 *
 * @method array getTaskInfos() Obtain Watermark detection information
 * @method void setTaskInfos(array $TaskInfos) Set Watermark detection information
...
{
    /**
     * @var array Watermark detection information
     */
    public $TaskInfos;
    ...
    /**
     * @param array $TaskInfos Watermark detection information
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("TaskInfos",$param) and $param["TaskInfos"] !== null) {
            ...
            foreach ($param["TaskInfos"] as $key => $value){
                $obj = new AbWatermarkDetectionInfo();
