 ...
 *
 * @method array getInfos() Obtain A list of the transcoding information.
 * @method void setInfos(array $Infos) Set A list of the transcoding information.
 * @method integer getPageNum() Obtain The number of the current page.
 * @method void setPageNum(integer $PageNum) Set The number of the current page.
...
{
    /**
     * @var array A list of the transcoding information.
     */
    public $Infos;

    /**
     * @var integer The number of the current page.
     */
    public $PageNum;
    ...
    /**
     * @param array $Infos A list of the transcoding information.
     * @param integer $PageNum The number of the current page.
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Infos",$param) and $param["Infos"] !== null) {
            ...
            foreach ($param["Infos"] as $key => $value){
                $obj = new DescribeTranscodeDetailInfo();
