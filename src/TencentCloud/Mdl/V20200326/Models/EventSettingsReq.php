...
class EventSettingsReq extends AbstractModel
{
    ...
    /**
     * @var integer When the type is FIXED_PTS, it is mandatory and defaults to 0
     */
    public $PipelineId;
    ...
    /**
     * @var integer The duration of the segment in 90kHz ticks.It used to  give the splicer an indication of when the break will be over and when the network In Point will occur. If not specifyed,the splice_insert will continue when enter a return_to_network to end the splice_insert at the appropriate time.
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("SCTE35SegmentationDescriptor",$param) and $param["SCTE35SegmentationDescriptor"] !== null) {
            ...
            foreach ($param["SCTE35SegmentationDescriptor"] as $key => $value){
                $obj = new SegmentationDescriptorInfo();
                $obj->deserialize($value);
