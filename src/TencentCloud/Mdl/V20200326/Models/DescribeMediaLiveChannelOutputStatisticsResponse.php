 ...
 *
 * @method array getInfos() Obtain Channel output information.
 * @method void setInfos(array $Infos) Set Channel output information.
...
{
    /**
     * @var array Channel output information.
     */
    public $Infos;
    ...
    /**
     * @param array $Infos Channel output information.
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Infos",$param) and $param["Infos"] !== null) {
            ...
            foreach ($param["Infos"] as $key => $value){
                $obj = new ChannelOutputsStatistics();
