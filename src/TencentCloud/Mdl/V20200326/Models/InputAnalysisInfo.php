...
class InputAnalysisInfo extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("HighlightSetting",$param) and $param["HighlightSetting"] !== null) {
            $this->HighlightSetting = new HighlightInfo();
            $this->HighlightSetting->deserialize($param["HighlightSetting"]);
        }
    }
}
