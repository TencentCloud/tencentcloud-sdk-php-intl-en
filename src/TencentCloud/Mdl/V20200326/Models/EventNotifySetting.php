...
class EventNotifySetting extends AbstractModel
{
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("PushEventSettings",$param) and $param["PushEventSettings"] !== null) {
            $this->PushEventSettings = new PushEventSetting();
            $this->PushEventSettings->deserialize($param["PushEventSettings"]);
        }
    }
}
