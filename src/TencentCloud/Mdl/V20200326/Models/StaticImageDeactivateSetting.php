 ...
 *
 * @method integer getLayer() Obtain The overlay level to be canceled, range 0-7, default value 0.
 * @method void setLayer(integer $Layer) Set The overlay level to be canceled, range 0-7, default value 0.
...
{
    /**
     * @var integer The overlay level to be canceled, range 0-7, default value 0.
     */
    public $Layer;
    ...
    /**
     * @param integer $Layer The overlay level to be canceled, range 0-7, default value 0.
