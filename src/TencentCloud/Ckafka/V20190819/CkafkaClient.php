 ...
 * @method Models\DescribeDatahubTopicResponse DescribeDatahubTopic(Models\DescribeDatahubTopicRequest $req) This API is used to retrieve DIP topic attributes.
 ...
 * @method Models\DescribeTopicAttributesResponse DescribeTopicAttributes(Models\DescribeTopicAttributesRequest $req) This API is used to retrieve topic attributes.
 ...
 * @method Models\DescribeTypeInstancesResponse DescribeTypeInstances(Models\DescribeTypeInstancesRequest $req) This API is used to search for a list of TDMQ CKafka instances of the specified type under a user account.
