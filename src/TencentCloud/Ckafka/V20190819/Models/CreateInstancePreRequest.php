 ...
 * @method string getPeriod() Obtain <p>Prepaid purchase duration, for example "1m", exactly one month, value ranges from 1m to 36m.</p>
 * @method void setPeriod(string $Period) Set <p>Prepaid purchase duration, for example "1m", exactly one month, value ranges from 1m to 36m.</p>
 ...
 * @method string getSpecificationsType() Obtain <p>Instance type: Fill in "standard" for [standard edition instance] (default), "profession" for [professional edition instance], and "premium" for [Advanced Edition Instance].</p>
 * @method void setSpecificationsType(string $SpecificationsType) Set <p>Instance type: Fill in "standard" for [standard edition instance] (default), "profession" for [professional edition instance], and "premium" for [Advanced Edition Instance].</p>
 ...
 * @method string getDiskType() Obtain <p>Instance disk type for Pro Edition/Advanced Edition instances. You do not need to fill it in for Standard Edition instances. "CLOUD_SSD": SSD CLOUD disk; "CLOUD_BASIC": high-performance CLOUD block storage. Defaults to "CLOUD_BASIC" if not specified.</p>
 * @method void setDiskType(string $DiskType) Set <p>Instance disk type for Pro Edition/Advanced Edition instances. You do not need to fill it in for Standard Edition instances. "CLOUD_SSD": SSD CLOUD disk; "CLOUD_BASIC": high-performance CLOUD block storage. Defaults to "CLOUD_BASIC" if not specified.</p>
...
class CreateInstancePreRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>Prepaid purchase duration, for example "1m", exactly one month, value ranges from 1m to 36m.</p>
     */
    public $Period;
    ...
    /**
     * @var string <p>Instance type: Fill in "standard" for [standard edition instance] (default), "profession" for [professional edition instance], and "premium" for [Advanced Edition Instance].</p>
     */
    ...
    /**
     * @var string <p>Instance disk type for Pro Edition/Advanced Edition instances. You do not need to fill it in for Standard Edition instances. "CLOUD_SSD": SSD CLOUD disk; "CLOUD_BASIC": high-performance CLOUD block storage. Defaults to "CLOUD_BASIC" if not specified.</p>
     */
    public $DiskType;
     ...
     * @param string $Period <p>Prepaid purchase duration, for example "1m", exactly one month, value ranges from 1m to 36m.</p>
     ...
     * @param string $SpecificationsType <p>Instance type: Fill in "standard" for [standard edition instance] (default), "profession" for [professional edition instance], and "premium" for [Advanced Edition Instance].</p>
     ...
     * @param string $DiskType <p>Instance disk type for Pro Edition/Advanced Edition instances. You do not need to fill it in for Standard Edition instances. "CLOUD_SSD": SSD CLOUD disk; "CLOUD_BASIC": high-performance CLOUD block storage. Defaults to "CLOUD_BASIC" if not specified.</p>
