 ...
 * @method string getName() Obtain Name of fuzzy matching site
 * @method void setName(string $Name) Set Name of fuzzy matching site
...
class DescribeSitesRequest extends AbstractModel
{
    ...
    /**
     * @var string Name of fuzzy matching site
     */
    public $Name;
     ...
     * @param string $Name Name of fuzzy matching site
