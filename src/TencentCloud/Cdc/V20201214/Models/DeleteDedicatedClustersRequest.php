 ...
 *
 * @method array getDedicatedClusterIds() Obtain CDC id to be deleted
 * @method void setDedicatedClusterIds(array $DedicatedClusterIds) Set CDC id to be deleted
 */
class DeleteDedicatedClustersRequest extends AbstractModel
{
    /**
     * @var array CDC id to be deleted
     */
    public $DedicatedClusterIds;

    /**
     * @param array $DedicatedClusterIds CDC id to be deleted
     */
