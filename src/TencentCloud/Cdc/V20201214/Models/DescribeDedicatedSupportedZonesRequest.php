 ...
 *
 * @method array getRegions() Obtain List of input regions
 * @method void setRegions(array $Regions) Set List of input regions
 */
class DescribeDedicatedSupportedZonesRequest extends AbstractModel
{
    /**
     * @var array List of input regions
     */
    public $Regions;

    /**
     * @param array $Regions List of input regions
     */
