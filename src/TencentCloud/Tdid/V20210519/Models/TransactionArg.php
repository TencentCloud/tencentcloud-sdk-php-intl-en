 ...
 *
 * @method string getInvokerTDid() Obtain The credential ID.
 * @method void setInvokerTDid(string $InvokerTDid) Set The credential ID.
 */
class TransactionArg extends AbstractModel
{
    ...
    /**
     * @param string $InvokerTDid The credential ID.
     */
