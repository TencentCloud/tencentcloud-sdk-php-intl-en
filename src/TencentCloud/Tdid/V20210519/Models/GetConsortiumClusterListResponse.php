 ...
 *
 * @method array getClusterList() Obtain A list of networks.
 * @method void setClusterList(array $ClusterList) Set A list of networks.
...
class GetConsortiumClusterListResponse extends AbstractModel
{
    ...
    /**
     * @param array $ClusterList A list of networks.
