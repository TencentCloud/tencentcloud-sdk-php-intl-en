 ...
 *
 * @method integer getPolicyIndex() Obtain The policy index.
 * @method void setPolicyIndex(integer $PolicyIndex) Set The policy index.
 */
class QueryPolicyRequest extends AbstractModel
{
    ...
    /**
     * @param integer $PolicyIndex The policy index.
     */
