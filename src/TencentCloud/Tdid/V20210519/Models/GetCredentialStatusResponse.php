 ...
 *
 * @method CredentialStatus getCredentialStatus() Obtain The credential status.
 * @method void setCredentialStatus(CredentialStatus $CredentialStatus) Set The credential status.
...
{
    /**
     * @var CredentialStatus The credential status.
     */
    ...
    /**
     * @param CredentialStatus $CredentialStatus The credential status.
