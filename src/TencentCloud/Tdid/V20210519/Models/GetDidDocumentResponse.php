 ...
 * @method string getDocument() Obtain The DID document.
 * @method void setDocument(string $Document) Set The DID document.
...
class GetDidDocumentResponse extends AbstractModel
{
     ...
     * @param string $Document The DID document.
