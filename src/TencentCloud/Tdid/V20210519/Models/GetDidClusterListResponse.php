 ...
 *
 * @method array getDidClusterList() Obtain A list of the DID networks.
 * @method void setDidClusterList(array $DidClusterList) Set A list of the DID networks.
...
{
    /**
     * @var array A list of the DID networks.
     */
    ...
    /**
     * @param array $DidClusterList A list of the DID networks.
