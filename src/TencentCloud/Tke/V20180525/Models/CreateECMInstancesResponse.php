 ...
 *
 * @method array getEcmIdSet() Obtain ECM ID list
 * @method void setEcmIdSet(array $EcmIdSet) Set ECM ID list
...
class CreateECMInstancesResponse extends AbstractModel
{
    ...
    /**
     * @param array $EcmIdSet ECM ID list
