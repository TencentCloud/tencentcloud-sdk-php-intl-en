 ...
 * @method ClusterAsGroupOption getClusterAsGroupOption() Obtain Cluster auto scaling attributes
 * @method void setClusterAsGroupOption(ClusterAsGroupOption $ClusterAsGroupOption) Set Cluster auto scaling attributes
 */
class ModifyClusterAsGroupOptionAttributeRequest extends AbstractModel
{
    ...
    /**
     * @var ClusterAsGroupOption Cluster auto scaling attributes
     */
    public $ClusterAsGroupOption;

    /**
     * @param string $ClusterId Cluster ID
     * @param ClusterAsGroupOption $ClusterAsGroupOption Cluster auto scaling attributes
     */
