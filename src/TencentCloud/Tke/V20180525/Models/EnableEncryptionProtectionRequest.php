 ...
 * @method KMSConfiguration getKMSConfiguration() Obtain KMS encryption configuration
 * @method void setKMSConfiguration(KMSConfiguration $KMSConfiguration) Set KMS encryption configuration
 */
class EnableEncryptionProtectionRequest extends AbstractModel
{
    ...
    /**
     * @var KMSConfiguration KMS encryption configuration
     */
    public $KMSConfiguration;

    /**
     * @param string $ClusterId Cluster ID
     * @param KMSConfiguration $KMSConfiguration KMS encryption configuration
     */
