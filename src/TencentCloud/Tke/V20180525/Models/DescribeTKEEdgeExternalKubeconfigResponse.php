 ...
 *
 * @method string getKubeconfig() Obtain Kubeconfig file content
 * @method void setKubeconfig(string $Kubeconfig) Set Kubeconfig file content
...
{
    /**
     * @var string Kubeconfig file content
     */
    public $Kubeconfig;
    ...
    /**
     * @param string $Kubeconfig Kubeconfig file content
