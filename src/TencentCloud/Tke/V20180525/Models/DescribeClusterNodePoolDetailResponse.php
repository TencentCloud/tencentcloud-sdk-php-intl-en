 ...
 *
 * @method NodePool getNodePool() Obtain Node pool details
 * @method void setNodePool(NodePool $NodePool) Set Node pool details
...
{
    /**
     * @var NodePool Node pool details
     */
    public $NodePool;
    ...
    /**
     * @param NodePool $NodePool Node pool details
