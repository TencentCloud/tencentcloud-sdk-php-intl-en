 ...
 * @method array getComponents() Obtain Component name list. currently supports cluster-autoscaler, kapenter.
 * @method void setComponents(array $Components) Set Component name list. currently supports cluster-autoscaler, kapenter.
 */
class EnableControlPlaneLogsRequest extends AbstractModel
{
     ...
     * @param array $Components Component name list. currently supports cluster-autoscaler, kapenter.
     */
