...
Note: This field may return `null`, indicating that no valid values can be obtained.
 * @method EdgeAvailableExtraArgs getAvailableExtraArgs() Obtain Available custom parameters
Note: This field may return `null`, indicating that no valid values can be obtained.
 * @method void setAvailableExtraArgs(EdgeAvailableExtraArgs $AvailableExtraArgs) Set Available custom parameters
Note: This field may return `null`, indicating that no valid values can be obtained.
...
Note: This field may return `null`, indicating that no valid values can be obtained.
    ...
    /**
     * @var EdgeAvailableExtraArgs Available custom parameters
Note: This field may return `null`, indicating that no valid values can be obtained.
     */
...
Note: This field may return `null`, indicating that no valid values can be obtained.
     * @param EdgeAvailableExtraArgs $AvailableExtraArgs Available custom parameters
Note: This field may return `null`, indicating that no valid values can be obtained.
