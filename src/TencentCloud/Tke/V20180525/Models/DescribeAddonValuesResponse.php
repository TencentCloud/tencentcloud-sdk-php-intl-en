 ...
 *
 * @method string getValues() Obtain Parameters list. If the add-on has been installed, the configured parameters are used for rendering, in a JSON string.
 * @method void setValues(string $Values) Set Parameters list. If the add-on has been installed, the configured parameters are used for rendering, in a JSON string.
...
{
    /**
     * @var string Parameters list. If the add-on has been installed, the configured parameters are used for rendering, in a JSON string.
     */
    public $Values;
    ...
    /**
     * @param string $Values Parameters list. If the add-on has been installed, the configured parameters are used for rendering, in a JSON string.
