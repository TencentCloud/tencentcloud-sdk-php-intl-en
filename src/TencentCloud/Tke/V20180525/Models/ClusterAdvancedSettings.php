 ...
 * @method boolean getDeletionProtection() Obtain Indicates whether to enable deletion protection
 * @method void setDeletionProtection(boolean $DeletionProtection) Set Indicates whether to enable deletion protection
 */
class ClusterAdvancedSettings extends AbstractModel
{
    ...
    /**
     * @var boolean Indicates whether to enable deletion protection
     */
     ...
     * @param boolean $DeletionProtection Indicates whether to enable deletion protection
     */
