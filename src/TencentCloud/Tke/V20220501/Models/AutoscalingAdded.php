 ...
 *
 * @method integer getJoining() Obtain Number of nodes being added
 * @method void setJoining(integer $Joining) Set Number of nodes being added
 * @method integer getInitializing() Obtain Number of nodes being initialized
 * @method void setInitializing(integer $Initializing) Set Number of nodes being initialized
...
{
    /**
     * @var integer Number of nodes being added
     */
    public $Joining;

    /**
     * @var integer Number of nodes being initialized
     */
    public $Initializing;
    ...
    /**
     * @param integer $Joining Number of nodes being added
     * @param integer $Initializing Number of nodes being initialized
