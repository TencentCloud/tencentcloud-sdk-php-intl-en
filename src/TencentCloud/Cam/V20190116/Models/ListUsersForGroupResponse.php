...
/**
 * @method integer getTotalNum() 获取Total number of users associated with the User Group
 * @method void setTotalNum(integer $TotalNum) 设置Total number of users associated with the User Group
 * @method array getUserInfo() 获取Sub-user information
 * @method void setUserInfo(array $UserInfo) 设置Sub-user information
