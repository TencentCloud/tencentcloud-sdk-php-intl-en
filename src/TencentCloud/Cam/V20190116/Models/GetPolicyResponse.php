...
Note: this field may return null, indicating that no valid values can be obtained.
 * @method array getTags() Obtain List of tags associated with the policy
 * @method void setTags(array $Tags) Set List of tags associated with the policy
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var array List of tags associated with the policy
     */
    public $Tags;
...
Note: this field may return null, indicating that no valid values can be obtained.
     * @param array $Tags List of tags associated with the policy
