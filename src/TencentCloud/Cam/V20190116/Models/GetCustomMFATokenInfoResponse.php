...
{
    /**
     * @var integer Account ID corresponding to the custom multi-factor verification Token
     */
    public $Uin;
    ...
    /**
     * @param integer $Uin Account ID corresponding to the custom multi-factor verification Token
