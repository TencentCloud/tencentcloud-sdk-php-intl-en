...
/**
 * @method RoleInfo getRoleInfo() Obtain Role details
 * @method void setRoleInfo(RoleInfo $RoleInfo) Set Role details
...
class GetRoleResponse extends AbstractModel
{
    ...
    public $RequestId;
    /**
     * @param RoleInfo $RoleInfo Role details
