 ...
 * @method array getVersionId() Obtain Policy version ID
 * @method void setVersionId(array $VersionId) Set Policy version ID
 */
class DeletePolicyVersionRequest extends AbstractModel
{
    ...
    /**
     * @var array Policy version ID
     */
    public $VersionId;

    /**
     * @param integer $PolicyId Policy ID
     * @param array $VersionId Policy version ID
     */
