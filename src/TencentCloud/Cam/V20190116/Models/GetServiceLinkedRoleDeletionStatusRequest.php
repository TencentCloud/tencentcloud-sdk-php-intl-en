 ...
 *
 * @method string getDeletionTaskId() Obtain Deletion task ID
 * @method void setDeletionTaskId(string $DeletionTaskId) Set Deletion task ID
 */
class GetServiceLinkedRoleDeletionStatusRequest extends AbstractModel
{
    /**
     * @var string Deletion task ID
     */
    public $DeletionTaskId;

    /**
     * @param string $DeletionTaskId Deletion task ID
     */
