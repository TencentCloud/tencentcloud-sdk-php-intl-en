 ...
 *
 * @method string getApiAppName() Obtain Custom application name.
 * @method void setApiAppName(string $ApiAppName) Set Custom application name.
...
{
    /**
     * @var string Custom application name.
     */
    public $ApiAppName;
    ...
    /**
     * @param string $ApiAppName Custom application name.
