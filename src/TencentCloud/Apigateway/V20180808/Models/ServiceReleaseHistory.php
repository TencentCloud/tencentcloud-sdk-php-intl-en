...
Note: this field may return null, indicating that no valid values can be obtained.
 * @method array getVersionList() Obtain Historical version list.
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setVersionList(array $VersionList) Set Historical version list.
Note: this field may return null, indicating that no valid values can be obtained.
 */
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var array Historical version list.
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public $VersionList;
...
Note: this field may return null, indicating that no valid values can be obtained.
     * @param array $VersionList Historical version list.
Note: this field may return null, indicating that no valid values can be obtained.
     */
