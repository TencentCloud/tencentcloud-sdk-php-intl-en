 ...
 *
 * @method string getClusterId() Obtain Microservice cluster.
 * @method void setClusterId(string $ClusterId) Set Microservice cluster.
 * @method string getNamespaceId() Obtain Microservice namespace.
 * @method void setNamespaceId(string $NamespaceId) Set Microservice namespace.
...
{
    /**
     * @var string Microservice cluster.
     */
    public $ClusterId;

    /**
     * @var string Microservice namespace.
     */
    public $NamespaceId;
    ...
    /**
     * @param string $ClusterId Microservice cluster.
     * @param string $NamespaceId Microservice namespace.
