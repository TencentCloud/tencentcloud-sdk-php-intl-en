 ...
 * @method array getFilters() Obtain Filter. Valid values: ServiceId, ServiceName, NotUsagePlanId, Environment, IpVersion.
 * @method void setFilters(array $Filters) Set Filter. Valid values: ServiceId, ServiceName, NotUsagePlanId, Environment, IpVersion.
 */
class DescribeServicesStatusRequest extends AbstractModel
{
    ...
    /**
     * @var array Filter. Valid values: ServiceId, ServiceName, NotUsagePlanId, Environment, IpVersion.
     */
    public $Filters;
     ...
     * @param array $Filters Filter. Valid values: ServiceId, ServiceName, NotUsagePlanId, Environment, IpVersion.
     */
