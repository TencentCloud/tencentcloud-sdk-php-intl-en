 ...
 * @method array getFilters() Obtain Filter. Valid values: ApiAppId, ApiAppName, KeyWord (match with `name` or ID).
 * @method void setFilters(array $Filters) Set Filter. Valid values: ApiAppId, ApiAppName, KeyWord (match with `name` or ID).
 */
class DescribeApiAppsStatusRequest extends AbstractModel
{
    ...
    /**
     * @var array Filter. Valid values: ApiAppId, ApiAppName, KeyWord (match with `name` or ID).
     */
    public $Filters;
     ...
     * @param array $Filters Filter. Valid values: ApiAppId, ApiAppName, KeyWord (match with `name` or ID).
     */
