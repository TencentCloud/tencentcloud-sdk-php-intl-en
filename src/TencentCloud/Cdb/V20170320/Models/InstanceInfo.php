...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getDeviceType() Obtain Instance type. Value range: HA (high availability edition), BASIC (basic edition)
 * @method void setDeviceType(string $DeviceType) Set Instance type. Value range: HA (high availability edition), BASIC (basic edition)
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var string Instance type. Value range: HA (high availability edition), BASIC (basic edition)
     */
    public $DeviceType;
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $DeviceType Instance type. Value range: HA (high availability edition), BASIC (basic edition)
