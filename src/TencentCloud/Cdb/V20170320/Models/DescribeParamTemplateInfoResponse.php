 ...
 * @method string getEngineVersion() Obtain The parameter template corresponds to the instance version. Valid values: 5.5, 5.6, 5.7, 8.0.
 * @method void setEngineVersion(string $EngineVersion) Set The parameter template corresponds to the instance version. Valid values: 5.5, 5.6, 5.7, 8.0.
 ...
 * @method string getEngineType() Obtain Parameter template engine. Supported values include "InnoDB", "RocksDB".
 * @method void setEngineType(string $EngineType) Set Parameter template engine. Supported values include "InnoDB", "RocksDB".
...
class DescribeParamTemplateInfoResponse extends AbstractModel
{
    ...
    /**
     * @var string The parameter template corresponds to the instance version. Valid values: 5.5, 5.6, 5.7, 8.0.
     */
    ...
    /**
     * @var string Parameter template engine. Supported values include "InnoDB", "RocksDB".
     */
    public $EngineType;
     ...
     * @param string $EngineVersion The parameter template corresponds to the instance version. Valid values: 5.5, 5.6, 5.7, 8.0.
     ...
     * @param string $EngineType Parameter template engine. Supported values include "InnoDB", "RocksDB".
