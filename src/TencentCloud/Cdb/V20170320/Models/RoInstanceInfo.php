 ...
 * @method string getZone() Obtain Canonical name of the RO Availability Zone, for example ap-shanghai-2
 * @method void setZone(string $Zone) Set Canonical name of the RO Availability Zone, for example ap-shanghai-2
...
class RoInstanceInfo extends AbstractModel
{
    ...
    /**
     * @var string Canonical name of the RO Availability Zone, for example ap-shanghai-2
     */
    public $Zone;
     ...
     * @param string $Zone Canonical name of the RO Availability Zone, for example ap-shanghai-2
