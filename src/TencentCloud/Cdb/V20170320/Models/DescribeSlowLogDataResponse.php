 ...
 * @method array getItems() Obtain Queried records.
 * @method void setItems(array $Items) Set Queried records.
...
class DescribeSlowLogDataResponse extends AbstractModel
{
     ...
     * @param array $Items Queried records.
