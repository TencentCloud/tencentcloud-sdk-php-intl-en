...
Note: this field may return `null`, indicating that no valid value can be found.
 * @method array getRWInstInfo() Obtain Information of instances in the proxy group
Note: this field may return `null`, indicating that no valid value can be found.
 * @method void setRWInstInfo(array $RWInstInfo) Set Information of instances in the proxy group
Note: this field may return `null`, indicating that no valid value can be found.
 */
...
Note: this field may return `null`, indicating that no valid value can be found.
    ...
    /**
     * @var array Information of instances in the proxy group
Note: this field may return `null`, indicating that no valid value can be found.
     */
    public $RWInstInfo;
...
Note: this field may return `null`, indicating that no valid value can be found.
     * @param array $RWInstInfo Information of instances in the proxy group
Note: this field may return `null`, indicating that no valid value can be found.
     */
