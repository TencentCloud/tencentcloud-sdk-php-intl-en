 ...
 * @method integer getRemoteBackupVolume() Obtain Total offsite backup capacity of the user in current region.
 * @method void setRemoteBackupVolume(integer $RemoteBackupVolume) Set Total offsite backup capacity of the user in current region.
 * @method integer getBackupArchiveVolume() Obtain Archive backup capacity, including data backup and log backup.
 * @method void setBackupArchiveVolume(integer $BackupArchiveVolume) Set Archive backup capacity, including data backup and log backup.
 * @method integer getBackupStandbyVolume() Obtain Standard storage backup capacity includes data backup and log backup.
 * @method void setBackupStandbyVolume(integer $BackupStandbyVolume) Set Standard storage backup capacity includes data backup and log backup.
...
class DescribeBackupOverviewResponse extends AbstractModel
{
    ...
    /**
     * @var integer Total offsite backup capacity of the user in current region.
     */
    public $RemoteBackupVolume;

    /**
     * @var integer Archive backup capacity, including data backup and log backup.
     */
    public $BackupArchiveVolume;

    /**
     * @var integer Standard storage backup capacity includes data backup and log backup.
     */
     ...
     * @param integer $RemoteBackupVolume Total offsite backup capacity of the user in current region.
     * @param integer $BackupArchiveVolume Archive backup capacity, including data backup and log backup.
     * @param integer $BackupStandbyVolume Standard storage backup capacity includes data backup and log backup.
