 ...
 * @method string getKeyId() Obtain Key ID used for encryption.
 * @method void setKeyId(string $KeyId) Set Key ID used for encryption.
 * @method string getKeyRegion() Obtain Key region.
 * @method void setKeyRegion(string $KeyRegion) Set Key region.
 * @method string getDefaultKmsRegion() Obtain The default region of the KMS service used by the current CDB backend service.
 * @method void setDefaultKmsRegion(string $DefaultKmsRegion) Set The default region of the KMS service used by the current CDB backend service.
...
class DescribeDBInstanceInfoResponse extends AbstractModel
{
    ...
    /**
     * @var string Key ID used for encryption.
     */
    public $KeyId;
    ...
    /**
     * @var string The default region of the KMS service used by the current CDB backend service.
     */
     ...
     * @param string $DefaultKmsRegion The default region of the KMS service used by the current CDB backend service.
