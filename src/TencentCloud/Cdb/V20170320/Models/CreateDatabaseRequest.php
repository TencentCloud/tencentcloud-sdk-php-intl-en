 ...
 * @method string getDBName() Obtain Database name, length not exceeding 64.
 * @method void setDBName(string $DBName) Set Database name, length not exceeding 64.
...
class CreateDatabaseRequest extends AbstractModel
{
    ...
    /**
     * @var string Database name, length not exceeding 64.
     */
    public $DBName;
     ...
     * @param string $DBName Database name, length not exceeding 64.
