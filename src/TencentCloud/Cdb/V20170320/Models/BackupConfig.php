 ...
 * @method string getZone() Obtain The canonical name of the second secondary availability zone, for example ap-shanghai-2
 * @method void setZone(string $Zone) Set The canonical name of the second secondary availability zone, for example ap-shanghai-2
...
class BackupConfig extends AbstractModel
{
    ...
    /**
     * @var string The canonical name of the second secondary availability zone, for example ap-shanghai-2
     */
    public $Zone;
     ...
     * @param string $Zone The canonical name of the second secondary availability zone, for example ap-shanghai-2
