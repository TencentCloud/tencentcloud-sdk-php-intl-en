 ...
 * @method string getDesc() Obtain Database proxy description
 * @method void setDesc(string $Desc) Set Database proxy description
 */
class ModifyCDBProxyDescRequest extends AbstractModel
{
    ...
    /**
     * @var string Database proxy description
     */
    public $Desc;
     ...
     * @param string $Desc Database proxy description
     */
