...
Note: this field may return `null`, indicating that no valid value can be found.
 * @method RWInfo getRWInstInfo() Obtain Routing information of the proxy
Note: this field may return `null`, indicating that no valid value can be found.
 * @method void setRWInstInfo(RWInfo $RWInstInfo) Set Routing information of the proxy
Note: this field may return `null`, indicating that no valid value can be found.
 */
...
Note: this field may return `null`, indicating that no valid value can be found.
    ...
    /**
     * @var RWInfo Routing information of the proxy
Note: this field may return `null`, indicating that no valid value can be found.
     */
    public $RWInstInfo;
...
Note: this field may return `null`, indicating that no valid value can be found.
     * @param RWInfo $RWInstInfo Routing information of the proxy
Note: this field may return `null`, indicating that no valid value can be found.
     */
