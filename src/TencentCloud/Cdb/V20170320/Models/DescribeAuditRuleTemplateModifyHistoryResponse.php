 ...
 * @method array getItems() Obtain Change details.
 * @method void setItems(array $Items) Set Change details.
...
class DescribeAuditRuleTemplateModifyHistoryResponse extends AbstractModel
{
     ...
     * @param array $Items Change details.
