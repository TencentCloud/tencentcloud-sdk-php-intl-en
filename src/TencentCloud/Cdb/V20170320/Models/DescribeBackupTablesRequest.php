 ...
 * @method string getDatabaseName() Obtain Specified database name.
 * @method void setDatabaseName(string $DatabaseName) Set Specified database name.
 * @method string getSearchTable() Obtain Prefix of the table to be queried.
 * @method void setSearchTable(string $SearchTable) Set Prefix of the table to be queried.
...
class DescribeBackupTablesRequest extends AbstractModel
{
    ...
    /**
     * @var string Specified database name.
     */
    public $DatabaseName;

    /**
     * @var string Prefix of the table to be queried.
     */
    public $SearchTable;
     ...
     * @param string $DatabaseName Specified database name.
     * @param string $SearchTable Prefix of the table to be queried.
