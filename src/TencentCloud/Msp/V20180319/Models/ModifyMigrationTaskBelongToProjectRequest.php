 ...
 * @method integer getProjectId() Obtain Project ID, such as 10005
 * @method void setProjectId(integer $ProjectId) Set Project ID, such as 10005
 */
class ModifyMigrationTaskBelongToProjectRequest extends AbstractModel
{
    ...
    /**
     * @var integer Project ID, such as 10005
     */
    public $ProjectId;

    /**
     * @param string $TaskId Task ID, such as msp-jitoh33n
     * @param integer $ProjectId Project ID, such as 10005
     */
