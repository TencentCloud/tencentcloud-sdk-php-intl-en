 ...
 *
 * @method array getTaskStatus() Obtain Migration details list
 * @method void setTaskStatus(array $TaskStatus) Set Migration details list
...
{
    /**
     * @var array Migration details list
     */
    public $TaskStatus;
    ...
    /**
     * @param array $TaskStatus Migration details list
