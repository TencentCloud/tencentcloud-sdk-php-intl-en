 ...
 * @method string getIp() Obtain Migration source Ip
 * @method void setIp(string $Ip) Set Migration source Ip
...
class SrcInfo extends AbstractModel
{
    ...
    /**
     * @var string Migration source Ip
     */
    public $Ip;
     ...
     * @param string $Ip Migration source Ip
