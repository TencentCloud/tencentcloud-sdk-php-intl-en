 ...
 *
 * @method array getDataList() Obtain <p>Data list.</p>
 * @method void setDataList(array $DataList) Set <p>Data list.</p>
 * @method integer getTotal() Obtain <p>Total number of records</p>
 * @method void setTotal(integer $Total) Set <p>Total number of records</p>
...
class DescribeCaptchaIpWhiteListDataNew extends AbstractModel
{
    ...
    /**
     * @param array $DataList <p>Data list.</p>
     * @param integer $Total <p>Total number of records</p>
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("DataList",$param) and $param["DataList"] !== null) {
            ...
            foreach ($param["DataList"] as $key => $value){
                $obj = new DescribeCaptchaWhiteListItem();
