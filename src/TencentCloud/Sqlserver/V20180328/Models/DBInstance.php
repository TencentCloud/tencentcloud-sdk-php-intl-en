 ...
 * @method integer getModel() Obtain Instance high availability status. 1: dual-server high-availability, 2: single-server
 * @method void setModel(integer $Model) Set Instance high availability status. 1: dual-server high-availability, 2: single-server
...
class DBInstance extends AbstractModel
{
    ...
    /**
     * @var integer Instance high availability status. 1: dual-server high-availability, 2: single-server
     */
    public $Model;
     ...
     * @param integer $Model Instance high availability status. 1: dual-server high-availability, 2: single-server
