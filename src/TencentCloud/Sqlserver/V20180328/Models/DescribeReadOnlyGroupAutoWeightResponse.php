 ...
 * @method string getZoneId() Obtain AZ of the read-only group, which is the same as that of the primary instance.
 * @method void setZoneId(string $ZoneId) Set AZ of the read-only group, which is the same as that of the primary instance.
 * @method integer getIsOfflineDelay() Obtain Whether to enable the delayed read-only instance removal feature. 1 - enabled; 0 - disabled.
 * @method void setIsOfflineDelay(integer $IsOfflineDelay) Set Whether to enable the delayed read-only instance removal feature. 1 - enabled; 0 - disabled.
...
class DescribeReadOnlyGroupAutoWeightResponse extends AbstractModel
{
    ...
    /**
     * @var string AZ of the read-only group, which is the same as that of the primary instance.
     */
    public $ZoneId;

    /**
     * @var integer Whether to enable the delayed read-only instance removal feature. 1 - enabled; 0 - disabled.
     */
     ...
     * @param string $ZoneId AZ of the read-only group, which is the same as that of the primary instance.
     * @param integer $IsOfflineDelay Whether to enable the delayed read-only instance removal feature. 1 - enabled; 0 - disabled.
