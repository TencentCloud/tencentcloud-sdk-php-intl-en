 ...
 * @method array getAccounts() Obtain Account permission list.
 * @method void setAccounts(array $Accounts) Set Account permission list.
...
class DescribeAccountPrivilegeByDBResponse extends AbstractModel
{
    ...
    /**
     * @var array Account permission list.
     */
    public $Accounts;
     ...
     * @param array $Accounts Account permission list.
