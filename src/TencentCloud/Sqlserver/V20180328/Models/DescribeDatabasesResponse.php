 ...
 * @method array getDBInstances() Obtain Instance database list.
 * @method void setDBInstances(array $DBInstances) Set Instance database list.
...
class DescribeDatabasesResponse extends AbstractModel
{
    ...
    /**
     * @var array Instance database list.
     */
    public $DBInstances;
     ...
     * @param array $DBInstances Instance database list.
