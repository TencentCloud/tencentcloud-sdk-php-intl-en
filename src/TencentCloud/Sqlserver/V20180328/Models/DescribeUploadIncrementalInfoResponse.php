 ...
 * @method string getRegion() Obtain Bucket region information.
 * @method void setRegion(string $Region) Set Bucket region information.
 ...
 * @method string getTmpSecretKey() Obtain Temporary key.
 * @method void setTmpSecretKey(string $TmpSecretKey) Set Temporary key.
 * @method string getXCosSecurityToken() Obtain Temporary token.
 * @method void setXCosSecurityToken(string $XCosSecurityToken) Set Temporary token.
 ...
 * @method string getCosSecurityToken() Obtain Temporary token.
 * @method void setCosSecurityToken(string $CosSecurityToken) Set Temporary token.
...
class DescribeUploadIncrementalInfoResponse extends AbstractModel
{
    ...
    /**
     * @var string Bucket region information.
     */
    public $Region;
     ...
     * @param string $Region Bucket region information.
     * @param string $Path Storage path.
     * @param string $TmpSecretId Temporary key ID.
     * @param string $TmpSecretKey Temporary key.
     * @param string $XCosSecurityToken Temporary token.
     * @param string $StartTime Temporary key start time.
     * @param string $ExpiredTime Temporary key expiration time.
     * @param string $CosSecurityToken Temporary token.
