 ...
 * @method string getInstanceNote() Obtain Instance remarks.
 * @method void setInstanceNote(string $InstanceNote) Set Instance remarks.
 */
class ModifyDBInstanceNoteRequest extends AbstractModel
{
     ...
     * @param string $InstanceNote Instance remarks.
     */
