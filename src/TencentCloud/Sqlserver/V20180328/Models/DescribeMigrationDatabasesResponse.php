 ...
 *
 * @method integer getAmount() Obtain Number of databases.
 * @method void setAmount(integer $Amount) Set Number of databases.
 * @method array getMigrateDBSet() Obtain Database name array.
 * @method void setMigrateDBSet(array $MigrateDBSet) Set Database name array.
...
class DescribeMigrationDatabasesResponse extends AbstractModel
{
    ...
    /**
     * @param integer $Amount Number of databases.
     * @param array $MigrateDBSet Database name array.
