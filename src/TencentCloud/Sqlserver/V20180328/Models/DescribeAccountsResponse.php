 ...
 * @method array getAccounts() Obtain Account information list
 * @method void setAccounts(array $Accounts) Set Account information list
...
class DescribeAccountsResponse extends AbstractModel
{
    ...
    /**
     * @var array Account information list
     */
    public $Accounts;
     ...
     * @param array $Accounts Account information list
