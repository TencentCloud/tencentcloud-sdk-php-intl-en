 ...
 * @method array getBackupMigrationSet() Obtain Migration task set
 * @method void setBackupMigrationSet(array $BackupMigrationSet) Set Migration task set
...
class DescribeBackupMigrationResponse extends AbstractModel
{
     ...
     * @param array $BackupMigrationSet Migration task set
