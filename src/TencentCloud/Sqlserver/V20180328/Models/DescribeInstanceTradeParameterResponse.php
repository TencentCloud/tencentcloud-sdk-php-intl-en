 ...
 *
 * @method string getParameter() Obtain Billing parameter.
 * @method void setParameter(string $Parameter) Set Billing parameter.
...
class DescribeInstanceTradeParameterResponse extends AbstractModel
{
    ...
    /**
     * @param string $Parameter Billing parameter.
