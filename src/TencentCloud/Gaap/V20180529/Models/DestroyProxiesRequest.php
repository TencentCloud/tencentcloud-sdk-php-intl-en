...
/**
 * @method integer getForce() 获取The identifier for forced deletion
 ...
 * @method void setForce(integer $Force) 设置The identifier for forced deletion
1: this connection list is deleted forcibly regardless of whether the origin server has been bound.
0: this connection list cannot be deleted if the origin server has been bound.
If this identifier is 0, the deletion can be performed only when all the connections have not been bound to any origin servers.
 * @method array getInstanceIds() 获取List of connection instance IDs; It’s an old parameter, please switch to ProxyIds.
 * @method void setInstanceIds(array $InstanceIds) 设置List of connection instance IDs; It’s an old parameter, please switch to ProxyIds.
...
For more information, please see How to Ensure Idempotence.
 * @method array getProxyIds() 获取List of connection instance IDs; It’s a new parameter.
 * @method void setProxyIds(array $ProxyIds) 设置List of connection instance IDs; It’s a new parameter.
 */
