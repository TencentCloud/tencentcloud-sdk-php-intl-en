...
{
    /**
     * @var integer Total quantity of listeners that matches the conditions
     */
    public $TotalCount;

    /**
     * @var array TCP listener list
     */
    public $ListenerSet;
    ...
    /**
     * @param integer $TotalCount Total quantity of listeners that matches the conditions
     * @param array $ListenerSet TCP listener list
