 ...
 *
 * @method array getInvalidStatusInstanceSet() Obtain List of IDs of the connection instances that are not running, which cannot be enabled.
 * @method void setInvalidStatusInstanceSet(array $InvalidStatusInstanceSet) Set List of IDs of the connection instances that are not running, which cannot be enabled.
...
{
    /**
     * @var array List of IDs of the connection instances that are not running, which cannot be enabled.
     */
    ...
    /**
     * @param array $InvalidStatusInstanceSet List of IDs of the connection instances that are not running, which cannot be enabled.
