...
/**
 * @method array getInstanceStatusSet() 获取Connection status list.
 * @method void setInstanceStatusSet(array $InstanceStatusSet) 设置Connection status list.
...
{
    /**
     * @var array Connection status list.
     */
