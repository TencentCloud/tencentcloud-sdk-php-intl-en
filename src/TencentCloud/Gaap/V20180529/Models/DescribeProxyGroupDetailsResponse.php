...
/**
 * @method ProxyGroupDetail getProxyGroupDetail() 获取Connection group details
 * @method void setProxyGroupDetail(ProxyGroupDetail $ProxyGroupDetail) 设置Connection group details
