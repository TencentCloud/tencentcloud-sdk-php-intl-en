...
/**
 * @method array getInstanceIds() 获取Connection instance ID; It’s an old parameter, please switch to ProxyIds.
 * @method void setInstanceIds(array $InstanceIds) 设置Connection instance ID; It’s an old parameter, please switch to ProxyIds.
...
For more information, please see How to Ensure Idempotence.
 * @method array getProxyIds() 获取Connection instance ID; It’s a new parameter.
 * @method void setProxyIds(array $ProxyIds) 设置Connection instance ID; It’s a new parameter.
 */
