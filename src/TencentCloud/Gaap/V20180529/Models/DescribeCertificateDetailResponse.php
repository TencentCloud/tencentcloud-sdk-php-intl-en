...
/**
 * @method CertificateDetail getCertificateDetail() 获取Certificate Details.
 * @method void setCertificateDetail(CertificateDetail $CertificateDetail) 设置Certificate Details.
