...
/**
 * @method array getCountryAreaMappingList() 获取Country/region code mapping table
 * @method void setCountryAreaMappingList(array $CountryAreaMappingList) 设置Country/region code mapping table
