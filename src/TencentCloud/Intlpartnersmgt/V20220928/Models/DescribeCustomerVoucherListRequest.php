 ...
 * @method string getUsage() Obtain valid values: ProductTrial, CustomerOffer.
 * @method void setUsage(string $Usage) Set valid values: ProductTrial, CustomerOffer.
...
class DescribeCustomerVoucherListRequest extends AbstractModel
{
    ...
    /**
     * @var string valid values: ProductTrial, CustomerOffer.
     */
    public $Usage;
     ...
     * @param string $Usage valid values: ProductTrial, CustomerOffer.
