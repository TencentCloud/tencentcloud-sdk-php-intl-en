 ...
 * @method string getReason() Obtain Binding Results
 * @method void setReason(string $Reason) Set Binding Results
...
class CreateAccountResponse extends AbstractModel
{
     ...
     * @param string $Reason Binding Results
