 ...
 * @method Models\DescribeCustomerOwnCostExplorerSummaryResponse DescribeCustomerOwnCostExplorerSummary(Models\DescribeCustomerOwnCostExplorerSummaryRequest $req) Cost analysis API
 ...
 * @method Models\DescribeCustomerVoucherUsageDetailsResponse DescribeCustomerVoucherUsageDetails(Models\DescribeCustomerVoucherUsageDetailsRequest $req) Description: The current API is used to query the usage details of reseller's customer vouchers by Reseller, Second-level Reseller or Distributor.
...
Callable roles: Distributor, Second-level reseller, Reseller
 * @method Models\QueryInvitationInfoResponse QueryInvitationInfo(Models\QueryInvitationInfoRequest $req) Query usage information of invitation link. Invitation link is valid for 30 days.And once created, the data will only be retained for 60 days, and the system will automatically delete the invitation link after 60 days.
