 ...
 * @method string getName() Obtain This field is optional and indicates the name of an audio moderation task for subsequent query and management of moderation tasks.
 * @method void setName(string $Name) Set This field is optional and indicates the name of an audio moderation task for subsequent query and management of moderation tasks.
...
class TaskInput extends AbstractModel
{
    ...
    /**
     * @var string This field is optional and indicates the name of an audio moderation task for subsequent query and management of moderation tasks.
     */
    public $Name;
     ...
     * @param string $Name This field is optional and indicates the name of an audio moderation task for subsequent query and management of moderation tasks.
