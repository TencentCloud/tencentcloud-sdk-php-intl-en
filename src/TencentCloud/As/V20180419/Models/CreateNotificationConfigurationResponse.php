...
/**
 * @method string getAutoScalingNotificationId() 获取Notification ID.
 * @method void setAutoScalingNotificationId(string $AutoScalingNotificationId) 设置Notification ID.
