 ...
 * @method integer getCooldown() 获取Cooldown period in seconds. Default value: 300 seconds.
 * @method void setCooldown(integer $Cooldown) 设置Cooldown period in seconds. Default value: 300 seconds.
