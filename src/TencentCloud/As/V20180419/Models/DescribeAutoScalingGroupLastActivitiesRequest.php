...
/**
 * @method array getAutoScalingGroupIds() 获取ID list of an auto scaling group.
 * @method void setAutoScalingGroupIds(array $AutoScalingGroupIds) 设置ID list of an auto scaling group.
 */
