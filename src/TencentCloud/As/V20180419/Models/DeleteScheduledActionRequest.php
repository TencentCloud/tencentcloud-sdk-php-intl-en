...
/**
 * @method string getScheduledActionId() 获取ID of the scheduled task to be deleted.
 * @method void setScheduledActionId(string $ScheduledActionId) 设置ID of the scheduled task to be deleted.
 */
