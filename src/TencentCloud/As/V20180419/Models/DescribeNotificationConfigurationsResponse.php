 ...
 * @method array getAutoScalingNotificationSet() 获取List of AS event notification details.
 * @method void setAutoScalingNotificationSet(array $AutoScalingNotificationSet) 设置List of AS event notification details.
