 ...
 *
 * @method string getAlarmNoticeId() Obtain Alarm template ID
 * @method void setAlarmNoticeId(string $AlarmNoticeId) Set Alarm template ID
...
class CreateAlarmNoticeResponse extends AbstractModel
{
    ...
    /**
     * @param string $AlarmNoticeId Alarm template ID
