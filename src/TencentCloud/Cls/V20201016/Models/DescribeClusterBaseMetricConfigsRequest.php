 ...
 * @method array getFilters() Obtain <li> Filter the topicId by [metric topic id]. Type: String. Required: No</li>
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li>
 * @method void setFilters(array $Filters) Set <li> Filter the topicId by [metric topic id]. Type: String. Required: No</li>
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li>
...
class DescribeClusterBaseMetricConfigsRequest extends AbstractModel
{
    ...
    /**
     * @var array <li> Filter the topicId by [metric topic id]. Type: String. Required: No</li>
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li>
     */
    public $Filters;
     ...
     * @param array $Filters <li> Filter the topicId by [metric topic id]. Type: String. Required: No</li>
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li>
