 ...
 * @method array getFilters() Obtain <li>Filter configId by [collection configuration id]. Type: String. Required: No</li>
 ...
 * @method void setFilters(array $Filters) Set <li>Filter configId by [collection configuration id]. Type: String. Required: No</li>
<li>name - String - required: no - filter by [configuration name]</li>
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li>
...
class DescribeClusterMetricConfigsRequest extends AbstractModel
{
    ...
    /**
     * @var array <li>Filter configId by [collection configuration id]. Type: String. Required: No</li>
<li>name - String - required: no - filter by [configuration name]</li>
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li>
     */
    public $Filters;
     ...
     * @param array $Filters <li>Filter configId by [collection configuration id]. Type: String. Required: No</li>
<li>name - String - required: no - filter by [configuration name]</li>
<li>Each request can have up to 10 Filters. The total upper limit of ALL Filter.Values is 100.</li>
