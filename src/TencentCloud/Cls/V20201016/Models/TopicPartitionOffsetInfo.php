...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method array getPartitionOffsets() Obtain Partition offset information.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setPartitionOffsets(array $PartitionOffsets) Set Partition offset information.
Note: This field may return null, indicating that no valid values can be obtained.
 */
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param array $PartitionOffsets Partition offset information.
Note: This field may return null, indicating that no valid values can be obtained.
     */
