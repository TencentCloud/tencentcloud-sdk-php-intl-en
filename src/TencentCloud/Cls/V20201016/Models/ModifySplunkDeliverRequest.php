 ...
 * @method string getName() Obtain <p>The delivery task name has the following restrictions: - Cannot be empty - Length not greater than 256 - Can only contain aA-zZ, underscore, -, 0-9</p>
 * @method void setName(string $Name) Set <p>The delivery task name has the following restrictions: - Cannot be empty - Length not greater than 256 - Can only contain aA-zZ, underscore, -, 0-9</p>
 * @method integer getEnable() Obtain <p>Task enable status. Valid values: 0: disabled; 1: enabled.</p>
 * @method void setEnable(integer $Enable) Set <p>Task enable status. Valid values: 0: disabled; 1: enabled.</p>
 ...
 * @method integer getHasServiceLog() Obtain <p>Whether to enable the service log; 1: Disabled; 2: Enabled</p>
 * @method void setHasServiceLog(integer $HasServiceLog) Set <p>Whether to enable the service log; 1: Disabled; 2: Enabled</p>
 * @method integer getIndexAck() Obtain <p>Advanced configuration - Whether to enable the indexer;<br>1 - Disable; 2 - Enable; Default: 1</p>
 * @method void setIndexAck(integer $IndexAck) Set <p>Advanced configuration - Whether to enable the indexer;<br>1 - Disable; 2 - Enable; Default: 1</p>
 ...
 * @method string getChannel() Obtain <p>Advanced configuration - Channel.<br>To meet the limitation: If the indexer is enabled, the value cannot be empty.</p>
 * @method void setChannel(string $Channel) Set <p>Advanced configuration - Channel.<br>To meet the limitation: If the indexer is enabled, the value cannot be empty.</p>
 * @method string getDSLFilter() Obtain <p>Pre-filtering process - filter out original data before writing to Splunk</p>
 * @method void setDSLFilter(string $DSLFilter) Set <p>Pre-filtering process - filter out original data before writing to Splunk</p>
...
class ModifySplunkDeliverRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>The delivery task name has the following restrictions: - Cannot be empty - Length not greater than 256 - Can only contain aA-zZ, underscore, -, 0-9</p>
     */
    public $Name;

    /**
     * @var integer <p>Task enable status. Valid values: 0: disabled; 1: enabled.</p>
     */
    public $Enable;
    ...
    /**
     * @var integer <p>Whether to enable the service log; 1: Disabled; 2: Enabled</p>
     */
    public $HasServiceLog;

    /**
     * @var integer <p>Advanced configuration - Whether to enable the indexer;<br>1 - Disable; 2 - Enable; Default: 1</p>
     */
    public $IndexAck;
    ...
    /**
     * @var string <p>Advanced configuration - Channel.<br>To meet the limitation: If the indexer is enabled, the value cannot be empty.</p>
     */
    public $Channel;

    /**
     * @var string <p>Pre-filtering process - filter out original data before writing to Splunk</p>
     */
    public $DSLFilter;
     ...
     * @param string $Name <p>The delivery task name has the following restrictions: - Cannot be empty - Length not greater than 256 - Can only contain aA-zZ, underscore, -, 0-9</p>
     * @param integer $Enable <p>Task enable status. Valid values: 0: disabled; 1: enabled.</p>
     ...
     * @param integer $HasServiceLog <p>Whether to enable the service log; 1: Disabled; 2: Enabled</p>
     * @param integer $IndexAck <p>Advanced configuration - Whether to enable the indexer;<br>1 - Disable; 2 - Enable; Default: 1</p>
     ...
     * @param string $Channel <p>Advanced configuration - Channel.<br>To meet the limitation: If the indexer is enabled, the value cannot be empty.</p>
     * @param string $DSLFilter <p>Pre-filtering process - filter out original data before writing to Splunk</p>
