 ...
 *
 * @method string getTaskId() Obtain Import task id.
 * @method void setTaskId(string $TaskId) Set Import task id.
 ...
 * @method EsInfo getEsInfo() Obtain es cluster configuration.
 * @method void setEsInfo(EsInfo $EsInfo) Set es cluster configuration.
 ...
 * @method integer getStatus() Obtain Task status. 1: Running, 2: Suspended.
 * @method void setStatus(integer $Status) Set Task status. 1: Running, 2: Suspended.
...
- Obtain the log topic Id through [Create Log Topic](https://www.tencentcloud.com/document/product/614/56456?from_cn_redirect=1).
    ...
    /**
     * @var EsInfo es cluster configuration.
     */
    public $EsInfo;
    ...
    /**
     * @var integer Task status. 1: Running, 2: Suspended.
     */
    public $Status;
    ...
    /**
     * @param string $TaskId Import task id.
