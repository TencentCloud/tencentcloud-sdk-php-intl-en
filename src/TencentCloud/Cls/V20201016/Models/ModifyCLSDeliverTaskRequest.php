 ...
 * @method integer getEnable() Obtain <p>Status.</p><p>Enumeration values: </p><ul><li>0: Running, </li><li>1: Suspension.</li></ul>
 * @method void setEnable(integer $Enable) Set <p>Status.</p><p>Enumeration values: </p><ul><li>0: Running, </li><li>1: Suspension.</li></ul>
...
class ModifyCLSDeliverTaskRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>Status.</p><p>Enumeration values: </p><ul><li>0: Running, </li><li>1: Suspension.</li></ul>
     */
    public $Enable;
     ...
     * @param integer $Enable <p>Status.</p><p>Enumeration values: </p><ul><li>0: Running, </li><li>1: Suspension.</li></ul>
