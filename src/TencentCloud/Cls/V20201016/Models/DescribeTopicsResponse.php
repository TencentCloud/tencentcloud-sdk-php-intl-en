 ...
 *
 * @method array getTopics() Obtain Log topic list
 * @method void setTopics(array $Topics) Set Log topic list
...
class DescribeTopicsResponse extends AbstractModel
{
    ...
    /**
     * @param array $Topics Log topic list
