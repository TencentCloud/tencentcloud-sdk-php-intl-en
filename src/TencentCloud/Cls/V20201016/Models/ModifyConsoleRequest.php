 ...
 *
 * @method string getConsoleId() Obtain <p>DataSight Console ConsoleId</p>
 * @method void setConsoleId(string $ConsoleId) Set <p>DataSight Console ConsoleId</p>
 ...
 * @method integer getLoginMode() Obtain <p>Login methods</p><p>Enumeration value:</p><ul><li>0: Account password authentication</li><li>1: Anonymous login</li><li>2: Third-party authentication login</li></ul>
 * @method void setLoginMode(integer $LoginMode) Set <p>Login methods</p><p>Enumeration value:</p><ul><li>0: Account password authentication</li><li>1: Anonymous login</li><li>2: Third-party authentication login</li></ul>
 ...
 * @method array getAccounts() Obtain <p>User account information</p><p>"Account password authentication" is required for login methods.</p>
 * @method void setAccounts(array $Accounts) Set <p>User account information</p><p>"Account password authentication" is required for login methods.</p>
 * @method AnonymousLoginInfo getAnonymousLogin() Obtain <p>Anonymous login account information</p><p>"Anonymous login" is required for the login method.</p>
 * @method void setAnonymousLogin(AnonymousLoginInfo $AnonymousLogin) Set <p>Anonymous login account information</p><p>"Anonymous login" is required for the login method.</p>
 ...
 * @method array getAuthRoles() Obtain <p>Auth user role information</p><p>"Third-party authentication login" is required for the login method.</p>
 * @method void setAuthRoles(array $AuthRoles) Set <p>Auth user role information</p><p>"Third-party authentication login" is required for the login method.</p>
 ...
 * @method array getMenus() Obtain <p>Custom display menu</p>
 * @method void setMenus(array $Menus) Set <p>Custom display menu</p>
 */
class ModifyConsoleRequest extends AbstractModel
{
    /**
     * @var string <p>DataSight Console ConsoleId</p>
     */
    public $ConsoleId;
    ...
    /**
     * @var integer <p>Login methods</p><p>Enumeration value:</p><ul><li>0: Account password authentication</li><li>1: Anonymous login</li><li>2: Third-party authentication login</li></ul>
     */
    public $LoginMode;
    ...
    /**
     * @var array <p>User account information</p><p>"Account password authentication" is required for login methods.</p>
     */
    public $Accounts;

    /**
     * @var AnonymousLoginInfo <p>Anonymous login account information</p><p>"Anonymous login" is required for the login method.</p>
     */
    ...
    /**
     * @var array <p>Auth user role information</p><p>"Third-party authentication login" is required for the login method.</p>
     */
    public $AuthRoles;
    ...
    /**
     * @var array <p>Custom display menu</p>
     */
    public $Menus;

    /**
     * @param string $ConsoleId <p>DataSight Console ConsoleId</p>
     * @param array $AccessMode <p>Access method: public - public network, internal - private network</p>
     * @param integer $LoginMode <p>Login methods</p><p>Enumeration value:</p><ul><li>0: Account password authentication</li><li>1: Anonymous login</li><li>2: Third-party authentication login</li></ul>
     * @param string $DomainPrefix <p>Custom domain name prefix</p>
     * @param array $Accounts <p>User account information</p><p>"Account password authentication" is required for login methods.</p>
     * @param AnonymousLoginInfo $AnonymousLogin <p>Anonymous login account information</p><p>"Anonymous login" is required for the login method.</p>
     ...
     * @param array $AuthRoles <p>Auth user role information</p><p>"Third-party authentication login" is required for the login method.</p>
     ...
     * @param array $Menus <p>Custom display menu</p>
     */
