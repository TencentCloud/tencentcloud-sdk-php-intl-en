 ...
 *
 * @method string getTopicId() Obtain ID of the log topic to be searched for
 * @method void setTopicId(string $TopicId) Set ID of the log topic to be searched for
...
{
    /**
     * @var string ID of the log topic to be searched for
     */
    public $TopicId;
    ...
    /**
     * @param string $TopicId ID of the log topic to be searched for
