 ...
 * @method string getUserDefineRule() Obtain Custom parsing string, which is a serialized JSON string
 * @method void setUserDefineRule(string $UserDefineRule) Set Custom parsing string, which is a serialized JSON string
 */
class ModifyConfigRequest extends AbstractModel
{
    ...
    /**
     * @var string Custom parsing string, which is a serialized JSON string
     */
     ...
     * @param string $UserDefineRule Custom parsing string, which is a serialized JSON string
     */
