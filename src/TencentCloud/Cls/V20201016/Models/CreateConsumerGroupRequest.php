 ...
 *
 * @method string getConsumerGroup() Obtain ID of the created consumer group
Restriction: Alphanumeric underscore, numbers not allowed at the beginning, length limited to 256.
 * @method void setConsumerGroup(string $ConsumerGroup) Set ID of the created consumer group
Restriction: Alphanumeric underscore, numbers not allowed at the beginning, length limited to 256.
 ...
 * @method array getTopics() Obtain List of log topics included in the created consumer group.
 * @method void setTopics(array $Topics) Set List of log topics included in the created consumer group.
...
{
    /**
     * @var string ID of the created consumer group
Restriction: Alphanumeric underscore, numbers not allowed at the beginning, length limited to 256.
     */
    ...
    /**
     * @var array List of log topics included in the created consumer group.
     */
    public $Topics;
    ...
    /**
     * @param string $ConsumerGroup ID of the created consumer group
Restriction: Alphanumeric underscore, numbers not allowed at the beginning, length limited to 256.
     * @param integer $Timeout Consumer heartbeat timeout (seconds).
     * @param array $Topics List of log topics included in the created consumer group.
