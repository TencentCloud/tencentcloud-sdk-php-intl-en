 ...
 * @method integer getStatus() Obtain <p>-1 Creating, 1 Creation completed</p>
 * @method void setStatus(integer $Status) Set <p>-1 Creating, 1 Creation completed</p>
...
class CreateCloudProductLogCollectionResponse extends AbstractModel
{
    ...
    /**
     * @var integer <p>-1 Creating, 1 Creation completed</p>
     */
    public $Status;
     ...
     * @param integer $Status <p>-1 Creating, 1 Creation completed</p>
