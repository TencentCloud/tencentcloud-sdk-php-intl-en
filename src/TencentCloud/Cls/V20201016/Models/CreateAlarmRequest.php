 ...
 * @method boolean getStatus() Obtain Whether to enable the alarm policy. Default value: true
 * @method void setStatus(boolean $Status) Set Whether to enable the alarm policy. Default value: true
...
class CreateAlarmRequest extends AbstractModel
{
    ...
    /**
     * @var boolean Whether to enable the alarm policy. Default value: true
     */
    public $Status;
     ...
     * @param boolean $Status Whether to enable the alarm policy. Default value: true
