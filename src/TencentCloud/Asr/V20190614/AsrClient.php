...
/**
 * @method Models\CreateRecTaskResponse CreateRecTask(Models\CreateRecTaskRequest $req) This API can be used to recognize audio content with a long duration in recording files. For product pricing, see [Billing Overview (Online Version)](https://www.tencentcloud.com/zh/document/product/1118/43352)
 ...
 * @method Models\DescribeTaskStatusResponse DescribeTaskStatus(Models\DescribeTaskStatusRequest $req) The recognition results can be obtained through callback or polling after the recording recognition request API is called.
