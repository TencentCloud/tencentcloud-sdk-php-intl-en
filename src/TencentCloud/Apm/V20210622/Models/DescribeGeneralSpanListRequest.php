 ...
 * @method integer getLimit() Obtain <p>Count of single-page projects. Defaults to 1000. Valid value range is 1–1000.</p>
 * @method void setLimit(integer $Limit) Set <p>Count of single-page projects. Defaults to 1000. Valid value range is 1–1000.</p>
...
class DescribeGeneralSpanListRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>Count of single-page projects. Defaults to 1000. Valid value range is 1–1000.</p>
     */
    public $Limit;
     ...
     * @param integer $Limit <p>Count of single-page projects. Defaults to 1000. Valid value range is 1–1000.</p>
