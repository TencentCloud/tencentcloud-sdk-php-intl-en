 ...
 * @method string getValue() Obtain Value definition.
 * @method void setValue(string $Value) Set Value definition.
 */
class APMKVItem extends AbstractModel
{
    ...
    /**
     * @var string Value definition.
     */
    public $Value;

    /**
     * @param string $Key Key value definition.
     * @param string $Value Value definition.
     */
