 ...
 *
 * @method array getWeeklyReportNonlocalLoginPlaces() Obtain Unusual login location data in weekly CWP Pro report
 * @method void setWeeklyReportNonlocalLoginPlaces(array $WeeklyReportNonlocalLoginPlaces) Set Unusual login location data in weekly CWP Pro report
...
{
    /**
     * @var array Unusual login location data in weekly CWP Pro report
     */
    ...
    /**
     * @param array $WeeklyReportNonlocalLoginPlaces Unusual login location data in weekly CWP Pro report
