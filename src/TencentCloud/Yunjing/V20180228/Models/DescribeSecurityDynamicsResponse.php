 ...
 *
 * @method array getSecurityDynamics() Obtain Security event message array.
 * @method void setSecurityDynamics(array $SecurityDynamics) Set Security event message array.
...
{
    /**
     * @var array Security event message array.
     */
    ...
    /**
     * @param array $SecurityDynamics Security event message array.
