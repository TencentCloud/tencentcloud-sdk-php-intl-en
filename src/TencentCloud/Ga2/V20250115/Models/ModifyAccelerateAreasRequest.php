 ...
 * @method array getAcceleratorAreas() Obtain <p>Acceleration region info.</p><p>Input limit: array length cannot exceed 10.</p>
 * @method void setAcceleratorAreas(array $AcceleratorAreas) Set <p>Acceleration region info.</p><p>Input limit: array length cannot exceed 10.</p>
 */
class ModifyAccelerateAreasRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>Acceleration region info.</p><p>Input limit: array length cannot exceed 10.</p>
     */
    public $AcceleratorAreas;

    /**
     * @param string $GlobalAcceleratorId <p>Global acceleration instance ID.</p>
     * @param array $AcceleratorAreas <p>Acceleration region info.</p><p>Input limit: array length cannot exceed 10.</p>
     */
