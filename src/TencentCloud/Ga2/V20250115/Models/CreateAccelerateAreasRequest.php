 ...
 * @method array getAcceleratorAreas() Obtain <p>Acceleration region info. Up to 10 acceleration region groups can be created at a time.</p>
 * @method void setAcceleratorAreas(array $AcceleratorAreas) Set <p>Acceleration region info. Up to 10 acceleration region groups can be created at a time.</p>
 */
class CreateAccelerateAreasRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>Acceleration region info. Up to 10 acceleration region groups can be created at a time.</p>
     */
    public $AcceleratorAreas;

    /**
     * @param string $GlobalAcceleratorId <p>Global acceleration instance ID.</p>
     * @param array $AcceleratorAreas <p>Acceleration region info. Up to 10 acceleration region groups can be created at a time.</p>
     */
