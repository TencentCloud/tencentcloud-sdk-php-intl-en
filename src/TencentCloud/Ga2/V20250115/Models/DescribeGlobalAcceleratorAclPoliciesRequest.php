 ...
 * @method string getLimit() Obtain <p>Number of returns. Default value: 20. Maximum value: 200.</p>
 * @method void setLimit(string $Limit) Set <p>Number of returns. Default value: 20. Maximum value: 200.</p>
 */
class DescribeGlobalAcceleratorAclPoliciesRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>Number of returns. Default value: 20. Maximum value: 200.</p>
     */
    public $Limit;
     ...
     * @param string $Limit <p>Number of returns. Default value: 20. Maximum value: 200.</p>
     */
