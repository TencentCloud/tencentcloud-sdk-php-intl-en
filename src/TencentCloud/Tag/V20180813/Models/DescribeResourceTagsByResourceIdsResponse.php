 ...
 * @method integer getLimit() 获取Page size.
 * @method void setLimit(integer $Limit) 设置Page size.
 * @method array getTags() 获取Tag list.
 * @method void setTags(array $Tags) 设置Tag list.
