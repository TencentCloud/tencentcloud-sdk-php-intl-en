 ...
 * @method integer getAffinity() Obtain The affinity of the placement group. Instances in the placement group are distributed according to this affinity. The affinity value range is: 1-10, and defaults to 1.
 * @method void setAffinity(integer $Affinity) Set The affinity of the placement group. Instances in the placement group are distributed according to this affinity. The affinity value range is: 1-10, and defaults to 1.
...
class CreateDisasterRecoverGroupRequest extends AbstractModel
{
    ...
    /**
     * @var integer The affinity of the placement group. Instances in the placement group are distributed according to this affinity. The affinity value range is: 1-10, and defaults to 1.
     */
    public $Affinity;
     ...
     * @param integer $Affinity The affinity of the placement group. Instances in the placement group are distributed according to this affinity. The affinity value range is: 1-10, and defaults to 1.
