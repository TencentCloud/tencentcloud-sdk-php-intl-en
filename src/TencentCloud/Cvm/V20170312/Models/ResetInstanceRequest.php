 ...
 * @method string getHostName() 获取You can use this parameter to specify a new HostName for the instance when reinstalling the system.
 * @method void setHostName(string $HostName) 设置You can use this parameter to specify a new HostName for the instance when reinstalling the system.
 */
