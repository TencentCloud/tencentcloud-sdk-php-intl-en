...
/**
 * @method array getInstanceTypeQuotaSet() 获取List of model configurations for the availability zone.
 * @method void setInstanceTypeQuotaSet(array $InstanceTypeQuotaSet) 设置List of model configurations for the availability zone.
...
{
    /**
     * @var array List of model configurations for the availability zone.
     */
