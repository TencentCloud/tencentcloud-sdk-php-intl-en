...
/**
 * @method array getDisasterRecoverGroupIds() 获取List of spread placement group IDs, which can be obtained by calling the [DescribeDisasterRecoverGroups](https://cloud.tencent.com/document/api/213/17810) API.
 * @method void setDisasterRecoverGroupIds(array $DisasterRecoverGroupIds) 设置List of spread placement group IDs, which can be obtained by calling the [DescribeDisasterRecoverGroups](https://cloud.tencent.com/document/api/213/17810) API.
 */
