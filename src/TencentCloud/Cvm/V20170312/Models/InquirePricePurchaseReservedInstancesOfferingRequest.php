 ...
 *
 * @method integer getInstanceCount() Obtain The number of the reserved instances you are purchasing.
 * @method void setInstanceCount(integer $InstanceCount) Set The number of the reserved instances you are purchasing.
...
{
    /**
     * @var integer The number of the reserved instances you are purchasing.
     */
    ...
    /**
     * @param integer $InstanceCount The number of the reserved instances you are purchasing.
