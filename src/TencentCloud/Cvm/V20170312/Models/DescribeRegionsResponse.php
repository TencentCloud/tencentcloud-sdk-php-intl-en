...
/**
 * @method integer getTotalCount() 获取Number of regions
 * @method void setTotalCount(integer $TotalCount) 设置Number of regions
 * @method array getRegionSet() 获取List of regions
 * @method void setRegionSet(array $RegionSet) 设置List of regions
