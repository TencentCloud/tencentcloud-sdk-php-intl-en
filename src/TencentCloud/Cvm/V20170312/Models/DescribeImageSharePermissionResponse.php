...
/**
 * @method array getSharePermissionSet() 获取Information on image sharing.
 * @method void setSharePermissionSet(array $SharePermissionSet) 设置Information on image sharing.
