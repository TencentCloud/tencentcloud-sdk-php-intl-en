...
/**
 * @method Price getPrice() 获取Price of the instance with the specified configurations.
 * @method void setPrice(Price $Price) 设置Price of the instance with the specified configurations.
