 ...
 *
 * @method array getChcHostDeniedActionSet() Obtain Actions not allowed for the CHC instance
 * @method void setChcHostDeniedActionSet(array $ChcHostDeniedActionSet) Set Actions not allowed for the CHC instance
...
{
    /**
     * @var array Actions not allowed for the CHC instance
     */
    ...
    /**
     * @param array $ChcHostDeniedActionSet Actions not allowed for the CHC instance
