 ...
 * @method integer getCvmInSwitchGroupQuota() Obtain 
 * @method void setCvmInSwitchGroupQuota(integer $CvmInSwitchGroupQuota) Set 
...
class DescribeDisasterRecoverGroupQuotaResponse extends AbstractModel
{
     ...
     * @param integer $CvmInSwitchGroupQuota 
