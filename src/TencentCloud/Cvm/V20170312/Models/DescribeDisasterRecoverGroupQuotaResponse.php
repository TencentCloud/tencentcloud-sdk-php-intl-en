 ...
 * @method integer getCvmInSwitchGroupQuota() Obtain Quota for instances in a disaster recovery group of the switch type.
 * @method void setCvmInSwitchGroupQuota(integer $CvmInSwitchGroupQuota) Set Quota for instances in a disaster recovery group of the switch type.
...
class DescribeDisasterRecoverGroupQuotaResponse extends AbstractModel
{
    ...
    /**
     * @var integer Quota for instances in a disaster recovery group of the switch type.
     */
     ...
     * @param integer $CvmInSwitchGroupQuota Quota for instances in a disaster recovery group of the switch type.
