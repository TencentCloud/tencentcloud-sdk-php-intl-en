 ...
 * @method Models\ModifyInstancesAttributeResponse ModifyInstancesAttribute(Models\ModifyInstancesAttributeRequest $req) The API is used to modify the attributes of an instance. Currently, you can only use the API to modify the name and the associated security groups of the instance.
