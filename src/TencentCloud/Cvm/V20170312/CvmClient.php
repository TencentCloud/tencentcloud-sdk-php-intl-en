 ...
 * @method Models\CreateLaunchTemplateResponse CreateLaunchTemplate(Models\CreateLaunchTemplateRequest $req) This interface (CreateLaunchTemplate) is used for instance launch template creation.
 ...
 * @method Models\DescribeChcDeniedActionsResponse DescribeChcDeniedActions(Models\DescribeChcDeniedActionsRequest $req) This API is used to query the actions not allowed for the specified CHC instances.
 * @method Models\DescribeChcHostsResponse DescribeChcHosts(Models\DescribeChcHostsRequest $req) This API is used to query the details of one or more CHC host.
 ...
 * @method Models\DescribeRegionsResponse DescribeRegions(Models\DescribeRegionsRequest $req) This API is suspended. To query the information of regions, use [DescribeZones](https://intl.cloud.tencent.com/document/product/1596/77930?from_cn_redirect=1).
 * @method Models\DescribeReservedInstancesResponse DescribeReservedInstances(Models\DescribeReservedInstancesRequest $req) This API is used to list the reserved instances purchased by the user.
 * @method Models\DescribeReservedInstancesConfigInfosResponse DescribeReservedInstancesConfigInfos(Models\DescribeReservedInstancesConfigInfosRequest $req) This API is used to describe reserved instance (RI) offerings.
 ...
 * @method Models\ModifyChcAttributeResponse ModifyChcAttribute(Models\ModifyChcAttributeRequest $req) This API is used to modify the CHC host attributes.
 ...
 * @method Models\ModifyInstancesAttributeResponse ModifyInstancesAttribute(Models\ModifyInstancesAttributeRequest $req) This API is used to modify instance attributes.
