 ...
 *
 * @method string getCertName() Obtain Private CA certificate name
 * @method void setCertName(string $CertName) Set Private CA certificate name
 */
class DeletePrivateCARequest extends AbstractModel
{
    ...
    /**
     * @param string $CertName Private CA certificate name
     */
