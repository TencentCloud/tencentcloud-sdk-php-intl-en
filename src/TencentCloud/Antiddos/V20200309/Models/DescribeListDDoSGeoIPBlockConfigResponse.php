 ...
 * @method array getConfigList() Obtain List of Anti-DDoS region blocking configurations
 * @method void setConfigList(array $ConfigList) Set List of Anti-DDoS region blocking configurations
...
class DescribeListDDoSGeoIPBlockConfigResponse extends AbstractModel
{
    ...
    /**
     * @var array List of Anti-DDoS region blocking configurations
     */
    public $ConfigList;
     ...
     * @param array $ConfigList List of Anti-DDoS region blocking configurations
