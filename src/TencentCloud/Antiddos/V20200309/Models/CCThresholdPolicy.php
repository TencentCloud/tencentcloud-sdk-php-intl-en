 ...
 * @method integer getThreshold() Obtain Cleansing threshold
 * @method void setThreshold(integer $Threshold) Set Cleansing threshold
...
class CCThresholdPolicy extends AbstractModel
{
    ...
    /**
     * @var integer Cleansing threshold
     */
    public $Threshold;
     ...
     * @param integer $Threshold Cleansing threshold
