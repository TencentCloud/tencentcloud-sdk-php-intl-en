 ...
 * @method PacketFilterConfig getPacketFilterConfig() Obtain Feature filtering rules
 * @method void setPacketFilterConfig(PacketFilterConfig $PacketFilterConfig) Set Feature filtering rules
 */
class CreatePacketFilterConfigRequest extends AbstractModel
{
    ...
    /**
     * @var PacketFilterConfig Feature filtering rules
     */
    public $PacketFilterConfig;

    /**
     * @param string $InstanceId Anti-DDoS instance ID
     * @param PacketFilterConfig $PacketFilterConfig Feature filtering rules
     */
