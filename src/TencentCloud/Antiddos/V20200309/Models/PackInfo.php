 ...
 * Package information
 *
 * @method string getPackType() Obtain Package type. Valid values:
`staticpack`: non-BGP package
`insurance`: guarantee package
]
 * @method void setPackType(string $PackType) Set Package type. Valid values:
`staticpack`: non-BGP package
`insurance`: guarantee package
]
 * @method string getPackId() Obtain Package ID
 * @method void setPackId(string $PackId) Set Package ID
 */
...
`insurance`: guarantee package
    ...
    /**
     * @param string $PackType Package type. Valid values:
`staticpack`: non-BGP package
`insurance`: guarantee package
]
