 ...
 * @method array getConfigList() Obtain Protocol blocking configuration
 * @method void setConfigList(array $ConfigList) Set Protocol blocking configuration
...
class DescribeListProtocolBlockConfigResponse extends AbstractModel
{
    ...
    /**
     * @var array Protocol blocking configuration
     */
    public $ConfigList;
     ...
     * @param array $ConfigList Protocol blocking configuration
