 ...
 * @method array getConfigList() Obtain Feature filtering configuration
 * @method void setConfigList(array $ConfigList) Set Feature filtering configuration
...
class DescribeListPacketFilterConfigResponse extends AbstractModel
{
    ...
    /**
     * @var array Feature filtering configuration
     */
    public $ConfigList;
     ...
     * @param array $ConfigList Feature filtering configuration
