...
Note: this field may return `null`, indicating that no valid values can be obtained.
 * @method integer getRewriteHttps() Obtain Specifies whether to forcibly redirect HTTP to HTTPS. `1`: Enable. `0`: Disable.
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    /**
     * @var integer Specifies whether to forcibly redirect HTTP to HTTPS. `1`: Enable. `0`: Disable.
     */
    public $RewriteHttps;

    /**
     * @var integer Returns an error code when the rule configuration fails (only valid when `Status=2`). `1001`: The certificate does not exist. `1002`: Failed to obtain the certificate. `1003`: Failed to upload the certificate. `1004`: The certificate has expired.
     */
    public $ErrCode;
