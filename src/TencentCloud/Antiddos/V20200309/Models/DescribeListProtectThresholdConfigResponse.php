 ...
 * @method array getConfigList() Obtain List of protection threshold configurations
 * @method void setConfigList(array $ConfigList) Set List of protection threshold configurations
...
class DescribeListProtectThresholdConfigResponse extends AbstractModel
{
    ...
    /**
     * @var array List of protection threshold configurations
     */
    public $ConfigList;
     ...
     * @param array $ConfigList List of protection threshold configurations
