 ...
 * @method array getIpList() Obtain IP blocklist/allowlist
 * @method void setIpList(array $IpList) Set IP blocklist/allowlist
...
class DescribeListBlackWhiteIpListResponse extends AbstractModel
{
     ...
     * @param array $IpList IP blocklist/allowlist
