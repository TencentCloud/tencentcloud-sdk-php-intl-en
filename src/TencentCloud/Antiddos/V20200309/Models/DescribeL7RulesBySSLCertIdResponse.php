 ...
 *
 * @method array getCertSet() Obtain Certificate rule set
 * @method void setCertSet(array $CertSet) Set Certificate rule set
...
{
    /**
     * @var array Certificate rule set
     */
    public $CertSet;
    ...
    /**
     * @param array $CertSet Certificate rule set
