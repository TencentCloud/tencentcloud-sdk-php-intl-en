 ...
 * @method string getFilterDomain() Obtain Domain name filter for querying CC protection thresholds of domain names and protocols
 * @method void setFilterDomain(string $FilterDomain) Set Domain name filter for querying CC protection thresholds of domain names and protocols
 * @method string getFilterProtocol() Obtain Protocol filter for querying CC protection thresholds of domain names and protocols
 * @method void setFilterProtocol(string $FilterProtocol) Set Protocol filter for querying CC protection thresholds of domain names and protocols
 */
class DescribeListProtectThresholdConfigRequest extends AbstractModel
{
    ...
    /**
     * @var string Domain name filter for querying CC protection thresholds of domain names and protocols
     */
    public $FilterDomain;

    /**
     * @var string Protocol filter for querying CC protection thresholds of domain names and protocols
     */
     ...
     * @param string $FilterDomain Domain name filter for querying CC protection thresholds of domain names and protocols
     * @param string $FilterProtocol Protocol filter for querying CC protection thresholds of domain names and protocols
     */
