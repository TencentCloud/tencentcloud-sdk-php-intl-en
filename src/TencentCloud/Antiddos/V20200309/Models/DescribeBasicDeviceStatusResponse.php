...
`2`: The P is normal.
`3`: The IP is being attacked.
 * @method array getCLBData() Obtain Name of the domain asset.
 * @method void setCLBData(array $CLBData) Set Name of the domain asset.
 * @method array getCnameWafData() Obtain Status of the CNAME WAF resource.
 * @method void setCnameWafData(array $CnameWafData) Set Status of the CNAME WAF resource.
...
`3`: The IP is being attacked.
    ...
    /**
     * @var array Name of the domain asset.
     */
    public $CLBData;

    /**
     * @var array Status of the CNAME WAF resource.
     */
    public $CnameWafData;
...
`2`: The P is normal.
`3`: The IP is being attacked.
     * @param array $CLBData Name of the domain asset.
     * @param array $CnameWafData Status of the CNAME WAF resource.
