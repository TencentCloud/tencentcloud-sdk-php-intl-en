 ...
 * @method array getConfigList() Obtain List of IP alarm threshold configurations
 * @method void setConfigList(array $ConfigList) Set List of IP alarm threshold configurations
...
class DescribeListIPAlarmConfigResponse extends AbstractModel
{
     ...
     * @param array $ConfigList List of IP alarm threshold configurations
