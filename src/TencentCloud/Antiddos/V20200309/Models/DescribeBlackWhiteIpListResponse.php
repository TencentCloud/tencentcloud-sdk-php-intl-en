 ...
 *
 * @method array getBlackIpList() Obtain IP blocklist
 * @method void setBlackIpList(array $BlackIpList) Set IP blocklist
 * @method array getWhiteIpList() Obtain IP allowlist
 * @method void setWhiteIpList(array $WhiteIpList) Set IP allowlist
...
class DescribeBlackWhiteIpListResponse extends AbstractModel
{
    ...
    /**
     * @param array $BlackIpList IP blocklist
     * @param array $WhiteIpList IP allowlist
