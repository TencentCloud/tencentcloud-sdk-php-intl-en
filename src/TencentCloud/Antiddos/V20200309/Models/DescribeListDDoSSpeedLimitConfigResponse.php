 ...
 * @method array getConfigList() Obtain List of access rate limit configurations
 * @method void setConfigList(array $ConfigList) Set List of access rate limit configurations
...
class DescribeListDDoSSpeedLimitConfigResponse extends AbstractModel
{
    ...
    /**
     * @var array List of access rate limit configurations
     */
    public $ConfigList;
     ...
     * @param array $ConfigList List of access rate limit configurations
