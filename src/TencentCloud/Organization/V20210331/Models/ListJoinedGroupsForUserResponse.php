 ...
 * @method array getJoinedGroups() Obtain List of user groups joined by the user.
 * @method void setJoinedGroups(array $JoinedGroups) Set List of user groups joined by the user.
...
class ListJoinedGroupsForUserResponse extends AbstractModel
{
    ...
    /**
     * @var array List of user groups joined by the user.
     */
    public $JoinedGroups;
     ...
     * @param array $JoinedGroups List of user groups joined by the user.
