 ...
 * @method integer getNodeId() Obtain <p>Department ID.</p>.
 * @method void setNodeId(integer $NodeId) Set <p>Department ID.</p>.
 */
class DeleteShareUnitNodeRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>Department ID.</p>.
     */
    public $NodeId;

    /**
     * @param string $UnitId <p>Shared unit ID.</p>.
     * @param integer $NodeId <p>Department ID.</p>.
     */
