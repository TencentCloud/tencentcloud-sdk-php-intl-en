 ...
 * @method string getOrgSubAccountName() Obtain Sub-Account.
 * @method void setOrgSubAccountName(string $OrgSubAccountName) Set Sub-Account.
 */
class OrgMemberAuthAccount extends AbstractModel
{
     ...
     * @param string $OrgSubAccountName Sub-Account.
     */
