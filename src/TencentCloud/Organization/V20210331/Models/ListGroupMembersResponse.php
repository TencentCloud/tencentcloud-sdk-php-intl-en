 ...
 * @method array getGroupMembers() Obtain The user list of a user group.
 * @method void setGroupMembers(array $GroupMembers) Set The user list of a user group.
...
class ListGroupMembersResponse extends AbstractModel
{
    ...
    /**
     * @var array The user list of a user group.
     */
    public $GroupMembers;
     ...
     * @param array $GroupMembers The user list of a user group.
