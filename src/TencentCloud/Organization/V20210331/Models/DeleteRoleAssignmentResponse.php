 ...
 *
 * @method TaskInfo getTask() Obtain Task details.
 * @method void setTask(TaskInfo $Task) Set Task details.
...
class DeleteRoleAssignmentResponse extends AbstractModel
{
    ...
    /**
     * @param TaskInfo $Task Task details.
