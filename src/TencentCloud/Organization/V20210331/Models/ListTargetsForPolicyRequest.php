 ...
 * @method string getTargetType() Obtain Policy type. Valid values: All, User, and Node.
 * @method void setTargetType(string $TargetType) Set Policy type. Valid values: All, User, and Node.
 ...
 * @method string getKeyword() Obtain Search by multiple policy IDs, separated by spaces.
 * @method void setKeyword(string $Keyword) Set Search by multiple policy IDs, separated by spaces.
 */
class ListTargetsForPolicyRequest extends AbstractModel
{
    ...
    /**
     * @var string Policy type. Valid values: All, User, and Node.
     */
    public $TargetType;
    ...
    /**
     * @var string Search by multiple policy IDs, separated by spaces.
     */
    public $Keyword;
     ...
     * @param string $TargetType Policy type. Valid values: All, User, and Node.
     ...
     * @param string $Keyword Search by multiple policy IDs, separated by spaces.
     */
