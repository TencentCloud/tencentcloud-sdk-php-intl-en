 ...
 * @method array getSAMLIdPCertificates() Obtain SAML signing certificate list.
 * @method void setSAMLIdPCertificates(array $SAMLIdPCertificates) Set SAML signing certificate list.
...
class ListExternalSAMLIdPCertificatesResponse extends AbstractModel
{
    ...
    /**
     * @var array SAML signing certificate list.
     */
     ...
     * @param array $SAMLIdPCertificates SAML signing certificate list.
