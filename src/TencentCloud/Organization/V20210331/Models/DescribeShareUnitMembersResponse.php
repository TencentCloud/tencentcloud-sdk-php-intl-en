 ...
 * @method array getItems() Obtain Shared unit member list.
 * @method void setItems(array $Items) Set Shared unit member list.
...
class DescribeShareUnitMembersResponse extends AbstractModel
{
    ...
    /**
     * @var array Shared unit member list.
     */
    public $Items;
     ...
     * @param array $Items Shared unit member list.
