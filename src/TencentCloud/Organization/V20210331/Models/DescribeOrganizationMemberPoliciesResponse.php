 ...
 *
 * @method array getItems() Obtain Member access policy list.
 * @method void setItems(array $Items) Set Member access policy list.
...
{
    /**
     * @var array Member access policy list.
     */
    public $Items;
    ...
    /**
     * @param array $Items Member access policy list.
