 ...
 * @method string getUserProvisioningId() Obtain ID of the CAM user synchronization.
 * @method void setUserProvisioningId(string $UserProvisioningId) Set ID of the CAM user synchronization.
 */
class GetUserSyncProvisioningRequest extends AbstractModel
{
    ...
    /**
     * @var string ID of the CAM user synchronization.
     */
    public $UserProvisioningId;

    /**
     * @param string $ZoneId Space ID.
     * @param string $UserProvisioningId ID of the CAM user synchronization.
     */
