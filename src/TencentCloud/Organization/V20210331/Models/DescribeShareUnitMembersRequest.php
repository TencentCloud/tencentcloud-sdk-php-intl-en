 ...
 * @method string getSearchKey() Obtain Search keyword. Member UIN search is supported.
 * @method void setSearchKey(string $SearchKey) Set Search keyword. Member UIN search is supported.
 */
class DescribeShareUnitMembersRequest extends AbstractModel
{
    ...
    /**
     * @var string Search keyword. Member UIN search is supported.
     */
    public $SearchKey;
     ...
     * @param string $SearchKey Search keyword. Member UIN search is supported.
     */
