 ...
 *
 * @method array getCertificateIds() Obtain Certificate ID.
 * @method void setCertificateIds(array $CertificateIds) Set Certificate ID.
...
class SetExternalSAMLIdentityProviderResponse extends AbstractModel
{
    ...
    /**
     * @param array $CertificateIds Certificate ID.
