 ...
 * @method array getUserProvisionings() Obtain User list of the CAM synchronization.
 * @method void setUserProvisionings(array $UserProvisionings) Set User list of the CAM synchronization.
...
class ListUserSyncProvisioningsResponse extends AbstractModel
{
    ...
    /**
     * @var array User list of the CAM synchronization.
     */
     ...
     * @param array $UserProvisionings User list of the CAM synchronization.
