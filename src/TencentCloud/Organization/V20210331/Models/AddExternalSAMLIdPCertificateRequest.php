 ...
 * @method string getX509Certificate() Obtain X509 certificate in PEM format, provided by the SAML identity provider.
 * @method void setX509Certificate(string $X509Certificate) Set X509 certificate in PEM format, provided by the SAML identity provider.
 */
class AddExternalSAMLIdPCertificateRequest extends AbstractModel
{
     ...
     * @param string $X509Certificate X509 certificate in PEM format, provided by the SAML identity provider.
     */
