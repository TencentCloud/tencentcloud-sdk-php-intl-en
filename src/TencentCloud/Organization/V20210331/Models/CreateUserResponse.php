 ...
 *
 * @method UserInfo getUserInfo() Obtain User details.
 * @method void setUserInfo(UserInfo $UserInfo) Set User details.
...
class CreateUserResponse extends AbstractModel
{
    ...
    /**
     * @param UserInfo $UserInfo User details.
