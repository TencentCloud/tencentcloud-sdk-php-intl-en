...
/**
 * @method array getNodes() Obtain Organizational unit list
 * @method void setNodes(array $Nodes) Set Organizational unit list
...
{
    /**
     * @var array Organizational unit list
     */
    public $Nodes;
    ...
    public $RequestId;
    /**
     * @param array $Nodes Organizational unit list
