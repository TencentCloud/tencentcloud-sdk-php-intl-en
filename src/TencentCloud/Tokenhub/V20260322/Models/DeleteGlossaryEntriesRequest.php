 ...
 * @method array getEntries() Obtain Terminology entry list to be deleted. At a time 200.
 * @method void setEntries(array $Entries) Set Terminology entry list to be deleted. At a time 200.
 */
class DeleteGlossaryEntriesRequest extends AbstractModel
{
    ...
    /**
     * @var array Terminology entry list to be deleted. At a time 200.
     */
    public $Entries;

    /**
     * @param string $GlossaryId Termbase ID. Obtain through the API DescribeGlossaries.
     * @param array $Entries Terminology entry list to be deleted. At a time 200.
     */
