 ...
 * @method string getApiKey() Obtain API Key secret key value (masked).
 * @method void setApiKey(string $ApiKey) Set API Key secret key value (masked).
 ...
 * @method string getStopReason() Obtain Reason for disabling the API Key. Valid values: NORMAL (normal, default value), QUOTA_EXHAUSTED (API Key quota package exhausted), ABNORMAL (exception, human intervention required)
 * @method void setStopReason(string $StopReason) Set Reason for disabling the API Key. Valid values: NORMAL (normal, default value), QUOTA_EXHAUSTED (API Key quota package exhausted), ABNORMAL (exception, human intervention required)
 ...
 * @method integer getTPM() Obtain TPM limit (Tokens Per Minute).
 * @method void setTPM(integer $TPM) Set TPM limit (Tokens Per Minute).
...
class TokenPlanApiKeyInfo extends AbstractModel
{
    ...
    /**
     * @var string API Key secret key value (masked).
     */
    public $ApiKey;
    ...
    /**
     * @var string Reason for disabling the API Key. Valid values: NORMAL (normal, default value), QUOTA_EXHAUSTED (API Key quota package exhausted), ABNORMAL (exception, human intervention required)
     */
    public $StopReason;
    ...
    /**
     * @var integer TPM limit (Tokens Per Minute).
     */
    public $TPM;
     ...
     * @param string $ApiKey API Key secret key value (masked).
     ...
     * @param string $StopReason Reason for disabling the API Key. Valid values: NORMAL (normal, default value), QUOTA_EXHAUSTED (API Key quota package exhausted), ABNORMAL (exception, human intervention required)
     ...
     * @param integer $TPM TPM limit (Tokens Per Minute).
