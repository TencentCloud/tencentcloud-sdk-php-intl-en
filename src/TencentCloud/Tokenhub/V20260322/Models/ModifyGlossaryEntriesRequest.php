 ...
 * @method array getEntries() Obtain Terminology entry list. At a time 200.
 * @method void setEntries(array $Entries) Set Terminology entry list. At a time 200.
 */
class ModifyGlossaryEntriesRequest extends AbstractModel
{
    ...
    /**
     * @var array Terminology entry list. At a time 200.
     */
    public $Entries;

    /**
     * @param string $GlossaryId Termbase ID. Obtain through the API DescribeGlossaries.
     * @param array $Entries Terminology entry list. At a time 200.
     */
