 ...
 * @method AbnormalProcessEventDescription getEventDetail() Obtain Event description
 * @method void setEventDetail(AbnormalProcessEventDescription $EventDetail) Set Event description
...
class DescribeAbnormalProcessDetailResponse extends AbstractModel
{
    ...
    /**
     * @var AbnormalProcessEventDescription Event description
     */
    public $EventDetail;
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param AbnormalProcessEventDescription $EventDetail Event description
