...
<li>Level- String - Required: No - Vulnerability level</li>
<li>Name - String - Required: No - Vulnerability name</li>
 * @method ImageInfo getImageInfo() Obtain Image ID
 * @method void setImageInfo(ImageInfo $ImageInfo) Set Image ID
 * @method string getBy() Obtain Sorting field: `Level`.
 * @method void setBy(string $By) Set Sorting field: `Level`.
 * @method string getOrder() Obtain Sorting order. Valid values: `+`, `-`.
 * @method void setOrder(string $Order) Set Sorting order. Valid values: `+`, `-`.
...
<li>Name - String - Required: No - Vulnerability name</li>
    ...
    /**
     * @var ImageInfo Image ID
     */
    public $ImageInfo;

    /**
     * @var string Sorting field: `Level`.
     */
    public $By;
...
<li>Level- String - Required: No - Vulnerability level</li>
<li>Name - String - Required: No - Vulnerability name</li>
     * @param ImageInfo $ImageInfo Image ID
     * @param string $By Sorting field: `Level`.
     * @param string $Order Sorting order. Valid values: `+`, `-`.
