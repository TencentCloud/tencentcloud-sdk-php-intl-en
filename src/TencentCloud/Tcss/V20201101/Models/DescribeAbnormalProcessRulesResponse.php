 ...
 * @method array getRuleSet() Obtain List of abnormal process policies
 * @method void setRuleSet(array $RuleSet) Set List of abnormal process policies
...
class DescribeAbnormalProcessRulesResponse extends AbstractModel
{
    ...
    /**
     * @var array List of abnormal process policies
     */
    public $RuleSet;
     ...
     * @param array $RuleSet List of abnormal process policies
