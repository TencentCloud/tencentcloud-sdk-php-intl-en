 ...
 * @method array getScanFailedAssetList() Obtain Return the list of summary information for assets with various types of detection failures.
 * @method void setScanFailedAssetList(array $ScanFailedAssetList) Set Return the list of summary information for assets with various types of detection failures.
...
class DescribeComplianceScanFailedAssetListResponse extends AbstractModel
{
    ...
    /**
     * @var array Return the list of summary information for assets with various types of detection failures.
     */
     ...
     * @param array $ScanFailedAssetList Return the list of summary information for assets with various types of detection failures.
