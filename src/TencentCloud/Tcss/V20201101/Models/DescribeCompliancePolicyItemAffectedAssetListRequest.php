 ...
 *
 * @method integer getCustomerPolicyItemId() Obtain `CustomerPolicyItemId` returned by `DescribeComplianceTaskPolicyItemSummaryList`, which indicates the check item ID.
 * @method void setCustomerPolicyItemId(integer $CustomerPolicyItemId) Set `CustomerPolicyItemId` returned by `DescribeComplianceTaskPolicyItemSummaryList`, which indicates the check item ID.
...
{
    /**
     * @var integer `CustomerPolicyItemId` returned by `DescribeComplianceTaskPolicyItemSummaryList`, which indicates the check item ID.
     */
...
Name. Valid values: `NodeName`, `CheckResult`.
    ...
    /**
     * @param integer $CustomerPolicyItemId `CustomerPolicyItemId` returned by `DescribeComplianceTaskPolicyItemSummaryList`, which indicates the check item ID.
