 ...
 * @method ComplianceImageDetailInfo getImageDetailInfo() Obtain When the asset is a mirror, return this field.
 * @method void setImageDetailInfo(ComplianceImageDetailInfo $ImageDetailInfo) Set When the asset is a mirror, return this field.
 * @method ComplianceHostDetailInfo getHostDetailInfo() Obtain This field is returned when the asset is a host.
 * @method void setHostDetailInfo(ComplianceHostDetailInfo $HostDetailInfo) Set This field is returned when the asset is a host.
 * @method ComplianceK8SDetailInfo getK8SDetailInfo() Obtain When the asset is K8S, return this field.
 * @method void setK8SDetailInfo(ComplianceK8SDetailInfo $K8SDetailInfo) Set When the asset is K8S, return this field.
...
class DescribeComplianceAssetDetailInfoResponse extends AbstractModel
{
    ...
    /**
     * @var ComplianceImageDetailInfo When the asset is a mirror, return this field.
     */
    public $ImageDetailInfo;

    /**
     * @var ComplianceHostDetailInfo This field is returned when the asset is a host.
     */
    public $HostDetailInfo;

    /**
     * @var ComplianceK8SDetailInfo When the asset is K8S, return this field.
     */
     ...
     * @param ComplianceImageDetailInfo $ImageDetailInfo When the asset is a mirror, return this field.
     * @param ComplianceHostDetailInfo $HostDetailInfo This field is returned when the asset is a host.
     * @param ComplianceK8SDetailInfo $K8SDetailInfo When the asset is K8S, return this field.
