 ...
 *
 * @method K8sApiAbnormalRuleInfo getInfo() Obtain Rule details
 * @method void setInfo(K8sApiAbnormalRuleInfo $Info) Set Rule details
...
class DescribeK8sApiAbnormalRuleInfoResponse extends AbstractModel
{
    ...
    /**
     * @param K8sApiAbnormalRuleInfo $Info Rule details
