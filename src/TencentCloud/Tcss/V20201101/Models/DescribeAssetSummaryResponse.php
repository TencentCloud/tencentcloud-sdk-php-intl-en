 ...
 * @method integer getTodayNewImageCnt() Obtain New image count added today
 * @method void setTodayNewImageCnt(integer $TodayNewImageCnt) Set New image count added today
 * @method integer getTodayUnsafeImageCnt() Obtain New unsafe image count added today
 * @method void setTodayUnsafeImageCnt(integer $TodayUnsafeImageCnt) Set New unsafe image count added today
 * @method integer getRecommendedFixImageCnt() Obtain The count of image should be fixed
 * @method void setRecommendedFixImageCnt(integer $RecommendedFixImageCnt) Set The count of image should be fixed
 * @method integer getScannedImageCnt() Obtain The count of image scanned
 * @method void setScannedImageCnt(integer $ScannedImageCnt) Set The count of image scanned
...
class DescribeAssetSummaryResponse extends AbstractModel
{
    ...
    /**
     * @var integer New image count added today
     */
    public $TodayNewImageCnt;

    /**
     * @var integer New unsafe image count added today
     */
    public $TodayUnsafeImageCnt;

    /**
     * @var integer The count of image should be fixed
     */
    public $RecommendedFixImageCnt;

    /**
     * @var integer The count of image scanned
     */
     ...
     * @param integer $TodayNewImageCnt New image count added today
     * @param integer $TodayUnsafeImageCnt New unsafe image count added today
     * @param integer $RecommendedFixImageCnt The count of image should be fixed
     * @param integer $ScannedImageCnt The count of image scanned
