 ...
 * @method array getCustomerAssetItemIdSet() Obtain List of IDs of assets to be ignored in the specified check item
 * @method void setCustomerAssetItemIdSet(array $CustomerAssetItemIdSet) Set List of IDs of assets to be ignored in the specified check item
 */
class AddCompliancePolicyAssetSetToWhitelistRequest extends AbstractModel
{
    ...
    /**
     * @var array List of IDs of assets to be ignored in the specified check item
     */
    public $CustomerAssetItemIdSet;

    /**
     * @param integer $CustomerPolicyItemId Check item ID
     * @param array $CustomerAssetItemIdSet List of IDs of assets to be ignored in the specified check item
     */
