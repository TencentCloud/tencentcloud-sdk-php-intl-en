 ...
 * @method integer getExcludedCount() Obtain Number of excluded nodes.
 * @method void setExcludedCount(integer $ExcludedCount) Set Number of excluded nodes.
...
class DescribeSecLogJoinObjectListResponse extends AbstractModel
{
    ...
    /**
     * @var integer Number of excluded nodes.
     */
     ...
     * @param integer $ExcludedCount Number of excluded nodes.
