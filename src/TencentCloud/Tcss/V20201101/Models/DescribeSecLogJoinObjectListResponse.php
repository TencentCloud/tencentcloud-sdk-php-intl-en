 ...
 * @method array getList() Obtain List of accessed objects
 * @method void setList(array $List) Set List of accessed objects
...
class DescribeSecLogJoinObjectListResponse extends AbstractModel
{
    ...
    /**
     * @var array List of accessed objects
     */
    public $List;
     ...
     * @param array $List List of accessed objects
