 ...
 * @method integer getUnhandledK8sApiEventCnt() Obtain Unresolved Kubernetes API Events
 * @method void setUnhandledK8sApiEventCnt(integer $UnhandledK8sApiEventCnt) Set Unresolved Kubernetes API Events
...
class DescribeContainerSecEventSummaryResponse extends AbstractModel
{
    ...
    /**
     * @var integer Unresolved Kubernetes API Events
     */
     ...
     * @param integer $UnhandledK8sApiEventCnt Unresolved Kubernetes API Events
