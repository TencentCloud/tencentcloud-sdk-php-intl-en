 ...
 *
 * @method array getList() Obtain List of automatic licensing tasks
 * @method void setList(array $List) Set List of automatic licensing tasks
...
{
    /**
     * @var array List of automatic licensing tasks
     */
    public $List;
    ...
    /**
     * @param array $List List of automatic licensing tasks
