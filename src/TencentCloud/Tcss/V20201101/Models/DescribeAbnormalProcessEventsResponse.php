 ...
 * @method array getEventSet() Obtain Array of abnormal processes
 * @method void setEventSet(array $EventSet) Set Array of abnormal processes
...
class DescribeAbnormalProcessEventsResponse extends AbstractModel
{
    ...
    /**
     * @var array Array of abnormal processes
     */
    public $EventSet;
     ...
     * @param array $EventSet Array of abnormal processes
