 ...
 * @method EscapeEventDescription getEventDetail() Obtain Event description
 * @method void setEventDetail(EscapeEventDescription $EventDetail) Set Event description
...
class DescribeEscapeEventDetailResponse extends AbstractModel
{
    ...
    /**
     * @var EscapeEventDescription Event description
     */
    public $EventDetail;
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param EscapeEventDescription $EventDetail Event description
