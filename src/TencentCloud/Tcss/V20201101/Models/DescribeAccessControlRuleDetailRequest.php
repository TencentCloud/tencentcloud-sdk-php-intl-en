 ...
 * @method string getImageId() Obtain Image ID, which is used only when allowing an event.
 * @method void setImageId(string $ImageId) Set Image ID, which is used only when allowing an event.
...
class DescribeAccessControlRuleDetailRequest extends AbstractModel
{
    ...
    /**
     * @var string Image ID, which is used only when allowing an event.
     */
    public $ImageId;
     ...
     * @param string $ImageId Image ID, which is used only when allowing an event.
