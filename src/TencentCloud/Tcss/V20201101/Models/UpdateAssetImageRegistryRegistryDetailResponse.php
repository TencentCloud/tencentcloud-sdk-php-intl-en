 ...
 * @method string getNameRepeatErr() Obtain Incorrect name message
 * @method void setNameRepeatErr(string $NameRepeatErr) Set Incorrect name message
...
class UpdateAssetImageRegistryRegistryDetailResponse extends AbstractModel
{
    ...
    /**
     * @var string Incorrect name message
     */
     ...
     * @param string $NameRepeatErr Incorrect name message
