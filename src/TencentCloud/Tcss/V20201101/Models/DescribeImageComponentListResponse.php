 ...
 * @method array getList() Obtain List of image components
 * @method void setList(array $List) Set List of image components
...
class DescribeImageComponentListResponse extends AbstractModel
{
    ...
    /**
     * @var array List of image components
     */
    public $List;
     ...
     * @param array $List List of image components
