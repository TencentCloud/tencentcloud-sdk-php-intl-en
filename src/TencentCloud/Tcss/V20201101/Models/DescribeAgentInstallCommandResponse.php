 ...
 * @method string getARMCommand() Obtain Installation command for systems with the Arm architecture.
 * @method void setARMCommand(string $ARMCommand) Set Installation command for systems with the Arm architecture.
...
class DescribeAgentInstallCommandResponse extends AbstractModel
{
    ...
    /**
     * @var string Installation command for systems with the Arm architecture.
     */
    public $ARMCommand;
     ...
     * @param string $ARMCommand Installation command for systems with the Arm architecture.
