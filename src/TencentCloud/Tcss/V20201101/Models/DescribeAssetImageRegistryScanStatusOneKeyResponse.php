 ...
 * @method array getImageStatus() Obtain Scan progress list
 * @method void setImageStatus(array $ImageStatus) Set Scan progress list
...
class DescribeAssetImageRegistryScanStatusOneKeyResponse extends AbstractModel
{
     ...
     * @param array $ImageStatus Scan progress list
