 ...
 * @method string getSupportCoreVersion() Obtain Supported kernel versions.
 * @method void setSupportCoreVersion(string $SupportCoreVersion) Set Supported kernel versions.
 * @method string getInterceptionFailureTip() Obtain Possible blocking failure reasons.
 * @method void setInterceptionFailureTip(string $InterceptionFailureTip) Set Possible blocking failure reasons.
...
class DescribeAccessControlEventsResponse extends AbstractModel
{
    ...
    /**
     * @var string Supported kernel versions.
     */
    public $SupportCoreVersion;

    /**
     * @var string Possible blocking failure reasons.
     */
     ...
     * @param string $SupportCoreVersion Supported kernel versions.
     * @param string $InterceptionFailureTip Possible blocking failure reasons.
