 ...
 * @method array getEventSet() Obtain Array of access control events
 * @method void setEventSet(array $EventSet) Set Array of access control events
...
class DescribeAccessControlEventsResponse extends AbstractModel
{
    ...
    /**
     * @var array Array of access control events
     */
    public $EventSet;
     ...
     * @param array $EventSet Array of access control events
