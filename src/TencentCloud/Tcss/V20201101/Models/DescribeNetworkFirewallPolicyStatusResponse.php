 ...
 * @method array getTaskResult() Obtain NameRepeat, K8sRuleIngressPortError, etc.
 * @method void setTaskResult(array $TaskResult) Set NameRepeat, K8sRuleIngressPortError, etc.
...
class DescribeNetworkFirewallPolicyStatusResponse extends AbstractModel
{
    ...
    /**
     * @var array NameRepeat, K8sRuleIngressPortError, etc.
     */
    public $TaskResult;
     ...
     * @param array $TaskResult NameRepeat, K8sRuleIngressPortError, etc.
