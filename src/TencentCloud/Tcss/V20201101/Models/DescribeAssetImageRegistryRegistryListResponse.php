 ...
 *
 * @method array getList() Obtain Mirror repository list
 * @method void setList(array $List) Set Mirror repository list
...
{
    /**
     * @var array Mirror repository list
     */
    public $List;
    ...
    /**
     * @param array $List Mirror repository list
