 ...
 *
 * @method array getList() Obtain Image repository list
 * @method void setList(array $List) Set Image repository list
...
{
    /**
     * @var array Image repository list
     */
    public $List;
    ...
    /**
     * @param array $List Image repository list
