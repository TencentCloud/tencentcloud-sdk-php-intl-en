 ...
 *
 * @method string getDownloadUrl() Obtain Excel download link
 * @method void setDownloadUrl(string $DownloadUrl) Set Excel download link
...
{
    /**
     * @var string Excel download link
     */
    public $DownloadUrl;
    ...
    /**
     * @param string $DownloadUrl Excel download link
