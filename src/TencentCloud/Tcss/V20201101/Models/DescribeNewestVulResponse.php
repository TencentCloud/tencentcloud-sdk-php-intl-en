 ...
 * @method integer getSupportDefense() Obtain Whether defense is supported for the vulnerability. 0: not supported; 1: supported.
 * @method void setSupportDefense(integer $SupportDefense) Set Whether defense is supported for the vulnerability. 0: not supported; 1: supported.
...
class DescribeNewestVulResponse extends AbstractModel
{
    ...
    /**
     * @var integer Whether defense is supported for the vulnerability. 0: not supported; 1: supported.
     */
     ...
     * @param integer $SupportDefense Whether defense is supported for the vulnerability. 0: not supported; 1: supported.
