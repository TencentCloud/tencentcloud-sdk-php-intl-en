 ...
 *
 * @method integer getTotalCount() Obtain Total number of namespaces that can be returned
 * @method void setTotalCount(integer $TotalCount) Set Total number of namespaces that can be returned
...
{
    /**
     * @var integer Total number of namespaces that can be returned
     */
    public $TotalCount;
    ...
    /**
     * @param integer $TotalCount Total number of namespaces that can be returned
