 ...
 *
 * @method array getWhiteListIdSet() Obtain IDs of allowed items
 * @method void setWhiteListIdSet(array $WhiteListIdSet) Set IDs of allowed items
 */
class DeleteReverseShellWhiteListsRequest extends AbstractModel
{
    /**
     * @var array IDs of allowed items
     */
    public $WhiteListIdSet;

    /**
     * @param array $WhiteListIdSet IDs of allowed items
     */
