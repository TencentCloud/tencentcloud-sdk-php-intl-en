 ...
 *
 * @method array getList() Obtain List of trojans
 * @method void setList(array $List) Set List of trojans
...
class DescribeVirusListResponse extends AbstractModel
{
    ...
    /**
     * @param array $List List of trojans
