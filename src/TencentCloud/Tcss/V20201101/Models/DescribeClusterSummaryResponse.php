 ...
 * @method integer getTkeClusterCount() Obtain TKE Cluster Count
 * @method void setTkeClusterCount(integer $TkeClusterCount) Set TKE Cluster Count
 * @method integer getUserCreateTencentClusterCount() Obtain Number of User-Built Tencent Cloud Clusters
 * @method void setUserCreateTencentClusterCount(integer $UserCreateTencentClusterCount) Set Number of User-Built Tencent Cloud Clusters
 * @method integer getUserCreateHybridClusterCount() Obtain Number of User-Built Cluster Hybrid Clouds
 * @method void setUserCreateHybridClusterCount(integer $UserCreateHybridClusterCount) Set Number of User-Built Cluster Hybrid Clouds
...
class DescribeClusterSummaryResponse extends AbstractModel
{
    ...
    /**
     * @var integer TKE Cluster Count
     */
    public $TkeClusterCount;

    /**
     * @var integer Number of User-Built Tencent Cloud Clusters
     */
    public $UserCreateTencentClusterCount;

    /**
     * @var integer Number of User-Built Cluster Hybrid Clouds
     */
     ...
     * @param integer $TkeClusterCount TKE Cluster Count
     * @param integer $UserCreateTencentClusterCount Number of User-Built Tencent Cloud Clusters
     * @param integer $UserCreateHybridClusterCount Number of User-Built Cluster Hybrid Clouds
