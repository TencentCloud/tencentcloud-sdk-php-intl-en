 ...
 * @method string getCreateResult() Obtain Result of creating the check task. Valid values: `Succ`, `Failed`.
 * @method void setCreateResult(string $CreateResult) Set Result of creating the check task. Valid values: `Succ`, `Failed`.
...
class CreateRefreshTaskResponse extends AbstractModel
{
    ...
    /**
     * @var string Result of creating the check task. Valid values: `Succ`, `Failed`.
     */
    public $CreateResult;
     ...
     * @param string $CreateResult Result of creating the check task. Valid values: `Succ`, `Failed`.
