 ...
 * @method string getBy() Obtain Sorting field: `ImageSize`.
 * @method void setBy(string $By) Set Sorting field: `ImageSize`.
 */
class DescribeVulIgnoreLocalImageListRequest extends AbstractModel
{
    ...
    /**
     * @var string Sorting field: `ImageSize`.
     */
    public $By;
     ...
     * @param string $By Sorting field: `ImageSize`.
     */
