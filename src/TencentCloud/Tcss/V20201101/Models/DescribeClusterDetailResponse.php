 ...
 * @method string getCheckFailReason() Obtain Check failure reasons.
 * @method void setCheckFailReason(string $CheckFailReason) Set Check failure reasons.
...
class DescribeClusterDetailResponse extends AbstractModel
{
    ...
    /**
     * @var string Check failure reasons.
     */
     ...
     * @param string $CheckFailReason Check failure reasons.
