 ...
 *
 * @method array getList() Obtain List of database services
 * @method void setList(array $List) Set List of database services
...
{
    /**
     * @var array List of database services
     */
    public $List;
    ...
    /**
     * @param array $List List of database services
