 ...
 * @method string getNewTaskID() Obtain Return the ID of the created new cluster task.
 * @method void setNewTaskID(string $NewTaskID) Set Return the ID of the created new cluster task.
...
class CreateClusterCheckTaskResponse extends AbstractModel
{
    ...
    /**
     * @var string Return the ID of the created new cluster task.
     */
    public $NewTaskID;
     ...
     * @param string $NewTaskID Return the ID of the created new cluster task.
