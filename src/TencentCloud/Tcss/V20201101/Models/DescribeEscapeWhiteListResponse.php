 ...
 * @method array getList() Obtain Allowlist of escapes
 * @method void setList(array $List) Set Allowlist of escapes
...
class DescribeEscapeWhiteListResponse extends AbstractModel
{
    ...
    /**
     * @var array Allowlist of escapes
     */
    public $List;
     ...
     * @param array $List Allowlist of escapes
