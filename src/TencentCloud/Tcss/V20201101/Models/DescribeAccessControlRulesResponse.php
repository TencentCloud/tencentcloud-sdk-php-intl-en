 ...
 * @method array getRuleSet() Obtain List of access control policies
 * @method void setRuleSet(array $RuleSet) Set List of access control policies
...
class DescribeAccessControlRulesResponse extends AbstractModel
{
    ...
    /**
     * @var array List of access control policies
     */
    public $RuleSet;
     ...
     * @param array $RuleSet List of access control policies
