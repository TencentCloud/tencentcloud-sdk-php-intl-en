 ...
 *
 * @method string getAssetSyncLastTime() Obtain Last asset sync time
 * @method void setAssetSyncLastTime(string $AssetSyncLastTime) Set Last asset sync time
...
{
    /**
     * @var string Last asset sync time
     */
    ...
    /**
     * @param string $AssetSyncLastTime Last asset sync time
