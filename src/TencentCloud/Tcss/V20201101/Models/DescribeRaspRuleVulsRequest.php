 ...
 * @method string getBy() Obtain Sort field. SubmitTime: Disclosure time
 * @method void setBy(string $By) Set Sort field. SubmitTime: Disclosure time
 */
...
<li>Name- string - required: no - vulnerability name</li>
    ...
    /**
     * @var string Sort field. SubmitTime: Disclosure time
     */
    public $By;
...
<li>Name- string - required: no - vulnerability name</li>
     ...
     * @param string $By Sort field. SubmitTime: Disclosure time
     */
