 ...
 * @method string getResult() Obtain Result of creating the check task. Valid values: `Succ`, `Failed`.
 * @method void setResult(string $Result) Set Result of creating the check task. Valid values: `Succ`, `Failed`.
...
class CreateNetworkFirewallPolicyDiscoverResponse extends AbstractModel
{
     ...
     * @param string $Result Result of creating the check task. Valid values: `Succ`, `Failed`.
