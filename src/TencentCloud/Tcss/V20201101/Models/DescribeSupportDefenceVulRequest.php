 ...
 * @method string getBy() Obtain Sorting field. Disclosure time: `SubmitTime`.
 * @method void setBy(string $By) Set Sorting field. Disclosure time: `SubmitTime`.
 */
...
<li>Name- string - Required: No - Vulnerability name</li>
    ...
    /**
     * @var string Sorting field. Disclosure time: `SubmitTime`.
     */
    public $By;
...
<li>Name- string - Required: No - Vulnerability name</li>
     ...
     * @param string $By Sorting field. Disclosure time: `SubmitTime`.
     */
