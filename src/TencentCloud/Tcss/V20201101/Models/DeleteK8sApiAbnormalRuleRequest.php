 ...
 *
 * @method array getRuleIDSet() Obtain Rule ID set
 * @method void setRuleIDSet(array $RuleIDSet) Set Rule ID set
 */
class DeleteK8sApiAbnormalRuleRequest extends AbstractModel
{
    /**
     * @var array Rule ID set
     */
    public $RuleIDSet;

    /**
     * @param array $RuleIDSet Rule ID set
     */
