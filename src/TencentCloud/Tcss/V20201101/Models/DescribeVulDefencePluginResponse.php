 ...
 * @method array getList() Obtain List of exploit prevention plugins
 * @method void setList(array $List) Set List of exploit prevention plugins
...
class DescribeVulDefencePluginResponse extends AbstractModel
{
    ...
    /**
     * @var array List of exploit prevention plugins
     */
    public $List;
     ...
     * @param array $List List of exploit prevention plugins
