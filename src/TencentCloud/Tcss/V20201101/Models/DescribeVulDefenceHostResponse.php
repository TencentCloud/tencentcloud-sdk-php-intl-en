 ...
 * @method array getList() Obtain List of servers with exploit prevention
 * @method void setList(array $List) Set List of servers with exploit prevention
...
class DescribeVulDefenceHostResponse extends AbstractModel
{
    ...
    /**
     * @var array List of servers with exploit prevention
     */
    public $List;
     ...
     * @param array $List List of servers with exploit prevention
