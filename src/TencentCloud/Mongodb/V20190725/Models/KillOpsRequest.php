 ...
 * @method array getOperations() Obtain Operation to be terminated.
 * @method void setOperations(array $Operations) Set Operation to be terminated.
 */
class KillOpsRequest extends AbstractModel
{
    ...
    /**
     * @var array Operation to be terminated.
     */
    public $Operations;
     ...
     * @param array $Operations Operation to be terminated.
     */
