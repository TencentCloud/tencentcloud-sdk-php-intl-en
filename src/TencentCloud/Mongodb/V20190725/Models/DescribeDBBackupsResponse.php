 ...
 * @method integer getTotalCount() Obtain Number of backups.
 * @method void setTotalCount(integer $TotalCount) Set Number of backups.
...
class DescribeDBBackupsResponse extends AbstractModel
{
     ...
     * @param integer $TotalCount Number of backups.
