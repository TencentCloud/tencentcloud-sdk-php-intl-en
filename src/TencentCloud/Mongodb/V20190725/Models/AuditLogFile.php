 ...
 * @method string getStatus() Obtain File status value. May return the following values:
"creating" - generating
"Failed" - Creation failed.
"success" - generated.
 * @method void setStatus(string $Status) Set File status value. May return the following values:
"creating" - generating
"Failed" - Creation failed.
"success" - generated.
...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method integer getProgressRate() Obtain Download progress
 * @method void setProgressRate(integer $ProgressRate) Set Download progress
 */
class AuditLogFile extends AbstractModel
{
    ...
    /**
     * @var string File status value. May return the following values:
"creating" - generating
"Failed" - Creation failed.
"success" - generated.
     */
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param string $Status File status value. May return the following values:
"creating" - generating
"Failed" - Creation failed.
"success" - generated.
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param integer $ProgressRate Download progress
     */
