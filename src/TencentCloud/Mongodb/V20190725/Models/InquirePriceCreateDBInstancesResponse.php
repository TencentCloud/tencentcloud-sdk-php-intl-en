 ...
 *
 * @method DBInstancePrice getPrice() Obtain <p>Price</p>
 * @method void setPrice(DBInstancePrice $Price) Set <p>Price</p>
...
class InquirePriceCreateDBInstancesResponse extends AbstractModel
{
    ...
    /**
     * @param DBInstancePrice $Price <p>Price</p>
