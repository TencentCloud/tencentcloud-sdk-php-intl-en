 ...
 *
 * @method DBInstancePrice getPrice() Obtain Price.
 * @method void setPrice(DBInstancePrice $Price) Set Price.
...
class InquirePriceCreateDBInstancesResponse extends AbstractModel
{
    ...
    /**
     * @param DBInstancePrice $Price Price.
