 ...
 *
 * @method array getGroups() Obtain Security groups associated with the instance
 * @method void setGroups(array $Groups) Set Security groups associated with the instance
...
class DescribeSecurityGroupResponse extends AbstractModel
{
    ...
    /**
     * @param array $Groups Security groups associated with the instance
