 ...
 * @method array getTasks() Obtain The list of download tasks
 * @method void setTasks(array $Tasks) Set The list of download tasks
...
class DescribeBackupDownloadTaskResponse extends AbstractModel
{
    ...
    /**
     * @var array The list of download tasks
     */
    public $Tasks;
     ...
     * @param array $Tasks The list of download tasks
