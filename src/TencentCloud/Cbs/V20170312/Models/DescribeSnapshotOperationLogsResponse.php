...
/**
 * @method array getSnapshotOperationLogSet() 获取List of snapshot operation logs.
 * @method void setSnapshotOperationLogSet(array $SnapshotOperationLogSet) 设置List of snapshot operation logs.
