...
/**
 * @method PrepayPrice getDiskPrice() 获取Describes the price of expanding the cloud disk.
 * @method void setDiskPrice(PrepayPrice $DiskPrice) 设置Describes the price of expanding the cloud disk.
...
{
    /**
     * @var PrepayPrice Describes the price of expanding the cloud disk.
     */
    public $DiskPrice;
