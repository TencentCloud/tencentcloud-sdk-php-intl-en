...
/**
 * @method array getDiskOperationLogSet() 获取List of cloud disk operation logs.
 * @method void setDiskOperationLogSet(array $DiskOperationLogSet) 设置List of cloud disk operation logs.
