...
/**
 * @method integer getTotalCount() 获取Number of snapshots.
 * @method void setTotalCount(integer $TotalCount) 设置Number of snapshots.
 * @method array getSnapshotSet() 获取List of snapshot details.
 * @method void setSnapshotSet(array $SnapshotSet) 设置List of snapshot details.
