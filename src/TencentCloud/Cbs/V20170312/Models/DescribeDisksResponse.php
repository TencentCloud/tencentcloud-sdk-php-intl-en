...
{
    /**
     * @var integer The quantity of cloud disks meeting the conditions.
     */
    public $TotalCount;

    /**
     * @var array List of cloud disk details.
     */
    public $DiskSet;
    ...
    /**
     * @param integer $TotalCount The quantity of cloud disks meeting the conditions.
     * @param array $DiskSet List of cloud disk details.
