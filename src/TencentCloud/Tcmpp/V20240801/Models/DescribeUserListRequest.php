 ...
 * @method integer getAccountType() Obtain User account 1 - Super Admin 2 - Platform Admin 3 - Ordinary member
 * @method void setAccountType(integer $AccountType) Set User account 1 - Super Admin 2 - Platform Admin 3 - Ordinary member
...
class DescribeUserListRequest extends AbstractModel
{
    ...
    /**
     * @var integer User account 1 - Super Admin 2 - Platform Admin 3 - Ordinary member
     */
    public $AccountType;
     ...
     * @param integer $AccountType User account 1 - Super Admin 2 - Platform Admin 3 - Ordinary member
