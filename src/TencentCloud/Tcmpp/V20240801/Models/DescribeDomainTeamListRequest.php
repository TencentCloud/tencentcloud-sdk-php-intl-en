 ...
 * @method string getKeyword() Obtain Query keywords (team name)
 * @method void setKeyword(string $Keyword) Set Query keywords (team name)
 */
class DescribeDomainTeamListRequest extends AbstractModel
{
    ...
    /**
     * @var string Query keywords (team name)
     */
    public $Keyword;
     ...
     * @param string $Keyword Query keywords (team name)
     */
