 ...
 * @method string getKeyword() Obtain Keywords for search (role name)
 * @method void setKeyword(string $Keyword) Set Keywords for search (role name)
...
class DescribeRoleListRequest extends AbstractModel
{
    ...
    /**
     * @var string Keywords for search (role name)
     */
    public $Keyword;
     ...
     * @param string $Keyword Keywords for search (role name)
