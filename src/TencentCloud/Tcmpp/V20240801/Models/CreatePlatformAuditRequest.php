 ...
 * @method string getApplyAction() Obtain submit - submit the review ticket, cancel - cancel the review ticket
 * @method void setApplyAction(string $ApplyAction) Set submit - submit the review ticket, cancel - cancel the review ticket
...
class CreatePlatformAuditRequest extends AbstractModel
{
    ...
    /**
     * @var string submit - submit the review ticket, cancel - cancel the review ticket
     */
    public $ApplyAction;
     ...
     * @param string $ApplyAction submit - submit the review ticket, cancel - cancel the review ticket
