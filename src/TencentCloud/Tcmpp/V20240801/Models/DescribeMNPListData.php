 ...
 * @method integer getStatus() Obtain Whether the mini program is submitted to the application. 1: Submitted; 2: Removed
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setStatus(integer $Status) Set Whether the mini program is submitted to the application. 1: Submitted; 2: Removed
Note: This field may return null, indicating that no valid values can be obtained.
...
class DescribeMNPListData extends AbstractModel
{
    ...
    /**
     * @var integer Whether the mini program is submitted to the application. 1: Submitted; 2: Removed
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Status;
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param integer $Status Whether the mini program is submitted to the application. 1: Submitted; 2: Removed
Note: This field may return null, indicating that no valid values can be obtained.
