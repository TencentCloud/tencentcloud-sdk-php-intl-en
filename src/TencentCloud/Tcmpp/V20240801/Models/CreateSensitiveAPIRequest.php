 ...
 * @method array getApiList() Obtain New API list
 * @method void setApiList(array $ApiList) Set New API list
...
class CreateSensitiveAPIRequest extends AbstractModel
{
     ...
     * @param array $ApiList New API list
