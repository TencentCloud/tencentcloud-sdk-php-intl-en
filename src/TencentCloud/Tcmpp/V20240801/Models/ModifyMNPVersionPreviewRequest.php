 ...
 * @method string getTestEntrancePath() Obtain Path to the demo page
 * @method void setTestEntrancePath(string $TestEntrancePath) Set Path to the demo page
 */
class ModifyMNPVersionPreviewRequest extends AbstractModel
{
    ...
    /**
     * @var string Path to the demo page
     */
     ...
     * @param string $TestEntrancePath Path to the demo page
     */
