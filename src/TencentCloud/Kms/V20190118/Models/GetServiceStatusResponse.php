 ...
 * @method integer getResourceZone() Obtain <p>Regional information of the resource</p>
 * @method void setResourceZone(integer $ResourceZone) Set <p>Regional information of the resource</p>
 * @method integer getResourceRegion() Obtain <p>Regional availability zone info of the resource</p>
 * @method void setResourceRegion(integer $ResourceRegion) Set <p>Regional availability zone info of the resource</p>
...
class GetServiceStatusResponse extends AbstractModel
{
    ...
    /**
     * @var integer <p>Regional information of the resource</p>
     */
    public $ResourceZone;

    /**
     * @var integer <p>Regional availability zone info of the resource</p>
     */
     ...
     * @param integer $ResourceZone <p>Regional information of the resource</p>
     * @param integer $ResourceRegion <p>Regional availability zone info of the resource</p>
