 ...
 * @method integer getTotalCount() Obtain Total number of white-box keys.
 * @method void setTotalCount(integer $TotalCount) Set Total number of white-box keys.
...
class DescribeWhiteBoxKeyDetailsResponse extends AbstractModel
{
    ...
    /**
     * @var integer Total number of white-box keys.
     */
    public $TotalCount;
     ...
     * @param integer $TotalCount Total number of white-box keys.
