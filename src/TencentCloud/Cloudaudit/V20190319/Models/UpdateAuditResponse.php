 ...
 *
 * @method integer getIsSuccess() Obtain Indicates if the update was completed successfully
 * @method void setIsSuccess(integer $IsSuccess) Set Indicates if the update was completed successfully
...
{
    /**
     * @var integer Indicates if the update was completed successfully
     */
    public $IsSuccess;
    ...
    /**
     * @param integer $IsSuccess Indicates if the update was completed successfully
