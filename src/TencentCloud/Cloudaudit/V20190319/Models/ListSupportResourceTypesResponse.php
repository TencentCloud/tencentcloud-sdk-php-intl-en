 ...
 *
 * @method array getResourceTypes() Obtain List of supported resource types
 * @method void setResourceTypes(array $ResourceTypes) Set List of supported resource types
...
class ListSupportResourceTypesResponse extends AbstractModel
{
    ...
    /**
     * @param array $ResourceTypes List of supported resource types
