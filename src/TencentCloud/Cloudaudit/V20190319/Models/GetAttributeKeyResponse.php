 ...
 *
 * @method array getAttributeKeyDetails() Obtain Valid values of `AttributeKey`
 * @method void setAttributeKeyDetails(array $AttributeKeyDetails) Set Valid values of `AttributeKey`
...
{
    /**
     * @var array Valid values of `AttributeKey`
     */
    ...
    /**
     * @param array $AttributeKeyDetails Valid values of `AttributeKey`
