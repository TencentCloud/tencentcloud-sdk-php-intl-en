...
<li>HTTP: (Default) the source type is HTTP.</li>
 * @method IncrementalMigrationHttpOriginConfig getHttpOriginConfig() Obtain Incremental migration HTTP origin source configuration. If left blank, it will default to no modification.
 * @method void setHttpOriginConfig(IncrementalMigrationHttpOriginConfig $HttpOriginConfig) Set Incremental migration HTTP origin source configuration. If left blank, it will default to no modification.
 */
...
<li>HTTP: (Default) the source type is HTTP.</li>
    ...
    /**
     * @var IncrementalMigrationHttpOriginConfig Incremental migration HTTP origin source configuration. If left blank, it will default to no modification.
     */
...
<li>HTTP: (Default) the source type is HTTP.</li>
     * @param IncrementalMigrationHttpOriginConfig $HttpOriginConfig Incremental migration HTTP origin source configuration. If left blank, it will default to no modification.
     */
