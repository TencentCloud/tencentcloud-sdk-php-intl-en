 ...
 * @method AiReviewPoliticalAsrTaskInput getInput() Obtain 
 * @method void setInput(AiReviewPoliticalAsrTaskInput $Input) Set 
...
class AiReviewTaskPoliticalAsrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPoliticalAsrTaskInput 
     */
    public $Input;
     ...
     * @param AiReviewPoliticalAsrTaskInput $Input 
