 ...
 *
 * @method string getVoiceId() Obtain <p>Cloned timbre</p>
 * @method void setVoiceId(string $VoiceId) Set <p>Cloned timbre</p>
...
class CloneVoiceSyncResponse extends AbstractModel
{
    ...
    /**
     * @param string $VoiceId <p>Cloned timbre</p>
