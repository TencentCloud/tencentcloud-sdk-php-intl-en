...
<li>ON: enable the text keyword recognition task;</li>
<li>OFF: Disable the text keyword recognition task.</li>
 * @method array getLabelSet() Obtain Tag for keyword-based filtering. Specify the tag of keywords to return. If not specified or empty, all results are returned.
The number of tags can be up to 10, and each tag can contain up to 16 characters.
 * @method void setLabelSet(array $LabelSet) Set Tag for keyword-based filtering. Specify the tag of keywords to return. If not specified or empty, all results are returned.
The number of tags can be up to 10, and each tag can contain up to 16 characters.
 */
...
<li>OFF: Disable the text keyword recognition task.</li>
    ...
    /**
     * @var array Tag for keyword-based filtering. Specify the tag of keywords to return. If not specified or empty, all results are returned.
The number of tags can be up to 10, and each tag can contain up to 16 characters.
     */
    public $LabelSet;
...
<li>ON: enable the text keyword recognition task;</li>
<li>OFF: Disable the text keyword recognition task.</li>
     * @param array $LabelSet Tag for keyword-based filtering. Specify the tag of keywords to return. If not specified or empty, all results are returned.
The number of tags can be up to 10, and each tag can contain up to 16 characters.
     */
