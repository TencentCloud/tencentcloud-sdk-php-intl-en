 ...
 * @method AiAnalysisTaskTagInput getInput() Obtain 
 * @method void setInput(AiAnalysisTaskTagInput $Input) Set 
...
class AiAnalysisTaskTagResult extends AbstractModel
{
     ...
     * @param AiAnalysisTaskTagInput $Input 
