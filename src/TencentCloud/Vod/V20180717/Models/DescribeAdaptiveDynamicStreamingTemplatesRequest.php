 ...
 * @method array getDefinitions() Obtain Filtering condition for the unique identifier of the adaptive bitstream template. The array length cannot exceed 100.
 * @method void setDefinitions(array $Definitions) Set Filtering condition for the unique identifier of the adaptive bitstream template. The array length cannot exceed 100.
...
class DescribeAdaptiveDynamicStreamingTemplatesRequest extends AbstractModel
{
    ...
    /**
     * @var array Filtering condition for the unique identifier of the adaptive bitstream template. The array length cannot exceed 100.
     */
    public $Definitions;
...
<li>Custom: custom template.</li>
     ...
     * @param array $Definitions Filtering condition for the unique identifier of the adaptive bitstream template. The array length cannot exceed 100.
