 ...
 * @method string getName() Obtain <p>Screenshot template name at specified time point. Length limited to 64 characters.</p>
 * @method void setName(string $Name) Set <p>Screenshot template name at specified time point. Length limited to 64 characters.</p>
...
class ModifySnapshotByTimeOffsetTemplateRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>Screenshot template name at specified time point. Length limited to 64 characters.</p>
     */
    public $Name;
    ...
    /**
     * @var string <p>Filling mode. When the video stream configuration width and height parameters are inconsistent with the aspect ratio of the original video, the processing method for transcoding is "fill". Optional filling modes:</p><li>stretch: Stretch each frame to fill the entire screen, which may cause the transcoded video to be "squashed" or "stretched".</li><li>black: Keep the video aspect ratio unchanged and fill the remaining edge part with black.</li><li>white: Keep the video aspect ratio unchanged and fill the remaining edge part with white.</li><li>gauss: Keep the video aspect ratio unchanged and apply Gaussian blur to the remaining edge part.</li>Default value: black.
     */
    public $FillType;
     ...
     * @param string $Name <p>Screenshot template name at specified time point. Length limited to 64 characters.</p>
     ...
     * @param string $FillType <p>Filling mode. When the video stream configuration width and height parameters are inconsistent with the aspect ratio of the original video, the processing method for transcoding is "fill". Optional filling modes:</p><li>stretch: Stretch each frame to fill the entire screen, which may cause the transcoded video to be "squashed" or "stretched".</li><li>black: Keep the video aspect ratio unchanged and fill the remaining edge part with black.</li><li>white: Keep the video aspect ratio unchanged and fill the remaining edge part with white.</li><li>gauss: Keep the video aspect ratio unchanged and apply Gaussian blur to the remaining edge part.</li>Default value: black.
     */
