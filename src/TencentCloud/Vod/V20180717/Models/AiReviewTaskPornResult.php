 ...
 * @method AiReviewPornTaskInput getInput() Obtain 
 * @method void setInput(AiReviewPornTaskInput $Input) Set 
...
class AiReviewTaskPornResult extends AbstractModel
{
     ...
     * @param AiReviewPornTaskInput $Input 
