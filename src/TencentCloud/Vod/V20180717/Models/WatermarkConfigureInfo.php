...
<li>ON: means enabling watermark;</li>
<li>OFF: means turning off watermark. </li>
 * @method string getImageContent() Obtain Watermark image Base64 encoded string. Supports jpeg, png image formats.
 * @method void setImageContent(string $ImageContent) Set Watermark image Base64 encoded string. Supports jpeg, png image formats.
...
<li>The string ends with %, indicating that the watermark Height is a percentage of the video height, for example, 10% means that the Height is 10% of the video height;</li>
 * @method string getXPos() Obtain The horizontal position of the watermark origin from the video image coordinate origin. The string ends with %, indicating that the watermark XPos specifies a percentage of the video width, such as 10% indicating that the XPos is 10% of the video width.
 * @method void setXPos(string $XPos) Set The horizontal position of the watermark origin from the video image coordinate origin. The string ends with %, indicating that the watermark XPos specifies a percentage of the video width, such as 10% indicating that the XPos is 10% of the video width.
...
<li>OFF: means turning off watermark. </li>
    ...
    /**
     * @var string Watermark image Base64 encoded string. Supports jpeg, png image formats.
     */
    public $ImageContent;
...
<li>The string ends with %, indicating that the watermark Height is a percentage of the video height, for example, 10% means that the Height is 10% of the video height;</li>
    ...
    /**
     * @var string The horizontal position of the watermark origin from the video image coordinate origin. The string ends with %, indicating that the watermark XPos specifies a percentage of the video width, such as 10% indicating that the XPos is 10% of the video width.
     */
    public $XPos;
...
<li>ON: means enabling watermark;</li>
<li>OFF: means turning off watermark. </li>
     * @param string $ImageContent Watermark image Base64 encoded string. Supports jpeg, png image formats.
     * @param string $Width The width of the watermark. 
<li>The string ends with %, indicating that the watermark Width is a percentage of the video width, such as 10% indicating that the Width is 10% of the video width;</li>
     * @param string $Height The height of the watermark. 
<li>The string ends with %, indicating that the watermark Height is a percentage of the video height, for example, 10% means that the Height is 10% of the video height;</li>
     * @param string $XPos The horizontal position of the watermark origin from the video image coordinate origin. The string ends with %, indicating that the watermark XPos specifies a percentage of the video width, such as 10% indicating that the XPos is 10% of the video width.
