 ...
 *
 * @method integer getSubAppId() Obtain **VOD application ID. Customers who activate VOD services after December 25, 2023 must fill in this field with the app ID when accessing resources in VOD applications (whether the default application or a newly created application).**
 * @method void setSubAppId(integer $SubAppId) Set **VOD application ID. Customers who activate VOD services after December 25, 2023 must fill in this field with the app ID when accessing resources in VOD applications (whether the default application or a newly created application).**
 ...
 * @method SceneAigcVideoOutputConfig getOutputConfig() Obtain Output media file configuration for a scenario-based video task.
 * @method void setOutputConfig(SceneAigcVideoOutputConfig $OutputConfig) Set Output media file configuration for a scenario-based video task.
...
{
    /**
     * @var integer **VOD application ID. Customers who activate VOD services after December 25, 2023 must fill in this field with the app ID when accessing resources in VOD applications (whether the default application or a newly created application).**
     */
    public $SubAppId;
    ...
    /**
     * @var SceneAigcVideoOutputConfig Output media file configuration for a scenario-based video task.
     */
    public $OutputConfig;
    ...
    /**
     * @param integer $SubAppId **VOD application ID. Customers who activate VOD services after December 25, 2023 must fill in this field with the app ID when accessing resources in VOD applications (whether the default application or a newly created application).**
     * @param AigcVideoSceneInfo $SceneInfo Scenario-based video generation parameter configuration.
     * @param SceneAigcVideoOutputConfig $OutputConfig Output media file configuration for a scenario-based video task.
