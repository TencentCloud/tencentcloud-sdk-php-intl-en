 ...
 *
 * @method integer getTotalCount() Obtain Total number of eligible entries.
 * @method void setTotalCount(integer $TotalCount) Set Total number of eligible entries.
...
{
    /**
     * @var integer Total number of eligible entries.
     */
    public $TotalCount;
    ...
    /**
     * @param integer $TotalCount Total number of eligible entries.
