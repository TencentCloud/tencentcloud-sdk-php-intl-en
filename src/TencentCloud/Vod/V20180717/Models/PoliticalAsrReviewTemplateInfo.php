...
<li>OFF: Disable the task involving ASR-based recognition of inappropriate information.</li>
    ...
    /**
     * @var integer Threshold score for determining suspected violations. When the audio/video moderation score reaches or exceeds this threshold, it is considered a suspected violation. If not specified, it defaults to 100 points. Value range: 0–100.
     */
