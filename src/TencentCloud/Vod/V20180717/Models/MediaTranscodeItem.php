 ...
 *
 * @method string getUrl() Obtain <p>File URL of the video after transcoding.</p>
 * @method void setUrl(string $Url) Set <p>File URL of the video after transcoding.</p>
 * @method integer getDefinition() Obtain <p>Transcoding specification ID. See <a href="https://www.tencentcloud.com/document/product/266/33476?from_cn_redirect=1">transcoding parameter template</a>.<br><font color="red">Note: The value 0 means the raw file.</font></p>
 * @method void setDefinition(integer $Definition) Set <p>Transcoding specification ID. See <a href="https://www.tencentcloud.com/document/product/266/33476?from_cn_redirect=1">transcoding parameter template</a>.<br><font color="red">Note: The value 0 means the raw file.</font></p>
 ...
 * @method integer getHeight() Obtain <p>Maximum height of the video stream. Unit: px.</p>
 * @method void setHeight(integer $Height) Set <p>Maximum height of the video stream. Unit: px.</p>
 ...
 * @method string getFileId() Obtain <p>New FileId generated by transcoding. Valid when requesting to turn on standalone media asset output.</p>
 * @method void setFileId(string $FileId) Set <p>New FileId generated by transcoding. Valid when requesting to turn on standalone media asset output.</p>
 */
class MediaTranscodeItem extends AbstractModel
{
    /**
     * @var string <p>File URL of the video after transcoding.</p>
     */
    public $Url;

    /**
     * @var integer <p>Transcoding specification ID. See <a href="https://www.tencentcloud.com/document/product/266/33476?from_cn_redirect=1">transcoding parameter template</a>.<br><font color="red">Note: The value 0 means the raw file.</font></p>
     */
    public $Definition;
    ...
    /**
     * @var integer <p>Maximum height of the video stream. Unit: px.</p>
     */
    public $Height;
    ...
    /**
     * @var string <p>New FileId generated by transcoding. Valid when requesting to turn on standalone media asset output.</p>
     */
    public $FileId;

    /**
     * @param string $Url <p>File URL of the video after transcoding.</p>
     * @param integer $Definition <p>Transcoding specification ID. See <a href="https://www.tencentcloud.com/document/product/266/33476?from_cn_redirect=1">transcoding parameter template</a>.<br><font color="red">Note: The value 0 means the raw file.</font></p>
     * @param integer $Bitrate <p>Sum of the average video stream bitrate and average audio stream bitrate. Unit: bps.</p>
     * @param integer $Height <p>Maximum height of the video stream. Unit: px.</p>
     ...
     * @param string $FileId <p>New FileId generated by transcoding. Valid when requesting to turn on standalone media asset output.</p>
     */
