 ...
 * @method string getImageUrl() Obtain URL of the image watermark. This field is valid only when Type is image.
 * @method void setImageUrl(string $ImageUrl) Set URL of the image watermark. This field is valid only when Type is image.
...
class CreateWatermarkTemplateResponse extends AbstractModel
{
    ...
    /**
     * @var string URL of the image watermark. This field is valid only when Type is image.
     */
    public $ImageUrl;
     ...
     * @param string $ImageUrl URL of the image watermark. This field is valid only when Type is image.
