...
class PoliticalImgReviewTemplateInfo extends AbstractModel
{
    ...
    /**
     * @var integer <p>Threshold score for determining suspected violations. When the review score reaches or exceeds this threshold, it is considered a suspected violation. If not specified, it defaults to 97 points. Value range: 0–100.</p>
     */
