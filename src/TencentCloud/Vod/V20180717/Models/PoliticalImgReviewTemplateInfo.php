 ...
 *
 * @method string getSwitch() Obtain Switch of politically sensitive information detection in video image task. Valid values:
 ...
 * @method void setSwitch(string $Switch) Set Switch of politically sensitive information detection in video image task. Valid values:
<li>ON: enables politically sensitive information detection in video image task;</li>
<li>OFF: disables politically sensitive information detection in video image task.</li>
 * @method array getLabelSet() Obtain Filter tag for politically sensitive information detection in video image. If an audit result contains the selected tag, it will be returned; if the filter tag is empty, all audit results will be returned. Valid values:
<li>violation_photo: violating photo;</li>
<li>politician: politically sensitive figure;</li>
<li>entertainment: entertainment celebrity;</li>
<li>sport: sports celebrity.</li>
 * @method void setLabelSet(array $LabelSet) Set Filter tag for politically sensitive information detection in video image. If an audit result contains the selected tag, it will be returned; if the filter tag is empty, all audit results will be returned. Valid values:
<li>violation_photo: violating photo;</li>
<li>politician: politically sensitive figure;</li>
<li>entertainment: entertainment celebrity;</li>
<li>sport: sports celebrity.</li>
...
{
    /**
     * @var string Switch of politically sensitive information detection in video image task. Valid values:
<li>ON: enables politically sensitive information detection in video image task;</li>
<li>OFF: disables politically sensitive information detection in video image task.</li>
     */
    public $Switch;
    ...
    /**
     * @var array Filter tag for politically sensitive information detection in video image. If an audit result contains the selected tag, it will be returned; if the filter tag is empty, all audit results will be returned. Valid values:
<li>violation_photo: violating photo;</li>
<li>politician: politically sensitive figure;</li>
<li>entertainment: entertainment celebrity;</li>
<li>sport: sports celebrity.</li>
    ...
    /**
     * @param string $Switch Switch of politically sensitive information detection in video image task. Valid values:
<li>ON: enables politically sensitive information detection in video image task;</li>
<li>OFF: disables politically sensitive information detection in video image task.</li>
     * @param array $LabelSet Filter tag for politically sensitive information detection in video image. If an audit result contains the selected tag, it will be returned; if the filter tag is empty, all audit results will be returned. Valid values:
<li>violation_photo: violating photo;</li>
<li>politician: politically sensitive figure;</li>
<li>entertainment: entertainment celebrity;</li>
<li>sport: sports celebrity.</li>
