 ...
 * @method AigcVideoRedrawTaskInfo getTaskInfo() Obtain <p>Parameters for the AIGC video conversion task.</p>
 * @method void setTaskInfo(AigcVideoRedrawTaskInfo $TaskInfo) Set <p>Parameters for the AIGC video conversion task.</p>
...
class CreateAigcVideoRedrawTaskRequest extends AbstractModel
{
    ...
    /**
     * @var AigcVideoRedrawTaskInfo <p>Parameters for the AIGC video conversion task.</p>
     */
    public $TaskInfo;
     ...
     * @param AigcVideoRedrawTaskInfo $TaskInfo <p>Parameters for the AIGC video conversion task.</p>
