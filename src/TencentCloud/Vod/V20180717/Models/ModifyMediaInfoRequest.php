 ...
 * @method string getCoverData() Obtain <p>The Base64-encoded string of the video cover image file (for example, jpeg or png). Only gif, jpeg, and png image formats are supported.</p>
 * @method void setCoverData(string $CoverData) Set <p>The Base64-encoded string of the video cover image file (for example, jpeg or png). Only gif, jpeg, and png image formats are supported.</p>
 ...
 * @method integer getClearKeyFrameDescs() Obtain <p>Value 1 indicates clearing video dotting information, and other values are meaningless.<br>In the same request, ClearKeyFrameDescs and AddKeyFrameDescs cannot appear simultaneously.</p>
 * @method void setClearKeyFrameDescs(integer $ClearKeyFrameDescs) Set <p>Value 1 indicates clearing video dotting information, and other values are meaningless.<br>In the same request, ClearKeyFrameDescs and AddKeyFrameDescs cannot appear simultaneously.</p>
 * @method array getAddTags() Obtain <p>A newly-added group of tags. Maximum for a single media file: 16 tags. Maximum for a single tag: 32 characters. In the same request, the AddTags parameter must be all different from DeleteTags.</p>
 * @method void setAddTags(array $AddTags) Set <p>A newly-added group of tags. Maximum for a single media file: 16 tags. Maximum for a single tag: 32 characters. In the same request, the AddTags parameter must be all different from DeleteTags.</p>
 * @method array getDeleteTags() Obtain <p>Set of tags to delete. In the same request, the AddTags parameter must be all different from DeleteTags.</p>
 * @method void setDeleteTags(array $DeleteTags) Set <p>Set of tags to delete. In the same request, the AddTags parameter must be all different from DeleteTags.</p>
 * @method integer getClearTags() Obtain <p>Value 1 means clear all tags of media files, and other values are meaningless.<br>In the same request, ClearTags and AddTags cannot appear simultaneously.</p>
 * @method void setClearTags(integer $ClearTags) Set <p>Value 1 means clear all tags of media files, and other values are meaningless.<br>In the same request, ClearTags and AddTags cannot appear simultaneously.</p>
 ...
 * @method array getDeleteSubtitleIds() Obtain <p>Unique identifier of subtitle to be deleted. In the same request, the specified subtitle id in AddSubtitles must be different from all DeleteSubtitleIds.</p>
 * @method void setDeleteSubtitleIds(array $DeleteSubtitleIds) Set <p>Unique identifier of subtitle to be deleted. In the same request, the specified subtitle id in AddSubtitles must be different from all DeleteSubtitleIds.</p>
 ...
 * @method integer getClearKnowledgeBases() Obtain <p>Value 1 means remove this media file from all knowledge bases, and other values are meaningless.</p><p><br>In the same request, ClearKnowledgeBases and DeleteKnowledgeBases cannot appear simultaneously.<p></p></p>
 * @method void setClearKnowledgeBases(integer $ClearKnowledgeBases) Set <p>Value 1 means remove this media file from all knowledge bases, and other values are meaningless.</p><p><br>In the same request, ClearKnowledgeBases and DeleteKnowledgeBases cannot appear simultaneously.<p></p></p>
 */
class ModifyMediaInfoRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>Media file expiry time in <a href="https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I">ISO date format</a>. "9999-12-31T23:59:59Z" means it never expires. After expiry, the media file and its related resources (transcoding result, sprites, etc.) will be permanently deleted.</p>
     */
    public $ExpireTime;

    /**
     * @var string <p>The Base64-encoded string of the video cover image file (for example, jpeg or png). Only gif, jpeg, and png image formats are supported.</p>
     */
    public $CoverData;
    ...
    /**
     * @var integer <p>Value 1 indicates clearing video dotting information, and other values are meaningless.<br>In the same request, ClearKeyFrameDescs and AddKeyFrameDescs cannot appear simultaneously.</p>
     */
    public $ClearKeyFrameDescs;

    /**
     * @var array <p>A newly-added group of tags. Maximum for a single media file: 16 tags. Maximum for a single tag: 32 characters. In the same request, the AddTags parameter must be all different from DeleteTags.</p>
     */
    public $AddTags;

    /**
     * @var array <p>Set of tags to delete. In the same request, the AddTags parameter must be all different from DeleteTags.</p>
     */
    public $DeleteTags;

    /**
     * @var integer <p>Value 1 means clear all tags of media files, and other values are meaningless.<br>In the same request, ClearTags and AddTags cannot appear simultaneously.</p>
     */
    public $ClearTags;
    ...
    /**
     * @var array <p>Unique identifier of subtitle to be deleted. In the same request, the specified subtitle id in AddSubtitles must be different from all DeleteSubtitleIds.</p>
     */
    ...
    /**
     * @var integer <p>Value 1 means remove this media file from all knowledge bases, and other values are meaningless.</p><p><br>In the same request, ClearKnowledgeBases and DeleteKnowledgeBases cannot appear simultaneously.<p></p></p>
     */
     ...
     * @param string $CoverData <p>The Base64-encoded string of the video cover image file (for example, jpeg or png). Only gif, jpeg, and png image formats are supported.</p>
     ...
     * @param integer $ClearKeyFrameDescs <p>Value 1 indicates clearing video dotting information, and other values are meaningless.<br>In the same request, ClearKeyFrameDescs and AddKeyFrameDescs cannot appear simultaneously.</p>
     * @param array $AddTags <p>A newly-added group of tags. Maximum for a single media file: 16 tags. Maximum for a single tag: 32 characters. In the same request, the AddTags parameter must be all different from DeleteTags.</p>
     * @param array $DeleteTags <p>Set of tags to delete. In the same request, the AddTags parameter must be all different from DeleteTags.</p>
     * @param integer $ClearTags <p>Value 1 means clear all tags of media files, and other values are meaningless.<br>In the same request, ClearTags and AddTags cannot appear simultaneously.</p>
     ...
     * @param array $DeleteSubtitleIds <p>Unique identifier of subtitle to be deleted. In the same request, the specified subtitle id in AddSubtitles must be different from all DeleteSubtitleIds.</p>
     ...
     * @param integer $ClearKnowledgeBases <p>Value 1 means remove this media file from all knowledge bases, and other values are meaningless.</p><p><br>In the same request, ClearKnowledgeBases and DeleteKnowledgeBases cannot appear simultaneously.<p></p></p>
     */
