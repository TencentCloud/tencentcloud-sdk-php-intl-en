 ...
 *
 * @method array getResultSet() Obtain Result set of text keyword recognition.
 ...
 * @method void setResultSet(array $ResultSet) Set Result set of text keyword recognition.
<font color=red>Note</font>: This list can only show up to the first 100 elements. To obtain the complete result, get it from the file corresponding to ResultSetFileUrl.
 * @method string getResultSetFileUrl() Obtain URL of the text keyword recognition result set file. The content of the file is in JSON format, and the data structure is consistent with the ResultSet fields. (The file is not retained permanently. It will be deleted after reaching the ResultSetFileUrlExpireTime time point.)
...
{
    /**
     * @var array Result set of text keyword recognition.
<font color=red>Note</font>: This list can only show up to the first 100 elements. To obtain the complete result, get it from the file corresponding to ResultSetFileUrl.
     */
    public $ResultSet;

    /**
     * @var string URL of the text keyword recognition result set file. The content of the file is in JSON format, and the data structure is consistent with the ResultSet fields. (The file is not retained permanently. It will be deleted after reaching the ResultSetFileUrlExpireTime time point.)
     */
    ...
    /**
     * @param array $ResultSet Result set of text keyword recognition.
<font color=red>Note</font>: This list can only show up to the first 100 elements. To obtain the complete result, get it from the file corresponding to ResultSetFileUrl.
     * @param string $ResultSetFileUrl URL of the text keyword recognition result set file. The content of the file is in JSON format, and the data structure is consistent with the ResultSet fields. (The file is not retained permanently. It will be deleted after reaching the ResultSetFileUrlExpireTime time point.)
