 ...
 *
 * @method DNSVerifyInfo getDNSVerifyInfo() Obtain 
 * @method void setDNSVerifyInfo(DNSVerifyInfo $DNSVerifyInfo) Set 
 * @method FileVerifyInfo getFileVerifyInfo() Obtain 
 * @method void setFileVerifyInfo(FileVerifyInfo $FileVerifyInfo) Set 
...
class CreateDomainVerifyRecordResponse extends AbstractModel
{
    ...
    /**
     * @param DNSVerifyInfo $DNSVerifyInfo 
     * @param FileVerifyInfo $FileVerifyInfo 
