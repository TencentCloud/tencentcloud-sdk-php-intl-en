...
<font color=red>Note</font>: This list can only display up to the first 100 elements. To obtain the complete result, get it from the file corresponding to ResultSetFileUrl.
 * @method string getResultSetFileUrl() Obtain Intelligent object recognition result set file URL. The content of the file is in JSON format, and the data structure is consistent with the fields of ResultSet. (The file is not retained permanently. It will be deleted after reaching the ResultSetFileUrlExpireTime time point.)
 * @method void setResultSetFileUrl(string $ResultSetFileUrl) Set Intelligent object recognition result set file URL. The content of the file is in JSON format, and the data structure is consistent with the fields of ResultSet. (The file is not retained permanently. It will be deleted after reaching the ResultSetFileUrlExpireTime time point.)
...
<font color=red>Note</font>: This list can only display up to the first 100 elements. To obtain the complete result, get it from the file corresponding to ResultSetFileUrl.
    ...
    /**
     * @var string Intelligent object recognition result set file URL. The content of the file is in JSON format, and the data structure is consistent with the fields of ResultSet. (The file is not retained permanently. It will be deleted after reaching the ResultSetFileUrlExpireTime time point.)
     */
...
<font color=red>Note</font>: This list can only display up to the first 100 elements. To obtain the complete result, get it from the file corresponding to ResultSetFileUrl.
     * @param string $ResultSetFileUrl Intelligent object recognition result set file URL. The content of the file is in JSON format, and the data structure is consistent with the fields of ResultSet. (The file is not retained permanently. It will be deleted after reaching the ResultSetFileUrlExpireTime time point.)
