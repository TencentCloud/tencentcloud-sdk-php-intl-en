 ...
 * @method string getTemplateType() Obtain <p>Type of MPS template to create. Value:</p><li>AIAnalysis: Create intelligent analysis template.</li><li>SmartSubtitle: Create intelligent subtitle template.</li><li>SmartErase: Create intelligent erasure template.</li><li>EmbedSubtitle: Create subtitle suppression template.</li>
 * @method void setTemplateType(string $TemplateType) Set <p>Type of MPS template to create. Value:</p><li>AIAnalysis: Create intelligent analysis template.</li><li>SmartSubtitle: Create intelligent subtitle template.</li><li>SmartErase: Create intelligent erasure template.</li><li>EmbedSubtitle: Create subtitle suppression template.</li>
...
class CreateMPSTemplateRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>Type of MPS template to create. Value:</p><li>AIAnalysis: Create intelligent analysis template.</li><li>SmartSubtitle: Create intelligent subtitle template.</li><li>SmartErase: Create intelligent erasure template.</li><li>EmbedSubtitle: Create subtitle suppression template.</li>
     */
    public $TemplateType;
     ...
     * @param string $TemplateType <p>Type of MPS template to create. Value:</p><li>AIAnalysis: Create intelligent analysis template.</li><li>SmartSubtitle: Create intelligent subtitle template.</li><li>SmartErase: Create intelligent erasure template.</li><li>EmbedSubtitle: Create subtitle suppression template.</li>
