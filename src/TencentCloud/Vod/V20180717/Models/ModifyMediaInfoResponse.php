 ...
 *
 * @method string getCoverUrl() Obtain New video cover URL.
* Note: This return value is valid only when the request carries CoverData. *
 * @method void setCoverUrl(string $CoverUrl) Set New video cover URL.
* Note: This return value is valid only when the request carries CoverData. *
 * @method array getAddedSubtitleSet() Obtain New subtitle information.
 * @method void setAddedSubtitleSet(array $AddedSubtitleSet) Set New subtitle information.
...
{
    /**
     * @var string New video cover URL.
* Note: This return value is valid only when the request carries CoverData. *
     */
    public $CoverUrl;

    /**
     * @var array New subtitle information.
     */
    ...
    /**
     * @param string $CoverUrl New video cover URL.
* Note: This return value is valid only when the request carries CoverData. *
     * @param array $AddedSubtitleSet New subtitle information.
