 ...
 * @method integer getCount() Obtain The number of license requests.
 * @method void setCount(integer $Count) Set The number of license requests.
 */
class LicenseUsageDataItem extends AbstractModel
{
    ...
    /**
     * @var integer The number of license requests.
     */
    public $Count;
     ...
     * @param integer $Count The number of license requests.
     */
