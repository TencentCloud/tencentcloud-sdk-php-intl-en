 ...
 * @method array getMultiViewImageInfos() Obtain <p>Multi-perspective image information used to generate a 3D model.</p><p>Input limits: The array length must be between 2 and 8, and it must contain the front perspective.</p><p>ImageInfos, MultiViewImageInfos, and Prompt are mutually exclusive with each other. One and only one must be filled in.</p>
 * @method void setMultiViewImageInfos(array $MultiViewImageInfos) Set <p>Multi-perspective image information used to generate a 3D model.</p><p>Input limits: The array length must be between 2 and 8, and it must contain the front perspective.</p><p>ImageInfos, MultiViewImageInfos, and Prompt are mutually exclusive with each other. One and only one must be filled in.</p>
 * @method string getPrompt() Obtain <p>Generate a Prompt for the 3D model.</p><p>Input parameter limit: Up to 1024 utf-8 characters.</p><p>The three input parameters ImageInfos, MultiViewImageInfos, and Prompt are mutually exclusive. One and only one must be filled in.</p>
 * @method void setPrompt(string $Prompt) Set <p>Generate a Prompt for the 3D model.</p><p>Input parameter limit: Up to 1024 utf-8 characters.</p><p>The three input parameters ImageInfos, MultiViewImageInfos, and Prompt are mutually exclusive. One and only one must be filled in.</p>
 ...
 * @method array getMeshInfos() Obtain <p>Reference 3D model used to generate a 3D model.</p><p>Input parameter limit: When MeshInfos is filled in, GenerateType must take the value Texture (texture scenario).</p>
 * @method void setMeshInfos(array $MeshInfos) Set <p>Reference 3D model used to generate a 3D model.</p><p>Input parameter limit: When MeshInfos is filled in, GenerateType must take the value Texture (texture scenario).</p>
 * @method string getEnablePBR() Obtain <p>Whether to enable output PBR material.</p><p>Enumeration values:</p><ul><li>Enabled: enable;</li><li>Disabled: disable.</li></ul><p>Default value: Disabled</p>
 * @method void setEnablePBR(string $EnablePBR) Set <p>Whether to enable output PBR material.</p><p>Enumeration values:</p><ul><li>Enabled: enable;</li><li>Disabled: disable.</li></ul><p>Default value: Disabled</p>
 ...
 * @method string getKeepUV() Obtain <p>Whether to retain UV unfold.</p><p>Enumeration values:</p><ul><li>Enabled: retain;</li><li>Disabled: not retain.</li></ul><p>Default value: Disabled</p>
 * @method void setKeepUV(string $KeepUV) Set <p>Whether to retain UV unfold.</p><p>Enumeration values:</p><ul><li>Enabled: retain;</li><li>Disabled: not retain.</li></ul><p>Default value: Disabled</p>
 * @method string getResultFormat() Obtain <p>Result format. In addition to the default return of obj and glb, an extra output format.</p><p>Enumeration values:</p><ul><li>FBX: FBX file format.</li></ul>
 * @method void setResultFormat(string $ResultFormat) Set <p>Result format. In addition to the default return of obj and glb, an extra output format.</p><p>Enumeration values:</p><ul><li>FBX: FBX file format.</li></ul>
 * @method integer getSeed() Obtain <p>Random Seed. Results can be reproduced with the same Seed input.</p><p>Value range: [0, 2147483647]</p>
 * @method void setSeed(integer $Seed) Set <p>Random Seed. Results can be reproduced with the same Seed input.</p><p>Value range: [0, 2147483647]</p>
...
class CreateAigcHunyuan3DTaskRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>Multi-perspective image information used to generate a 3D model.</p><p>Input limits: The array length must be between 2 and 8, and it must contain the front perspective.</p><p>ImageInfos, MultiViewImageInfos, and Prompt are mutually exclusive with each other. One and only one must be filled in.</p>
     */
    public $MultiViewImageInfos;

    /**
     * @var string <p>Generate a Prompt for the 3D model.</p><p>Input parameter limit: Up to 1024 utf-8 characters.</p><p>The three input parameters ImageInfos, MultiViewImageInfos, and Prompt are mutually exclusive. One and only one must be filled in.</p>
     */
    public $Prompt;
    ...
    /**
     * @var array <p>Reference 3D model used to generate a 3D model.</p><p>Input parameter limit: When MeshInfos is filled in, GenerateType must take the value Texture (texture scenario).</p>
     */
    public $MeshInfos;

    /**
     * @var string <p>Whether to enable output PBR material.</p><p>Enumeration values:</p><ul><li>Enabled: enable;</li><li>Disabled: disable.</li></ul><p>Default value: Disabled</p>
     */
    public $EnablePBR;
    ...
    /**
     * @var string <p>Whether to retain UV unfold.</p><p>Enumeration values:</p><ul><li>Enabled: retain;</li><li>Disabled: not retain.</li></ul><p>Default value: Disabled</p>
     */
    public $KeepUV;

    /**
     * @var string <p>Result format. In addition to the default return of obj and glb, an extra output format.</p><p>Enumeration values:</p><ul><li>FBX: FBX file format.</li></ul>
     */
    public $ResultFormat;

    /**
     * @var integer <p>Random Seed. Results can be reproduced with the same Seed input.</p><p>Value range: [0, 2147483647]</p>
     */
    public $Seed;
     ...
     * @param array $MultiViewImageInfos <p>Multi-perspective image information used to generate a 3D model.</p><p>Input limits: The array length must be between 2 and 8, and it must contain the front perspective.</p><p>ImageInfos, MultiViewImageInfos, and Prompt are mutually exclusive with each other. One and only one must be filled in.</p>
     * @param string $Prompt <p>Generate a Prompt for the 3D model.</p><p>Input parameter limit: Up to 1024 utf-8 characters.</p><p>The three input parameters ImageInfos, MultiViewImageInfos, and Prompt are mutually exclusive. One and only one must be filled in.</p>
     ...
     * @param array $MeshInfos <p>Reference 3D model used to generate a 3D model.</p><p>Input parameter limit: When MeshInfos is filled in, GenerateType must take the value Texture (texture scenario).</p>
     * @param string $EnablePBR <p>Whether to enable output PBR material.</p><p>Enumeration values:</p><ul><li>Enabled: enable;</li><li>Disabled: disable.</li></ul><p>Default value: Disabled</p>
     ...
     * @param string $KeepUV <p>Whether to retain UV unfold.</p><p>Enumeration values:</p><ul><li>Enabled: retain;</li><li>Disabled: not retain.</li></ul><p>Default value: Disabled</p>
     * @param string $ResultFormat <p>Result format. In addition to the default return of obj and glb, an extra output format.</p><p>Enumeration values:</p><ul><li>FBX: FBX file format.</li></ul>
     * @param integer $Seed <p>Random Seed. Results can be reproduced with the same Seed input.</p><p>Value range: [0, 2147483647]</p>
