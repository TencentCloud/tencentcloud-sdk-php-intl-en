 ...
 * @method string getTimeParam() Obtain Timestamp parameter name;Only upper and lower-case letters, digits, and underscores (_) are allowed. It cannot start with a digit. Length limit: 1-100 characters.
 * @method void setTimeParam(string $TimeParam) Set Timestamp parameter name;Only upper and lower-case letters, digits, and underscores (_) are allowed. It cannot start with a digit. Length limit: 1-100 characters.
 * @method string getTimeFormat() Obtain Timestamp settings: <li>dec: Decimal</li> <li>hex: Hexadecimal</li>
 * @method void setTimeFormat(string $TimeFormat) Set Timestamp settings: <li>dec: Decimal</li> <li>hex: Hexadecimal</li>
...
class AuthenticationTypeD extends AbstractModel
{
    ...
    /**
     * @var string Timestamp parameter name;Only upper and lower-case letters, digits, and underscores (_) are allowed. It cannot start with a digit. Length limit: 1-100 characters.
     */
    public $TimeParam;

    /**
     * @var string Timestamp settings: <li>dec: Decimal</li> <li>hex: Hexadecimal</li>
     */
    public $TimeFormat;
     ...
     * @param string $TimeParam Timestamp parameter name;Only upper and lower-case letters, digits, and underscores (_) are allowed. It cannot start with a digit. Length limit: 1-100 characters.
     * @param string $TimeFormat Timestamp settings: <li>dec: Decimal</li> <li>hex: Hexadecimal</li>
