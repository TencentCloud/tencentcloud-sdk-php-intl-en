 ...
 * @method integer getSegmentIndex() Obtain Index number of the M3U8 file shard. The SegmentIndex of the first shard in an M3U8 file is 0. This parameter is valid when Operation is InsertTemporary and ItemId has a value.
 * @method void setSegmentIndex(integer $SegmentIndex) Set Index number of the M3U8 file shard. The SegmentIndex of the first shard in an M3U8 file is 0. This parameter is valid when Operation is InsertTemporary and ItemId has a value.
 * @method array getRoundPlaylist() Obtain Program list. Required when Operation is Insert, InsertTemporary, or Delete. Indicates the program list to operate. Maximum list length: 10.
 * @method void setRoundPlaylist(array $RoundPlaylist) Set Program list. Required when Operation is Insert, InsertTemporary, or Delete. Indicates the program list to operate. Maximum list length: 10.
 */
class HandleCurrentPlaylistRequest extends AbstractModel
{
    ...
    /**
     * @var integer Index number of the M3U8 file shard. The SegmentIndex of the first shard in an M3U8 file is 0. This parameter is valid when Operation is InsertTemporary and ItemId has a value.
     */
    public $SegmentIndex;

    /**
     * @var array Program list. Required when Operation is Insert, InsertTemporary, or Delete. Indicates the program list to operate. Maximum list length: 10.
     */
     ...
     * @param integer $SegmentIndex Index number of the M3U8 file shard. The SegmentIndex of the first shard in an M3U8 file is 0. This parameter is valid when Operation is InsertTemporary and ItemId has a value.
     * @param array $RoundPlaylist Program list. Required when Operation is Insert, InsertTemporary, or Delete. Indicates the program list to operate. Maximum list length: 10.
     */
