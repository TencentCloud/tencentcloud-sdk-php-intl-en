 ...
 * @method void setTrtcSdkAppIds(array $TrtcSdkAppIds) Set <p>TRTC application ID collection. Match any element in the collection.</p><li>Array length limit: 10.</li>
 * @method array getTrtcRoomIds() Obtain <p>TRTC room ID collection. Match any element in the collection.</p><li>Single room ID length limit: 64 characters;</li><li>Array length limit: 10.</li>
 ...
 * @method void setKnowledgeBases(array $KnowledgeBases) Set <p>Knowledge base ID, match any element in the collection.</p>
 */
class SearchMediaRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>File name collection, fuzzy match media file names. The higher the matching degree, the higher priority in sorting.</p><li>Single file name length limit: 100 characters.</li><li>Array length limit: 10.</li>
     */
    public $Names;
    ...
    /**
     * @var TimeRange <p>Files whose creation time matches this time period.</p><li>Includes the specified start and end points in time.</li>
     */
    public $CreateTime;

    /**
     * @var TimeRange <p>Files whose expiration time falls within this period cannot be retrieved.</p><li>Includes the specified start and end points in time.</li>
     */
    public $ExpireTime;
    ...
    /**
     * @var array <p>TRTC application ID collection. Match any element in the collection.</p><li>Array length limit: 10.</li>
     */
    public $TrtcSdkAppIds;

    /**
     * @var array <p>TRTC room ID collection. Match any element in the collection.</p><li>Single room ID length limit: 64 characters;</li><li>Array length limit: 10.</li>
     */
    public $TrtcRoomIds;
    ...
    /**
     * @var integer <div id="p_limit">Number of records returned in pages. Default value: 10. Records from Offset to Offset+Limit-1 will be returned.<li>Value range: Offset + Limit no more than 5000. (See <a href="#maxResultsDesc">API return result count limit</a>.)</li></div>
     */
    public $Limit;
    ...
    /**
     * @var string <p>(Not recommended: use StreamIds instead)<br>Push stream live code.</p>
     */
    public $StreamId;
    ...
    /**
     * @var array <p>Live push Path. Valid when the media asset source is live recording.</p>
     */
    public $StreamPaths;

    /**
     * @var array <p>Knowledge base ID, match any element in the collection.</p>
     */
