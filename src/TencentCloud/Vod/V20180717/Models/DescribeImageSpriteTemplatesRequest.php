 ...
 * @method array getDefinitions() Obtain Sprite template unique identifier filter condition, with an array length limit of 100.
 * @method void setDefinitions(array $Definitions) Set Sprite template unique identifier filter condition, with an array length limit of 100.
...
class DescribeImageSpriteTemplatesRequest extends AbstractModel
{
    ...
    /**
     * @var array Sprite template unique identifier filter condition, with an array length limit of 100.
     */
    public $Definitions;
...
<li>Custom: custom template.</li>
     ...
     * @param array $Definitions Sprite template unique identifier filter condition, with an array length limit of 100.
