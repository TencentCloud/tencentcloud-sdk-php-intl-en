 ...
 * @method array getDefinitions() Obtain Filter condition for the sprite template unique identifier. The array length cannot exceed 100.
 * @method void setDefinitions(array $Definitions) Set Filter condition for the sprite template unique identifier. The array length cannot exceed 100.
...
class DescribeImageSpriteTemplatesRequest extends AbstractModel
{
    ...
    /**
     * @var array Filter condition for the sprite template unique identifier. The array length cannot exceed 100.
     */
    public $Definitions;
...
<li>Custom: User-defined template.</li>
     ...
     * @param array $Definitions Filter condition for the sprite template unique identifier. The array length cannot exceed 100.
