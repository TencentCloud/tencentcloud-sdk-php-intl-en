 ...
 *
 * @method array getUrls() Obtain Preheated URL list. You can specify up to 20 URLs at a time.
 * @method void setUrls(array $Urls) Set Preheated URL list. You can specify up to 20 URLs at a time.
...
{
    /**
     * @var array Preheated URL list. You can specify up to 20 URLs at a time.
     */
    public $Urls;
    ...
    /**
     * @param array $Urls Preheated URL list. You can specify up to 20 URLs at a time.
