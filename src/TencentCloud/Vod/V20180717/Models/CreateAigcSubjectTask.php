...
/**
 * Create principal task information.
 *
 ...
 * @method void setInput(CreateAigcSubjectInput $Input) Set <p>Create AIGC subject input information.</p>
 * @method CreateAigcSubjectOutput getOutput() Obtain <p>Create AIGC subject output information.</p>
 * @method void setOutput(CreateAigcSubjectOutput $Output) Set <p>Create AIGC subject output information.</p>
...
class CreateAigcSubjectTask extends AbstractModel
{
    ...
    /**
     * @var CreateAigcSubjectInput <p>Create AIGC subject input information.</p>
     */
    public $Input;

    /**
     * @var CreateAigcSubjectOutput <p>Create AIGC subject output information.</p>
     */
    public $Output;
