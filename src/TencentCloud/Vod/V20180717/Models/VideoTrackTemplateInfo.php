 ...
 *
 * @method integer getDefinition() Obtain Unique ID of a video track template.
 * @method void setDefinition(integer $Definition) Set Unique ID of a video track template.
 * @method string getCodec() Obtain Encoder. Valid values:
<li>libx264: H.264</li>
<li>libx265: H.265</li>
Currently, a resolution within 640*480p must be specified for H.265.
 * @method void setCodec(string $Codec) Set Encoder. Valid values:
<li>libx264: H.264</li>
<li>libx265: H.265</li>
Currently, a resolution within 640*480p must be specified for H.265.
...
{
    /**
     * @var integer Unique ID of a video track template.
     */
    public $Definition;

    /**
     * @var string Encoder. Valid values:
<li>libx264: H.264</li>
<li>libx265: H.265</li>
Currently, a resolution within 640*480p must be specified for H.265.
     */
...
Default value: black.
    ...
    /**
     * @param integer $Definition Unique ID of a video track template.
     * @param string $Codec Encoder. Valid values:
<li>libx264: H.264</li>
<li>libx265: H.265</li>
Currently, a resolution within 640*480p must be specified for H.265.
