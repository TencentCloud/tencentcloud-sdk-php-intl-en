 ...
 * @method string getEnhanceSwitch() Obtain <p>Whether to enable video enhancement. Valid values: <li>Enabled: enable;</li> <li>Disabled: disable;</li><br>Description:</p><ol><li>For the selected resolution exceeding the model's generation resolution, enhancement is enabled by default.</li><li>For resolutions the model can directly generate, you can also choose direct low-resolution generation and use enhancement to obtain the specified resolution.</li></ol>
 * @method void setEnhanceSwitch(string $EnhanceSwitch) Set <p>Whether to enable video enhancement. Valid values: <li>Enabled: enable;</li> <li>Disabled: disable;</li><br>Description:</p><ol><li>For the selected resolution exceeding the model's generation resolution, enhancement is enabled by default.</li><li>For resolutions the model can directly generate, you can also choose direct low-resolution generation and use enhancement to obtain the specified resolution.</li></ol>
...
class AigcVideoOutputConfig extends AbstractModel
{
    ...
    /**
     * @var string <p>Whether to enable video enhancement. Valid values: <li>Enabled: enable;</li> <li>Disabled: disable;</li><br>Description:</p><ol><li>For the selected resolution exceeding the model's generation resolution, enhancement is enabled by default.</li><li>For resolutions the model can directly generate, you can also choose direct low-resolution generation and use enhancement to obtain the specified resolution.</li></ol>
     */
     ...
     * @param string $EnhanceSwitch <p>Whether to enable video enhancement. Valid values: <li>Enabled: enable;</li> <li>Disabled: disable;</li><br>Description:</p><ol><li>For the selected resolution exceeding the model's generation resolution, enhancement is enabled by default.</li><li>For resolutions the model can directly generate, you can also choose direct low-resolution generation and use enhancement to obtain the specified resolution.</li></ol>
