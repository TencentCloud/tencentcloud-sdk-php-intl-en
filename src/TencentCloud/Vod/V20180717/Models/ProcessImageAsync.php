 ...
 * @method ProcessImageAsyncInput getInput() Obtain Input information for asynchronous task processing of images.
 * @method void setInput(ProcessImageAsyncInput $Input) Set Input information for asynchronous task processing of images.
 * @method ProcessImageAsyncOutput getOutput() Obtain Output information of asynchronous image processing tasks.
 * @method void setOutput(ProcessImageAsyncOutput $Output) Set Output information of asynchronous image processing tasks.
...
class ProcessImageAsync extends AbstractModel
{
    ...
    /**
     * @var ProcessImageAsyncInput Input information for asynchronous task processing of images.
     */
    public $Input;

    /**
     * @var ProcessImageAsyncOutput Output information of asynchronous image processing tasks.
     */
    public $Output;
     ...
     * @param ProcessImageAsyncInput $Input Input information for asynchronous task processing of images.
     * @param ProcessImageAsyncOutput $Output Output information of asynchronous image processing tasks.
