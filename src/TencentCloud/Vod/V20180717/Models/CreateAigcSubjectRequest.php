 ...
 * @method array getSubjectImages() Obtain <p>Main image. Upload at least 1 main image. * Note 1: Supports passing an image URL (ensure it is accessible); * Note 2: Input limit is 3 images; * Note 3: Supports png, jpeg, jpg, and webp formats; * Note 4: Image ratio must be less than 1:4 or 4:1; * Note 5: Image size must be no more than 50 MB;</p>
 * @method void setSubjectImages(array $SubjectImages) Set <p>Main image. Upload at least 1 main image. * Note 1: Supports passing an image URL (ensure it is accessible); * Note 2: Input limit is 3 images; * Note 3: Supports png, jpeg, jpg, and webp formats; * Note 4: Image ratio must be less than 1:4 or 4:1; * Note 5: Image size must be no more than 50 MB;</p>
 * @method array getSubjectVideos() Obtain <p>Video reference supports uploading 1 main video</p><ul><li>Note 1: For reference only, the viduq2-pro model supports the use of video subjects</li><li>Note 2: Supports uploading up to 1 video of 5 seconds</li><li>Note 3: Video supports mp4, avi, and mov formats</li><li>Note 4: Video pixels cannot be less than 128*128, and the ratio must be less than 1:4 or 4:1, and the size must not exceed 100M.</li></ul>
 * @method void setSubjectVideos(array $SubjectVideos) Set <p>Video reference supports uploading 1 main video</p><ul><li>Note 1: For reference only, the viduq2-pro model supports the use of video subjects</li><li>Note 2: Supports uploading up to 1 video of 5 seconds</li><li>Note 3: Video supports mp4, avi, and mov formats</li><li>Note 4: Video pixels cannot be less than 128*128, and the ratio must be less than 1:4 or 4:1, and the size must not exceed 100M.</li></ul>
 ...
 * @method string getSessionContext() Obtain <p>Source context. This is used to pass through user request information. The task completion callback returns the value of this field. The maximum length is 1000 characters.</p>
 * @method void setSessionContext(string $SessionContext) Set <p>Source context. This is used to pass through user request information. The task completion callback returns the value of this field. The maximum length is 1000 characters.</p>
...
class CreateAigcSubjectRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>Main image. Upload at least 1 main image. * Note 1: Supports passing an image URL (ensure it is accessible); * Note 2: Input limit is 3 images; * Note 3: Supports png, jpeg, jpg, and webp formats; * Note 4: Image ratio must be less than 1:4 or 4:1; * Note 5: Image size must be no more than 50 MB;</p>
     */
    public $SubjectImages;

    /**
     * @var array <p>Video reference supports uploading 1 main video</p><ul><li>Note 1: For reference only, the viduq2-pro model supports the use of video subjects</li><li>Note 2: Supports uploading up to 1 video of 5 seconds</li><li>Note 3: Video supports mp4, avi, and mov formats</li><li>Note 4: Video pixels cannot be less than 128*128, and the ratio must be less than 1:4 or 4:1, and the size must not exceed 100M.</li></ul>
     */
    ...
    /**
     * @var string <p>Source context. This is used to pass through user request information. The task completion callback returns the value of this field. The maximum length is 1000 characters.</p>
     */
     ...
     * @param array $SubjectImages <p>Main image. Upload at least 1 main image. * Note 1: Supports passing an image URL (ensure it is accessible); * Note 2: Input limit is 3 images; * Note 3: Supports png, jpeg, jpg, and webp formats; * Note 4: Image ratio must be less than 1:4 or 4:1; * Note 5: Image size must be no more than 50 MB;</p>
     * @param array $SubjectVideos <p>Video reference supports uploading 1 main video</p><ul><li>Note 1: For reference only, the viduq2-pro model supports the use of video subjects</li><li>Note 2: Supports uploading up to 1 video of 5 seconds</li><li>Note 3: Video supports mp4, avi, and mov formats</li><li>Note 4: Video pixels cannot be less than 128*128, and the ratio must be less than 1:4 or 4:1, and the size must not exceed 100M.</li></ul>
     ...
     * @param string $SessionContext <p>Source context. This is used to pass through user request information. The task completion callback returns the value of this field. The maximum length is 1000 characters.</p>
