 ...
 *
 * @method integer getDefinition() Obtain Unique ID of a specified time point screencapturing template.
 * @method void setDefinition(integer $Definition) Set Unique ID of a specified time point screencapturing template.
...
<li>Preset: preset template;</li>
<li>Custom: custom template.</li>
 * @method string getName() Obtain Name of a specified time point screencapturing template.
 * @method void setName(string $Name) Set Name of a specified time point screencapturing template.
...
{
    /**
     * @var integer Unique ID of a specified time point screencapturing template.
     */
    public $Definition;
...
<li>Custom: custom template.</li>
    ...
    /**
     * @var string Name of a specified time point screencapturing template.
     */
    public $Name;
...
Default value: black.
    ...
    /**
     * @param integer $Definition Unique ID of a specified time point screencapturing template.
     * @param string $Type Template type. Valid values:
<li>Preset: preset template;</li>
<li>Custom: custom template.</li>
     * @param string $Name Name of a specified time point screencapturing template.
