 ...
 * @method RebuildMediaTargetVideoStream getVideoStream() Obtain 
 * @method void setVideoStream(RebuildMediaTargetVideoStream $VideoStream) Set 
 * @method RebuildMediaTargetAudioStream getAudioStream() Obtain 
 * @method void setAudioStream(RebuildMediaTargetAudioStream $AudioStream) Set 
...
class RebuildMediaTargetInfo extends AbstractModel
{
     ...
     * @param RebuildMediaTargetVideoStream $VideoStream 
     * @param RebuildMediaTargetAudioStream $AudioStream 
