 ...
 *
 * @method AiSamplePerson getPerson() Obtain 
 * @method void setPerson(AiSamplePerson $Person) Set 
 * @method array getFailFaceInfoSet() Obtain 
 * @method void setFailFaceInfoSet(array $FailFaceInfoSet) Set 
...
class ModifyPersonSampleResponse extends AbstractModel
{
    ...
    /**
     * @param AiSamplePerson $Person 
     * @param array $FailFaceInfoSet 
