...
<li>review.</li>
<li>block.</li>
 * @method array getSegmentSet() Obtain List of video segments with Ocr text suspected of involving unsafe information.
...
<li>block.</li>
    ...
    /**
     * @var array List of video segments with Ocr text suspected of involving unsafe information.
<font color=red>Note</font>: This list can only display up to the first 100 elements. To obtain the complete result, get it from the file corresponding to SegmentSetFileUrl.
     */
    public $SegmentSet;
