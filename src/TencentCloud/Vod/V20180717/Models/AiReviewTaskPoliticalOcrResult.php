 ...
 * @method AiReviewPoliticalOcrTaskInput getInput() Obtain 
 * @method void setInput(AiReviewPoliticalOcrTaskInput $Input) Set 
...
class AiReviewTaskPoliticalOcrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPoliticalOcrTaskInput 
     */
    public $Input;
     ...
     * @param AiReviewPoliticalOcrTaskInput $Input 
