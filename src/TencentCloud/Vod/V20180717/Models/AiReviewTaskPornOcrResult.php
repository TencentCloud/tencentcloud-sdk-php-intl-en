 ...
 * @method AiReviewPornOcrTaskInput getInput() Obtain 
 * @method void setInput(AiReviewPornOcrTaskInput $Input) Set 
...
class AiReviewTaskPornOcrResult extends AbstractModel
{
     ...
     * @param AiReviewPornOcrTaskInput $Input 
