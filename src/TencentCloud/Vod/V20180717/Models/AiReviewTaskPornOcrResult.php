...
/**
 * Task result type of Ocr text involving offensive content in audio/video moderation
 *
 ...
 * @method AiReviewPornOcrTaskInput getInput() Obtain Task input of Ocr text involving offensive content in audio/video moderation.
...
class AiReviewTaskPornOcrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPornOcrTaskInput Task input of Ocr text involving offensive content in audio/video moderation.
     */
    public $Input;

    /**
     * @var AiReviewPornOcrTaskOutput Task output of Ocr text, audio, and video moderation involving offensive content.
     */
    public $Output;
