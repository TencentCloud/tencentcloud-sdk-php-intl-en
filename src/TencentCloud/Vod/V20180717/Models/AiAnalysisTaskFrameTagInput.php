...
{
    /**
     * @var integer ID of the intelligent video frame-by-frame tagging template.
     */
    public $Definition;

    /**
     * @param integer $Definition ID of the intelligent video frame-by-frame tagging template.
     */
