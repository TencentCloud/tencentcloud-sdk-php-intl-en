 ...
 * @method CreateAigcCustomVoiceInput getInput() Obtain <p>Create AIGC custom timbre input.</p>
 * @method void setInput(CreateAigcCustomVoiceInput $Input) Set <p>Create AIGC custom timbre input.</p>
 * @method CreateAigcCustomVoiceOutput getOutput() Obtain <p>Create custom voice type output message for AIGC.</p>
 * @method void setOutput(CreateAigcCustomVoiceOutput $Output) Set <p>Create custom voice type output message for AIGC.</p>
...
class CreateAigcCustomVoiceTask extends AbstractModel
{
    ...
    /**
     * @var CreateAigcCustomVoiceInput <p>Create AIGC custom timbre input.</p>
     */
    public $Input;

    /**
     * @var CreateAigcCustomVoiceOutput <p>Create custom voice type output message for AIGC.</p>
     */
    public $Output;
     ...
     * @param CreateAigcCustomVoiceInput $Input <p>Create AIGC custom timbre input.</p>
     * @param CreateAigcCustomVoiceOutput $Output <p>Create custom voice type output message for AIGC.</p>
