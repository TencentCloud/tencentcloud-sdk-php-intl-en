 ...
 * @method array getStreamInfos() Obtain <p>Adaptive Transcoding Output Substream Parameter Information. Up to 10 substreams can be output.<br>Note: The frame rate of each substream must remain consistent. If inconsistent, use the frame rate of the first substream as the output frame rate.</p>
 * @method void setStreamInfos(array $StreamInfos) Set <p>Adaptive Transcoding Output Substream Parameter Information. Up to 10 substreams can be output.<br>Note: The frame rate of each substream must remain consistent. If inconsistent, use the frame rate of the first substream as the output frame rate.</p>
 ...
 * @method string getDrmType() Obtain <p>DRM solution type. Value range:</p><li>SimpleAES</li><li>Widevine</li><li>FairPlay</li><li>Widevine+FairPlay</li>The default value is an empty string. If it is an empty string, the video is not protected by DRM.
 * @method void setDrmType(string $DrmType) Set <p>DRM solution type. Value range:</p><li>SimpleAES</li><li>Widevine</li><li>FairPlay</li><li>Widevine+FairPlay</li>The default value is an empty string. If it is an empty string, the video is not protected by DRM.
 ...
 * @method string getDrmEncryptType() Obtain <p>Encryption method. Available values:<br>cbcs: supported by Widevine, FairPlay, and WideVine+FairPlay;<br>cenc: supported by Widevine;   </p><p>If left blank<br>FairPlay defaults to cbcs;<br>Widevine defaults to cenc;<br>WideVine+FairPlay defaults to cbcs;</p>
 * @method void setDrmEncryptType(string $DrmEncryptType) Set <p>Encryption method. Available values:<br>cbcs: supported by Widevine, FairPlay, and WideVine+FairPlay;<br>cenc: supported by Widevine;   </p><p>If left blank<br>FairPlay defaults to cbcs;<br>Widevine defaults to cenc;<br>WideVine+FairPlay defaults to cbcs;</p>
...
class CreateAdaptiveDynamicStreamingTemplateRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>Adaptive Transcoding Output Substream Parameter Information. Up to 10 substreams can be output.<br>Note: The frame rate of each substream must remain consistent. If inconsistent, use the frame rate of the first substream as the output frame rate.</p>
     */
    public $StreamInfos;
    ...
    /**
     * @var string <p>DRM solution type. Value range:</p><li>SimpleAES</li><li>Widevine</li><li>FairPlay</li><li>Widevine+FairPlay</li>The default value is an empty string. If it is an empty string, the video is not protected by DRM.
     */
    public $DrmType;
    ...
    /**
     * @var string <p>Encryption method. Available values:<br>cbcs: supported by Widevine, FairPlay, and WideVine+FairPlay;<br>cenc: supported by Widevine;   </p><p>If left blank<br>FairPlay defaults to cbcs;<br>Widevine defaults to cenc;<br>WideVine+FairPlay defaults to cbcs;</p>
     */
     ...
     * @param array $StreamInfos <p>Adaptive Transcoding Output Substream Parameter Information. Up to 10 substreams can be output.<br>Note: The frame rate of each substream must remain consistent. If inconsistent, use the frame rate of the first substream as the output frame rate.</p>
     * @param integer $SubAppId <p><b>Video-on-demand (VOD) <a href="https://www.tencentcloud.com/document/product/266/14574?from_cn_redirect=1">application</a> ID. For customers who activate on-demand services from December 25, 2023, if they access resources in on-demand applications (whether the default application or a newly created application), this field must be filled in as the app ID.</b></p>
     * @param string $Name <p>Template name. Length limit: 64 characters.</p>
     * @param string $DrmType <p>DRM solution type. Value range:</p><li>SimpleAES</li><li>Widevine</li><li>FairPlay</li><li>Widevine+FairPlay</li>The default value is an empty string. If it is an empty string, the video is not protected by DRM.
     ...
     * @param string $DrmEncryptType <p>Encryption method. Available values:<br>cbcs: supported by Widevine, FairPlay, and WideVine+FairPlay;<br>cenc: supported by Widevine;   </p><p>If left blank<br>FairPlay defaults to cbcs;<br>Widevine defaults to cenc;<br>WideVine+FairPlay defaults to cbcs;</p>
