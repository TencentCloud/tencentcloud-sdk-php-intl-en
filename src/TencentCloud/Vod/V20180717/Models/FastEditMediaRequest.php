...
{
    /**
     * @var array Information of the input media files. You can pass in up to 100 media files.
     */
    public $FileInfos;
    ...
    /**
     * @param array $FileInfos Information of the input media files. You can pass in up to 100 media files.
