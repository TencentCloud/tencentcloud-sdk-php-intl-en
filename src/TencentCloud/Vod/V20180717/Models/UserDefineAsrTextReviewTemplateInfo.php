 ...
 *
 * @method string getSwitch() Obtain Whether to enable custom ASR-based recognition. Valid values:
<li>ON</li>
<li>OFF</li>
 * @method void setSwitch(string $Switch) Set Whether to enable custom ASR-based recognition. Valid values:
<li>ON</li>
<li>OFF</li>
 * @method array getLabelSet() Obtain Filter labels for custom ASR-based recognition. Results containing the specified labels are returned. If no labels are specified, all results are returned. To filter by labels, specify the labels when adding keywords for custom ASR-based recognition.
Up to 10 labels are allowed, each containing no more than 16 characters.
 * @method void setLabelSet(array $LabelSet) Set Filter labels for custom ASR-based recognition. Results containing the specified labels are returned. If no labels are specified, all results are returned. To filter by labels, specify the labels when adding keywords for custom ASR-based recognition.
Up to 10 labels are allowed, each containing no more than 16 characters.
...
{
    /**
     * @var string Whether to enable custom ASR-based recognition. Valid values:
<li>ON</li>
<li>OFF</li>
     */
    public $Switch;
    ...
    /**
     * @var array Filter labels for custom ASR-based recognition. Results containing the specified labels are returned. If no labels are specified, all results are returned. To filter by labels, specify the labels when adding keywords for custom ASR-based recognition.
Up to 10 labels are allowed, each containing no more than 16 characters.
     */
    public $LabelSet;
    ...
    /**
     * @param string $Switch Whether to enable custom ASR-based recognition. Valid values:
<li>ON</li>
<li>OFF</li>
     * @param array $LabelSet Filter labels for custom ASR-based recognition. Results containing the specified labels are returned. If no labels are specified, all results are returned. To filter by labels, specify the labels when adding keywords for custom ASR-based recognition.
Up to 10 labels are allowed, each containing no more than 16 characters.
