...
/**
 * @method array getDefinitions() Obtain Unique ID filter of templates. Array length limit: 100.
 * @method void setDefinitions(array $Definitions) Set Unique ID filter of templates. Array length limit: 100.
...
{
    /**
     * @var array Unique ID filter of templates. Array length limit: 100.
     */
    public $Definitions;
...
<li>Custom: custom template.</li>
    ...
    public $SubAppId;
    /**
     * @param array $Definitions Unique ID filter of templates. Array length limit: 100.
