 ...
 * @method array getCategorySet() Obtain Classification list by frame tag name. CategorySet.N indicates the (N+1)-level category.
 ...
 * @method void setCategorySet(array $CategorySet) Set Classification list by frame tag name. CategorySet.N indicates the (N+1)-level category.
For example, if Tag is "tower", CategorySet contains two elements: CategorySet.0 is "scenario" and CategorySet.1 is "building", which means the frame tag is "tower", with "scenario" as the level-1 category and "building" as the level-2 category.
...
class MediaAiAnalysisFrameTagItem extends AbstractModel
{
    ...
    /**
     * @var array Classification list by frame tag name. CategorySet.N indicates the (N+1)-level category.
For example, if Tag is "tower", CategorySet contains two elements: CategorySet.0 is "scenario" and CategorySet.1 is "building", which means the frame tag is "tower", with "scenario" as the level-1 category and "building" as the level-2 category.
     */
    public $CategorySet;
     ...
     * @param array $CategorySet Classification list by frame tag name. CategorySet.N indicates the (N+1)-level category.
For example, if Tag is "tower", CategorySet contains two elements: CategorySet.0 is "scenario" and CategorySet.1 is "building", which means the frame tag is "tower", with "scenario" as the level-1 category and "building" as the level-2 category.
