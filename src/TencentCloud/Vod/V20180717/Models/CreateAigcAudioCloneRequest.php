 ...
 * @method AigcAudioCloneInputFileInfo getAudioFileInfo() Obtain <p>Original audio file (ensure it is accessible). The model will use the audio timbre passed in this parameter as an example to replicate the voice type.  </p><p>Input limitations: Note 1: Supported audio formats: mp3, m4a, wav; Note 2: The duration of the uploaded audio file should be no less than 10 seconds and no more than 5 minutes; Note 3: The uploaded audio file size must not exceed 20 MB; Note 4: The audio content must not involve copyright, otherwise it will be removed or terminated.</p>
 * @method void setAudioFileInfo(AigcAudioCloneInputFileInfo $AudioFileInfo) Set <p>Original audio file (ensure it is accessible). The model will use the audio timbre passed in this parameter as an example to replicate the voice type.  </p><p>Input limitations: Note 1: Supported audio formats: mp3, m4a, wav; Note 2: The duration of the uploaded audio file should be no less than 10 seconds and no more than 5 minutes; Note 3: The uploaded audio file size must not exceed 20 MB; Note 4: The audio content must not involve copyright, otherwise it will be removed or terminated.</p>
 ...
 * @method string getText() Obtain <p>Parameters for clone audition.</p><p>Parameter format: up to 1000 characters. The model will use the cloned voice type to read aloud the text content and return an audition audio link. Note: Audition will incur text to speech fees based on the number of characters.</p>
 * @method void setText(string $Text) Set <p>Parameters for clone audition.</p><p>Parameter format: up to 1000 characters. The model will use the cloned voice type to read aloud the text content and return an audition audio link. Note: Audition will incur text to speech fees based on the number of characters.</p>
 * @method AigcAudioCloneInputFileInfo getPromptAudioFileInfo() Obtain <p>Sample audio for voice replication. Providing this parameter will help in enhancing the similarity and stability of the text to speech voice type. If you use this parameter, you need to upload a short sample audio at the same time.</p><p>Input parameter limits: Note 1: Supported audio formats: mp3, m4a, wav; Note 2: The duration of the uploaded audio must be less than 8 seconds; Note 3: The uploaded audio file size must be no more than 20 mb.</p>
 * @method void setPromptAudioFileInfo(AigcAudioCloneInputFileInfo $PromptAudioFileInfo) Set <p>Sample audio for voice replication. Providing this parameter will help in enhancing the similarity and stability of the text to speech voice type. If you use this parameter, you need to upload a short sample audio at the same time.</p><p>Input parameter limits: Note 1: Supported audio formats: mp3, m4a, wav; Note 2: The duration of the uploaded audio must be less than 8 seconds; Note 3: The uploaded audio file size must be no more than 20 mb.</p>
 * @method string getPromptText() Obtain <p>The text content corresponding to the sample audio must be consistent with the audio content, and punctuation is required at the end of the sentence.</p>
 * @method void setPromptText(string $PromptText) Set <p>The text content corresponding to the sample audio must be consistent with the audio content, and punctuation is required at the end of the sentence.</p>
 * @method string getPayload() Obtain <p>Pass-through parameter. Input parameter limit: no processing, data transmission only. Note: up to 1048576 characters</p>
 * @method void setPayload(string $Payload) Set <p>Pass-through parameter. Input parameter limit: no processing, data transmission only. Note: up to 1048576 characters</p>
...
class CreateAigcAudioCloneRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>Parameters for clone audition.</p><p>Parameter format: up to 1000 characters. The model will use the cloned voice type to read aloud the text content and return an audition audio link. Note: Audition will incur text to speech fees based on the number of characters.</p>
     */
    public $Text;
    ...
    /**
     * @var string <p>The text content corresponding to the sample audio must be consistent with the audio content, and punctuation is required at the end of the sentence.</p>
     */
    public $PromptText;

    /**
     * @var string <p>Pass-through parameter. Input parameter limit: no processing, data transmission only. Note: up to 1048576 characters</p>
     */
    public $Payload;
     ...
     * @param AigcAudioCloneInputFileInfo $AudioFileInfo <p>Original audio file (ensure it is accessible). The model will use the audio timbre passed in this parameter as an example to replicate the voice type.  </p><p>Input limitations: Note 1: Supported audio formats: mp3, m4a, wav; Note 2: The duration of the uploaded audio file should be no less than 10 seconds and no more than 5 minutes; Note 3: The uploaded audio file size must not exceed 20 MB; Note 4: The audio content must not involve copyright, otherwise it will be removed or terminated.</p>
     ...
     * @param string $Text <p>Parameters for clone audition.</p><p>Parameter format: up to 1000 characters. The model will use the cloned voice type to read aloud the text content and return an audition audio link. Note: Audition will incur text to speech fees based on the number of characters.</p>
     * @param AigcAudioCloneInputFileInfo $PromptAudioFileInfo <p>Sample audio for voice replication. Providing this parameter will help in enhancing the similarity and stability of the text to speech voice type. If you use this parameter, you need to upload a short sample audio at the same time.</p><p>Input parameter limits: Note 1: Supported audio formats: mp3, m4a, wav; Note 2: The duration of the uploaded audio must be less than 8 seconds; Note 3: The uploaded audio file size must be no more than 20 mb.</p>
     * @param string $PromptText <p>The text content corresponding to the sample audio must be consistent with the audio content, and punctuation is required at the end of the sentence.</p>
     * @param string $Payload <p>Pass-through parameter. Input parameter limit: no processing, data transmission only. Note: up to 1048576 characters</p>
