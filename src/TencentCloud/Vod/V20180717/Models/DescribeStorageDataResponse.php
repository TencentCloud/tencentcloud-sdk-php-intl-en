 ...
 * @method array getStorageStat() Obtain Storage usage in each billing region.
 * @method void setStorageStat(array $StorageStat) Set Storage usage in each billing region.
...
class DescribeStorageDataResponse extends AbstractModel
{
    ...
    /**
     * @var array Storage usage in each billing region.
     */
    public $StorageStat;
