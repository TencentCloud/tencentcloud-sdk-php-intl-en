 ...
 * @method string getSubtitleLang() Obtain <p>Subtitle language, used for OCR recognition. Default value: zh_en. This parameter is valid only when OcrSwitch is set to "ON".</p><ul><li>zh_en: Chinese and English</li><li>multi: other<br>Other supported languages for recognition are as follows:<br>Chinese, English, Japanese, Korean, Spanish, French, German, Portuguese, Vietnamese, Malay, Russian, Italian, Dutch, Swedish, Finnish, Danish, Norwegian, Hungarian, Thai, Hindi, Arabic, Bengali, Gujarati, Kannada, Malayalam, Tamil, Telugu, Slovenian, Polish, Catalan, Bosnian, Czech, Estonian, Croatian, Punjabi, Marathi, Azerbaijani, Indonesian, Luxembourgish, Lithuanian, Latvian, Maltese, Slovak, Turkish, Kazakh, Greek, Irish, Belarusian, Khmer, Tagalog, Pashto, Persian, Tajik</li></ul>
 * @method void setSubtitleLang(string $SubtitleLang) Set <p>Subtitle language, used for OCR recognition. Default value: zh_en. This parameter is valid only when OcrSwitch is set to "ON".</p><ul><li>zh_en: Chinese and English</li><li>multi: other<br>Other supported languages for recognition are as follows:<br>Chinese, English, Japanese, Korean, Spanish, French, German, Portuguese, Vietnamese, Malay, Russian, Italian, Dutch, Swedish, Finnish, Danish, Norwegian, Hungarian, Thai, Hindi, Arabic, Bengali, Gujarati, Kannada, Malayalam, Tamil, Telugu, Slovenian, Polish, Catalan, Bosnian, Czech, Estonian, Croatian, Punjabi, Marathi, Azerbaijani, Indonesian, Luxembourgish, Lithuanian, Latvian, Maltese, Slovak, Turkish, Kazakh, Greek, Irish, Belarusian, Khmer, Tagalog, Pashto, Persian, Tajik</li></ul>
 * @method string getSubtitleFormat() Obtain <p>Subtitle file format. Default value: vtt. This parameter is valid only when OcrSwitch is "ON".</p><ul><li>srt: SRT format</li><li>vtt: WebVTT format</li><li>When SubtitleEmbedId is filled, it can take an empty string, which means no subtitle file is output.</li></ul>
 * @method void setSubtitleFormat(string $SubtitleFormat) Set <p>Subtitle file format. Default value: vtt. This parameter is valid only when OcrSwitch is "ON".</p><ul><li>srt: SRT format</li><li>vtt: WebVTT format</li><li>When SubtitleEmbedId is filled, it can take an empty string, which means no subtitle file is output.</li></ul>
 * @method string getTransSwitch() Obtain <p>Whether to enable caption translation. Default value: OFF. This parameter is valid only when OcrSwitch is set to "ON".</p><ul><li>ON: Enable</li><li>OFF: Disable</li></ul>
 * @method void setTransSwitch(string $TransSwitch) Set <p>Whether to enable caption translation. Default value: OFF. This parameter is valid only when OcrSwitch is set to "ON".</p><ul><li>ON: Enable</li><li>OFF: Disable</li></ul>
 * @method string getTransDstLang() Obtain <p>Subtitle translation target language. Default value: en. This parameter is valid only when TransSwitch is set to "ON".<br>Currently supported languages:<br>zh: Simplified Chinese<br>en: English<br>ja: Japanese<br>ko: Korean<br>fr: French<br>es: Spanish<br>it: Italian<br>de: German<br>tr: Turkish<br>ru: Russian<br>pt: Portuguese<br>vi: Vietnamese<br>id: Indonesian<br>ms: Malay<br>th: Thai<br>ar: Arabic<br>hi: Hindi</p>
 * @method void setTransDstLang(string $TransDstLang) Set <p>Subtitle translation target language. Default value: en. This parameter is valid only when TransSwitch is set to "ON".<br>Currently supported languages:<br>zh: Simplified Chinese<br>en: English<br>ja: Japanese<br>ko: Korean<br>fr: French<br>es: Spanish<br>it: Italian<br>de: German<br>tr: Turkish<br>ru: Russian<br>pt: Portuguese<br>vi: Vietnamese<br>id: Indonesian<br>ms: Malay<br>th: Thai<br>ar: Arabic<br>hi: Hindi</p>
...
class MPSSmartEraseSubtitleConfig extends AbstractModel
{
    ...
    /**
     * @var string <p>Subtitle language, used for OCR recognition. Default value: zh_en. This parameter is valid only when OcrSwitch is set to "ON".</p><ul><li>zh_en: Chinese and English</li><li>multi: other<br>Other supported languages for recognition are as follows:<br>Chinese, English, Japanese, Korean, Spanish, French, German, Portuguese, Vietnamese, Malay, Russian, Italian, Dutch, Swedish, Finnish, Danish, Norwegian, Hungarian, Thai, Hindi, Arabic, Bengali, Gujarati, Kannada, Malayalam, Tamil, Telugu, Slovenian, Polish, Catalan, Bosnian, Czech, Estonian, Croatian, Punjabi, Marathi, Azerbaijani, Indonesian, Luxembourgish, Lithuanian, Latvian, Maltese, Slovak, Turkish, Kazakh, Greek, Irish, Belarusian, Khmer, Tagalog, Pashto, Persian, Tajik</li></ul>
     */
    public $SubtitleLang;

    /**
     * @var string <p>Subtitle file format. Default value: vtt. This parameter is valid only when OcrSwitch is "ON".</p><ul><li>srt: SRT format</li><li>vtt: WebVTT format</li><li>When SubtitleEmbedId is filled, it can take an empty string, which means no subtitle file is output.</li></ul>
     */
    public $SubtitleFormat;

    /**
     * @var string <p>Whether to enable caption translation. Default value: OFF. This parameter is valid only when OcrSwitch is set to "ON".</p><ul><li>ON: Enable</li><li>OFF: Disable</li></ul>
     */
    public $TransSwitch;

    /**
     * @var string <p>Subtitle translation target language. Default value: en. This parameter is valid only when TransSwitch is set to "ON".<br>Currently supported languages:<br>zh: Simplified Chinese<br>en: English<br>ja: Japanese<br>ko: Korean<br>fr: French<br>es: Spanish<br>it: Italian<br>de: German<br>tr: Turkish<br>ru: Russian<br>pt: Portuguese<br>vi: Vietnamese<br>id: Indonesian<br>ms: Malay<br>th: Thai<br>ar: Arabic<br>hi: Hindi</p>
     */
    public $TransDstLang;
     ...
     * @param string $SubtitleLang <p>Subtitle language, used for OCR recognition. Default value: zh_en. This parameter is valid only when OcrSwitch is set to "ON".</p><ul><li>zh_en: Chinese and English</li><li>multi: other<br>Other supported languages for recognition are as follows:<br>Chinese, English, Japanese, Korean, Spanish, French, German, Portuguese, Vietnamese, Malay, Russian, Italian, Dutch, Swedish, Finnish, Danish, Norwegian, Hungarian, Thai, Hindi, Arabic, Bengali, Gujarati, Kannada, Malayalam, Tamil, Telugu, Slovenian, Polish, Catalan, Bosnian, Czech, Estonian, Croatian, Punjabi, Marathi, Azerbaijani, Indonesian, Luxembourgish, Lithuanian, Latvian, Maltese, Slovak, Turkish, Kazakh, Greek, Irish, Belarusian, Khmer, Tagalog, Pashto, Persian, Tajik</li></ul>
     * @param string $SubtitleFormat <p>Subtitle file format. Default value: vtt. This parameter is valid only when OcrSwitch is "ON".</p><ul><li>srt: SRT format</li><li>vtt: WebVTT format</li><li>When SubtitleEmbedId is filled, it can take an empty string, which means no subtitle file is output.</li></ul>
     * @param string $TransSwitch <p>Whether to enable caption translation. Default value: OFF. This parameter is valid only when OcrSwitch is set to "ON".</p><ul><li>ON: Enable</li><li>OFF: Disable</li></ul>
     * @param string $TransDstLang <p>Subtitle translation target language. Default value: en. This parameter is valid only when TransSwitch is set to "ON".<br>Currently supported languages:<br>zh: Simplified Chinese<br>en: English<br>ja: Japanese<br>ko: Korean<br>fr: French<br>es: Spanish<br>it: Italian<br>de: German<br>tr: Turkish<br>ru: Russian<br>pt: Portuguese<br>vi: Vietnamese<br>id: Indonesian<br>ms: Malay<br>th: Thai<br>ar: Arabic<br>hi: Hindi</p>
