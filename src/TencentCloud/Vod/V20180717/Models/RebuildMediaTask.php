 ...
 * @method RebuildMediaTaskInput getInput() Obtain 
 * @method void setInput(RebuildMediaTaskInput $Input) Set 
 * @method RebuildMediaTaskOutput getOutput() Obtain 
 * @method void setOutput(RebuildMediaTaskOutput $Output) Set 
...
class RebuildMediaTask extends AbstractModel
{
    ...
    /**
     * @var RebuildMediaTaskInput 
     */
    public $Input;

    /**
     * @var RebuildMediaTaskOutput 
     */
    public $Output;
     ...
     * @param RebuildMediaTaskInput $Input 
     * @param RebuildMediaTaskOutput $Output 
