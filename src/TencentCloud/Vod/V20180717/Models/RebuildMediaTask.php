...
<li>PROCESSING: Processing;</li>
<li>FINISH: completed</li>
 * @method integer getErrCode() Obtain Error code. 0 indicates success, and additional values indicate failure:
 ...
 * @method void setErrCode(integer $ErrCode) Set Error code. 0 indicates success, and additional values indicate failure:
<li>40000: Invalid input parameter. Check the input parameter;</li>
<li>60000: Source file error (for example, video data damage). Confirm whether the source file is normal;</li>
<li>70000: internal service error. Retry is recommended.</li>
 ...
 * @method integer getProgress() Obtain Progress of the audio and video quality regeneration task, in the range of [0,100].
 * @method void setProgress(integer $Progress) Set Progress of the audio and video quality regeneration task, in the range of [0,100].
...
<li>FINISH: completed</li>
    ...
    /**
     * @var integer Error code. 0 indicates success, and additional values indicate failure:
<li>40000: Invalid input parameter. Check the input parameter;</li>
<li>60000: Source file error (for example, video data damage). Confirm whether the source file is normal;</li>
<li>70000: internal service error. Retry is recommended.</li>
     */
    ...
    /**
     * @var integer Progress of the audio and video quality regeneration task, in the range of [0,100].
     */
    public $Progress;
...
<li>PROCESSING: Processing;</li>
<li>FINISH: completed</li>
     * @param integer $ErrCode Error code. 0 indicates success, and additional values indicate failure:
<li>40000: Invalid input parameter. Check the input parameter;</li>
<li>60000: Source file error (for example, video data damage). Confirm whether the source file is normal;</li>
<li>70000: internal service error. Retry is recommended.</li>
     ...
     * @param integer $Progress Progress of the audio and video quality regeneration task, in the range of [0,100].
