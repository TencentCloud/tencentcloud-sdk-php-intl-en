...
<li>Maximum value: 5000. If the number of eligible entries is greater than 5,000, this field will return 5,000 instead of the actual number.</li>
 * @method array getMediaInfoSet() Obtain List of media file information, only including the basic information (BasicInfo).
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setMediaInfoSet(array $MediaInfoSet) Set List of media file information, only including the basic information (BasicInfo).
Note: this field may return null, indicating that no valid values can be obtained.
...
<li>Maximum value: 5000. If the number of eligible entries is greater than 5,000, this field will return 5,000 instead of the actual number.</li>
    ...
    /**
     * @var array List of media file information, only including the basic information (BasicInfo).
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public $MediaInfoSet;
...
<li>Maximum value: 5000. If the number of eligible entries is greater than 5,000, this field will return 5,000 instead of the actual number.</li>
     * @param array $MediaInfoSet List of media file information, only including the basic information (BasicInfo).
Note: this field may return null, indicating that no valid values can be obtained.
