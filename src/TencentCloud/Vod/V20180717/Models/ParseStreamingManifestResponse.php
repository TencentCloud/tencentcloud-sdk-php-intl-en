 ...
 *
 * @method array getMediaSegmentSet() Obtain <p>Shard file list.</p>
 * @method void setMediaSegmentSet(array $MediaSegmentSet) Set <p>Shard file list.</p>
...
class ParseStreamingManifestResponse extends AbstractModel
{
    ...
    /**
     * @param array $MediaSegmentSet <p>Shard file list.</p>
