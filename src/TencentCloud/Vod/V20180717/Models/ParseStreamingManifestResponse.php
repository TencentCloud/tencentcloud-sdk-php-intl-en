 ...
 *
 * @method array getMediaSegmentSet() Obtain Segment file list.
 * @method void setMediaSegmentSet(array $MediaSegmentSet) Set Segment file list.
...
class ParseStreamingManifestResponse extends AbstractModel
{
    ...
    /**
     * @param array $MediaSegmentSet Segment file list.
