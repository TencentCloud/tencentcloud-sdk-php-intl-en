 ...
 * @method AiAnalysisTaskHighlightInput getInput() Obtain 
 * @method void setInput(AiAnalysisTaskHighlightInput $Input) Set 
...
class AiAnalysisTaskHighlightResult extends AbstractModel
{
    ...
    /**
     * @var AiAnalysisTaskHighlightInput 
     */
    public $Input;
     ...
     * @param AiAnalysisTaskHighlightInput $Input 
