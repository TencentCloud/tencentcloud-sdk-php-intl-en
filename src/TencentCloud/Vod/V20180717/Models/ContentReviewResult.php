...
Note: This field may return `null`, indicating that no valid value was found.
 * @method TerrorismImageResult getTerrorismImageResult() Obtain The terrorism content detected in the image. This parameter is valid if `Type` is `Terrorism.Image`.
Note: This field may return `null`, indicating that no valid value was found.
 * @method void setTerrorismImageResult(TerrorismImageResult $TerrorismImageResult) Set The terrorism content detected in the image. This parameter is valid if `Type` is `Terrorism.Image`.
Note: This field may return `null`, indicating that no valid value was found.
...
Note: This field may return `null`, indicating that no valid value was found.
 * @method ContentReviewOcrResult getTerrorismOcrResult() Obtain The terrorism content detected in the image based on OCR. This parameter is valid if `Type` is `Terrorism.Ocr`.
Note: This field may return `null`, indicating that no valid value was found.
 * @method void setTerrorismOcrResult(ContentReviewOcrResult $TerrorismOcrResult) Set The terrorism content detected in the image based on OCR. This parameter is valid if `Type` is `Terrorism.Ocr`.
Note: This field may return `null`, indicating that no valid value was found.
...
Note: This field may return `null`, indicating that no valid value was found.
    ...
    /**
     * @var TerrorismImageResult The terrorism content detected in the image. This parameter is valid if `Type` is `Terrorism.Image`.
Note: This field may return `null`, indicating that no valid value was found.
     */
...
Note: This field may return `null`, indicating that no valid value was found.
    ...
    /**
     * @var ContentReviewOcrResult The terrorism content detected in the image based on OCR. This parameter is valid if `Type` is `Terrorism.Ocr`.
Note: This field may return `null`, indicating that no valid value was found.
     */
...
Note: This field may return `null`, indicating that no valid value was found.
     * @param TerrorismImageResult $TerrorismImageResult The terrorism content detected in the image. This parameter is valid if `Type` is `Terrorism.Image`.
Note: This field may return `null`, indicating that no valid value was found.
...
Note: This field may return `null`, indicating that no valid value was found.
     * @param ContentReviewOcrResult $TerrorismOcrResult The terrorism content detected in the image based on OCR. This parameter is valid if `Type` is `Terrorism.Ocr`.
Note: This field may return `null`, indicating that no valid value was found.
