 ...
 *
 * @method string getCodec() Obtain <p>Video stream encoding format. Available values:</p><li>libx264: H.264 encoding</li><li>libx265: H.265 encoding</li><li>av1: AOMedia Video 1 encoding</li><li>H.266: H.266 encoding.</li><font color="red">Note:</font><li> The av1 and H.266 encoding containers currently only support mp4.</li><li> H.266 currently only supports the fixed CRF bitrate control method. </li>
 * @method void setCodec(string $Codec) Set <p>Video stream encoding format. Available values:</p><li>libx264: H.264 encoding</li><li>libx265: H.265 encoding</li><li>av1: AOMedia Video 1 encoding</li><li>H.266: H.266 encoding.</li><font color="red">Note:</font><li> The av1 and H.266 encoding containers currently only support mp4.</li><li> H.266 currently only supports the fixed CRF bitrate control method. </li>
 ...
 * @method integer getVcrf() Obtain <p>Control factor for constant video bitrate. Value range: [1, 51].</p><p><font color="red">Note:</font></p><li>If you specify this parameter, the bitrate control mode for CRF will be used for transcoding (video bitrate will no longer take effect);</li><li>This field is required when the encoding format of the specified video stream is H.266. Recommended value: 28;</li><li>If there are no special requirements, it is not recommended to specify this parameter.</li>
 * @method void setVcrf(integer $Vcrf) Set <p>Control factor for constant video bitrate. Value range: [1, 51].</p><p><font color="red">Note:</font></p><li>If you specify this parameter, the bitrate control mode for CRF will be used for transcoding (video bitrate will no longer take effect);</li><li>This field is required when the encoding format of the specified video stream is H.266. Recommended value: 28;</li><li>If there are no special requirements, it is not recommended to specify this parameter.</li>
 ...
 * @method string getPreserveHDRSwitch() Obtain <p>Whether to retain HDR in the transcoding output when the original video is HDR (High Dynamic Range). Value range:</p><li>ON: If the original file is HDR, the transcoding output retains HDR; otherwise, the transcoding output is SDR (Standard Dynamic Range).</li><li>OFF: Regardless of whether the original file is HDR or SDR, the transcoding output is SDR.</li>Default value: OFF.
 ...
 * @method integer getBframes() Obtain <p>Number of B-frames between reference frames. Set to auto by default.</p><p>Value range: [0, 16]</p>
 * @method void setBframes(integer $Bframes) Set <p>Number of B-frames between reference frames. Set to auto by default.</p><p>Value range: [0, 16]</p>
 * @method integer getHlsTime() Obtain <p>Average duration of slices. 0 or left empty means auto, which will automatically choose an appropriate slice duration based on features such as the video GOP.</p><p>Value range: [0, 10]</p><p>Unit: second</p><p>Supports only transcoding templates. Adaptive bitrate stream templates are not currently supported.</p>
 * @method void setHlsTime(integer $HlsTime) Set <p>Average duration of slices. 0 or left empty means auto, which will automatically choose an appropriate slice duration based on features such as the video GOP.</p><p>Value range: [0, 10]</p><p>Unit: second</p><p>Supports only transcoding templates. Adaptive bitrate stream templates are not currently supported.</p>
 * @method string getVideoProfile() Obtain <p>A predefined combination of encoding tools or features allowed in a video encoding standard, suitable for different scenarios.</p><p>Enumeration values:</p><ul><li>baseline: Supports only I/p frames and non-interlaced scenarios, suitable for video calls, mobile video, and other scenarios.</li><li>main: The mainstream Profile, providing I-frames, p-frames, and B-frames, and supporting both interlaced and non-interlaced modes. It is mainly used in mainstream audio and video consumption products such as video players and streaming media transmission devices.</li><li>high: The highest encoding level, adding 8X8 prediction on top of the main Profile and supporting custom quantification. It is widely used in Blu-ray storage, HDTV, and other scenarios.</li><li>default: Automatic filling along with the original video.  </li></ul><p>default value: default</p><p>This configuration item is valid only when Codec is libx264.</p>
...
{
    /**
     * @var string <p>Video stream encoding format. Available values:</p><li>libx264: H.264 encoding</li><li>libx265: H.265 encoding</li><li>av1: AOMedia Video 1 encoding</li><li>H.266: H.266 encoding.</li><font color="red">Note:</font><li> The av1 and H.266 encoding containers currently only support mp4.</li><li> H.266 currently only supports the fixed CRF bitrate control method. </li>
     */
    public $Codec;
    ...
    /**
     * @var integer <p>Control factor for constant video bitrate. Value range: [1, 51].</p><p><font color="red">Note:</font></p><li>If you specify this parameter, the bitrate control mode for CRF will be used for transcoding (video bitrate will no longer take effect);</li><li>This field is required when the encoding format of the specified video stream is H.266. Recommended value: 28;</li><li>If there are no special requirements, it is not recommended to specify this parameter.</li>
     */
    public $Vcrf;
    ...
    /**
     * @var string <p>Whether to retain HDR in the transcoding output when the original video is HDR (High Dynamic Range). Value range:</p><li>ON: If the original file is HDR, the transcoding output retains HDR; otherwise, the transcoding output is SDR (Standard Dynamic Range).</li><li>OFF: Regardless of whether the original file is HDR or SDR, the transcoding output is SDR.</li>Default value: OFF.
     */
    ...
    /**
     * @var integer <p>Number of B-frames between reference frames. Set to auto by default.</p><p>Value range: [0, 16]</p>
     */
    public $Bframes;

    /**
     * @var integer <p>Average duration of slices. 0 or left empty means auto, which will automatically choose an appropriate slice duration based on features such as the video GOP.</p><p>Value range: [0, 10]</p><p>Unit: second</p><p>Supports only transcoding templates. Adaptive bitrate stream templates are not currently supported.</p>
     */
    public $HlsTime;

    /**
     * @var string <p>A predefined combination of encoding tools or features allowed in a video encoding standard, suitable for different scenarios.</p><p>Enumeration values:</p><ul><li>baseline: Supports only I/p frames and non-interlaced scenarios, suitable for video calls, mobile video, and other scenarios.</li><li>main: The mainstream Profile, providing I-frames, p-frames, and B-frames, and supporting both interlaced and non-interlaced modes. It is mainly used in mainstream audio and video consumption products such as video players and streaming media transmission devices.</li><li>high: The highest encoding level, adding 8X8 prediction on top of the main Profile and supporting custom quantification. It is widely used in Blu-ray storage, HDTV, and other scenarios.</li><li>default: Automatic filling along with the original video.  </li></ul><p>default value: default</p><p>This configuration item is valid only when Codec is libx264.</p>
     */
    public $VideoProfile;

    /**
     * @param string $Codec <p>Video stream encoding format. Available values:</p><li>libx264: H.264 encoding</li><li>libx265: H.265 encoding</li><li>av1: AOMedia Video 1 encoding</li><li>H.266: H.266 encoding.</li><font color="red">Note:</font><li> The av1 and H.266 encoding containers currently only support mp4.</li><li> H.266 currently only supports the fixed CRF bitrate control method. </li>
     ...
     * @param integer $Vcrf <p>Control factor for constant video bitrate. Value range: [1, 51].</p><p><font color="red">Note:</font></p><li>If you specify this parameter, the bitrate control mode for CRF will be used for transcoding (video bitrate will no longer take effect);</li><li>This field is required when the encoding format of the specified video stream is H.266. Recommended value: 28;</li><li>If there are no special requirements, it is not recommended to specify this parameter.</li>
     ...
     * @param integer $Bframes <p>Number of B-frames between reference frames. Set to auto by default.</p><p>Value range: [0, 16]</p>
     * @param integer $HlsTime <p>Average duration of slices. 0 or left empty means auto, which will automatically choose an appropriate slice duration based on features such as the video GOP.</p><p>Value range: [0, 10]</p><p>Unit: second</p><p>Supports only transcoding templates. Adaptive bitrate stream templates are not currently supported.</p>
     * @param string $VideoProfile <p>A predefined combination of encoding tools or features allowed in a video encoding standard, suitable for different scenarios.</p><p>Enumeration values:</p><ul><li>baseline: Supports only I/p frames and non-interlaced scenarios, suitable for video calls, mobile video, and other scenarios.</li><li>main: The mainstream Profile, providing I-frames, p-frames, and B-frames, and supporting both interlaced and non-interlaced modes. It is mainly used in mainstream audio and video consumption products such as video players and streaming media transmission devices.</li><li>high: The highest encoding level, adding 8X8 prediction on top of the main Profile and supporting custom quantification. It is widely used in Blu-ray storage, HDTV, and other scenarios.</li><li>default: Automatic filling along with the original video.  </li></ul><p>default value: default</p><p>This configuration item is valid only when Codec is libx264.</p>
     */
