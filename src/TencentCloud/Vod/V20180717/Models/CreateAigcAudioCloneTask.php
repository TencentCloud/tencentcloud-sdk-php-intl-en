 ...
 * @method integer getErrCode() Obtain <p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p>
 * @method void setErrCode(integer $ErrCode) Set <p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p>
 * @method string getErrCodeExt() Obtain <p>Error code expansion. A null string indicates success, while other values indicate failure.</p>
 * @method void setErrCodeExt(string $ErrCodeExt) Set <p>Error code expansion. A null string indicates success, while other values indicate failure.</p>
 ...
 * @method CreateAigcAudioCloneInput getInput() Obtain <p>Input information for the AIGC audio clone task.</p>
 * @method void setInput(CreateAigcAudioCloneInput $Input) Set <p>Input information for the AIGC audio clone task.</p>
 * @method CreateAigcAudioCloneOutput getOutput() Obtain <p>Output information for the AIGC audio clone task.</p>
 * @method void setOutput(CreateAigcAudioCloneOutput $Output) Set <p>Output information for the AIGC audio clone task.</p>
...
class CreateAigcAudioCloneTask extends AbstractModel
{
    ...
    /**
     * @var integer <p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p>
     */
    public $ErrCode;

    /**
     * @var string <p>Error code expansion. A null string indicates success, while other values indicate failure.</p>
     */
    public $ErrCodeExt;
    ...
    /**
     * @var CreateAigcAudioCloneInput <p>Input information for the AIGC audio clone task.</p>
     */
    public $Input;

    /**
     * @var CreateAigcAudioCloneOutput <p>Output information for the AIGC audio clone task.</p>
     */
    public $Output;
     ...
     * @param integer $ErrCode <p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p>
     * @param string $ErrCodeExt <p>Error code expansion. A null string indicates success, while other values indicate failure.</p>
     * @param string $Message <p>Error message.</p>
     * @param integer $Progress <p>Task progress, value ranges from 0 to 100.</p>
     * @param CreateAigcAudioCloneInput $Input <p>Input information for the AIGC audio clone task.</p>
     * @param CreateAigcAudioCloneOutput $Output <p>Output information for the AIGC audio clone task.</p>
