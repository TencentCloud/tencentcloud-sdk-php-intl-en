 ...
 * @method TextToSpeechSyncOutputOption getOutput() Obtain <p>Output parameters.</p><p>Specifies the output format, etc. The default output audio format is URL.</p>
 * @method void setOutput(TextToSpeechSyncOutputOption $Output) Set <p>Output parameters.</p><p>Specifies the output format, etc. The default output audio format is URL.</p>
...
class TextToSpeechSyncRequest extends AbstractModel
{
    ...
    /**
     * @var TextToSpeechSyncOutputOption <p>Output parameters.</p><p>Specifies the output format, etc. The default output audio format is URL.</p>
     */
    public $Output;
     ...
     * @param TextToSpeechSyncOutputOption $Output <p>Output parameters.</p><p>Specifies the output format, etc. The default output audio format is URL.</p>
