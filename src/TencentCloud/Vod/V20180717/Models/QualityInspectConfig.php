 ...
 * @method integer getIntervalTime() Obtain <p>Sampling interval time</p><p>Unit: ms.</p>
 * @method void setIntervalTime(integer $IntervalTime) Set <p>Sampling interval time</p><p>Unit: ms.</p>
 * @method integer getDuration() Obtain <p>Duration of abnormality.</p><p>Measurement unit: ms.</p>
 * @method void setDuration(integer $Duration) Set <p>Duration of abnormality.</p><p>Measurement unit: ms.</p>
 * @method string getThreshold() Obtain <p>Threshold corresponding to the detection item. Different detection items have different thresholds.</p>
 * @method void setThreshold(string $Threshold) Set <p>Threshold corresponding to the detection item. Different detection items have different thresholds.</p>
 */
class QualityInspectConfig extends AbstractModel
{
    ...
    /**
     * @var integer <p>Sampling interval time</p><p>Unit: ms.</p>
     */
    public $IntervalTime;

    /**
     * @var integer <p>Duration of abnormality.</p><p>Measurement unit: ms.</p>
     */
    public $Duration;

    /**
     * @var string <p>Threshold corresponding to the detection item. Different detection items have different thresholds.</p>
     */
    public $Threshold;
     ...
     * @param integer $IntervalTime <p>Sampling interval time</p><p>Unit: ms.</p>
     * @param integer $Duration <p>Duration of abnormality.</p><p>Measurement unit: ms.</p>
     * @param string $Threshold <p>Threshold corresponding to the detection item. Different detection items have different thresholds.</p>
     */
