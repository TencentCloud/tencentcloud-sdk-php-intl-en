...
/**
 * Output file information for an AIGC video conversion task.
 *
 ...
 * @method string getMediaName() Obtain <p>Output filename, up to 64 characters. By default, the system specifies the generated filename. Valid when StorageMode is Permanent.</p>
 * @method void setMediaName(string $MediaName) Set <p>Output filename, up to 64 characters. By default, the system specifies the generated filename. Valid when StorageMode is Permanent.</p>
 ...
 * @method string getFileType() Obtain <p>File type, for example, mp4 and flv.</p>
 * @method void setFileType(string $FileType) Set <p>File type, for example, mp4 and flv.</p>
 ...
 * @method MediaMetaData getMetaData() Obtain <p>Meta-information of the output video. Valid when StorageMode is Permanent.</p>
 * @method void setMetaData(MediaMetaData $MetaData) Set <p>Meta-information of the output video. Valid when StorageMode is Permanent.</p>
 */
class AigcVideoRedrawOutputFileInfo extends AbstractModel
{
    ...
    /**
     * @var string <p>Output filename, up to 64 characters. By default, the system specifies the generated filename. Valid when StorageMode is Permanent.</p>
     */
    public $MediaName;
    ...
    /**
     * @var string <p>File type, for example, mp4 and flv.</p>
     */
    public $FileType;
    ...
    /**
     * @var MediaMetaData <p>Meta-information of the output video. Valid when StorageMode is Permanent.</p>
     */
    public $MetaData;
     ...
     * @param string $MediaName <p>Output filename, up to 64 characters. By default, the system specifies the generated filename. Valid when StorageMode is Permanent.</p>
     ...
     * @param string $FileType <p>File type, for example, mp4 and flv.</p>
     ...
     * @param MediaMetaData $MetaData <p>Meta-information of the output video. Valid when StorageMode is Permanent.</p>
     */
