...
Note: This field may return null, indicating that no valid value can be obtained.
 * @method ProcessMediaByMPS getProcessMediaByMPSTask() Obtain Media processing by MPS task information. This field contains a value only when TaskType is ProcessMediaByMPS.
 * @method void setProcessMediaByMPSTask(ProcessMediaByMPS $ProcessMediaByMPSTask) Set Media processing by MPS task information. This field contains a value only when TaskType is ProcessMediaByMPS.
 * @method AigcImageTask getAigcImageTask() Obtain AIGC image task information. This field contains a value only when TaskType is AigcImageTask.
 * @method void setAigcImageTask(AigcImageTask $AigcImageTask) Set AIGC image task information. This field contains a value only when TaskType is AigcImageTask.
 * @method AigcVideoTask getAigcVideoTask() Obtain AIGC video task information. This field contains a value only when TaskType is AigcVideoTask.
 * @method void setAigcVideoTask(AigcVideoTask $AigcVideoTask) Set AIGC video task information. This field contains a value only when TaskType is AigcVideoTask.
 ...
 * @method SceneAigcImageTask getSceneAigcImageTask() Obtain Scenario-based AIGC image task information. This field contains a value only when TaskType is SceneAigcImageTask.
 * @method void setSceneAigcImageTask(SceneAigcImageTask $SceneAigcImageTask) Set Scenario-based AIGC image task information. This field contains a value only when TaskType is SceneAigcImageTask.
...
Note: This field may return null, indicating that no valid value can be obtained.
    ...
    /**
     * @var ProcessMediaByMPS Media processing by MPS task information. This field contains a value only when TaskType is ProcessMediaByMPS.
     */
    public $ProcessMediaByMPSTask;

    /**
     * @var AigcImageTask AIGC image task information. This field contains a value only when TaskType is AigcImageTask.
     */
    public $AigcImageTask;

    /**
     * @var AigcVideoTask AIGC video task information. This field contains a value only when TaskType is AigcVideoTask.
     */
    ...
    /**
     * @var SceneAigcImageTask Scenario-based AIGC image task information. This field contains a value only when TaskType is SceneAigcImageTask.
     */
...
Note: This field may return null, indicating that no valid value can be obtained.
     * @param ProcessMediaByMPS $ProcessMediaByMPSTask Media processing by MPS task information. This field contains a value only when TaskType is ProcessMediaByMPS.
     * @param AigcImageTask $AigcImageTask AIGC image task information. This field contains a value only when TaskType is AigcImageTask.
     * @param AigcVideoTask $AigcVideoTask AIGC video task information. This field contains a value only when TaskType is AigcVideoTask.
     * @param ImportMediaKnowledgeTask $ImportMediaKnowledge 
     * @param SceneAigcImageTask $SceneAigcImageTask Scenario-based AIGC image task information. This field contains a value only when TaskType is SceneAigcImageTask.
