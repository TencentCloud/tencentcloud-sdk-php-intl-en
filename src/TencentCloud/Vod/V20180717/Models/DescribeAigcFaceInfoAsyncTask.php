 ...
 * @method void setOutput(DescribeAigcFaceInfoAsyncOutput $Output) Set <p>Asynchronously fetch the output information of the AIGC human face information task.</p>
...
class DescribeAigcFaceInfoAsyncTask extends AbstractModel
{
    ...
    /**
     * @var DescribeAigcFaceInfoAsyncInput <p>Asynchronously fetch the input information of AIGC face information tasks.</p>
     */
    public $Input;

    /**
     * @var DescribeAigcFaceInfoAsyncOutput <p>Asynchronously fetch the output information of the AIGC human face information task.</p>
     */
    public $Output;
