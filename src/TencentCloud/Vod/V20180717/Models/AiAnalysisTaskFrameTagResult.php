 ...
 * @method AiAnalysisTaskFrameTagInput getInput() Obtain 
 * @method void setInput(AiAnalysisTaskFrameTagInput $Input) Set 
...
class AiAnalysisTaskFrameTagResult extends AbstractModel
{
    ...
    /**
     * @var AiAnalysisTaskFrameTagInput 
     */
    public $Input;
     ...
     * @param AiAnalysisTaskFrameTagInput $Input 
