 ...
 *
 * @method float getConfidence() Obtain The confidence score for the OCR-based recognition result. Value range: 0-100.
 * @method void setConfidence(float $Confidence) Set The confidence score for the OCR-based recognition result. Value range: 0-100.
...
{
    /**
     * @var float The confidence score for the OCR-based recognition result. Value range: 0-100.
     */
    public $Confidence;
...
<li>block</li>
    ...
    /**
     * @param float $Confidence The confidence score for the OCR-based recognition result. Value range: 0-100.
