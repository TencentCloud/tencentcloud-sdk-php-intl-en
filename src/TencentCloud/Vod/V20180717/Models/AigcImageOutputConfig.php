 ...
 * @method string getMediaName() Obtain <p>Output filename, up to 64 characters. By default, the system generates the filename.</p>
 * @method void setMediaName(string $MediaName) Set <p>Output filename, up to 64 characters. By default, the system generates the filename.</p>
 ...
 * @method string getInputComplianceCheck() Obtain <p>Whether compliance check is enabled for the input content. Valid values: <li>Enabled: enable;</li> <li>Disabled: disable;</li></p>
 * @method void setInputComplianceCheck(string $InputComplianceCheck) Set <p>Whether compliance check is enabled for the input content. Valid values: <li>Enabled: enable;</li> <li>Disabled: disable;</li></p>
 * @method string getOutputComplianceCheck() Obtain <p>Whether compliance check is enabled for output content. Valid values: <li>Enabled: enabled;</li> <li>Disabled: disabled;</li></p>
 * @method void setOutputComplianceCheck(string $OutputComplianceCheck) Set <p>Whether compliance check is enabled for output content. Valid values: <li>Enabled: enabled;</li> <li>Disabled: disabled;</li></p>
 * @method integer getOutputImageCount() Obtain <p>Number of images generated. Available values for each model:</p><ul><li>Kling: value range 1-9;</li><li>OG: value range 1-8;</li></ul><p><strong>Not effective for other models.</strong></p>
 * @method void setOutputImageCount(integer $OutputImageCount) Set <p>Number of images generated. Available values for each model:</p><ul><li>Kling: value range 1-9;</li><li>OG: value range 1-8;</li></ul><p><strong>Not effective for other models.</strong></p>
 ...
 * @method string getLogoAdd() Obtain <p>Indicates whether to enable the logo watermark. Default value: Disabled. Valid values:</p><ul><li>Enabled: enable;</li><li>Disabled: disable;</li></ul>
 * @method void setLogoAdd(string $LogoAdd) Set <p>Indicates whether to enable the logo watermark. Default value: Disabled. Valid values:</p><ul><li>Enabled: enable;</li><li>Disabled: disable;</li></ul>
 */
class AigcImageOutputConfig extends AbstractModel
{
    ...
    /**
     * @var string <p>Output filename, up to 64 characters. By default, the system generates the filename.</p>
     */
    public $MediaName;
    ...
    /**
     * @var string <p>Whether compliance check is enabled for the input content. Valid values: <li>Enabled: enable;</li> <li>Disabled: disable;</li></p>
     */
    public $InputComplianceCheck;

    /**
     * @var string <p>Whether compliance check is enabled for output content. Valid values: <li>Enabled: enabled;</li> <li>Disabled: disabled;</li></p>
     */
    public $OutputComplianceCheck;

    /**
     * @var integer <p>Number of images generated. Available values for each model:</p><ul><li>Kling: value range 1-9;</li><li>OG: value range 1-8;</li></ul><p><strong>Not effective for other models.</strong></p>
     */
    ...
    /**
     * @var string <p>Indicates whether to enable the logo watermark. Default value: Disabled. Valid values:</p><ul><li>Enabled: enable;</li><li>Disabled: disable;</li></ul>
     */
    public $LogoAdd;
     ...
     * @param string $MediaName <p>Output filename, up to 64 characters. By default, the system generates the filename.</p>
     ...
     * @param string $InputComplianceCheck <p>Whether compliance check is enabled for the input content. Valid values: <li>Enabled: enable;</li> <li>Disabled: disable;</li></p>
     * @param string $OutputComplianceCheck <p>Whether compliance check is enabled for output content. Valid values: <li>Enabled: enabled;</li> <li>Disabled: disabled;</li></p>
     * @param integer $OutputImageCount <p>Number of images generated. Available values for each model:</p><ul><li>Kling: value range 1-9;</li><li>OG: value range 1-8;</li></ul><p><strong>Not effective for other models.</strong></p>
     ...
     * @param string $LogoAdd <p>Indicates whether to enable the logo watermark. Default value: Disabled. Valid values:</p><ul><li>Enabled: enable;</li><li>Disabled: disable;</li></ul>
     */
