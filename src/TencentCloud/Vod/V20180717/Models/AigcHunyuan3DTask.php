...
/**
 * AIGC Hunyuan 3D task information.
 *
 ...
 * @method AigcHunyuan3DTaskInput getInput() Obtain <p>Input information of the AIGC Hunyuan 3D task.</p>
 * @method void setInput(AigcHunyuan3DTaskInput $Input) Set <p>Input information of the AIGC Hunyuan 3D task.</p>
 * @method AigcHunyuan3DTaskOutput getOutput() Obtain <p>Output information of the AIGC Hunyuan 3D task.</p>
 * @method void setOutput(AigcHunyuan3DTaskOutput $Output) Set <p>Output information of the AIGC Hunyuan 3D task.</p>
...
class AigcHunyuan3DTask extends AbstractModel
{
    ...
    /**
     * @var AigcHunyuan3DTaskInput <p>Input information of the AIGC Hunyuan 3D task.</p>
     */
    public $Input;

    /**
     * @var AigcHunyuan3DTaskOutput <p>Output information of the AIGC Hunyuan 3D task.</p>
     */
    public $Output;
     ...
     * @param AigcHunyuan3DTaskOutput $Output <p>Output information of the AIGC Hunyuan 3D task.</p>
