 ...
 * @method AiRecognitionTaskAsrTranslateResultInput getInput() Obtain 
 * @method void setInput(AiRecognitionTaskAsrTranslateResultInput $Input) Set 
 * @method AiRecognitionTaskAsrTranslateResultOutput getOutput() Obtain 
 * @method void setOutput(AiRecognitionTaskAsrTranslateResultOutput $Output) Set 
...
class AiRecognitionTaskAsrTranslateResult extends AbstractModel
{
    ...
    /**
     * @var AiRecognitionTaskAsrTranslateResultInput 
     */
    public $Input;

    /**
     * @var AiRecognitionTaskAsrTranslateResultOutput 
     */
    public $Output;
     ...
     * @param AiRecognitionTaskAsrTranslateResultInput $Input 
     * @param AiRecognitionTaskAsrTranslateResultOutput $Output 
