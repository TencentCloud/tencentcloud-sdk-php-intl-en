 ...
 * @method AigcImageTask getAigcImageCompleteEvent() Obtain <p>AIGC image generation task information. Valid only when EventType is AigcImageTaskComplete.</p>
 * @method void setAigcImageCompleteEvent(AigcImageTask $AigcImageCompleteEvent) Set <p>AIGC image generation task information. Valid only when EventType is AigcImageTaskComplete.</p>
 ...
 * @method AigcHunyuan3DTask getAigcHunyuan3DCompleteEvent() Obtain <p>AIGC Hunyuan 3D task information. This field has a value only when EventType is AigcHunyuan3DTaskComplete.</p>
 * @method void setAigcHunyuan3DCompleteEvent(AigcHunyuan3DTask $AigcHunyuan3DCompleteEvent) Set <p>AIGC Hunyuan 3D task information. This field has a value only when EventType is AigcHunyuan3DTaskComplete.</p>
 */
class EventContent extends AbstractModel
{
    ...
    /**
     * @var AigcImageTask <p>AIGC image generation task information. Valid only when EventType is AigcImageTaskComplete.</p>
     */
    ...
    /**
     * @var AigcHunyuan3DTask <p>AIGC Hunyuan 3D task information. This field has a value only when EventType is AigcHunyuan3DTaskComplete.</p>
     */
     ...
     * @param AigcImageTask $AigcImageCompleteEvent <p>AIGC image generation task information. Valid only when EventType is AigcImageTaskComplete.</p>
     ...
     * @param AigcHunyuan3DTask $AigcHunyuan3DCompleteEvent <p>AIGC Hunyuan 3D task information. This field has a value only when EventType is AigcHunyuan3DTaskComplete.</p>
     */
