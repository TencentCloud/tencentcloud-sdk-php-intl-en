 ...
 *
 * @method array getNotExistFileIdSet() Obtain Non-existent file ID list.
 * @method void setNotExistFileIdSet(array $NotExistFileIdSet) Set Non-existent file ID list.
...
{
    /**
     * @var array Non-existent file ID list.
     */
    ...
    /**
     * @param array $NotExistFileIdSet Non-existent file ID list.
