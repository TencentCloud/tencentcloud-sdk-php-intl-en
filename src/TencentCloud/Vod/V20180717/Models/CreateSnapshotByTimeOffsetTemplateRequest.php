 ...
 * @method string getName() Obtain <p>Time point screenshot template name. Length limit: 64 characters.</p>
 * @method void setName(string $Name) Set <p>Time point screenshot template name. Length limit: 64 characters.</p>
...
class CreateSnapshotByTimeOffsetTemplateRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>Time point screenshot template name. Length limit: 64 characters.</p>
     */
    public $Name;
     ...
     * @param string $Name <p>Time point screenshot template name. Length limit: 64 characters.</p>
