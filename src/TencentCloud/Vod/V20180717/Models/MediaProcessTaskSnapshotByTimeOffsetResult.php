...
Note: this field may return null, indicating that no valid values can be obtained.
 * @method SnapshotByTimeOffsetTaskInput getInput() Obtain Input of time point screencapturing task.
 * @method void setInput(SnapshotByTimeOffsetTaskInput $Input) Set Input of time point screencapturing task.
 * @method MediaSnapshotByTimeOffsetItem getOutput() Obtain Output of time point screencapturing task.
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setOutput(MediaSnapshotByTimeOffsetItem $Output) Set Output of time point screencapturing task.
Note: this field may return null, indicating that no valid values can be obtained.
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var SnapshotByTimeOffsetTaskInput Input of time point screencapturing task.
     */
    public $Input;

    /**
     * @var MediaSnapshotByTimeOffsetItem Output of time point screencapturing task.
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public $Output;

    /**
     * @var integer The progress of a time point screenshot task. Value range: 0-100.
     */
    public $Progress;
...
Note: this field may return null, indicating that no valid values can be obtained.
     * @param SnapshotByTimeOffsetTaskInput $Input Input of time point screencapturing task.
