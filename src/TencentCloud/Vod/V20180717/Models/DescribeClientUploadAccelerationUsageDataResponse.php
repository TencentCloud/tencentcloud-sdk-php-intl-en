 ...
 *
 * @method array getClientUploadAccelerationUsageDataSet() Obtain Client upload acceleration statistics data.
 * @method void setClientUploadAccelerationUsageDataSet(array $ClientUploadAccelerationUsageDataSet) Set Client upload acceleration statistics data.
...
{
    /**
     * @var array Client upload acceleration statistics data.
     */
    ...
    /**
     * @param array $ClientUploadAccelerationUsageDataSet Client upload acceleration statistics data.
