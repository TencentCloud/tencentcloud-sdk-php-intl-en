 ...
 * @method Models\FastEditMediaResponse FastEditMedia(Models\FastEditMediaRequest $req) Implement fast splicing and editing of HLS videos to generate new HLS format media.
