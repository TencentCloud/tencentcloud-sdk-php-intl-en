 ...
 * @method Models\CloneVoiceAsyncResponse CloneVoiceAsync(Models\CloneVoiceAsyncRequest $req) This API is used to trigger a voice cloning task. It clones a reference audio to generate an exclusive voice, which can be used for subsequent text to speech. Voice cloning is an asynchronous task. The voice ID and audio audition are generated after task completion.
 * @method Models\CloneVoiceSyncResponse CloneVoiceSync(Models\CloneVoiceSyncRequest $req) This API is used to trigger a voice cloning task. It clones a reference audio to generate an exclusive voice, which can be used for subsequent text to speech.
 ...
 * @method Models\ConfirmEventsResponse ConfirmEvents(Models\ConfirmEventsRequest $req) * Developers call event notification pull to obtain events, and then must call this API to ACK message received.
 ...
 * @method Models\CreateAIAnalysisTemplateResponse CreateAIAnalysisTemplate(Models\CreateAIAnalysisTemplateRequest $req) This API is used to create user-defined audio and video content analysis templates. Maximum number: 50. HLS format is not supported currently.
 * @method Models\CreateAIRecognitionTemplateResponse CreateAIRecognitionTemplate(Models\CreateAIRecognitionTemplateRequest $req) This API is used to create user-defined audio and video content recognition templates. Maximum number: 50.
 * @method Models\CreateAdaptiveDynamicStreamingTemplateResponse CreateAdaptiveDynamicStreamingTemplate(Models\CreateAdaptiveDynamicStreamingTemplateRequest $req) Create an adaptive bitrate streaming template. Max: 100.
 ...
 * @method Models\CreateAigcApiTokenResponse CreateAigcApiToken(Models\CreateAigcApiTokenRequest $req) This API is used to create a Token for AIGC API calls. Data sync has a delay once created. It can be queried or deleted after about 30 seconds.
 ...
 * @method Models\CreateAnimatedGraphicsTemplateResponse CreateAnimatedGraphicsTemplate(Models\CreateAnimatedGraphicsTemplateRequest $req) This API is used to create a user-customized animated image generating template. Maximum number: 16.
 ...
 * @method Models\CreateCDNDomainResponse CreateCDNDomain(Models\CreateCDNDomainRequest $req) This API is used to add domain names to VOD. A user can add up to 20 domain names. After the domain name is successfully added, VOD will deploy the domain. It takes about 2 minutes for the domain to change from the deployment state to the online status.
 * @method Models\CreateCLSLogsetResponse CreateCLSLogset(Models\CreateCLSLogsetRequest $req) Create a logset via VOD.
 * @method Models\CreateCLSTopicResponse CreateCLSTopic(Models\CreateCLSTopicRequest $req) This API is used to create a CLS log topic under VOD.
 ...
 * @method Models\CreateComplexAdaptiveDynamicStreamingTaskResponse CreateComplexAdaptiveDynamicStreamingTask(Models\CreateComplexAdaptiveDynamicStreamingTaskRequest $req) Initiate complex adaptive bitstream processing tasks. Features include:
 ...
 * @method Models\CreateContentReviewTemplateResponse CreateContentReviewTemplate(Models\CreateContentReviewTemplateRequest $req) This API is <font color=red>no longer maintained</font>. The new version moderation template supports audio/video moderation and image moderation. For details, please see [Create Moderation Template](https://www.tencentcloud.com/document/api/266/84391?from_cn_redirect=1).
This API is used to create a user-customized audio/video moderation template. Up to 50 templates can be created.
 * @method Models\CreateDomainVerifyRecordResponse CreateDomainVerifyRecord(Models\CreateDomainVerifyRecordRequest $req) This API is used to generate a subdomain name resolution and prompt the customer to add it to the domain name resolution for wildcard domain name and domain name retrieval ownership verification.
 * @method Models\CreateEnhanceMediaTemplateResponse CreateEnhanceMediaTemplate(Models\CreateEnhanceMediaTemplateRequest $req) This API is no longer maintained. The new version of the [audio and video quality revival](https://www.tencentcloud.com/document/product/266/102571?from_cn_redirect=1) API uses preset templates. For details, see [Audio and Video Quality Rebirth Template](https://www.tencentcloud.com/document/product/266/102586?from_cn_redirect=1#50604b3f-0286-4a10-a3f7-18218116aff7).
 ...
 * @method Models\CreateImageProcessingTemplateResponse CreateImageProcessingTemplate(Models\CreateImageProcessingTemplateRequest $req) Create a user-defined image processing template. Maximum quantity: 16. Supports up to ten operations, for example: crop - thumbnail - crop - blur - thumbnail - crop - thumbnail - crop - blur - thumbnail.
 ...
 * @method Models\CreateLLMComprehendTemplateResponse CreateLLMComprehendTemplate(Models\CreateLLMComprehendTemplateRequest $req) Create a large model parsing template.
 * @method Models\CreateMPSTemplateResponse CreateMPSTemplate(Models\CreateMPSTemplateRequest $req) This API is used to create custom templates for partial features of the ProcessMediaByMPS API.
 ...
 * @method Models\CreatePersonSampleResponse CreatePersonSample(Models\CreatePersonSampleRequest $req) This API is used to create material samples for video processing such as content recognition and inappropriate video recognition through facial feature positioning technology.
 ...
 * @method Models\CreateProcessImageAsyncTemplateResponse CreateProcessImageAsyncTemplate(Models\CreateProcessImageAsyncTemplateRequest $req) This API is used to create user-customized image asynchronous processing templates. Maximum number: 50. HLS format is not supported currently.
 ...
 * @method Models\CreateReviewTemplateResponse CreateReviewTemplate(Models\CreateReviewTemplateRequest $req) This API is used to create user-customized moderation templates. Maximum number: 50.
 ...
 * @method Models\DeleteAdaptiveDynamicStreamingTemplateResponse DeleteAdaptiveDynamicStreamingTemplate(Models\DeleteAdaptiveDynamicStreamingTemplateRequest $req) Deletes an adaptive bitrate streaming template
 * @method Models\DeleteAigcAdvancedCustomElementResponse DeleteAigcAdvancedCustomElement(Models\DeleteAigcAdvancedCustomElementRequest $req) This API is used to delete advanced custom AIGC subjects.
 * @method Models\DeleteAigcApiTokenResponse DeleteAigcApiToken(Models\DeleteAigcApiTokenRequest $req) Deletes an AIGC API Token. The AIGC quota associated with the Token will also be deleted.
 ...
 * @method Models\DeleteClassResponse DeleteClass(Models\DeleteClassRequest $req) * A category can be deleted only when it has no subcategories and no media association.
 ...
 * @method Models\DeleteEnhanceMediaTemplateResponse DeleteEnhanceMediaTemplate(Models\DeleteEnhanceMediaTemplateRequest $req) This API is <font color=red>no longer maintained</font>. The new version of [Audio and Video Quality Rebirth](https://www.tencentcloud.com/document/product/266/102571?from_cn_redirect=1) interface uses preset templates. For details, see [Audio and Video Quality Rebirth Template](https://www.tencentcloud.com/document/product/266/102586?from_cn_redirect=1#50604b3f-0286-4a10-a3f7-18218116aff7).
This API is used to delete an audio and video quality rebirth template.
 * @method Models\DeleteHeadTailTemplateResponse DeleteHeadTailTemplate(Models\DeleteHeadTailTemplateRequest $req) This API is used to delete a title and trailer template.
 ...
 * @method Models\DeleteImageSpriteTemplateResponse DeleteImageSpriteTemplate(Models\DeleteImageSpriteTemplateRequest $req) This API is used to delete an image sprite template.
 ...
 * @method Models\DeleteLLMComprehendTemplateResponse DeleteLLMComprehendTemplate(Models\DeleteLLMComprehendTemplateRequest $req) Delete a customized large model parsing template.
 ...
 * @method Models\DeletePersonSampleResponse DeletePersonSample(Models\DeletePersonSampleRequest $req) This API is used to delete material samples based on figure IDs.
 ...
 * @method Models\DeleteRebuildMediaTemplateResponse DeleteRebuildMediaTemplate(Models\DeleteRebuildMediaTemplateRequest $req) This API is <font color=red>no longer maintained</font>. The new version of [audio and video quality revival](https://www.tencentcloud.com/document/product/266/102571?from_cn_redirect=1) API uses preset templates. For details, see [Audio and Video Quality Rebirth Template](https://www.tencentcloud.com/document/product/266/102586?from_cn_redirect=1#50604b3f-0286-4a10-a3f7-18218116aff7).
Deletes a video rebirth template.
 * @method Models\DeleteReviewTemplateResponse DeleteReviewTemplate(Models\DeleteReviewTemplateRequest $req) Delete a user-customized moderation template.
>Template is applicable only to the ReviewAudioVideo (https://www.tencentcloud.com/document/api/266/80283?from_cn_redirect=1) and ReviewImage (https://www.tencentcloud.com/document/api/266/73217?from_cn_redirect=1) APIs.
 ...
 * @method Models\DeleteVoiceResponse DeleteVoice(Models\DeleteVoiceRequest $req) Delete a specified voice by voice ID. This operation cannot be undone, and the voice cannot be used for subsequent APIs. Only voices for this account can be deleted. System preset voices cannot be deleted.
 ...
 * @method Models\DescribeAIAnalysisTemplatesResponse DescribeAIAnalysisTemplates(Models\DescribeAIAnalysisTemplatesRequest $req) This API is used to get the detail list of audio and video content analysis templates based on their unique identifiers. The returned results include all eligible user-defined audio and video content analysis templates and [system preset audio/video content analysis templates](https://www.tencentcloud.com/document/product/266/33476?from_cn_redirect=1#.E9.A2.84.E7.BD.AE.E8.A7.86.E9.A2.91.E5.86.85.E5.AE.B9.E5.88.86.E6.9E.90.E6.A8.A1.E6.9D.BF).
 * @method Models\DescribeAIRecognitionTemplatesResponse DescribeAIRecognitionTemplates(Models\DescribeAIRecognitionTemplatesRequest $req) This API is used to get the list of details of audio/video content recognition templates based on their unique IDs. The returned results include all eligible user-defined audio/video content recognition templates and system preset audio/video content recognition templates.
 ...
 * @method Models\DescribeAigcApiTokensResponse DescribeAigcApiTokens(Models\DescribeAigcApiTokensRequest $req) This API is used to query the list of AIGC API Tokens. Data sync has a delay after creation or deletion. The latest data can be queried after about 30 seconds.
 ...
 * @method Models\DescribeAnimatedGraphicsTemplatesResponse DescribeAnimatedGraphicsTemplates(Models\DescribeAnimatedGraphicsTemplatesRequest $req) This API is used to query the list of rotating image templates based on conditions with paging.
 * @method Models\DescribeBlindWatermarkTemplatesResponse DescribeBlindWatermarkTemplates(Models\DescribeBlindWatermarkTemplatesRequest $req) This API is used to query user-customized digit watermark templates.
 * @method Models\DescribeCDNDomainsResponse DescribeCDNDomains(Models\DescribeCDNDomainsRequest $req) Queries an on-demand domain name.
 * @method Models\DescribeCDNStatDetailsResponse DescribeCDNStatDetails(Models\DescribeCDNStatDetailsRequest $req) This API is used to query CDN bandwidth, traffic, and other stats for a VOD domain.
 ...
 * @method Models\DescribeCDNUsageDataResponse DescribeCDNUsageData(Models\DescribeCDNUsageDataRequest $req) This API is used to query VOD CDN traffic, bandwidth, and other stats.
 ...
 * @method Models\DescribeCdnLogsResponse DescribeCdnLogs(Models\DescribeCdnLogsRequest $req) This API is used to query the download URL of CDN access logs for VOD domains, excluding EdgeOne origin-pull to VOD domains.
 ...
 * @method Models\DescribeContentReviewTemplatesResponse DescribeContentReviewTemplates(Models\DescribeContentReviewTemplatesRequest $req) This API is <font color=red>no longer maintained</font>. The new moderation template supports audio/video moderation and image moderation. For details, please see [Query Moderation Template List](https://www.tencentcloud.com/document/api/266/84389?from_cn_redirect=1).
 ...
 * @method Models\DescribeDailyMediaPlayStatResponse DescribeDailyMediaPlayStat(Models\DescribeDailyMediaPlayStatRequest $req) This API is used to query the daily playback statistics within a specified date range.
 ...
 * @method Models\DescribeDailyMostPlayedStatResponse DescribeDailyMostPlayedStat(Models\DescribeDailyMostPlayedStatRequest $req) This API is used to query daily playback statistics of the Top 100 media files.
 ...
 * @method Models\DescribeFileAttributesResponse DescribeFileAttributes(Models\DescribeFileAttributesRequest $req) Used to get file attributes asynchronously.
 ...
 * @method Models\DescribeHeadTailTemplatesResponse DescribeHeadTailTemplates(Models\DescribeHeadTailTemplatesRequest $req) This API is used to search for title and trailer template lists.
 ...
 * @method Models\DescribeImageReviewUsageDataResponse DescribeImageReviewUsageData(Models\DescribeImageReviewUsageDataRequest $req) This API is used to return the daily image review usage information within the specified query time range.
 ...
 * @method Models\DescribeImageSpriteTemplatesResponse DescribeImageSpriteTemplates(Models\DescribeImageSpriteTemplatesRequest $req) Query image sprite templates based on conditions with paging.
 ...
 * @method Models\DescribeKnowledgeBasesResponse DescribeKnowledgeBases(Models\DescribeKnowledgeBasesRequest $req) Queries the knowledge base list. Returns all knowledge base information under the specified user.
 * @method Models\DescribeLLMComprehendTemplatesResponse DescribeLLMComprehendTemplates(Models\DescribeLLMComprehendTemplatesRequest $req) According to the unique identifier of the large model parsing template, retrieve the large model parsing template detail list. The returned results include all user-customized large model parsing templates that meet the conditions.
 ...
 * @method Models\DescribeMPSTemplatesResponse DescribeMPSTemplates(Models\DescribeMPSTemplatesRequest $req) This API is used to query user-customized media processing service task templates.
...
1. Video processing usage data is retained for 13 months in the data system. You can only query usage data from the most recent 365 days through the interface. To retrieve historical usage data beyond 365 days, contact us.
   2. The query time span should not exceed 90 days.
 * @method Models\DescribePersonSamplesResponse DescribePersonSamples(Models\DescribePersonSamplesRequest $req) This API is used to query material sample information by material ID, name, or tag with paging.
 ...
 * @method Models\DescribeProcessImageAsyncTemplatesResponse DescribeProcessImageAsyncTemplates(Models\DescribeProcessImageAsyncTemplatesRequest $req) This API is used to obtain the template details list for asynchronous image processing based on the Template Unique Identifier. The returned results include all eligible user-customized asynchronous image processing templates.
...
2. The query time span should not exceed 90 days.
 * @method Models\DescribeReviewTemplatesResponse DescribeReviewTemplates(Models\DescribeReviewTemplatesRequest $req) This API is used to get the moderation template list.
>Template is applicable only to the [ReviewAudioVideo](https://www.tencentcloud.com/document/api/266/80283?from_cn_redirect=1) and [ReviewImage](https://www.tencentcloud.com/document/api/266/73217?from_cn_redirect=1) APIs.
 ...
 * @method Models\DescribeVoicesResponse DescribeVoices(Models\DescribeVoicesRequest $req) Queries the available timbre list under the current account, supporting filtering by optional conditions such as voice ID, type, name, gender, age, language, tag, and scenario.
 ...
 * @method Models\DescribeWatermarkTemplatesResponse DescribeWatermarkTemplates(Models\DescribeWatermarkTemplatesRequest $req) This API is used to query user-customized watermark templates, and the pagination query is supported based on conditions.
 * @method Models\DescribeWordSamplesResponse DescribeWordSamples(Models\DescribeWordSamplesRequest $req) This API is used to paging query keyword sample info by scenario, keyword, and tag.
 * @method Models\DesignVoiceAsyncResponse DesignVoiceAsync(Models\DesignVoiceAsyncRequest $req) This API is used to trigger a voice design task. It generates a custom voice based on a natural language description. You can specify a voice profile at the same time, such as name, gender, age, language, tag, and scenario. If trial text is attached during submission, an audio audition is generated after task completion. Voice design is an asynchronous task. The voice ID is generated after task completion.
 * @method Models\EditMediaResponse EditMedia(Models\EditMediaRequest $req) This API is used to edit a video, such as clipping and splicing, to generate a new on-demand video. Editing features include:
 ...
 * @method Models\EnhanceMediaQualityResponse EnhanceMediaQuality(Models\EnhanceMediaQualityRequest $req) This API is used to trigger an audio and video quality regeneration task for on-demand audio-video media.
 ...
 * @method Models\ForbidMediaDistributionResponse ForbidMediaDistribution(Models\ForbidMediaDistributionRequest $req) * After media blocking, except for VOD console preview, accessing URLs of various video resources (raw files, transcoding output files, screenshots, etc.) for other scenarios will return 403.
 ...
 * @method Models\HandleCurrentPlaylistResponse HandleCurrentPlaylist(Models\HandleCurrentPlaylistRequest $req) Perform operations on the carousel current playlist. Supported operations: <li> Insert: Insert a program into the current playlist.</li><li> Delete: Delete a program in the playlist.</li>
 ...
 * @method Models\ModifyAigcQuotaResponse ModifyAigcQuota(Models\ModifyAigcQuotaRequest $req) This API is used to edit AIGC quota configuration. Quota usage starts accumulating when the quota feature is enabled. Once the quota is reached, AIGC features will no longer be usable.
 ...
 * @method Models\ModifyCDNDomainConfigResponse ModifyCDNDomainConfig(Models\ModifyCDNDomainConfigRequest $req) This API is used to modify CDN domain configuration.
 * @method Models\ModifyClassResponse ModifyClass(Models\ModifyClassRequest $req) Modifies media classification attributes.
 * @method Models\ModifyContentReviewTemplateResponse ModifyContentReviewTemplate(Models\ModifyContentReviewTemplateRequest $req) This API is no longer maintained. The new version of the moderation template supports video and image moderation. For details, please see [Modify Moderation Template](https://www.tencentcloud.com/document/API/266/84388?from_cn_redirect=1).
 ...
 * @method Models\ModifyEnhanceMediaTemplateResponse ModifyEnhanceMediaTemplate(Models\ModifyEnhanceMediaTemplateRequest $req) This API is <font color=red>no longer maintained</font>. The new version of the [audio and video quality revival](https://www.tencentcloud.com/document/product/266/102571?from_cn_redirect=1) API uses preset templates. For details, see [Audio and Video Quality Rebirth Template](https://www.tencentcloud.com/document/product/266/102586?from_cn_redirect=1#50604b3f-0286-4a10-a3f7-18218116aff7).
Modify an audio and video quality rebirth template.
 * @method Models\ModifyEventConfigResponse ModifyEventConfig(Models\ModifyEventConfigRequest $req) Tencent Cloud VOD provides customers with media upload, media management, media processing, and other services. During or after the execution of these services, Tencent Cloud VOD also provides various event notifications, allowing developers to sense the service processing status and perform the next business operation.
 ...
 * @method Models\ModifyJustInTimeTranscodeTemplateResponse ModifyJustInTimeTranscodeTemplate(Models\ModifyJustInTimeTranscodeTemplateRequest $req) Modify an instant transcoding template.
 ...
 * @method Models\ModifyKnowledgeBaseResponse ModifyKnowledgeBase(Models\ModifyKnowledgeBaseRequest $req) Modify a knowledge base. The name and/or description of the knowledge base can be modified. At least one of the Name or Description fields is required.
 * @method Models\ModifyLLMComprehendTemplateResponse ModifyLLMComprehendTemplate(Models\ModifyLLMComprehendTemplateRequest $req) Modifies a large model parsing template
...
<li>Standard storage</li>
 * @method Models\ModifyPersonSampleResponse ModifyPersonSample(Models\ModifyPersonSampleRequest $req) This API is used to modify material sample information based on the material ID, including the modification of the name and description, as well as the addition, deletion, and reset of facial features and tags. The deletion of facial features must ensure at least 1 image remains. Otherwise, please use the reset operation.
 ...
 * @method Models\ModifyQualityInspectTemplateResponse ModifyQualityInspectTemplate(Models\ModifyQualityInspectTemplateRequest $req) Modifies an audio and video quality detection template.
 * @method Models\ModifyRebuildMediaTemplateResponse ModifyRebuildMediaTemplate(Models\ModifyRebuildMediaTemplateRequest $req) This API is <font color=red>no longer maintained</font>. The new version of the [Audio and Video Quality Rebirth](https://www.tencentcloud.com/document/product/266/102571?from_cn_redirect=1) API uses preset templates. For details, see [Audio and Video Quality Rebirth Template](https://www.tencentcloud.com/document/product/266/102586?from_cn_redirect=1#50604b3f-0286-4a10-a3f7-18218116aff7).
 ...
 * @method Models\ModifySubAppIdInfoResponse ModifySubAppIdInfo(Models\ModifySubAppIdInfoRequest $req) This API is used to change application information, but the default application info is not allowed to be modified.
 * @method Models\ModifySubAppIdStatusResponse ModifySubAppIdStatus(Models\ModifySubAppIdStatusRequest $req) This API is used to enable or disable an application. A disabled application will have its corresponding domain blocked and console access restricted.
 ...
 * @method Models\ProcessImageAsyncResponse ProcessImageAsync(Models\ProcessImageAsyncRequest $req) This API is used to process image processing tasks.
 ...
 * @method Models\ProcessMediaByMPSResponse ProcessMediaByMPS(Models\ProcessMediaByMPSRequest $req) Use the media processing capability of the media processing service (MPS) to initiate media processing for videos in video-on-demand.
 ...
 * @method Models\PushUrlCacheResponse PushUrlCache(Models\PushUrlCacheRequest $req) 1. Preheat a specified URL list.
 ...
 * @method Models\RebuildMediaResponse RebuildMedia(Models\RebuildMediaRequest $req) The API is <font color=red>no longer maintained</font>. Please use the new version of APIs [Audio and Video Quality Revival](https://www.tencentcloud.com/document/api/266/102571?from_cn_redirect=1).
This API is used to initiate audio and video quality revival.
 * @method Models\RebuildMediaByTemplateResponse RebuildMediaByTemplate(Models\RebuildMediaByTemplateRequest $req) This API is <font color=red>no longer maintained</font>. Please use the new version of APIs [audio and video quality revival](https://www.tencentcloud.com/document/api/266/102571?from_cn_redirect=1).
Use a template to initiate video rebirth.
 * @method Models\RefreshUrlCacheResponse RefreshUrlCache(Models\RefreshUrlCacheRequest $req) 1. Refreshes a specified URL list.
2. The domain name of the URL must be registered in VOD.
3. A maximum of 20 URLs can be specified per request.
4. The default refresh quota is 100,000 URLs per day.
 * @method Models\RemoveWatermarkResponse RemoveWatermark(Models\RemoveWatermarkRequest $req) Removes watermarks intelligently
 ...
 * @method Models\RestoreMediaResponse RestoreMedia(Models\RestoreMediaRequest $req) When the storage type of a media file is archive storage or deep archive storage, it is inaccessible. If you need access, call this API to unfreeze it. The unfrozen media file is temporarily accessible and becomes inaccessible after the validity period expires.
 * @method Models\ReviewAudioVideoResponse ReviewAudioVideo(Models\ReviewAudioVideoRequest $req) This API is used to initiate moderation tasks for on-demand audio-video media, intelligently detecting violative content in video footage, text in images, text in speech, and sounds.
 ...
 * @method Models\ReviewImageResponse ReviewImage(Models\ReviewImageRequest $req) Initiate a review task for image files in on-demand video for offensive, unsafe, and inappropriate information.
 ...
 * @method Models\SetCLSPushTargetResponse SetCLSPushTarget(Models\SetCLSPushTargetRequest $req) Set a delivery target for the VOD domain in CLS.
 ...
 * @method Models\SimpleHlsClipResponse SimpleHlsClip(Models\SimpleHlsClipRequest $req) Crop an HLS video by time period to generate a new HLS video in real time. Developers can share it immediately or store it for long-term preservation.
 ...
 * @method Models\SplitMediaResponse SplitMedia(Models\SplitMediaRequest $req) This API is used to split an on-demand video and generate multiple new on-demand videos.
 ...
 * @method Models\TextToSpeechAsyncResponse TextToSpeechAsync(Models\TextToSpeechAsyncRequest $req) This API is used to initiate a text to speech task, synthesizing text into speech for long text scenarios (up to 200,000 characters). It supports specifying voice tone and synthesis parameters such as speaking rate, volume, pitch, sampling rate, and output format. Text to speech is an asynchronous task, and audio is generated upon completion.
 * @method Models\TextToSpeechSyncResponse TextToSpeechSync(Models\TextToSpeechSyncRequest $req) Initiate a text to speech task to convert text into speech.
 * @method Models\UpdateAigcApiTokenResponse UpdateAigcApiToken(Models\UpdateAigcApiTokenRequest $req) Creates a Token for invoking AIGC APIs. Data sync has a delay once created. It can be queried or deleted after about 30 seconds.
 * @method Models\UpdateVoiceResponse UpdateVoice(Models\UpdateVoiceRequest $req) This API is used to update the profile information of a voice by voice ID, including name, description, gender, age, language, tags, and scenarios, and return the complete voice information after the update. Only voices under this account can be updated. System preset voices do not support update.
