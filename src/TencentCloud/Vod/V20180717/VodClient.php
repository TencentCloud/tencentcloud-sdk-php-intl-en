 ...
 * @method Models\CreateAigcCustomVoiceResponse CreateAigcCustomVoice(Models\CreateAigcCustomVoiceRequest $req) This API is used to create custom voice types. Note that calling this API will incur customization fees. See the billing documentation (https://www.tencentcloud.com/document/product/266/95125?from_cn_redirect=1#5e5217e8-29fc-467e-ac2d-853648f988b7).
 ...
 * @method Models\CreateAigcQuotaResponse CreateAigcQuota(Models\CreateAigcQuotaRequest $req) This API is used to create and enable AIGC quota configuration. Quota usage starts accumulating when the quota feature is enabled. The AIGC feature will no longer be usable when the quota is reached.
 ...
 * @method Models\DeleteAigcQuotaResponse DeleteAigcQuota(Models\DeleteAigcQuotaRequest $req) This API is used to delete AIGC quota configurations. Once deleted, it will no longer limit the initiation of AIGC tasks.
 ...
 * @method Models\DescribeAigcQuotasResponse DescribeAigcQuotas(Models\DescribeAigcQuotasRequest $req) This API is used to query the AIGC quota configuration.
 ...
 * @method Models\ModifyAigcQuotaResponse ModifyAigcQuota(Models\ModifyAigcQuotaRequest $req) This API is used to edit AIGC quota configuration. Quota usage starts accumulating when the quota functionality is enabled. The AIGC functionality will no longer be usable once the quota is reached.
 ...
 * @method Models\UpdateAigcApiTokenResponse UpdateAigcApiToken(Models\UpdateAigcApiTokenRequest $req) This API is used to create a Token for invoking the AIGC API. After creation, data sync has a delay. It becomes queryable or deletable after about 30 seconds.
