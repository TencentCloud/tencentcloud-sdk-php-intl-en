...
/**
 * @method Models\ApplyUploadResponse ApplyUpload(Models\ApplyUploadRequest $req) * We strongly recommend that you use the [server-side upload SDK](https://www.tencentcloud.com/document/product/266/33912#1.-initiate-upload) provided by VOD to upload files. Directly invoking the API for upload is significantly more difficult and involves a much larger workload than using the SDK.
 ...
 * @method Models\AttachMediaSubtitlesResponse AttachMediaSubtitles(Models\AttachMediaSubtitlesRequest $req) Associate media asset subtitles with the media output file corresponding to the designated adaptive bitrate streaming template ID (or disassociate them).
 * @method Models\CloneCDNDomainResponse CloneCDNDomain(Models\CloneCDNDomainRequest $req) Clone a CDN domain.
 * @method Models\CloneVoiceAsyncResponse CloneVoiceAsync(Models\CloneVoiceAsyncRequest $req) This API is used to initiate a voice cloning task. It clones an exclusive voice based on reference audio. The generated voice can be used for subsequent text to speech. Voice cloning is an asynchronous task. The voice ID and audio audition are generated after task completion.
 * @method Models\CloneVoiceSyncResponse CloneVoiceSync(Models\CloneVoiceSyncRequest $req) This API is used to initiate a voice cloning task. It clones an exclusive voice based on reference audio. The generated voice can be used for subsequent text to speech.
 * @method Models\CommitUploadResponse CommitUpload(Models\CommitUploadRequest $req) This API is used to confirm the upload result of media files and cover files to Tencent Cloud VOD, store media information, and return the playback address and file ID.
 ...
 * @method Models\CreateAigcAdvancedCustomElementResponse CreateAigcAdvancedCustomElement(Models\CreateAigcAdvancedCustomElementRequest $req) This API is used to create an AIGC advanced custom subject.
 * @method Models\CreateAigcApiTokenResponse CreateAigcApiToken(Models\CreateAigcApiTokenRequest $req) This API is used to create a Token for AIGC API calls. Data sync may be delayed once created. It can be queried or deleted after about 30 seconds.
 ...
 * @method Models\CreateAigcImageTaskResponse CreateAigcImageTask(Models\CreateAigcImageTaskRequest $req) This API is used to generate AIGC images. The default limit is 1 concurrent processing. API calls will incur actual fees. Refer to the VOD AIGC image generation billing documentation. The settlement mode for the feature is pay-as-you-go. For daily billing customers, usage on the day is billed on the second day. For monthly settlement customers, the usage fees of the previous month are billed on the 1st of the next month.
 ...
 * @method Models\CreateAnimatedGraphicsTemplateResponse CreateAnimatedGraphicsTemplate(Models\CreateAnimatedGraphicsTemplateRequest $req) This API is used to create a custom animated image generating template. Maximum number: 16.
 ...
 * @method Models\CreateCDNDomainResponse CreateCDNDomain(Models\CreateCDNDomainRequest $req) This API is used to add domain names to VOD. A user can add up to 20 domain names. 1. After the domain name is successfully added, VOD will deploy the domain name. It takes about 2 minutes for the domain name to change from the deployment state to the online status.
 ...
 * @method Models\CreateComplexAdaptiveDynamicStreamingTaskResponse CreateComplexAdaptiveDynamicStreamingTask(Models\CreateComplexAdaptiveDynamicStreamingTaskRequest $req) Initiate a complex adaptive bitstream processing task. Features include:
 ...
 * @method Models\CreateHeadTailTemplateResponse CreateHeadTailTemplate(Models\CreateHeadTailTemplateRequest $req) Creates a title and trailer template.
-Maximum supported template quantity: 100.
 * @method Models\CreateImageProcessingTemplateResponse CreateImageProcessingTemplate(Models\CreateImageProcessingTemplateRequest $req) Create a custom image processing template. Maximum quantity: 16. Supports up to ten operations, for example: crop - thumbnail - crop - blurry - thumbnail - crop - thumbnail - crop - blurry - thumbnail.
 ...
 * @method Models\CreateProcessImageAsyncTemplateResponse CreateProcessImageAsyncTemplate(Models\CreateProcessImageAsyncTemplateRequest $req) This API is used to create a user-customized image async processing template. Maximum quantity: 50. HLS format is not supported currently.
 * @method Models\CreateQualityInspectTemplateResponse CreateQualityInspectTemplate(Models\CreateQualityInspectTemplateRequest $req) This API is used to create an audio-visual quality inspection template.
 * @method Models\CreateRebuildMediaTemplateResponse CreateRebuildMediaTemplate(Models\CreateRebuildMediaTemplateRequest $req) This API is no longer maintained. The new version of the [Audio and Video Quality Revival](https://www.tencentcloud.com/document/product/266/102571?from_cn_redirect=1) API uses preset templates. For details, see [Audio and Video Quality Revival Template](https://www.tencentcloud.com/document/product/266/102586?from_cn_redirect=1#50604b3f-0286-4a10-a3f7-18218116aff7).
This API is used to create a video rebirth template.
 * @method Models\CreateReviewTemplateResponse CreateReviewTemplate(Models\CreateReviewTemplateRequest $req) This API is used to create a user-defined moderation template. Maximum quantity: 50.
 ...
 * @method Models\CreateSampleSnapshotTemplateResponse CreateSampleSnapshotTemplate(Models\CreateSampleSnapshotTemplateRequest $req) This API is used to create a custom sampled screenshot template. Maximum number: 16.
 ...
 * @method Models\CreateSceneAigcVideoTaskResponse CreateSceneAigcVideoTask(Models\CreateSceneAigcVideoTaskRequest $req) This API is used to generate scenario-based AIGC images.
 ...
 * @method Models\CreateVodDomainResponse CreateVodDomain(Models\CreateVodDomainRequest $req) This API is used to add an acceleration domain name to VOD. A user can add up to 20 acceleration domain names.
 ...
 * @method Models\CreateWordSamplesResponse CreateWordSamples(Models\CreateWordSamplesRequest $req) This API is used to create keyword samples in batches. The samples are used for video processing such as inappropriate content recognition and content recognition through OCR and ASR technologies.
 ...
 * @method Models\DeleteAigcApiTokenResponse DeleteAigcApiToken(Models\DeleteAigcApiTokenRequest $req) Deletes an AIGC API Token. The associated AIGC quota will also be deleted.
 ...
 * @method Models\DeleteCDNDomainResponse DeleteCDNDomain(Models\DeleteCDNDomainRequest $req) Delete a CDN domain
 ...
 * @method Models\DeleteContentReviewTemplateResponse DeleteContentReviewTemplate(Models\DeleteContentReviewTemplateRequest $req) This API is <font color=red>no longer maintained</font>. The new version moderation template supports video moderation and image moderation. For details, please see [Delete Moderation Template](https://www.tencentcloud.com/document/api/266/84390?from_cn_redirect=1).
Delete a user-customized audio/video moderation template.
 * @method Models\DeleteEnhanceMediaTemplateResponse DeleteEnhanceMediaTemplate(Models\DeleteEnhanceMediaTemplateRequest $req) This API is <font color=red>no longer maintained</font>. The new version of [audio and video quality revival](https://www.tencentcloud.com/document/product/266/102571?from_cn_redirect=1) API uses preset templates. For details, see [Audio and Video Quality Rebirth Template](https://www.tencentcloud.com/document/product/266/102586?from_cn_redirect=1#50604b3f-0286-4a10-a3f7-18218116aff7).
 ...
 * @method Models\DeleteImageProcessingTemplateResponse DeleteImageProcessingTemplate(Models\DeleteImageProcessingTemplateRequest $req) This API is used to delete a user-defined image processing template.
 ...
 * @method Models\DeleteJustInTimeTranscodeTemplateResponse DeleteJustInTimeTranscodeTemplate(Models\DeleteJustInTimeTranscodeTemplateRequest $req) This API is used to delete a just in time transcoding template.
 ...
 * @method Models\DeleteLLMComprehendTemplateResponse DeleteLLMComprehendTemplate(Models\DeleteLLMComprehendTemplateRequest $req) This API is used to delete a user-defined customized large model parsing template.
 ...
 * @method Models\DeletePersonSampleResponse DeletePersonSample(Models\DeletePersonSampleRequest $req) This API is used to delete material samples based on character ID.
 ...
 * @method Models\DeleteProcessImageAsyncTemplateResponse DeleteProcessImageAsyncTemplate(Models\DeleteProcessImageAsyncTemplateRequest $req) This API is used to delete a user-customized asynchronous image processing template.
 ...
 * @method Models\DeleteReviewTemplateResponse DeleteReviewTemplate(Models\DeleteReviewTemplateRequest $req) This API is used to delete a user-defined moderation template.
>Template is applicable only to the [audio/video moderation (ReviewAudioVideo)](https://www.tencentcloud.com/document/api/266/80283?from_cn_redirect=1) and [image moderation (ReviewImage)](https://www.tencentcloud.com/document/api/266/73217?from_cn_redirect=1) APIs.
 ...
 * @method Models\DeleteVoiceResponse DeleteVoice(Models\DeleteVoiceRequest $req) Deletes a specified voice type by voice ID. The deletion cannot be undone, and the voice type cannot be used for subsequent APIs. Only voice types for this account can be deleted. System preset voice types cannot be deleted.
 ...
 * @method Models\DeleteWatermarkTemplateResponse DeleteWatermarkTemplate(Models\DeleteWatermarkTemplateRequest $req) This API is used to delete a user-defined watermark template.
 ...
 * @method Models\DescribeAIAnalysisTemplatesResponse DescribeAIAnalysisTemplates(Models\DescribeAIAnalysisTemplatesRequest $req) This API is used to retrieve the audio/video content analysis template detail list based on the unique identifier of an audio/video content analysis template. The returned results include all eligible user-defined audio/video content analysis templates and [system preset audio/video content analysis templates](https://www.tencentcloud.com/document/product/266/33476?from_cn_redirect=1#.E9.A2.84.E7.BD.AE.E8.A7.86.E9.A2.91.E5.86.85.E5.AE.B9.E5.88.86.E6.9E.90.E6.A8.A1.E6.9D.BF).
 * @method Models\DescribeAIRecognitionTemplatesResponse DescribeAIRecognitionTemplates(Models\DescribeAIRecognitionTemplatesRequest $req) This API is used to get the list of audio/video content recognition templates by unique ID. The returned results include all eligible user-defined audio/video content recognition templates and [system preset audio/video content recognition templates](https://www.tencentcloud.com/document/product/266/33476?from_cn_redirect=1#.E9.A2.84.E7.BD.AE.E8.A7.86.E9.A2.91.E5.86.85.E5.AE.B9.E8.AF.86.E5.88.AB.E6.A8.A1.E6.9D.BF).
 ...
 * @method Models\DescribeAigcAdvancedCustomElementsResponse DescribeAigcAdvancedCustomElements(Models\DescribeAigcAdvancedCustomElementsRequest $req) This API is used to retrieve advanced custom AIGC subjects.
 * @method Models\DescribeAigcApiTokensResponse DescribeAigcApiTokens(Models\DescribeAigcApiTokensRequest $req) Query the list of AIGC API tokens. Data sync has a delay after creation or deletion. You can query the latest data after about 30 seconds.
 * @method Models\DescribeAigcFaceInfoResponse DescribeAigcFaceInfo(Models\DescribeAigcFaceInfoRequest $req) This API is used to retrieve AIGC face information. Note that calling this API incurs face recognition fees. Refer to the billing documentation (https://www.tencentcloud.com/document/product/266/95125?from_cn_redirect=1#96b3b59a-f9e1-49e9-966a-bedb70a4bf12).
 * @method Models\DescribeAigcFaceInfoAsyncResponse DescribeAigcFaceInfoAsync(Models\DescribeAigcFaceInfoAsyncRequest $req) This API is used to asynchronously fetch AIGC face information. Note that calling this API incurs face recognition fees. Refer to the billing documentation (https://www.tencentcloud.com/document/product/266/95125?from_cn_redirect=1#96b3b59a-f9e1-49e9-966a-bedb70a4bf12).
 ...
 * @method Models\DescribeAigcUsageDataResponse DescribeAigcUsageData(Models\DescribeAigcUsageDataRequest $req) This API returns AIGC statistical information within a specified time range.
 ...
 * @method Models\DescribeAnimatedGraphicsTemplatesResponse DescribeAnimatedGraphicsTemplates(Models\DescribeAnimatedGraphicsTemplatesRequest $req) This API is used to query a list of rotating image templates, and the pagination query is supported based on conditions.
 * @method Models\DescribeBlindWatermarkTemplatesResponse DescribeBlindWatermarkTemplates(Models\DescribeBlindWatermarkTemplatesRequest $req) This API is used to query user-customized digital watermark templates.
 * @method Models\DescribeCDNDomainsResponse DescribeCDNDomains(Models\DescribeCDNDomainsRequest $req) This API is used to query on-demand domain names.
 * @method Models\DescribeCDNStatDetailsResponse DescribeCDNStatDetails(Models\DescribeCDNStatDetailsRequest $req) This API is used to query CDN bandwidth, traffic, and other stats for on-demand domain names.
 ...
 * @method Models\DescribeCdnLogsResponse DescribeCdnLogs(Models\DescribeCdnLogsRequest $req) This API is used to query the download URL of CDN access logs for an on-demand domain name, excluding EdgeOne origin-pull to VOD domains.
 ...
 * @method Models\DescribeClientUploadAccelerationUsageDataResponse DescribeClientUploadAccelerationUsageData(Models\DescribeClientUploadAccelerationUsageDataRequest $req) This API is used to return client upload acceleration statistics within a specified time range.
 ...
 * @method Models\DescribeContentReviewTemplatesResponse DescribeContentReviewTemplates(Models\DescribeContentReviewTemplatesRequest $req) This API is <font color=red>no longer maintained</font>. The new version of the moderation template supports video and image moderation. For details, please see [Query the moderation template list](https://www.tencentcloud.com/document/api/266/84389?from_cn_redirect=1).
 ...
 * @method Models\DescribeDailyMediaPlayStatResponse DescribeDailyMediaPlayStat(Models\DescribeDailyMediaPlayStatRequest $req) This API is used to query daily playback statistics within a specified date range.
 ...
 * @method Models\DescribeDailyMostPlayedStatResponse DescribeDailyMostPlayedStat(Models\DescribeDailyMostPlayedStatRequest $req) This API is used to query daily playback statistics for the Top 100 media files.
* Playback statistics from the past one year can be queried.
 ...
 * @method Models\DescribeEventConfigResponse DescribeEventConfig(Models\DescribeEventConfigRequest $req) Tencent Cloud VOD provides media upload, media management, media processing, and other services. During or after the execution of these services, Tencent Cloud VOD also provides various event notifications, allowing developers to detect service processing status and perform next business operations.
 ...
 * @method Models\DescribeFileAttributesResponse DescribeFileAttributes(Models\DescribeFileAttributesRequest $req) Used to asynchronously get file attributes.
 ...
 * @method Models\DescribeHeadTailTemplatesResponse DescribeHeadTailTemplates(Models\DescribeHeadTailTemplatesRequest $req) This API is used to search for a list of title and trailer templates.
 * @method Models\DescribeImageProcessingTemplatesResponse DescribeImageProcessingTemplates(Models\DescribeImageProcessingTemplatesRequest $req) This API is used to query the list of image processing templates, and the pagination query is supported based on conditions.
...
1. Image moderation statistics data from the last 365 days can be queried.
   2. The query time span should not exceed 90 days.
3. If the query time span exceeds 1 day, the data returned is at a daily granularity. Otherwise, the data returned is at a 5-minute granularity.
 * @method Models\DescribeImageSpriteTemplatesResponse DescribeImageSpriteTemplates(Models\DescribeImageSpriteTemplatesRequest $req) This API is used to query image sprite templates based on conditions with paging.
 * @method Models\DescribeJustInTimeTranscodeTemplatesResponse DescribeJustInTimeTranscodeTemplates(Models\DescribeJustInTimeTranscodeTemplatesRequest $req) This API is used to search the instant transcoding template list.
 * @method Models\DescribeKnowledgeBasesResponse DescribeKnowledgeBases(Models\DescribeKnowledgeBasesRequest $req) Queries the knowledge base list. Returns all knowledge base info under the designated user.
 * @method Models\DescribeLLMComprehendTemplatesResponse DescribeLLMComprehendTemplates(Models\DescribeLLMComprehendTemplatesRequest $req) This API is used to obtain the parsing template detail list of a large model based on the template unique identifier. The returned results include all user-customized large model parsing templates that meet the conditions.
...
1. License request count stats from the last 365 days can be queried.
   2. The query time span should not exceed 90 days.
3. If the query time span exceeds 1 day, the data returned is at a daily granularity. Otherwise, the data returned is at a 5-minute granularity.
 * @method Models\DescribeMPSTemplatesResponse DescribeMPSTemplates(Models\DescribeMPSTemplatesRequest $req) Query a user-customized media processing service task template.
...
2. The query time span should not exceed 90 days.
 * @method Models\DescribeReviewTemplatesResponse DescribeReviewTemplates(Models\DescribeReviewTemplatesRequest $req) Retrieves the moderation template list.
 ...
 * @method Models\DescribeSnapshotByTimeOffsetTemplatesResponse DescribeSnapshotByTimeOffsetTemplates(Models\DescribeSnapshotByTimeOffsetTemplatesRequest $req) This API is used to query specified time point screenshot templates based on conditions with paging.
 ...
 * @method Models\DescribeSuperPlayerConfigsResponse DescribeSuperPlayerConfigs(Models\DescribeSuperPlayerConfigsRequest $req) This API is <font color='red'>no longer maintained</font>. The new version of player signature no longer uses the player configuration template. For details, please see [Player Signature](https://www.tencentcloud.com/document/product/266/45554?from_cn_redirect=1).
 ...
 * @method Models\DescribeTranscodeTemplatesResponse DescribeTranscodeTemplates(Models\DescribeTranscodeTemplatesRequest $req) This API is used to search the transcoding template detail list by transcoding template unique identifier. The returned results include all eligible custom templates and [system preset transcoding templates](https://www.tencentcloud.com/document/product/266/33476?from_cn_redirect=1#.E9.A2.84.E7.BD.AE.E8.BD.AC.E7.A0.81.E6.A8.A1.E6.9D.BF).
 * @method Models\DescribeVodDomainsResponse DescribeVodDomains(Models\DescribeVodDomainsRequest $req) This API is used to query the information list of on-demand domain names.
 * @method Models\DescribeVoicesResponse DescribeVoices(Models\DescribeVoicesRequest $req) Queries the list of available timbres under the current account, supporting filtering by optional conditions such as voice ID, type, name, gender, age, language, tag, and scenario.
 ...
 * @method Models\DescribeWatermarkTemplatesResponse DescribeWatermarkTemplates(Models\DescribeWatermarkTemplatesRequest $req) This API is used to query user-defined watermark templates, and the pagination query is supported based on conditions.
 ...
 * @method Models\EditMediaResponse EditMedia(Models\EditMediaRequest $req) This API is used to edit a video, such as clipping and concatenation, to generate a new video on demand. Editing features include:
 ...
 * @method Models\EnhanceMediaByTemplateResponse EnhanceMediaByTemplate(Models\EnhanceMediaByTemplateRequest $req) This API is <font color=red>no longer maintained</font>. Please use the new version of APIs for [audio and video quality revival](https://www.tencentcloud.com/document/api/266/102571?from_cn_redirect=1).
 ...
 * @method Models\ExecuteFunctionResponse ExecuteFunction(Models\ExecuteFunctionRequest $req) This API is only used for special customized development scenarios. Do not call this API unless VOD customer service proactively informs you to do so.
 ...
 * @method Models\ForbidMediaDistributionResponse ForbidMediaDistribution(Models\ForbidMediaDistributionRequest $req) After media blocking, except for VOD console preview, accessing video resource URLs (raw files, transcoding output files, screenshots, etc.) for other scenarios will return 403.
 ...
 * @method Models\HandleCurrentPlaylistResponse HandleCurrentPlaylist(Models\HandleCurrentPlaylistRequest $req) Perform operations on the carousel current playlist. Supported operations: <li> Insert: insert a play program into the current playlist.</li><li> Delete: delete a play program from the playlist.</li>
 ...
 * @method Models\InspectMediaQualityResponse InspectMediaQuality(Models\InspectMediaQualityRequest $req) This API is used to trigger an audio and video quality inspection task for on-demand audio-video media.
 ...
 * @method Models\LiveRealTimeClipResponse LiveRealTimeClip(Models\LiveRealTimeClipRequest $req) Live stream clipping refers to the ability for customers to select a segment from past live stream content during live streaming (when the live stream has not yet ended), generate a new video in real time (HLS format), and developers can share it instantly or store it for long-term preservation.
 ...
 * @method Models\ModifyAIAnalysisTemplateResponse ModifyAIAnalysisTemplate(Models\ModifyAIAnalysisTemplateRequest $req) Modify a user-defined audio and video content analysis template.
 ...
 * @method Models\ModifyAigcQuotaResponse ModifyAigcQuota(Models\ModifyAigcQuotaRequest $req) Used to edit AIGC quota configuration. Quota usage is accumulated from the start of the quota feature. Once the quota is reached, the AIGC feature will no longer be usable.
...
* Distribution domain name and distribution protocol, i.e., the domain name and protocol in the media file distribution URL. Media files are distributed based on the default distribution configuration.
Playback key, used to calculate player signature.
 * @method Models\ModifyDefaultStorageRegionResponse ModifyDefaultStorageRegion(Models\ModifyDefaultStorageRegionRequest $req) This API is used to set the default storage region. If no region is specified during file upload, files are uploaded to the default region.
 * @method Models\ModifyEnhanceMediaTemplateResponse ModifyEnhanceMediaTemplate(Models\ModifyEnhanceMediaTemplateRequest $req) This API is no longer maintained. The new version of the [audio and video quality revival](https://www.tencentcloud.com/document/product/266/102571?from_cn_redirect=1) interface uses preset templates. For details, see [Audio and Video Quality Rebirth Template](https://www.tencentcloud.com/document/product/266/102586?from_cn_redirect=1#50604b3f-0286-4a10-a3f7-18218116aff7).
Modifies an Audio and Video Quality Rebirth Template.
 * @method Models\ModifyEventConfigResponse ModifyEventConfig(Models\ModifyEventConfigRequest $req) Tencent Cloud Video on Demand (VOD) provides customers with media upload, media management, media processing, and other services. During or after these services are executed, VOD also offers various event notifications, helping developers detect service processing status and perform the next business operation.
 ...
 * @method Models\ModifyHeadTailTemplateResponse ModifyHeadTailTemplate(Models\ModifyHeadTailTemplateRequest $req) Modifies a title and trailer template.
 * @method Models\ModifyImageSpriteTemplateResponse ModifyImageSpriteTemplate(Models\ModifyImageSpriteTemplateRequest $req) Modify a custom image sprite template.
 * @method Models\ModifyJustInTimeTranscodeTemplateResponse ModifyJustInTimeTranscodeTemplate(Models\ModifyJustInTimeTranscodeTemplateRequest $req) This API is used to modify a just in time transcoding template.
 ...
 * @method Models\ModifyKnowledgeBaseResponse ModifyKnowledgeBase(Models\ModifyKnowledgeBaseRequest $req) This API is used to modify a knowledge base. The name and/or description of the knowledge base can be modified. A minimum of one field, Name or Description, is required.
 ...
 * @method Models\ModifyMediaInfoResponse ModifyMediaInfo(Models\ModifyMediaInfoRequest $req) This API is used to modify media file attributes, including category, name, description, tag, expiration time, dotting information, video cover, and subtitle information.
 * @method Models\ModifyMediaStorageClassResponse ModifyMediaStorageClass(Models\ModifyMediaStorageClassRequest $req) Modify the storage type of media files.
...
<li>Standard storage</li>
 * @method Models\ModifyPersonSampleResponse ModifyPersonSample(Models\ModifyPersonSampleRequest $req) This API is used to modify material sample info based on the material ID, including modification of the name and description, as well as addition, deletion, and reset of facial features and tags. Ensure at least 1 image remains after facial feature deletion. Otherwise, use reset.
 * @method Models\ModifyProcessImageAsyncTemplateResponse ModifyProcessImageAsyncTemplate(Models\ModifyProcessImageAsyncTemplateRequest $req) This API is used to modify a user-customized asynchronous image processing template.

Note: Templates with IDs below 10000 are preset templates and are not allowed to be modified.
 * @method Models\ModifyQualityInspectTemplateResponse ModifyQualityInspectTemplate(Models\ModifyQualityInspectTemplateRequest $req) This API is used to modify an audio and video quality detection template.
 ...
 * @method Models\ModifyReviewTemplateResponse ModifyReviewTemplate(Models\ModifyReviewTemplateRequest $req) Modify a user-customized moderation template.
>Template is applicable only to the [audio/video moderation (ReviewAudioVideo)](https://www.tencentcloud.com/document/api/266/80283?from_cn_redirect=1) and [image moderation (ReviewImage)](https://www.tencentcloud.com/document/api/266/73217?from_cn_redirect=1) APIs.
 ...
 * @method Models\ModifySampleSnapshotTemplateResponse ModifySampleSnapshotTemplate(Models\ModifySampleSnapshotTemplateRequest $req) Modify a custom sampled screenshot template.
 ...
 * @method Models\ModifySubAppIdInfoResponse ModifySubAppIdInfo(Models\ModifySubAppIdInfoRequest $req) This API is used to change application information, but the default application information is not allowed to be modified.
 * @method Models\ModifySubAppIdStatusResponse ModifySubAppIdStatus(Models\ModifySubAppIdStatusRequest $req) This API is used to enable or deactivate applications. Deactivated applications will have their corresponding domains blocked and console access restricted.
 ...
 * @method Models\ModifyWordSampleResponse ModifyWordSample(Models\ModifyWordSampleRequest $req) This API is used to modify the scenario and tags of a keyword. The keyword itself cannot be modified. If modification is needed, delete and rebuild it.
 * @method Models\ParseStreamingManifestResponse ParseStreamingManifest(Models\ParseStreamingManifestRequest $req) When uploading HLS videos, this API parses the index file content and returns the list of shard files to be uploaded. The sharded file path must be a relative path in the current directory or subdirectory. It cannot be a URL or an absolute path.
 ...
 * @method Models\ProcessMediaByMPSResponse ProcessMediaByMPS(Models\ProcessMediaByMPSRequest $req) Use the media processing capacity of the media processing service (MPS) to initiate media processing for videos in video-on-demand.
 ...
 * @method Models\PullEventsResponse PullEvents(Models\PullEventsRequest $req) * This API is used for business servers to get event notifications via reliable callback (https://www.tencentcloud.com/document/product/266/33779?from_cn_redirect=1#.E5.8F.AF.E9.9D.A0.E5.9B.9E.E8.B0.83).
 ...
 * @method Models\PushUrlCacheResponse PushUrlCache(Models\PushUrlCacheRequest $req) 1. Preheats a specified URL list.
 ...
 * @method Models\RestoreMediaResponse RestoreMedia(Models\RestoreMediaRequest $req) When the storage type of a media file is archive storage or deep archive storage, it is unreachable. If you need access, call this API to unfreeze it. The unfrozen media file is temporarily accessible and becomes unreachable after the validity period expires.
 * @method Models\ReviewAudioVideoResponse ReviewAudioVideo(Models\ReviewAudioVideoRequest $req) This API is used to initiate moderation tasks for on-demand audio-video media, intelligently detecting violative content in video footage, text in visuals, text in speech, and sound.
 ...
 * @method Models\ReviewImageResponse ReviewImage(Models\ReviewImageRequest $req) This API is used to initiate review tasks for image files in on-demand video, including offensive, unsafe, and inappropriate content.
 ...
 * @method Models\SearchMediaResponse SearchMedia(Models\SearchMediaRequest $req) This API is used to search media information with conditional filtering, sort and filter returned results, and other features. This includes:
 ...
 * @method Models\SetCLSPushTargetResponse SetCLSPushTarget(Models\SetCLSPushTargetRequest $req) Set a delivery destination for CLS for the vod domain.
 ...
 * @method Models\SetVodDomainCertificateResponse SetVodDomainCertificate(Models\SetVodDomainCertificateRequest $req) Set the HTTPS certificate for the vod domain.
 * @method Models\SimpleHlsClipResponse SimpleHlsClip(Models\SimpleHlsClipRequest $req) Crop an HLS video by time period to generate a new HLS video in real time. Developers can share it immediately or save it for long-term preservation.
 ...
 * @method Models\StartCDNDomainResponse StartCDNDomain(Models\StartCDNDomainRequest $req) This API is used to enable or disable a CDN acceleration domain name.
 * @method Models\TextToSpeechAsyncResponse TextToSpeechAsync(Models\TextToSpeechAsyncRequest $req) Initiate a speech synthesis task to convert text to speech for long text scenarios (up to 200,000 characters). It supports specifying voice tone, speaking rate, volume, pitch, sampling rate, output format, and other synthesis parameters. Speech synthesis is an asynchronous task, and audio results are generated upon completion.
 * @method Models\TextToSpeechSyncResponse TextToSpeechSync(Models\TextToSpeechSyncRequest $req) This API is used to initiate a text to speech task.
 * @method Models\UpdateAigcApiTokenResponse UpdateAigcApiToken(Models\UpdateAigcApiTokenRequest $req) This API is used to create a Token for AIGC API calls. Data sync may delay once created. It can be queried or deleted after about 30 seconds.
 * @method Models\UpdateVoiceResponse UpdateVoice(Models\UpdateVoiceRequest $req) This API is used to update the profile information of a voice type by voice ID, including name, description, gender, age, language, tag, and scenario. It returns the complete voice type information after the update. Only voice types for this account can be updated. System preset voice types do not support update.
