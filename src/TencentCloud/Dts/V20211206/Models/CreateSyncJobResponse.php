 ...
 *
 * @method array getJobIds() Obtain Sync task IDs
 * @method void setJobIds(array $JobIds) Set Sync task IDs
...
class CreateSyncJobResponse extends AbstractModel
{
    ...
    /**
     * @param array $JobIds Sync task IDs
