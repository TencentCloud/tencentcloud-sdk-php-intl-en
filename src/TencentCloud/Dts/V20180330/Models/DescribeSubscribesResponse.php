 ...
 * @method array getItems() Obtain Information list of data subscription instances
 * @method void setItems(array $Items) Set Information list of data subscription instances
...
class DescribeSubscribesResponse extends AbstractModel
{
    ...
    /**
     * @var array Information list of data subscription instances
     */
    public $Items;
     ...
     * @param array $Items Information list of data subscription instances
