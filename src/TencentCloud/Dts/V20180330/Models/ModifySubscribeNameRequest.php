 ...
 * @method string getSubscribeName() Obtain Data subscription instance name. Length limit: [1,60]
 * @method void setSubscribeName(string $SubscribeName) Set Data subscription instance name. Length limit: [1,60]
 */
class ModifySubscribeNameRequest extends AbstractModel
{
    ...
    /**
     * @var string Data subscription instance name. Length limit: [1,60]
     */
    public $SubscribeName;

    /**
     * @param string $SubscribeId Data subscription instance ID
     * @param string $SubscribeName Data subscription instance name. Length limit: [1,60]
     */
