 ...
 *
 * @method array getVersions() Obtain List of application versions.
 * @method void setVersions(array $Versions) Set List of application versions.
...
class DescribeApplicationVersionResponse extends AbstractModel
{
    ...
    /**
     * @param array $Versions List of application versions.
