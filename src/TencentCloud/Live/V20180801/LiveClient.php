 ...
 * @method Models\StartLivePadStreamResponse StartLivePadStream(Models\StartLivePadStreamRequest $req) Call this API to switch the live broadcast to standby footage.
 * @method Models\StopLivePadStreamResponse StopLivePadStream(Models\StopLivePadStreamRequest $req) Call this API to end the transition to standby footage.
