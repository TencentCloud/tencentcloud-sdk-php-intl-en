 ...
 * @method integer getEnable() Obtain Whether to enable referer. Valid values: `0` (no), `1` (yes)
 * @method void setEnable(integer $Enable) Set Whether to enable referer. Valid values: `0` (no), `1` (yes)
...
class RefererAuthConfig extends AbstractModel
{
    ...
    /**
     * @var integer Whether to enable referer. Valid values: `0` (no), `1` (yes)
     */
    public $Enable;
     ...
     * @param integer $Enable Whether to enable referer. Valid values: `0` (no), `1` (yes)
