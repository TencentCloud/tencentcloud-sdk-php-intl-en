 ...
 *
 * @method array getDataInfoList() Obtain Returned data list.
 * @method void setDataInfoList(array $DataInfoList) Set Returned data list.
...
class DescribeStreamPushInfoListResponse extends AbstractModel
{
    ...
    /**
     * @param array $DataInfoList Returned data list.
