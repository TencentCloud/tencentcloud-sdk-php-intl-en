 ...
 *
 * @method array getDataInfoList() Obtain Detailed data.
 * @method void setDataInfoList(array $DataInfoList) Set Detailed data.
...
class DescribeUploadStreamNumsResponse extends AbstractModel
{
    ...
    /**
     * @param array $DataInfoList Detailed data.
