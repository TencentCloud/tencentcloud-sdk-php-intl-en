 ...
 *
 * @method array getDataInfoList() Obtain List of transcoding data
Note: This field may return `null`, indicating that no valid value can be found.
 * @method void setDataInfoList(array $DataInfoList) Set List of transcoding data
Note: This field may return `null`, indicating that no valid value can be found.
...
{
    /**
     * @var array List of transcoding data
Note: This field may return `null`, indicating that no valid value can be found.
     */
    public $DataInfoList;
    ...
    /**
     * @param array $DataInfoList List of transcoding data
Note: This field may return `null`, indicating that no valid value can be found.
