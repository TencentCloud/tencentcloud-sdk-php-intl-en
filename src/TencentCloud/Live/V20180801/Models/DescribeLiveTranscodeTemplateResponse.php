 ...
 *
 * @method TemplateInfo getTemplate() Obtain Template information.
 * @method void setTemplate(TemplateInfo $Template) Set Template information.
...
{
    /**
     * @var TemplateInfo Template information.
     */
    public $Template;
