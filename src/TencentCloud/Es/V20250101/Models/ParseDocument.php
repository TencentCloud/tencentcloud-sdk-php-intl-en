...
Supported image pixel: Unilateral between 20-10000px.
Either FileUrl or FileContent of the file must be provided. If both are provided, only FileUrl is used.
 * @method DocumentParseConfig getDocumentParseConfig() Obtain Document parsing configuration
 * @method void setDocumentParseConfig(DocumentParseConfig $DocumentParseConfig) Set Document parsing configuration
...
Either FileUrl or FileContent of the file must be provided. If both are provided, only FileUrl is used.
    ...
    /**
     * @var DocumentParseConfig Document parsing configuration
     */
...
Supported image pixel: Unilateral between 20-10000px.
Either FileUrl or FileContent of the file must be provided. If both are provided, only FileUrl is used.
     * @param DocumentParseConfig $DocumentParseConfig Document parsing configuration
