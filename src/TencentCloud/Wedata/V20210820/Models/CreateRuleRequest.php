 ...
 * @method integer getRuleTemplateId() Obtain Rule Template List
 * @method void setRuleTemplateId(integer $RuleTemplateId) Set Rule Template List
 ...
 * @method array getSourceEngineTypes() Obtain Supported Execution Engine List for the Rule
 * @method void setSourceEngineTypes(array $SourceEngineTypes) Set Supported Execution Engine List for the Rule
 */
class CreateRuleRequest extends AbstractModel
{
    ...
    /**
     * @var integer Rule Template List
     */
    ...
    /**
     * @var array Supported Execution Engine List for the Rule
     */
     ...
     * @param integer $RuleTemplateId Rule Template List
     ...
     * @param array $SourceEngineTypes Supported Execution Engine List for the Rule
     */
