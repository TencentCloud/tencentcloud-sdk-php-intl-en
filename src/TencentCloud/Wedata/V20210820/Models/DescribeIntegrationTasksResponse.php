 ...
 *
 * @method array getTaskInfoSet() Obtain Task ListNote: This field may return null, indicating that no valid value can be obtained.
 * @method void setTaskInfoSet(array $TaskInfoSet) Set Task ListNote: This field may return null, indicating that no valid value can be obtained.
...
Note: This field may return null, indicating that no valid value can be obtained.
    ...
    /**
     * @param array $TaskInfoSet Task ListNote: This field may return null, indicating that no valid value can be obtained.
