 ...
 * @method boolean getMonitorStatus() Obtain Monitor switch status
 * @method void setMonitorStatus(boolean $MonitorStatus) Set Monitor switch status
 */
class ModifyMonitorStatusRequest extends AbstractModel
{
    ...
    /**
     * @var boolean Monitor switch status
     */
     ...
     * @param boolean $MonitorStatus Monitor switch status
     */
