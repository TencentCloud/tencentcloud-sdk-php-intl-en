 ...
 * @method InstanceApiOpsRequest getSearchCondition() Obtain Query conditions, this interface requires the example information to be placed in this field
 * @method void setSearchCondition(InstanceApiOpsRequest $SearchCondition) Set Query conditions, this interface requires the example information to be placed in this field
...
class DagInstancesRequest extends AbstractModel
{
    ...
    /**
     * @var InstanceApiOpsRequest Query conditions, this interface requires the example information to be placed in this field
     */
     ...
     * @param InstanceApiOpsRequest $SearchCondition Query conditions, this interface requires the example information to be placed in this field
