 ...
 * @method InstanceApiOpsRequest getSearchCondition() Obtain Query Conditions (TaskId and CurRunDate need to be filled in this field for diagnosis)
 * @method void setSearchCondition(InstanceApiOpsRequest $SearchCondition) Set Query Conditions (TaskId and CurRunDate need to be filled in this field for diagnosis)
...
class DiagnoseProRequest extends AbstractModel
{
    ...
    /**
     * @var InstanceApiOpsRequest Query Conditions (TaskId and CurRunDate need to be filled in this field for diagnosis)
     */
     ...
     * @param InstanceApiOpsRequest $SearchCondition Query Conditions (TaskId and CurRunDate need to be filled in this field for diagnosis)
