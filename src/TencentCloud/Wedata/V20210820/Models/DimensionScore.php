 ...
 * Dimension Scoring
 *
 * @method array getDimensionScoreList() Obtain Dimension Scoring List
Note: This field may return null, indicating that no valid value can be obtained.
 * @method void setDimensionScoreList(array $DimensionScoreList) Set Dimension Scoring List
Note: This field may return null, indicating that no valid value can be obtained.
 */
class DimensionScore extends AbstractModel
{
    /**
     * @var array Dimension Scoring List
Note: This field may return null, indicating that no valid value can be obtained.
     */
    public $DimensionScoreList;

    /**
     * @param array $DimensionScoreList Dimension Scoring List
Note: This field may return null, indicating that no valid value can be obtained.
     */
