 ...
 *
 * @method array getNodes() Obtain Task Node Information
Note: This field may return null, indicating that no valid value can be obtained.
 * @method void setNodes(array $Nodes) Set Task Node Information
Note: This field may return null, indicating that no valid value can be obtained.
 * @method array getMappings() Obtain Task Mapping Information
Note: This field may return null, indicating that no valid value can be obtained.
 * @method void setMappings(array $Mappings) Set Task Mapping Information
Note: This field may return null, indicating that no valid value can be obtained.
...
{
    /**
     * @var array Task Node Information
Note: This field may return null, indicating that no valid value can be obtained.
     */
    public $Nodes;

    /**
     * @var array Task Mapping Information
Note: This field may return null, indicating that no valid value can be obtained.
     */
    public $Mappings;
    ...
    /**
     * @param array $Nodes Task Node Information
Note: This field may return null, indicating that no valid value can be obtained.
     * @param array $Mappings Task Mapping Information
Note: This field may return null, indicating that no valid value can be obtained.
