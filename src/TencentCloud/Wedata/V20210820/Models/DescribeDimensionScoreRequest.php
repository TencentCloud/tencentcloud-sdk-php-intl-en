 ...
 *
 * @method integer getStatisticsDate() Obtain Statistics Date Timestamp
 * @method void setStatisticsDate(integer $StatisticsDate) Set Statistics Date Timestamp
...
{
    /**
     * @var integer Statistics Date Timestamp
     */
    ...
    /**
     * @param integer $StatisticsDate Statistics Date Timestamp
