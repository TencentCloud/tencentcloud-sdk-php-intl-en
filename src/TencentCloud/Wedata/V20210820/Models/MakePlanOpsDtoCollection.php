...
Note: This field may return null, indicating that no valid value can be obtained.
 * @method integer getTotalPage() Obtain Total number of records
Note: This field may return null, indicating that no valid value can be obtained.
 * @method void setTotalPage(integer $TotalPage) Set Total number of records
Note: This field may return null, indicating that no valid value can be obtained.
...
Note: This field may return null, indicating that no valid value can be obtained.
     * @param integer $TotalPage Total number of records
Note: This field may return null, indicating that no valid value can be obtained.
