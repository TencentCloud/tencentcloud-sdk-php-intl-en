 ...
 * @method string getOwnerProjectIdent() Obtain Project Chinese Name
 * @method void setOwnerProjectIdent(string $OwnerProjectIdent) Set Project Chinese Name
 ...
 * @method string getProjectId() Obtain Operation Item ID
 * @method void setProjectId(string $ProjectId) Set Operation Item ID
 * @method string getDevelopmentParams() Obtain Data Source Development Environment Configuration
 * @method void setDevelopmentParams(string $DevelopmentParams) Set Data Source Development Environment Configuration
 */
class ModifyDataSourceRequest extends AbstractModel
{
    ...
    /**
     * @var string Operation Item ID
     */
    public $ProjectId;

    /**
     * @var string Data Source Development Environment Configuration
     */
     ...
     * @param string $OwnerProjectIdent Project Chinese Name
     * @param string $COSBucket cos bucket
     * @param string $COSRegion cos region
     * @param string $ProjectId Operation Item ID
     * @param string $DevelopmentParams Data Source Development Environment Configuration
     */
