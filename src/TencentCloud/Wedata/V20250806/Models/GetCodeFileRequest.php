 ...
 * @method boolean getIncludeContent() Obtain true: return file content and configuration. false: only return configuration message. default false.
 * @method void setIncludeContent(boolean $IncludeContent) Set true: return file content and configuration. false: only return configuration message. default false.
 */
class GetCodeFileRequest extends AbstractModel
{
    ...
    /**
     * @var boolean true: return file content and configuration. false: only return configuration message. default false.
     */
     ...
     * @param boolean $IncludeContent true: return file content and configuration. false: only return configuration message. default false.
     */
