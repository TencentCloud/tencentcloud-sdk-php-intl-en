 ...
 * @method string getParentFolderPath() Obtain Parent folder absolute path, for example /abc/de, if it is root directory, pass /.
 * @method void setParentFolderPath(string $ParentFolderPath) Set Parent folder absolute path, for example /abc/de, if it is root directory, pass /.
...
class ListWorkflowFoldersRequest extends AbstractModel
{
    ...
    /**
     * @var string Parent folder absolute path, for example /abc/de, if it is root directory, pass /.
     */
     ...
     * @param string $ParentFolderPath Parent folder absolute path, for example /abc/de, if it is root directory, pass /.
