 ...
 * @method array getRecyclePolicySet() Obtain List of permissions to revoke.
 * @method void setRecyclePolicySet(array $RecyclePolicySet) Set List of permissions to revoke.
 */
class DeleteCodePermissionsRequest extends AbstractModel
{
    ...
    /**
     * @var array List of permissions to revoke.
     */
    public $RecyclePolicySet;

    /**
     * @param string $ProjectId Project ID.
     * @param array $RecyclePolicySet List of permissions to revoke.
     */
