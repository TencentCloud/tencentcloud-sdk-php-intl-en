 ...
 * ListDatabasePage
 *
 * @method array getItems() Obtain Database record list.
 * @method void setItems(array $Items) Set Database record list.
...
{
    /**
     * @var array Database record list.
     */
    public $Items;
    ...
    /**
     * @param array $Items Database record list.
