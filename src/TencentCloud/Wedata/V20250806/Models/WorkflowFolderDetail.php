 ...
 * @method string getFolderPath() Obtain Absolute path of the folder.
 * @method void setFolderPath(string $FolderPath) Set Absolute path of the folder.
...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getParentFolderPath() Obtain Parent folder absolute path.
 * @method void setParentFolderPath(string $ParentFolderPath) Set Parent folder absolute path.
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $ParentFolderPath Parent folder absolute path.
