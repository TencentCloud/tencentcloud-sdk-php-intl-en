 ...
 * @method UpdateTaskPart getNewSetting() Obtain Task basic attributes.
 * @method void setNewSetting(UpdateTaskPart $NewSetting) Set Task basic attributes.
...
class UpdateTaskPartiallyRequest extends AbstractModel
{
    ...
    /**
     * @var UpdateTaskPart Task basic attributes.
     */
    public $NewSetting;
     ...
     * @param UpdateTaskPart $NewSetting Task basic attributes.
