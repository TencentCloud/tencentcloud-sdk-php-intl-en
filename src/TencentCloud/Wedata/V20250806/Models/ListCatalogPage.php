 ...
 * ListCatalogPage
 *
 * @method array getItems() Obtain Directory record list.
 * @method void setItems(array $Items) Set Directory record list.
...
{
    /**
     * @var array Directory record list.
     */
    public $Items;
    ...
    /**
     * @param array $Items Directory record list.
