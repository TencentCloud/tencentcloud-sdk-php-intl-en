 ...
 *
 * @method UpdateTriggerTaskBaseAttribute getTriggerTaskBaseAttribute() Obtain Task basic attributes.
 * @method void setTriggerTaskBaseAttribute(UpdateTriggerTaskBaseAttribute $TriggerTaskBaseAttribute) Set Task basic attributes.
...
{
    /**
     * @var UpdateTriggerTaskBaseAttribute Task basic attributes.
     */
    ...
    /**
     * @param UpdateTriggerTaskBaseAttribute $TriggerTaskBaseAttribute Task basic attributes.
