 ...
 *
 * @method UpdateTriggerTaskBaseAttributePart getTriggerTaskBaseAttribute() Obtain Task basic attributes.
 * @method void setTriggerTaskBaseAttribute(UpdateTriggerTaskBaseAttributePart $TriggerTaskBaseAttribute) Set Task basic attributes.
...
{
    /**
     * @var UpdateTriggerTaskBaseAttributePart Task basic attributes.
     */
    ...
    /**
     * @param UpdateTriggerTaskBaseAttributePart $TriggerTaskBaseAttribute Task basic attributes.
