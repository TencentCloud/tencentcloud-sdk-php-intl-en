 ...
 * @method array getItems() Obtain Alarm information list.
 * @method void setItems(array $Items) Set Alarm information list.
 */
class ListAlarmMessages extends AbstractModel
{
     ...
     * @param array $Items Alarm information list.
     */
