 ...
 * @method string getParamValue() Obtain Parameter definition.
 * @method void setParamValue(string $ParamValue) Set Parameter definition.
 */
class OutTaskParameter extends AbstractModel
{
    ...
    /**
     * @var string Parameter definition.
     */
    public $ParamValue;
     ...
     * @param string $ParamValue Parameter definition.
     */
