 ...
 * @method string getDataBackfillPlanId() Obtain Backfill plan Id.
 * @method void setDataBackfillPlanId(string $DataBackfillPlanId) Set Backfill plan Id.
...
class ListDataBackfillInstancesRequest extends AbstractModel
{
     ...
     * @param string $DataBackfillPlanId Backfill plan Id.
