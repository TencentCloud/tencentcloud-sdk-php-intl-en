 ...
 * @method boolean getKillInstance() Obtain Specifies whether to terminate the generated instance. default value: false.
 * @method void setKillInstance(boolean $KillInstance) Set Specifies whether to terminate the generated instance. default value: false.
 */
class StopOpsTasksAsyncRequest extends AbstractModel
{
    ...
    /**
     * @var boolean Specifies whether to terminate the generated instance. default value: false.
     */
    public $KillInstance;
     ...
     * @param boolean $KillInstance Specifies whether to terminate the generated instance. default value: false.
     */
