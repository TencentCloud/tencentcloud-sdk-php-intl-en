...
TABLE|METRIC|MODEL|SERVICE|COLUMN
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getLineageNodeId() Obtain Unique identifier of the node lineage symbol.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setLineageNodeId(string $LineageNodeId) Set Unique identifier of the node lineage symbol.
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var string Unique identifier of the node lineage symbol.
Note: This field may return null, indicating that no valid values can be obtained.
     */
...
TABLE|METRIC|MODEL|SERVICE|COLUMN
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $LineageNodeId Unique identifier of the node lineage symbol.
Note: This field may return null, indicating that no valid values can be obtained.
