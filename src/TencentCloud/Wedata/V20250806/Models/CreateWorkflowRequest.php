 ...
 * @method string getParentFolderPath() Obtain Specifies the folder path.
 * @method void setParentFolderPath(string $ParentFolderPath) Set Specifies the folder path.
 * @method string getWorkflowType() Obtain Workflow type. value examples: cycle for periodic workflow; manual for manual workflow. default input: cycle.
 * @method void setWorkflowType(string $WorkflowType) Set Workflow type. value examples: cycle for periodic workflow; manual for manual workflow. default input: cycle.
 ...
 * @method WorkflowSchedulerConfigurationInfo getWorkflowSchedulerConfiguration() Obtain Specifies unified scheduling info.
 * @method void setWorkflowSchedulerConfiguration(WorkflowSchedulerConfigurationInfo $WorkflowSchedulerConfiguration) Set Specifies unified scheduling info.
...
class CreateWorkflowRequest extends AbstractModel
{
    ...
    /**
     * @var string Workflow type. value examples: cycle for periodic workflow; manual for manual workflow. default input: cycle.
     */
    public $WorkflowType;
    ...
    /**
     * @var WorkflowSchedulerConfigurationInfo Specifies unified scheduling info.
     */
     ...
     * @param string $ParentFolderPath Specifies the folder path.
     * @param string $WorkflowType Workflow type. value examples: cycle for periodic workflow; manual for manual workflow. default input: cycle.
     ...
     * @param WorkflowSchedulerConfigurationInfo $WorkflowSchedulerConfiguration Specifies unified scheduling info.
