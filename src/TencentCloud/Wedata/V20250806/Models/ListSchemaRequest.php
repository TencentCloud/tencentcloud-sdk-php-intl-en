 ...
 * @method string getKeyword() Obtain Search by database schema keyword.
 * @method void setKeyword(string $Keyword) Set Search by database schema keyword.
 */
class ListSchemaRequest extends AbstractModel
{
    ...
    /**
     * @var string Search by database schema keyword.
     */
    public $Keyword;
     ...
     * @param string $Keyword Search by database schema keyword.
     */
