 ...
 * @method array getItems() Obtain Specifies the backfill instance list.
 * @method void setItems(array $Items) Set Specifies the backfill instance list.
 */
class BackfillInstanceCollection extends AbstractModel
{
    ...
    /**
     * @var array Specifies the backfill instance list.
     */
    public $Items;
     ...
     * @param array $Items Specifies the backfill instance list.
     */
