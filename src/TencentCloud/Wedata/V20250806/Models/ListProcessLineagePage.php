 ...
 * ListLineagePage
 *
 * @method array getItems() Obtain Lineage pair list.
 * @method void setItems(array $Items) Set Lineage pair list.
...
class ListProcessLineagePage extends AbstractModel
{
    ...
    /**
     * @param array $Items Lineage pair list.
