 ...
 * @method string getCrontabExpression() Obtain 0 2 3 1,L,2 * ?	

 * @method void setCrontabExpression(string $CrontabExpression) Set 0 2 3 1,L,2 * ?	

 * @method string getStartTime() Obtain Effective date.

 * @method void setStartTime(string $StartTime) Set Effective date.

 * @method string getEndTime() Obtain End date

 * @method void setEndTime(string $EndTime) Set End date

 * @method string getExecutionStartTime() Obtain Execution time. the left-closed interval.

 * @method void setExecutionStartTime(string $ExecutionStartTime) Set Execution time. the left-closed interval.
 ...
 * @method string getCalendarName() Obtain Calendar name, which needs to be obtained from DescribeScheduleCalendarPageList API.
 * @method void setCalendarName(string $CalendarName) Set Calendar name, which needs to be obtained from DescribeScheduleCalendarPageList API.
...
CRONTAB_CYCLE: specifies the crontab expression type
    ...
    /**
     * @var string Execution time. the left-closed interval.
    ...
    /**
     * @var string Calendar name, which needs to be obtained from DescribeScheduleCalendarPageList API.
     */
    public $CalendarName;
    ...
    /**
     * @var array Specifies the upstream dependency array.
     */
...
CRONTAB_CYCLE: specifies the crontab expression type
     ...
     * @param string $StartTime Effective date.

     * @param string $EndTime End date

     * @param string $ExecutionStartTime Execution time. the left-closed interval.
