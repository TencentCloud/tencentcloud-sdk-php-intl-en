 ...
 *
 * @method UpdateTaskBaseAttribute getTaskBaseAttribute() Obtain Describes the basic attributes of the task.
 * @method void setTaskBaseAttribute(UpdateTaskBaseAttribute $TaskBaseAttribute) Set Describes the basic attributes of the task.
...
{
    /**
     * @var UpdateTaskBaseAttribute Describes the basic attributes of the task.
     */
    ...
    /**
     * @param UpdateTaskBaseAttribute $TaskBaseAttribute Describes the basic attributes of the task.
