 ...
 * @method string getVersionRemark() Obtain Version remarks.
 * @method void setVersionRemark(string $VersionRemark) Set Version remarks.
 */
class SubmitTaskRequest extends AbstractModel
{
     ...
     * @param string $VersionRemark Version remarks.
     */
