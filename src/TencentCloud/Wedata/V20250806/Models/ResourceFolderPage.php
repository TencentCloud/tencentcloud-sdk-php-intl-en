 ...
 * @method integer getTotalCount() Obtain Total resource folder count
 * @method void setTotalCount(integer $TotalCount) Set Total resource folder count
...
{
    /**
     * @var array Resource folder collection information.
     */
    public $Items;
    ...
    /**
     * @var integer Total resource folder count
     */
    public $TotalCount;
    ...
    /**
     * @param array $Items Resource folder collection information.
     * @param integer $TotalPageNumber Total page number.
     * @param integer $TotalCount Total resource folder count
