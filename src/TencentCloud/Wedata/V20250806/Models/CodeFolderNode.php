 ...
 * @method string getTitle() Obtain Name
 * @method void setTitle(string $Title) Set Name
 * @method string getType() Obtain folder type, script.
 * @method void setType(string $Type) Set folder type, script.
 ...
 * @method string getOwnerUin() Obtain Specifies the uin of the responsible person for the directory/file.
 * @method void setOwnerUin(string $OwnerUin) Set Specifies the uin of the responsible person for the directory/file.
...
class CodeFolderNode extends AbstractModel
{
    ...
    /**
     * @var string Specifies the uin of the responsible person for the directory/file.
     */
    public $OwnerUin;
     ...
     * @param string $OwnerUin Specifies the uin of the responsible person for the directory/file.
