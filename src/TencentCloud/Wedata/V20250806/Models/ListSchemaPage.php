 ...
 * ListSchemaPage
 *
 * @method array getItems() Obtain Schema record list.
 * @method void setItems(array $Items) Set Schema record list.
...
class ListSchemaPage extends AbstractModel
{
    ...
    /**
     * @param array $Items Schema record list.
