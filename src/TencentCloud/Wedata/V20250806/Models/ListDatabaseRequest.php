 ...
 * @method string getKeyword() Obtain Search by database name keyword.
 * @method void setKeyword(string $Keyword) Set Search by database name keyword.
 */
class ListDatabaseRequest extends AbstractModel
{
    ...
    /**
     * @var string Search by database name keyword.
     */
    public $Keyword;
     ...
     * @param string $Keyword Search by database name keyword.
     */
