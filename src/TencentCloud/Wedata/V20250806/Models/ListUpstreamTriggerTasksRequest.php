 ...
 * @method integer getPageSize() Obtain The page number of the requested data. the default value is 1. the value must be equal to or greater than 1.
 * @method void setPageSize(integer $PageSize) Set The page number of the requested data. the default value is 1. the value must be equal to or greater than 1.
 */
class ListUpstreamTriggerTasksRequest extends AbstractModel
{
     ...
     * @param integer $PageSize The page number of the requested data. the default value is 1. the value must be equal to or greater than 1.
     */
