 ...
 * @method AiReviewPoliticalAsrTaskInput getInput() Obtain Content review Asr text sensitivity task input.
 * @method void setInput(AiReviewPoliticalAsrTaskInput $Input) Set Content review Asr text sensitivity task input.
 * @method AiReviewPoliticalAsrTaskOutput getOutput() Obtain 
 * @method void setOutput(AiReviewPoliticalAsrTaskOutput $Output) Set 
 */
class AiReviewTaskPoliticalAsrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPoliticalAsrTaskInput Content review Asr text sensitivity task input.
     */
    public $Input;

    /**
     * @var AiReviewPoliticalAsrTaskOutput 
     */
    public $Output;
     ...
     * @param AiReviewPoliticalAsrTaskInput $Input Content review Asr text sensitivity task input.
     * @param AiReviewPoliticalAsrTaskOutput $Output 
     */
