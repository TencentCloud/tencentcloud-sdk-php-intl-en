 ...
 *
 * @method AiDramaInput getInput() Obtain <p>ai comic input</p>
 * @method void setInput(AiDramaInput $Input) Set <p>ai comic input</p>
...
{
    /**
     * @var AiDramaInput <p>ai comic input</p>
     */
    public $Input;
    ...
    /**
     * @param AiDramaInput $Input <p>ai comic input</p>
