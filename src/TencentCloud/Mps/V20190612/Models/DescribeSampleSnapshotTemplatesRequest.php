 ...
 *
 * @method array getDefinitions() Obtain Unique ID filter of sampled screencapturing templates. Array length limit: 100.
 * @method void setDefinitions(array $Definitions) Set Unique ID filter of sampled screencapturing templates. Array length limit: 100.
...
<li>Preset: Preset template;</li>
<li>Custom: Custom template.</li>
 * @method string getName() Obtain Filter condition for sampled screenshot template identifiers, with a length limit of 64 characters.
 * @method void setName(string $Name) Set Filter condition for sampled screenshot template identifiers, with a length limit of 64 characters.
 */
class DescribeSampleSnapshotTemplatesRequest extends AbstractModel
{
    /**
     * @var array Unique ID filter of sampled screencapturing templates. Array length limit: 100.
     */
    public $Definitions;
...
<li>Custom: Custom template.</li>
    ...
    /**
     * @var string Filter condition for sampled screenshot template identifiers, with a length limit of 64 characters.
     */
    public $Name;

    /**
     * @param array $Definitions Unique ID filter of sampled screencapturing templates. Array length limit: 100.
     * @param integer $Offset Paging offset. Default value: 0.
     * @param integer $Limit Number of returned entries. Default value: 10. Maximum value: 100.
     * @param string $Type Template type filter. Valid values:
<li>Preset: Preset template;</li>
<li>Custom: Custom template.</li>
     * @param string $Name Filter condition for sampled screenshot template identifiers, with a length limit of 64 characters.
     */
