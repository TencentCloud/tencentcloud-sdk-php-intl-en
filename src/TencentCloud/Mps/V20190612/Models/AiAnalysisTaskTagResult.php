 ...
 * @method AiAnalysisTaskTagOutput getOutput() Obtain 
 * @method void setOutput(AiAnalysisTaskTagOutput $Output) Set 
 */
class AiAnalysisTaskTagResult extends AbstractModel
{
     ...
     * @param AiAnalysisTaskTagOutput $Output 
     */
