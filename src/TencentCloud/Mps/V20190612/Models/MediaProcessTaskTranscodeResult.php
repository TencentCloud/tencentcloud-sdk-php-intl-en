 ...
 * @method TranscodeTaskInput getInput() Obtain Input for a transcoding task.
 * @method void setInput(TranscodeTaskInput $Input) Set Input for a transcoding task.
 * @method MediaTranscodeItem getOutput() Obtain Output of a transcoding task.
...
class MediaProcessTaskTranscodeResult extends AbstractModel
{
    ...
    /**
     * @var TranscodeTaskInput Input for a transcoding task.
     */
    public $Input;

    /**
     * @var MediaTranscodeItem Output of a transcoding task.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Output;
