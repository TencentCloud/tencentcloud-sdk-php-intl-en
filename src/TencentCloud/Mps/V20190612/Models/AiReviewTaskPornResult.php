 ...
 * @method AiReviewPornTaskInput getInput() Obtain Content review porn task input.
 * @method void setInput(AiReviewPornTaskInput $Input) Set Content review porn task input.
 * @method AiReviewPornTaskOutput getOutput() Obtain 
 * @method void setOutput(AiReviewPornTaskOutput $Output) Set 
 */
class AiReviewTaskPornResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPornTaskInput Content review porn task input.
     */
    public $Input;

    /**
     * @var AiReviewPornTaskOutput 
     */
    public $Output;
     ...
     * @param AiReviewPornTaskInput $Input Content review porn task input.
     * @param AiReviewPornTaskOutput $Output 
     */
