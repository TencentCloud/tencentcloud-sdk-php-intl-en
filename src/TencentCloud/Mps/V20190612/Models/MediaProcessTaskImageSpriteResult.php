 ...
 * @method MediaImageSpriteItem getOutput() Obtain 
 * @method void setOutput(MediaImageSpriteItem $Output) Set 
...
class MediaProcessTaskImageSpriteResult extends AbstractModel
{
     ...
     * @param MediaImageSpriteItem $Output 
