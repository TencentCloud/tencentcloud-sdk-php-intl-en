 ...
 * @method AiReviewProhibitedAsrTaskInput getInput() Obtain Content review Asr text prohibited task input.
 * @method void setInput(AiReviewProhibitedAsrTaskInput $Input) Set Content review Asr text prohibited task input.
 * @method AiReviewProhibitedAsrTaskOutput getOutput() Obtain 
 * @method void setOutput(AiReviewProhibitedAsrTaskOutput $Output) Set 
 */
class AiReviewTaskProhibitedAsrResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewProhibitedAsrTaskInput Content review Asr text prohibited task input.
     */
    public $Input;

    /**
     * @var AiReviewProhibitedAsrTaskOutput 
     */
    public $Output;
     ...
     * @param AiReviewProhibitedAsrTaskInput $Input Content review Asr text prohibited task input.
     * @param AiReviewProhibitedAsrTaskOutput $Output 
     */
