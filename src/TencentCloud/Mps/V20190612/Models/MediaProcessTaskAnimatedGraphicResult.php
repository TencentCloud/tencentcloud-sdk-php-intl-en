 ...
 * @method AnimatedGraphicTaskInput getInput() Obtain Input for an animated image generating task.
 * @method void setInput(AnimatedGraphicTaskInput $Input) Set Input for an animated image generating task.
 * @method MediaAnimatedGraphicsItem getOutput() Obtain Output of an animated image generating task.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setOutput(MediaAnimatedGraphicsItem $Output) Set Output of an animated image generating task.
Note: This field may return null, indicating that no valid values can be obtained.
 */
class MediaProcessTaskAnimatedGraphicResult extends AbstractModel
{
    ...
    /**
     * @var AnimatedGraphicTaskInput Input for an animated image generating task.
     */
    public $Input;

    /**
     * @var MediaAnimatedGraphicsItem Output of an animated image generating task.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Output;
     ...
     * @param AnimatedGraphicTaskInput $Input Input for an animated image generating task.
     * @param MediaAnimatedGraphicsItem $Output Output of an animated image generating task.
Note: This field may return null, indicating that no valid values can be obtained.
     */
