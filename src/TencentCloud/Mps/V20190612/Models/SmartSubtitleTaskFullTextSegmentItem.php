 ...
 * @method string getSpeakerId() Obtain <p>Speaker ID.</p>
 * @method void setSpeakerId(string $SpeakerId) Set <p>Speaker ID.</p>
 */
class SmartSubtitleTaskFullTextSegmentItem extends AbstractModel
{
     ...
     * @param string $SpeakerId <p>Speaker ID.</p>
     */
