 ...
 * @method AiRecognitionTaskOcrWordsResultInput getInput() Obtain Input information of a text keyword recognition task.
 * @method void setInput(AiRecognitionTaskOcrWordsResultInput $Input) Set Input information of a text keyword recognition task.
 * @method AiRecognitionTaskOcrWordsResultOutput getOutput() Obtain Output information of a text keyword recognition task.
...
class AiRecognitionTaskOcrWordsResult extends AbstractModel
{
    ...
    /**
     * @var AiRecognitionTaskOcrWordsResultInput Input information of a text keyword recognition task.
     */
    public $Input;

    /**
     * @var AiRecognitionTaskOcrWordsResultOutput Output information of a text keyword recognition task.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Output;
     ...
     * @param AiRecognitionTaskOcrWordsResultInput $Input Input information of a text keyword recognition task.
     * @param AiRecognitionTaskOcrWordsResultOutput $Output Output information of a text keyword recognition task.
Note: This field may return null, indicating that no valid values can be obtained.
     */
