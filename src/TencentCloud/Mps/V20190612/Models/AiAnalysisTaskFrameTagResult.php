 ...
 * @method AiAnalysisTaskFrameTagInput getInput() Obtain Intelligent frame tagging task input.
 * @method void setInput(AiAnalysisTaskFrameTagInput $Input) Set Intelligent frame tagging task input.
 * @method AiAnalysisTaskFrameTagOutput getOutput() Obtain 
 * @method void setOutput(AiAnalysisTaskFrameTagOutput $Output) Set 
 */
class AiAnalysisTaskFrameTagResult extends AbstractModel
{
    ...
    /**
     * @var AiAnalysisTaskFrameTagInput Intelligent frame tagging task input.
     */
    public $Input;

    /**
     * @var AiAnalysisTaskFrameTagOutput 
     */
    public $Output;
     ...
     * @param AiAnalysisTaskFrameTagInput $Input Intelligent frame tagging task input.
     * @param AiAnalysisTaskFrameTagOutput $Output 
     */
