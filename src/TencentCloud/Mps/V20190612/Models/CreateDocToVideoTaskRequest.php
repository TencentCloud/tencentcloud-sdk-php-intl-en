 ...
 *
 * @method DocToVideoInput getInput() Obtain <p>Input information for AIGC document‑to‑video generation</p>
...
{
    /**
     * @var DocToVideoInput <p>Input information for AIGC document‑to‑video generation</p>
     */
    public $Input;

    /**
     * @var DocToVideoCosInfo <p>User cos information, used to store the generation result</p>
     */
    public $CosInfo;
