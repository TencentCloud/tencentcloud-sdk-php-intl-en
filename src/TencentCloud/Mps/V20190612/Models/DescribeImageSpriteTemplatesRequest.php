...
<li>Preset: Preset template;</li>
<li>Custom: Custom template.</li>
 * @method string getName() Obtain Filter condition for sprite template identifiers, with a length limit of 64 characters.
 * @method void setName(string $Name) Set Filter condition for sprite template identifiers, with a length limit of 64 characters.
 */
class DescribeImageSpriteTemplatesRequest extends AbstractModel
{
    /**
     * @var array Unique ID filter of image sprite generating templates. Array length limit: 100.
     */
    public $Definitions;
...
<li>Custom: Custom template.</li>
    ...
    /**
     * @var string Filter condition for sprite template identifiers, with a length limit of 64 characters.
     */
    public $Name;
...
<li>Preset: Preset template;</li>
<li>Custom: Custom template.</li>
     * @param string $Name Filter condition for sprite template identifiers, with a length limit of 64 characters.
     */
