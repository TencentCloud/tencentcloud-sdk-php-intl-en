 ...
 * @method AiReviewPoliticalTaskInput getInput() Obtain Content review sensitive task input.
 * @method void setInput(AiReviewPoliticalTaskInput $Input) Set Content review sensitive task input.
 * @method AiReviewPoliticalTaskOutput getOutput() Obtain 
 * @method void setOutput(AiReviewPoliticalTaskOutput $Output) Set 
 */
class AiReviewTaskPoliticalResult extends AbstractModel
{
    ...
    /**
     * @var AiReviewPoliticalTaskInput Content review sensitive task input.
     */
    public $Input;

    /**
     * @var AiReviewPoliticalTaskOutput 
     */
    public $Output;
     ...
     * @param AiReviewPoliticalTaskInput $Input Content review sensitive task input.
     * @param AiReviewPoliticalTaskOutput $Output 
     */
