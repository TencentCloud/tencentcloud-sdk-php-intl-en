 ...
 * @method array getAudioInfos() Obtain <p>Some models support reference audio input via URL.</p>
 * @method void setAudioInfos(array $AudioInfos) Set <p>Some models support reference audio input via URL.</p>
...
class CreateAigcVideoTaskRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>Some models support reference audio input via URL.</p>
     */
    public $AudioInfos;
     ...
     * @param array $AudioInfos <p>Some models support reference audio input via URL.</p>
