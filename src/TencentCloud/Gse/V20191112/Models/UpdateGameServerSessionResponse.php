 ...
 *
 * @method GameServerSession getGameServerSession() Obtain Updated game session
 * @method void setGameServerSession(GameServerSession $GameServerSession) Set Updated game session
...
{
    /**
     * @var GameServerSession Updated game session
     */
    ...
    /**
     * @param GameServerSession $GameServerSession Updated game session
