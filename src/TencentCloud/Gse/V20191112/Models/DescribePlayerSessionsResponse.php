...
Note: this field may return null, indicating that no valid values can be obtained.
 * @method string getNextToken() Obtain Pagination offset
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setNextToken(string $NextToken) Set Pagination offset
Note: this field may return null, indicating that no valid values can be obtained.
...
Note: this field may return null, indicating that no valid values can be obtained.
     * @param string $NextToken Pagination offset
Note: this field may return null, indicating that no valid values can be obtained.
