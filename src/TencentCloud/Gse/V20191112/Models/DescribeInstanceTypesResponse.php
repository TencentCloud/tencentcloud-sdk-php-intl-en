 ...
 *
 * @method array getInstanceTypeList() Obtain List of server types
 * @method void setInstanceTypeList(array $InstanceTypeList) Set List of server types
...
{
    /**
     * @var array List of server types
     */
    ...
    /**
     * @param array $InstanceTypeList List of server types
