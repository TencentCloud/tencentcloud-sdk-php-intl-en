 ...
 *
 * @method GameServerSessionPlacement getGameServerSessionPlacement() Obtain Game server session placement
 * @method void setGameServerSessionPlacement(GameServerSessionPlacement $GameServerSessionPlacement) Set Game server session placement
...
{
    /**
     * @var GameServerSessionPlacement Game server session placement
     */
    ...
    /**
     * @param GameServerSessionPlacement $GameServerSessionPlacement Game server session placement
