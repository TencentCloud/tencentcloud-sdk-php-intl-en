 ...
 * @method integer getStartConsumeTime() Obtain After this time is set, the `(Batch)receiveMessage` API will consume the messages received after this timestamp in the order in which they are produced.
 * @method void setStartConsumeTime(integer $StartConsumeTime) Set After this time is set, the `(Batch)receiveMessage` API will consume the messages received after this timestamp in the order in which they are produced.
 */
class RewindQueueRequest extends AbstractModel
{
    ...
    /**
     * @var integer After this time is set, the `(Batch)receiveMessage` API will consume the messages received after this timestamp in the order in which they are produced.
     */
     ...
     * @param integer $StartConsumeTime After this time is set, the `(Batch)receiveMessage` API will consume the messages received after this timestamp in the order in which they are produced.
     */
