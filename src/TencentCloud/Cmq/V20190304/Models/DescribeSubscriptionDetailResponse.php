 ...
 * @method array getSubscriptionSet() Obtain Subscription attribute set
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setSubscriptionSet(array $SubscriptionSet) Set Subscription attribute set
Note: this field may return null, indicating that no valid values can be obtained.
...
class DescribeSubscriptionDetailResponse extends AbstractModel
{
    ...
    /**
     * @var array Subscription attribute set
Note: this field may return null, indicating that no valid values can be obtained.
     */
     ...
     * @param array $SubscriptionSet Subscription attribute set
Note: this field may return null, indicating that no valid values can be obtained.
