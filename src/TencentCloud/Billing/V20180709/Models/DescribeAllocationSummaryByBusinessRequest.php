...
Ratio - Proportion (discounted total)
Trend - Month-on-month ratio (discounted total)
 * @method array getBillDates() Obtain Date, used for filtering and provided when PeriodType is set to day

 * @method void setBillDates(array $BillDates) Set Date, used for filtering and provided when PeriodType is set to day
...
Trend - Month-on-month ratio (discounted total)
    ...
    /**
     * @var array Date, used for filtering and provided when PeriodType is set to day
...
Ratio - Proportion (discounted total)
Trend - Month-on-month ratio (discounted total)
     * @param array $BillDates Date, used for filtering and provided when PeriodType is set to day
