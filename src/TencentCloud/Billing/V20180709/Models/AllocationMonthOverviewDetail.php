 ...
 * @method string getAllocateVoucherPayAmount() Obtain Allocated fees (vouchers): Resource vouchers allocated to the cost allocation unit based on the allocation rules
 * @method void setAllocateVoucherPayAmount(string $AllocateVoucherPayAmount) Set Allocated fees (vouchers): Resource vouchers allocated to the cost allocation unit based on the allocation rules
 ...
 * @method string getTotalTransferPayAmount() Obtain Total fees (royalty amount): Total cost of the cost allocation unit, Collected Fees (Royalty Amount) + Allocated fees (Royalty Amount)
 * @method void setTotalTransferPayAmount(string $TotalTransferPayAmount) Set Total fees (royalty amount): Total cost of the cost allocation unit, Collected Fees (Royalty Amount) + Allocated fees (Royalty Amount)
...
class AllocationMonthOverviewDetail extends AbstractModel
{
    ...
    /**
     * @var string Allocated fees (vouchers): Resource vouchers allocated to the cost allocation unit based on the allocation rules
     */
    ...
    /**
     * @var string Total fees (royalty amount): Total cost of the cost allocation unit, Collected Fees (Royalty Amount) + Allocated fees (Royalty Amount)
     */
...
none - Stable
     ...
     * @param string $AllocateVoucherPayAmount Allocated fees (vouchers): Resource vouchers allocated to the cost allocation unit based on the allocation rules
     ...
     * @param string $TotalTransferPayAmount Total fees (royalty amount): Total cost of the cost allocation unit, Collected Fees (Royalty Amount) + Allocated fees (Royalty Amount)
