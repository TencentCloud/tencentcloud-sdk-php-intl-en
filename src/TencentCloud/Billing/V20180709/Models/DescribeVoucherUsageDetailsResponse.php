 ...
 * @method array getUsageRecords() Obtain Voucher usage record details
 * @method void setUsageRecords(array $UsageRecords) Set Voucher usage record details
...
class DescribeVoucherUsageDetailsResponse extends AbstractModel
{
    ...
    /**
     * @var array Voucher usage record details
     */
    public $UsageRecords;
     ...
     * @param array $UsageRecords Voucher usage record details
