 ...
 * @method array getData() Obtain Consumption details summarized by business
 * @method void setData(array $Data) Set Consumption details summarized by business
 * @method integer getRecordNum() Obtain Record count. The system returns null when NeedRecordNum is 0.
 * @method void setRecordNum(integer $RecordNum) Set Record count. The system returns null when NeedRecordNum is 0.
...
class DescribeCostSummaryByProjectResponse extends AbstractModel
{
    ...
    /**
     * @var array Consumption details summarized by business
     */
    public $Data;

    /**
     * @var integer Record count. The system returns null when NeedRecordNum is 0.
     */
    public $RecordNum;
     ...
     * @param array $Data Consumption details summarized by business
     * @param integer $RecordNum Record count. The system returns null when NeedRecordNum is 0.
