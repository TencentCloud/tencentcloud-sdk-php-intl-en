 ...
 *
 * @method integer getRuleId() Obtain The deleted sharing rule ID.
 * @method void setRuleId(integer $RuleId) Set The deleted sharing rule ID.
...
{
    /**
     * @var integer The deleted sharing rule ID.
     */
    public $RuleId;
    ...
    /**
     * @param integer $RuleId The deleted sharing rule ID.
