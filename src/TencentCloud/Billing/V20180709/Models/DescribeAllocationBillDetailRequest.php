 ...
 * @method array getZoneIds() Obtain AZ ID, used for filtering
 * @method void setZoneIds(array $ZoneIds) Set AZ ID, used for filtering
...
desc - Descending
    ...
    /**
     * @var array AZ ID, used for filtering
     */
    public $ZoneIds;
...
desc - Descending
     ...
     * @param array $ZoneIds AZ ID, used for filtering
