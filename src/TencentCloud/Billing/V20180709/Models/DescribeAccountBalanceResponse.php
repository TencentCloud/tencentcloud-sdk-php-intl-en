 ...
 * @method integer getUin() Obtain The user Uin for the query
 * @method void setUin(integer $Uin) Set The user Uin for the query
 ...
 * @method float getTempCredit() Obtain Temporary limit, unit cent
 * @method void setTempCredit(float $TempCredit) Set Temporary limit, unit cent
 * @method array getTempAmountInfoList() Obtain Temporary limit details
 * @method void setTempAmountInfoList(array $TempAmountInfoList) Set Temporary limit details
...
class DescribeAccountBalanceResponse extends AbstractModel
{
    ...
    /**
     * @var integer The user Uin for the query
     */
    public $Uin;
    ...
    /**
     * @var float Temporary limit, unit cent
     */
    public $TempCredit;

    /**
     * @var array Temporary limit details
     */
     ...
     * @param integer $Uin The user Uin for the query
     ...
     * @param float $TempCredit Temporary limit, unit cent
     * @param array $TempAmountInfoList Temporary limit details
