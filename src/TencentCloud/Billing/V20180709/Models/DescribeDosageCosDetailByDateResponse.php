 ...
 *
 * @method array getDetailSets() Obtain Array of usage
 * @method void setDetailSets(array $DetailSets) Set Array of usage
...
class DescribeDosageCosDetailByDateResponse extends AbstractModel
{
    ...
    /**
     * @param array $DetailSets Array of usage
