 ...
 * @method void setSummaryOverview(array $SummaryOverview) Set Detailed cost distribution for all regions
Note: This field may return null, indicating that no valid value was found.
...
{
    /**
     * @var integer Indicates whether or not the data is ready. 0 = not ready, 1 = ready.
     */
    public $Ready;

    /**
     * @var array Detailed cost distribution for all regions
Note: This field may return null, indicating that no valid value was found.
     */
