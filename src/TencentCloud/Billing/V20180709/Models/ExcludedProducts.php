 ...
 *
 * @method string getGoodsName() Obtain The names of non-applicable products.
 * @method void setGoodsName(string $GoodsName) Set The names of non-applicable products.
...
{
    /**
     * @var string The names of non-applicable products.
     */
    public $GoodsName;
    ...
    /**
     * @param string $GoodsName The names of non-applicable products.
