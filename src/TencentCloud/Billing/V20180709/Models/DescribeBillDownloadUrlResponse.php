 ...
 * @method string getDownloadUrl() Obtain Bill download URL, valid for one hour.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setDownloadUrl(string $DownloadUrl) Set Bill download URL, valid for one hour.
Note: This field may return null, indicating that no valid values can be obtained.
...
class DescribeBillDownloadUrlResponse extends AbstractModel
{
    ...
    /**
     * @var string Bill download URL, valid for one hour.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $DownloadUrl;
     ...
     * @param string $DownloadUrl Bill download URL, valid for one hour.
Note: This field may return null, indicating that no valid values can be obtained.
