 ...
 * @method string getName() Obtain Cost allocation unit name.
 * @method void setName(string $Name) Set Cost allocation unit name.
 ...
 * @method array getChildren() Obtain Subtree.
 * @method void setChildren(array $Children) Set Subtree.
 */
class AllocationTree extends AbstractModel
{
    ...
    /**
     * @var string Cost allocation unit name.
     */
    public $Name;
