 ...
 *
 * @method integer getId() Obtain Cost allocation unit ID that the rule belongs to.
 * @method void setId(integer $Id) Set Cost allocation unit ID that the rule belongs to.
 * @method GatherRuleSummary getRuleList() Obtain Collection rule details.
 * @method void setRuleList(GatherRuleSummary $RuleList) Set Collection rule details.
...
{
    /**
     * @var integer Cost allocation unit ID that the rule belongs to.
     */
    public $Id;

    /**
     * @var GatherRuleSummary Collection rule details.
     */
    public $RuleList;
    ...
    /**
     * @param integer $Id Cost allocation unit ID that the rule belongs to.
     * @param GatherRuleSummary $RuleList Collection rule details.
