 ...
 *
 * @method integer getRuleId() Obtain The queried sharing rule ID.
 * @method void setRuleId(integer $RuleId) Set The queried sharing rule ID.
...
{
    /**
     * @var integer The queried sharing rule ID.
     */
    public $RuleId;
    ...
    /**
     * @param integer $RuleId The queried sharing rule ID.
