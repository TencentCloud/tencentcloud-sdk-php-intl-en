 ...
 *
 * @method integer getRuleId() Obtain The deleted collection rule ID.
 * @method void setRuleId(integer $RuleId) Set The deleted collection rule ID.
...
{
    /**
     * @var integer The deleted collection rule ID.
     */
    public $RuleId;
    ...
    /**
     * @param integer $RuleId The deleted collection rule ID.
