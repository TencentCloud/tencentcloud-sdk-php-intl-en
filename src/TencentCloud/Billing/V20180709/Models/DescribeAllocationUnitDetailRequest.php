 ...
 *
 * @method integer getId() Obtain ID of the queried cost allocation unit.
 * @method void setId(integer $Id) Set ID of the queried cost allocation unit.
...
{
    /**
     * @var integer ID of the queried cost allocation unit.
     */
    public $Id;
    ...
    /**
     * @param integer $Id ID of the queried cost allocation unit.
