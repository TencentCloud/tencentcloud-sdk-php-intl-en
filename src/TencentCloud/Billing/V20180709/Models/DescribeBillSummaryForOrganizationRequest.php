 ...
 * @method array getTagKey() Obtain Tag key. Pass in it when `GroupType` is `tag`.
 * @method void setTagKey(array $TagKey) Set Tag key. Pass in it when `GroupType` is `tag`.
 */
class DescribeBillSummaryForOrganizationRequest extends AbstractModel
{
    ...
    /**
     * @var array Tag key. Pass in it when `GroupType` is `tag`.
     */
    public $TagKey;
     ...
     * @param array $TagKey Tag key. Pass in it when `GroupType` is `tag`.
     */
