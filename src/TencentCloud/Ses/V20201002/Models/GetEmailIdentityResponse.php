 ...
 * @method array getAttributes() Obtain DNS configuration details.
 * @method void setAttributes(array $Attributes) Set DNS configuration details.
...
class GetEmailIdentityResponse extends AbstractModel
{
    ...
    /**
     * @var array DNS configuration details.
     */
    public $Attributes;
     ...
     * @param array $Attributes DNS configuration details.
