 ...
 * @method string getDesc() Obtain Recipient list description.
 * @method void setDesc(string $Desc) Set Recipient list description.
 * @method integer getReceiversStatus() Obtain List status (1 to be uploaded 2 uploading 3 upload complete).
 * @method void setReceiversStatus(integer $ReceiversStatus) Set List status (1 to be uploaded 2 uploading 3 upload complete).
 ...
 * @method integer getInvalidCount() Obtain Invalid number of recipients.
 * @method void setInvalidCount(integer $InvalidCount) Set Invalid number of recipients.
 */
class ReceiverData extends AbstractModel
{
    ...
    /**
     * @var string Recipient list description.
     */
    public $Desc;

    /**
     * @var integer List status (1 to be uploaded 2 uploading 3 upload complete).
     */
    ...
    /**
     * @var integer Invalid number of recipients.
     */
    public $InvalidCount;
     ...
     * @param string $Desc Recipient list description.
     * @param integer $ReceiversStatus List status (1 to be uploaded 2 uploading 3 upload complete).
     * @param string $CreateTime Creation time, such as 2021-09-28 16:40:35
     * @param integer $InvalidCount Invalid number of recipients.
     */
