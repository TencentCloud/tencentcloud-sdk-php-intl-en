 ...
 * @method Models\SendEmailResponse SendEmail(Models\SendEmailRequest $req) This API is used to send a TEXT or HTML email. By default, you can only send emails using a template. To send custom content, please contact your sales rep to enable this feature.
