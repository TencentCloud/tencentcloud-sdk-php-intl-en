 ...
 * @method Models\CreateCustomBlacklistResponse CreateCustomBlacklist(Models\CreateCustomBlacklistRequest $req) Add a custom blocklist.
 ...
 * @method Models\ListCustomBlacklistResponse ListCustomBlacklist(Models\ListCustomBlacklistRequest $req) Retrieve the custom blocklist.
 ...
 * @method Models\ListReceiverDetailsResponse ListReceiverDetails(Models\ListReceiverDetailsRequest $req) Query ALL recipient email addresses in the recipient list based on the recipient list id with paging query. Filter queries can be based on the recipient email address.
 ...
 * @method Models\UpdateCustomBlackListResponse UpdateCustomBlackList(Models\UpdateCustomBlackListRequest $req) Refresh custom blocklist.
