 ...
 *
 * @method array getUrlRecordList() Obtain Blocking history
Note: This field may return `null`, indicating that no valid value can be obtained.
 * @method void setUrlRecordList(array $UrlRecordList) Set Blocking history
Note: This field may return `null`, indicating that no valid value can be obtained.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    /**
     * @param array $UrlRecordList Blocking history
Note: This field may return `null`, indicating that no valid value can be obtained.
