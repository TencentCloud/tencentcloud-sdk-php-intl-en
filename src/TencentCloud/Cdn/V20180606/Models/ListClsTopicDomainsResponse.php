 ...
 * @method string getUpdateTime() Obtain Latest update time of the log topic.
 * @method void setUpdateTime(string $UpdateTime) Set Latest update time of the log topic.
...
class ListClsTopicDomainsResponse extends AbstractModel
{
    ...
    /**
     * @var string Latest update time of the log topic.
     */
    public $UpdateTime;
     ...
     * @param string $UpdateTime Latest update time of the log topic.
