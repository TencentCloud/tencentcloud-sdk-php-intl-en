...
/**
 * @method array getIps() Obtain Node ownership details
 * @method void setIps(array $Ips) Set Node ownership details
...
{
    /**
     * @var array Node ownership details
     */
    public $Ips;
    ...
    public $RequestId;
    /**
     * @param array $Ips Node ownership details
