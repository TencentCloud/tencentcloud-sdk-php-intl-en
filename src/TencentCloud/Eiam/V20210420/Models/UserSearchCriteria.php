 ...
 * @method string getLastUpdateTime() Obtain The user's last update time.
 * @method void setLastUpdateTime(string $LastUpdateTime) Set The user's last update time.
 * @method string getKeyword() Obtain Search by name. The match criteria include username and user ID.
 * @method void setKeyword(string $Keyword) Set Search by name. The match criteria include username and user ID.
 */
class UserSearchCriteria extends AbstractModel
{
    ...
    /**
     * @var string The user's last update time.
     */
    public $LastUpdateTime;

    /**
     * @var string Search by name. The match criteria include username and user ID.
     */
    public $Keyword;
     ...
     * @param string $LastUpdateTime The user's last update time.
     * @param string $Keyword Search by name. The match criteria include username and user ID.
     */
