 ...
 *
 * @method array getAccountIdList() Obtain Array of account IDs .
 * @method void setAccountIdList(array $AccountIdList) Set Array of account IDs .
 */
class DeleteAppAccountRequest extends AbstractModel
{
    /**
     * @var array Array of account IDs .
     */
    public $AccountIdList;

    /**
     * @param array $AccountIdList Array of account IDs .
     */
