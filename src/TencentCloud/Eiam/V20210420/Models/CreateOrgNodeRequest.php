 ...
 * @method string getParentOrgNodeId() Obtain Parent organization node ID. If this parameter is left empty, the organization will be created under the root organization node by default.
 * @method void setParentOrgNodeId(string $ParentOrgNodeId) Set Parent organization node ID. If this parameter is left empty, the organization will be created under the root organization node by default.
...
class CreateOrgNodeRequest extends AbstractModel
{
    ...
    /**
     * @var string Parent organization node ID. If this parameter is left empty, the organization will be created under the root organization node by default.
     */
     ...
     * @param string $ParentOrgNodeId Parent organization node ID. If this parameter is left empty, the organization will be created under the root organization node by default.
