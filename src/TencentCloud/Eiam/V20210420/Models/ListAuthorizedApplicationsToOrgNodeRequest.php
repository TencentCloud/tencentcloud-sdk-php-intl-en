 ...
 *
 * @method string getOrgNodeId() Obtain Organization node ID.
 * @method void setOrgNodeId(string $OrgNodeId) Set Organization node ID.
 */
class ListAuthorizedApplicationsToOrgNodeRequest extends AbstractModel
{
    /**
     * @var string Organization node ID.
     */
    public $OrgNodeId;

    /**
     * @param string $OrgNodeId Organization node ID.
     */
