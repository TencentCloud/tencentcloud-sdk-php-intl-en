 ...
 * @method integer getLimit() Obtain Number of items per page for pagination
 * @method void setLimit(integer $Limit) Set Number of items per page for pagination
 */
class DescribeRecordGroupListRequest extends AbstractModel
{
    ...
    /**
     * @var integer Number of items per page for pagination
     */
    public $Limit;
     ...
     * @param integer $Limit Number of items per page for pagination
     */
