 ...
 * @method string getRecordId() Obtain Record ID. Separate multiple IDs by vertical bar ("|").
 * @method void setRecordId(string $RecordId) Set Record ID. Separate multiple IDs by vertical bar ("|").
...
class ModifyRecordToGroupRequest extends AbstractModel
{
    ...
    /**
     * @var string Record ID. Separate multiple IDs by vertical bar ("|").
     */
    public $RecordId;
     ...
     * @param string $RecordId Record ID. Separate multiple IDs by vertical bar ("|").
