 ...
 *
 * @method integer getDomainAliasId() Obtain Domain alias ID. You can view all domain aliases and their IDs via the `DescribeDomainAliasList` API.
 * @method void setDomainAliasId(integer $DomainAliasId) Set Domain alias ID. You can view all domain aliases and their IDs via the `DescribeDomainAliasList` API.
...
{
    /**
     * @var integer Domain alias ID. You can view all domain aliases and their IDs via the `DescribeDomainAliasList` API.
     */
    ...
    /**
     * @param integer $DomainAliasId Domain alias ID. You can view all domain aliases and their IDs via the `DescribeDomainAliasList` API.
