 ...
 * @method string getRemark() Obtain DNS record remarks. To delete the remarks, submit empty content.
 * @method void setRemark(string $Remark) Set DNS record remarks. To delete the remarks, submit empty content.
 */
class ModifyRecordRemarkRequest extends AbstractModel
{
    ...
    /**
     * @var string DNS record remarks. To delete the remarks, submit empty content.
     */
    public $Remark;
     ...
     * @param string $Remark DNS record remarks. To delete the remarks, submit empty content.
     */
