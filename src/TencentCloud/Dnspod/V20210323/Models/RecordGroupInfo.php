 ...
 * @method string getGroupType() Obtain Group type. Valid values: `system`, `user`.
 * @method void setGroupType(string $GroupType) Set Group type. Valid values: `system`, `user`.
 */
class RecordGroupInfo extends AbstractModel
{
    ...
    /**
     * @var string Group type. Valid values: `system`, `user`.
     */
    public $GroupType;
     ...
     * @param string $GroupType Group type. Valid values: `system`, `user`.
     */
