 ...
 * @method string getAccount() Obtain The account to which to transfer the domain, which can be an UIN or email address
 * @method void setAccount(string $Account) Set The account to which to transfer the domain, which can be an UIN or email address
...
class ModifyDomainOwnerRequest extends AbstractModel
{
    ...
    /**
     * @var string The account to which to transfer the domain, which can be an UIN or email address
     */
    public $Account;
     ...
     * @param string $Account The account to which to transfer the domain, which can be an UIN or email address
