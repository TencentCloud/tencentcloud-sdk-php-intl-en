 ...
 * @method string getLockCode() Obtain Domain unlock code, which will be returned when the domain is locked.
 * @method void setLockCode(string $LockCode) Set Domain unlock code, which will be returned when the domain is locked.
...
class ModifyDomainUnlockRequest extends AbstractModel
{
    ...
    /**
     * @var string Domain unlock code, which will be returned when the domain is locked.
     */
    public $LockCode;
     ...
     * @param string $LockCode Domain unlock code, which will be returned when the domain is locked.
