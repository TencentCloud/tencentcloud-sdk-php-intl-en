 ...
 * @method integer getLockDays() Obtain Number of days to lock the domain. The maximum number of locked days can be obtained by calling the API for getting the permissions of a domain.
 * @method void setLockDays(integer $LockDays) Set Number of days to lock the domain. The maximum number of locked days can be obtained by calling the API for getting the permissions of a domain.
...
class ModifyDomainLockRequest extends AbstractModel
{
    ...
    /**
     * @var integer Number of days to lock the domain. The maximum number of locked days can be obtained by calling the API for getting the permissions of a domain.
     */
    public $LockDays;
     ...
     * @param integer $LockDays Number of days to lock the domain. The maximum number of locked days can be obtained by calling the API for getting the permissions of a domain.
