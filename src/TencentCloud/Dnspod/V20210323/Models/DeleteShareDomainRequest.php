 ...
 * @method string getAccount() Obtain Account of the domain to be shared
 * @method void setAccount(string $Account) Set Account of the domain to be shared
...
class DeleteShareDomainRequest extends AbstractModel
{
    ...
    /**
     * @var string Account of the domain to be shared
     */
    public $Account;
     ...
     * @param string $Account Account of the domain to be shared
