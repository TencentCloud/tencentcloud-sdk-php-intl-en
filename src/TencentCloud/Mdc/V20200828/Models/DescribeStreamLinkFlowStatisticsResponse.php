 ...
 *
 * @method array getInfos() Obtain A list of the media data.
 * @method void setInfos(array $Infos) Set A list of the media data.
...
{
    /**
     * @var array A list of the media data.
     */
    public $Infos;
    ...
    /**
     * @param array $Infos A list of the media data.
