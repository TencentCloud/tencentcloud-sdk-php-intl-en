 ...
 *
 * @method array getURLNotices() Obtain Alarm callback notification
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setURLNotices(array $URLNotices) Set Alarm callback notification
Note: this field may return null, indicating that no valid values can be obtained.
...
{
    /**
     * @var array Alarm callback notification
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public $URLNotices;
    ...
    /**
     * @param array $URLNotices Alarm callback notification
Note: this field may return null, indicating that no valid values can be obtained.
