 ...
 * @method array getExternalLabels() Obtain New external labels
 * @method void setExternalLabels(array $ExternalLabels) Set New external labels
 */
class ModifyPrometheusAgentExternalLabelsRequest extends AbstractModel
{
     ...
     * @param array $ExternalLabels New external labels
     */
