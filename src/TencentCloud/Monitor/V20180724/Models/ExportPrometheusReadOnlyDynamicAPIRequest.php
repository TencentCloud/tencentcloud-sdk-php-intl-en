 ...
 * @method boolean getSelfMonitor() Obtain <p>Whether to request self-monitoring data. Self-monitoring is only supported for the /api/v1/query and /api/v1/query_range APIs.</p>
 * @method void setSelfMonitor(boolean $SelfMonitor) Set <p>Whether to request self-monitoring data. Self-monitoring is only supported for the /api/v1/query and /api/v1/query_range APIs.</p>
 */
class ExportPrometheusReadOnlyDynamicAPIRequest extends AbstractModel
{
    ...
    /**
     * @var boolean <p>Whether to request self-monitoring data. Self-monitoring is only supported for the /api/v1/query and /api/v1/query_range APIs.</p>
     */
    public $SelfMonitor;
     ...
     * @param boolean $SelfMonitor <p>Whether to request self-monitoring data. Self-monitoring is only supported for the /api/v1/query and /api/v1/query_range APIs.</p>
     */
