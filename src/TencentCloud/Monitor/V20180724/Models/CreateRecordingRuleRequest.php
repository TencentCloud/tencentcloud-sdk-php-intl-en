 ...
 * @method string getGroup() Obtain Recording rule group content in YAML format
 * @method void setGroup(string $Group) Set Recording rule group content in YAML format
...
class CreateRecordingRuleRequest extends AbstractModel
{
    ...
    /**
     * @var string Recording rule group content in YAML format
     */
    public $Group;
...
Default value: 2 (enabled).
     ...
     * @param string $Group Recording rule group content in YAML format
