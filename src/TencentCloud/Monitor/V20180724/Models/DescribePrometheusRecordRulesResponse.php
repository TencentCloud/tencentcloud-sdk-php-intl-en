 ...
 *
 * @method array getRecords() Obtain Recording rule
 * @method void setRecords(array $Records) Set Recording rule
...
class DescribePrometheusRecordRulesResponse extends AbstractModel
{
    ...
    /**
     * @param array $Records Recording rule
