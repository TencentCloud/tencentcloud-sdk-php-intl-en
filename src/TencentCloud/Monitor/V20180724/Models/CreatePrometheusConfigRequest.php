 ...
 * @method array getRawJobs() Obtain Configuration of Prometheus raw job
 * @method void setRawJobs(array $RawJobs) Set Configuration of Prometheus raw job
 */
class CreatePrometheusConfigRequest extends AbstractModel
{
    ...
    /**
     * @var array Configuration of Prometheus raw job
     */
    public $RawJobs;
     ...
     * @param array $RawJobs Configuration of Prometheus raw job
     */
