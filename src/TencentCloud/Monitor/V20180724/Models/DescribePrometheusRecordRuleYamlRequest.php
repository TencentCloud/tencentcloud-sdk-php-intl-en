 ...
 * @method array getFilters() Obtain Filter. Valid values:
`Name`: Name
`Values`: List of target names
 * @method void setFilters(array $Filters) Set Filter. Valid values:
`Name`: Name
`Values`: List of target names
 */
...
`Values`: List of target names
     ...
     * @param array $Filters Filter. Valid values:
`Name`: Name
`Values`: List of target names
     */
