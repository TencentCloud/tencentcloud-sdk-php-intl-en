 ...
 *
 * @method array getNotices() Obtain <p>Alarm notification template list</p>
 * @method void setNotices(array $Notices) Set <p>Alarm notification template list</p>
...
{
    /**
     * @var array <p>Alarm notification template list</p>
     */
    public $Notices;
    ...
    /**
     * @param array $Notices <p>Alarm notification template list</p>
