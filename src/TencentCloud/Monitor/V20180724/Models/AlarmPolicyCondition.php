 ...
 *
 * @method integer getIsUnionRule() Obtain Metric trigger condition operator. Valid values: 0 (OR), 1 (AND)
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setIsUnionRule(integer $IsUnionRule) Set Metric trigger condition operator. Valid values: 0 (OR), 1 (AND)
Note: this field may return null, indicating that no valid values can be obtained.
...
{
    /**
     * @var integer Metric trigger condition operator. Valid values: 0 (OR), 1 (AND)
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public $IsUnionRule;
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @param integer $IsUnionRule Metric trigger condition operator. Valid values: 0 (OR), 1 (AND)
Note: this field may return null, indicating that no valid values can be obtained.
