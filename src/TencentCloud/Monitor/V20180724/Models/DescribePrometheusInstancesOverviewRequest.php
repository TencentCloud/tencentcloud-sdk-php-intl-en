 ...
 * @method array getFilters() Obtain Instance filter. Valid values:
`ID`: Filter by instance ID 
`Name`: Filter by instance name
 * @method void setFilters(array $Filters) Set Instance filter. Valid values:
`ID`: Filter by instance ID 
`Name`: Filter by instance name
 */
class DescribePrometheusInstancesOverviewRequest extends AbstractModel
{
    ...
    /**
     * @var array Instance filter. Valid values:
`ID`: Filter by instance ID 
`Name`: Filter by instance name
     */
    public $Filters;
     ...
     * @param array $Filters Instance filter. Valid values:
`ID`: Filter by instance ID 
`Name`: Filter by instance name
     */
