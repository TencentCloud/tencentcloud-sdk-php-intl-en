 ...
 * @method string getExpression() Obtain 
 * @method void setExpression(string $Expression) Set 
 * @method string getDimensions() Obtain 
 * @method void setDimensions(string $Dimensions) Set 
 */
