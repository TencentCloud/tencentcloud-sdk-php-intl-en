 ...
 * @method array getHistories() Obtain Alarm record list
 * @method void setHistories(array $Histories) Set Alarm record list
...
class DescribeAlarmHistoriesResponse extends AbstractModel
{
     ...
     * @param array $Histories Alarm record list
