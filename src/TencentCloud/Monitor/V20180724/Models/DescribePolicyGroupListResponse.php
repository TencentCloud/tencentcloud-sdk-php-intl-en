 ...
 *
 * @method array getGroupList() Obtain Policy group list.
Note: This field may return null, indicating that no valid value was found.
 * @method void setGroupList(array $GroupList) Set Policy group list.
Note: This field may return null, indicating that no valid value was found.
...
{
    /**
     * @var array Policy group list.
Note: This field may return null, indicating that no valid value was found.
     */
    public $GroupList;

    /**
     * @var integer Total number of policy groups.
     */
    public $Total;
