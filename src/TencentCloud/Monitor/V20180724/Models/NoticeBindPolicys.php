 ...
 *
 * @method string getNoticeId() Obtain Alert notification template ID
 * @method void setNoticeId(string $NoticeId) Set Alert notification template ID
...
{
    /**
     * @var string Alert notification template ID
     */
    public $NoticeId;
    ...
    /**
     * @param string $NoticeId Alert notification template ID
