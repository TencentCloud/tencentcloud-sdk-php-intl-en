 ...
 * @method array getPoints() Obtain Monitoring data point
 * @method void setPoints(array $Points) Set Monitoring data point
 */
class MetricData extends AbstractModel
{
    ...
    /**
     * @var array Monitoring data point
     */
    public $Points;

    /**
     * @param string $MetricName Metric name
     * @param array $Points Monitoring data point
     */
