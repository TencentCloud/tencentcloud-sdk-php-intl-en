 ...
 *
 * @method array getEvents() Obtain Alarm event list
 * @method void setEvents(array $Events) Set Alarm event list
...
class DescribeAlarmEventsResponse extends AbstractModel
{
    ...
    /**
     * @param array $Events Alarm event list
