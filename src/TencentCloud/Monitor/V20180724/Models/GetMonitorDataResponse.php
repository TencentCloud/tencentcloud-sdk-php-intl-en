 ...
 * @method array getDataPoints() Obtain Array of data points
 * @method void setDataPoints(array $DataPoints) Set Array of data points
...
class GetMonitorDataResponse extends AbstractModel
{
    ...
    /**
     * @var array Array of data points
     */
    public $DataPoints;
