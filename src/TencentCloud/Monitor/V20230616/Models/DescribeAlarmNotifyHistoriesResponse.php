 ...
 *
 * @method array getAlarmNotifyHistoryList() Obtain Alarm history
 * @method void setAlarmNotifyHistoryList(array $AlarmNotifyHistoryList) Set Alarm history
 * @method PageByNoResult getPageResult() Obtain Pagination condition
 * @method void setPageResult(PageByNoResult $PageResult) Set Pagination condition
...
{
    /**
     * @var array Alarm history
     */
    public $AlarmNotifyHistoryList;

    /**
     * @var PageByNoResult Pagination condition
     */
    public $PageResult;
    ...
    /**
     * @param array $AlarmNotifyHistoryList Alarm history
     * @param PageByNoResult $PageResult Pagination condition
