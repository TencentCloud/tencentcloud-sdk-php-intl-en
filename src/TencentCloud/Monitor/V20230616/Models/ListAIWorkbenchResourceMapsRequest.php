 ...
 * @method string getKeyword() Obtain <p>Search by name</p>
 * @method void setKeyword(string $Keyword) Set <p>Search by name</p>
 */
class ListAIWorkbenchResourceMapsRequest extends AbstractModel
{
     ...
     * @param string $Keyword <p>Search by name</p>
     */
