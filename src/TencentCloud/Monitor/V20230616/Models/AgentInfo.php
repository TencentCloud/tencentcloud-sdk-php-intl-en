 ...
 * @method string getStatus() Obtain <p>Status: draft/configured/running/standby/disabled</p>
 * @method void setStatus(string $Status) Set <p>Status: draft/configured/running/standby/disabled</p>
 ...
 * @method array getMCPIds() Obtain <p>Associated mcp id.</p>
 * @method void setMCPIds(array $MCPIds) Set <p>Associated mcp id.</p>
...
class AgentInfo extends AbstractModel
{
    ...
    /**
     * @var string <p>Status: draft/configured/running/standby/disabled</p>
     */
    public $Status;
    ...
    /**
     * @var array <p>Associated mcp id.</p>
     */
    public $MCPIds;
     ...
     * @param string $Status <p>Status: draft/configured/running/standby/disabled</p>
     * @param array $SkillIds <p>List of associated skill IDs.</p>
     * @param string $ResourceMapId <p>Associated resource map ID.</p>
     * @param array $MCPIds <p>Associated mcp id.</p>
