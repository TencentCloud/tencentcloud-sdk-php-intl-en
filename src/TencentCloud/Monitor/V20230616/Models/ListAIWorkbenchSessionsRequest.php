 ...
 * @method array getSessionIds() Obtain <p>Session ID list filtering</p>
 * @method void setSessionIds(array $SessionIds) Set <p>Session ID list filtering</p>
 */
class ListAIWorkbenchSessionsRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>Session ID list filtering</p>
     */
    public $SessionIds;
     ...
     * @param array $SessionIds <p>Session ID list filtering</p>
     */
