 ...
 * @method string getNoticeName() Obtain Name of the notification template
 * @method void setNoticeName(string $NoticeName) Set Name of the notification template
 */
class NotifyRelatedNotice extends AbstractModel
{
    ...
    /**
     * @var string Name of the notification template
     */
    public $NoticeName;

    /**
     * @param string $NoticeId Notification template ID
     * @param string $NoticeName Name of the notification template
     */
