...
<li> direct-connect-tunnel-id: Dedicated tunnel instance ID, such as `dcx-abcdefgh`.</li>
<li>direct-connect-id: Connection instance ID, such as `dc-abcdefgh`.</li>
 * @method array getDirectConnectTunnelIds() Obtain Array of dedicated tunnel IDs.
 * @method void setDirectConnectTunnelIds(array $DirectConnectTunnelIds) Set Array of dedicated tunnel IDs.
...
<li>direct-connect-id: Connection instance ID, such as `dc-abcdefgh`.</li>
    ...
    /**
     * @var array Array of dedicated tunnel IDs.
     */
...
<li> direct-connect-tunnel-id: Dedicated tunnel instance ID, such as `dcx-abcdefgh`.</li>
<li>direct-connect-id: Connection instance ID, such as `dc-abcdefgh`.</li>
     * @param array $DirectConnectTunnelIds Array of dedicated tunnel IDs.
