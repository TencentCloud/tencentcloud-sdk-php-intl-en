 ...
 *
 * @method float getLat() Obtain Latitude
 * @method void setLat(float $Lat) Set Latitude
 * @method float getLng() Obtain Longitude
 * @method void setLng(float $Lng) Set Longitude
 */
