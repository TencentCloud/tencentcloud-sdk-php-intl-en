 ...
 * @method string getCreatedOn() Obtain The verification time.
 * @method void setCreatedOn(string $CreatedOn) Set The verification time.
 */
class IntlPhoneEmailLists extends AbstractModel
{
    ...
    /**
     * @var string The verification time.
     */
    public $CreatedOn;
     ...
     * @param string $CreatedOn The verification time.
     */
