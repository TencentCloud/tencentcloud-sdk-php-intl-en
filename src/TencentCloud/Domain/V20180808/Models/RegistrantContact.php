 ...
 * @method string getPhone() Obtain The mobile number, such as `+86.1360000000`.
 * @method void setPhone(string $Phone) Set The mobile number, such as `+86.1360000000`.
...
class RegistrantContact extends AbstractModel
{
    ...
    /**
     * @var string The mobile number, such as `+86.1360000000`.
     */
    public $Phone;
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param string $Phone The mobile number, such as `+86.1360000000`.
