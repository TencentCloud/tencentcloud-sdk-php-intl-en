 ...
 *
 * @method array getPriceList() Obtain The price list of domains.
 * @method void setPriceList(array $PriceList) Set The price list of domains.
...
{
    /**
     * @var array The price list of domains.
     */
    public $PriceList;
    ...
    /**
     * @param array $PriceList The price list of domains.
