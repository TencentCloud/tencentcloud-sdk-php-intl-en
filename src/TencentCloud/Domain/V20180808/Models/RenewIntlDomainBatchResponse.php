 ...
 *
 * @method integer getLogId() Obtain The ID of the bulk task.
 * @method void setLogId(integer $LogId) Set The ID of the bulk task.
...
class RenewIntlDomainBatchResponse extends AbstractModel
{
    ...
    /**
     * @param integer $LogId The ID of the bulk task.
