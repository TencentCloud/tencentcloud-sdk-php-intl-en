 ...
 * @method array getRows() Obtain List of the permissions granted by DLCCatalog
 * @method void setRows(array $Rows) Set List of the permissions granted by DLCCatalog
...
class DescribeDLCCatalogAccessResponse extends AbstractModel
{
    ...
    /**
     * @var array List of the permissions granted by DLCCatalog
     */
    public $Rows;
     ...
     * @param array $Rows List of the permissions granted by DLCCatalog
