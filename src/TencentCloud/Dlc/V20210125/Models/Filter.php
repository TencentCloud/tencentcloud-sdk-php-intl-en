 ...
 *
 * @method string getName() Obtain Attribute name. If more than one filter exists, the logical relationship between these filters is `OR`.
 * @method void setName(string $Name) Set Attribute name. If more than one filter exists, the logical relationship between these filters is `OR`.
...
{
    /**
     * @var string Attribute name. If more than one filter exists, the logical relationship between these filters is `OR`.
     */
    public $Name;
    ...
    /**
     * @param string $Name Attribute name. If more than one filter exists, the logical relationship between these filters is `OR`.
