 ...
 * @method string getIsLocal() Obtain Whether it is upload locally. Valid values: `cos`, `lakefs`.
 * @method void setIsLocal(string $IsLocal) Set Whether it is upload locally. Valid values: `cos`, `lakefs`.
 ...
 * @method string getIsLocalJars() Obtain Whether it is upload locally. Valid values: `cos`, `lakefs`.
 * @method void setIsLocalJars(string $IsLocalJars) Set Whether it is upload locally. Valid values: `cos`, `lakefs`.
 ...
 * @method string getIsLocalFiles() Obtain Whether it is upload locally. Valid values: `cos`, `lakefs`.
 * @method void setIsLocalFiles(string $IsLocalFiles) Set Whether it is upload locally. Valid values: `cos`, `lakefs`.
...
class CreateSparkAppRequest extends AbstractModel
{
    ...
    /**
     * @var string Whether it is upload locally. Valid values: `cos`, `lakefs`.
     */
    public $IsLocal;
     ...
     * @param string $IsLocal Whether it is upload locally. Valid values: `cos`, `lakefs`.
     ...
     * @param string $IsLocalJars Whether it is upload locally. Valid values: `cos`, `lakefs`.
     * @param string $AppJars Dependency JAR packages of the Spark JAR job separated by comma
     * @param string $IsLocalFiles Whether it is upload locally. Valid values: `cos`, `lakefs`.
