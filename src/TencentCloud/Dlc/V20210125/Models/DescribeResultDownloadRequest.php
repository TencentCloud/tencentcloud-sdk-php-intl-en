 ...
 *
 * @method string getDownloadId() Obtain The query task ID.
 * @method void setDownloadId(string $DownloadId) Set The query task ID.
 */
class DescribeResultDownloadRequest extends AbstractModel
{
    /**
     * @var string The query task ID.
     */
    public $DownloadId;

    /**
     * @param string $DownloadId The query task ID.
     */
