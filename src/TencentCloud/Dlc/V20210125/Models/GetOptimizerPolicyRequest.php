 ...
 *
 * @method SmartPolicy getSmartPolicy() Obtain Policy description
 * @method void setSmartPolicy(SmartPolicy $SmartPolicy) Set Policy description
 */
class GetOptimizerPolicyRequest extends AbstractModel
{
    /**
     * @var SmartPolicy Policy description
     */
    public $SmartPolicy;

    /**
     * @param SmartPolicy $SmartPolicy Policy description
     */
