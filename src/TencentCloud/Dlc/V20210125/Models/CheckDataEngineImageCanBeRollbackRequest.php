 ...
 *
 * @method string getDataEngineId() Obtain Unique engine ID
 * @method void setDataEngineId(string $DataEngineId) Set Unique engine ID
 */
class CheckDataEngineImageCanBeRollbackRequest extends AbstractModel
{
    /**
     * @var string Unique engine ID
     */
    public $DataEngineId;

    /**
     * @param string $DataEngineId Unique engine ID
     */
