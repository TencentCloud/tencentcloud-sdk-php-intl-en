 ...
 *
 * @method string getMountPoint() Obtain Names of metadata acceleration buckets to be bound
 * @method void setMountPoint(string $MountPoint) Set Names of metadata acceleration buckets to be bound
 ...
 * @method array getVpcInfo() Obtain VPC information. When the product name is other, this parameter must be specified.
 * @method void setVpcInfo(array $VpcInfo) Set VPC information. When the product name is other, this parameter must be specified.
 */
class CreateCHDFSBindingProductRequest extends AbstractModel
{
    /**
     * @var string Names of metadata acceleration buckets to be bound
     */
    public $MountPoint;
    ...
    /**
     * @var array VPC information. When the product name is other, this parameter must be specified.
     */
    public $VpcInfo;

    /**
     * @param string $MountPoint Names of metadata acceleration buckets to be bound
     ...
     * @param array $VpcInfo VPC information. When the product name is other, this parameter must be specified.
     */
