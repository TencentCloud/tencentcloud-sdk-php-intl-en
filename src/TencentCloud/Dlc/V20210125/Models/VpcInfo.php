...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getVpcCidrBlock() Obtain VPC subnet
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setVpcCidrBlock(string $VpcCidrBlock) Set VPC subnet
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $VpcCidrBlock VPC subnet
Note: This field may return null, indicating that no valid values can be obtained.
