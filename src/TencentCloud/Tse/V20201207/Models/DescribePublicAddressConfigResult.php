 ...
 * @method array getConfigList() Obtain Public IP address info
 * @method void setConfigList(array $ConfigList) Set Public IP address info
...
class DescribePublicAddressConfigResult extends AbstractModel
{
    ...
    /**
     * @var array Public IP address info
     */
    public $ConfigList;
     ...
     * @param array $ConfigList Public IP address info
