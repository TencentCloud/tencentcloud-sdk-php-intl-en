 ...
 * @method CloudNativeAPIGatewayRateLimitDetail getLimitDetail() Obtain Configure throttling
 * @method void setLimitDetail(CloudNativeAPIGatewayRateLimitDetail $LimitDetail) Set Configure throttling
 */
class ModifyCloudNativeAPIGatewayServiceRateLimitRequest extends AbstractModel
{
    ...
    /**
     * @var CloudNativeAPIGatewayRateLimitDetail Configure throttling
     */
    public $LimitDetail;
     ...
     * @param CloudNativeAPIGatewayRateLimitDetail $LimitDetail Configure throttling
     */
