 ...
 * @method array getGroupIds() Obtain gateway group ID list
 * @method void setGroupIds(array $GroupIds) Set gateway group ID list
 */
class BindAutoScalerResourceStrategyToGroupsRequest extends AbstractModel
{
    ...
    /**
     * @var array gateway group ID list
     */
    public $GroupIds;
     ...
     * @param array $GroupIds gateway group ID list
     */
