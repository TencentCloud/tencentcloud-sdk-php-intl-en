 ...
 * @method string getServiceID() Obtain ID of the associated service
 * @method void setServiceID(string $ServiceID) Set ID of the associated service
 * @method string getRouteID() Obtain Route ID, unique at the instance level
 * @method void setRouteID(string $RouteID) Set Route ID, unique at the instance level
 * @method string getRouteName() Obtain Route name, unique at the instance level, does not provide
 * @method void setRouteName(string $RouteName) Set Route name, unique at the instance level, does not provide
 * @method array getMethods() Obtain Route method. Available values:
- GET
- POST
- DELETE
- PUT
...
- LOCK
- UNLOCK
 * @method void setMethods(array $Methods) Set Route method. Available values:
- GET
- POST
- DELETE
- PUT
...
- LOCK
- UNLOCK
 * @method array getHosts() Obtain Domain name of the route
 * @method void setHosts(array $Hosts) Set Domain name of the route
 * @method array getPaths() Obtain Path of the route
 * @method void setPaths(array $Paths) Set Path of the route
 * @method array getProtocols() Obtain Route protocol, selectable
- https
- http
 * @method void setProtocols(array $Protocols) Set Route protocol, selectable
- https
- http
 ...
 * @method integer getRegexPriority() Obtain Add priority
 * @method void setRegexPriority(integer $RegexPriority) Set Add priority
...
class ModifyCloudNativeAPIGatewayRouteRequest extends AbstractModel
{
    ...
    /**
     * @var string ID of the associated service
     */
    public $ServiceID;

    /**
     * @var string Route ID, unique at the instance level
     */
    public $RouteID;

    /**
     * @var string Route name, unique at the instance level, does not provide
     */
    public $RouteName;

    /**
     * @var array Route method. Available values:
- GET
- POST
- DELETE
- PUT
...
- UNLOCK
    ...
    /**
     * @var array Domain name of the route
     */
    public $Hosts;
    ...
    /**
     * @var array Route protocol, selectable
- https
- http
     */
    public $Protocols;
     ...
     * @param string $ServiceID ID of the associated service
     * @param string $RouteID Route ID, unique at the instance level
     * @param string $RouteName Route name, unique at the instance level, does not provide
     * @param array $Methods Route method. Available values:
- GET
- POST
- DELETE
- PUT
...
- LOCK
- UNLOCK
     * @param array $Hosts Domain name of the route
     * @param array $Paths Path of the route
     * @param array $Protocols Route protocol, selectable
- https
- http
     ...
     * @param integer $RegexPriority Add priority
