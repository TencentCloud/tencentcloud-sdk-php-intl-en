 ...
 * @method string getRuleType() Obtain Grayscale rule type Standard | Lane
 * @method void setRuleType(string $RuleType) Set Grayscale rule type Standard | Lane
...
class DescribeCloudNativeAPIGatewayCanaryRulesRequest extends AbstractModel
{
    ...
    /**
     * @var string Grayscale rule type Standard | Lane
     */
    public $RuleType;
     ...
     * @param string $RuleType Grayscale rule type Standard | Lane
