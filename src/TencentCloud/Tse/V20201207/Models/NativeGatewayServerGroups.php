 ...
 * @method array getGatewayGroupList() Obtain Group information array.
 * @method void setGatewayGroupList(array $GatewayGroupList) Set Group information array.
 */
class NativeGatewayServerGroups extends AbstractModel
{
    ...
    /**
     * @var array Group information array.
     */
    public $GatewayGroupList;

    /**
     * @param integer $TotalCount Total number.
     * @param array $GatewayGroupList Group information array.
     */
