 ...
 *
 * @method array getServiceList() Obtain Service list
 * @method void setServiceList(array $ServiceList) Set Service list
...
class GatewayServices extends AbstractModel
{
    ...
    /**
     * @param array $ServiceList Service list
