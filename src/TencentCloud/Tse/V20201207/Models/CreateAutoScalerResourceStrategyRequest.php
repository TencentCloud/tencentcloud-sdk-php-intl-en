 ...
 * @method CloudNativeAPIGatewayStrategyCronScalerConfig getCronScalerConfig() Obtain Scheduled scaling configuration list
 * @method void setCronScalerConfig(CloudNativeAPIGatewayStrategyCronScalerConfig $CronScalerConfig) Set Scheduled scaling configuration list
...
class CreateAutoScalerResourceStrategyRequest extends AbstractModel
{
    ...
    /**
     * @var CloudNativeAPIGatewayStrategyCronScalerConfig Scheduled scaling configuration list
     * @deprecated
     */
     ...
     * @param CloudNativeAPIGatewayStrategyCronScalerConfig $CronScalerConfig Scheduled scaling configuration list
