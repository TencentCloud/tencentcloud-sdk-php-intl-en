 ...
 *
 * @method KongCertificatesPreview getCert() Obtain None.
 * @method void setCert(KongCertificatesPreview $Cert) Set None.
 */
class KongCertificate extends AbstractModel
{
    /**
     * @var KongCertificatesPreview None.
     */
    public $Cert;

    /**
     * @param KongCertificatesPreview $Cert None.
     */
