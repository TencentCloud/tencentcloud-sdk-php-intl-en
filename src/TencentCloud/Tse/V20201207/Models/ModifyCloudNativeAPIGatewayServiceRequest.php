...
- HostIP
- Scf	
 * @method KongUpstreamInfo getUpstreamInfo() Obtain service configuration
 * @method void setUpstreamInfo(KongUpstreamInfo $UpstreamInfo) Set service configuration
...
- Scf	
    ...
    /**
     * @var KongUpstreamInfo service configuration
     */
    public $UpstreamInfo;
...
- HostIP
- Scf	
     * @param KongUpstreamInfo $UpstreamInfo service configuration
