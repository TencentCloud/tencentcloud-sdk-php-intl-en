 ...
 *
 * @method string getPurpose() Obtain Captcha target, currently supported: rebind super administrator account, BindSuperAdmin; trial version business upgrade verification, ChannelUpdateVerify.
 * @method void setPurpose(string $Purpose) Set Captcha target, currently supported: rebind super administrator account, BindSuperAdmin; trial version business upgrade verification, ChannelUpdateVerify.
 ...
 * @method string getCode() Obtain Specifies the sms verification code.
 * @method void setCode(string $Code) Set Specifies the sms verification code.
...
{
    /**
     * @var string Captcha target, currently supported: rebind super administrator account, BindSuperAdmin; trial version business upgrade verification, ChannelUpdateVerify.
     */
    public $Purpose;
    ...
    /**
     * @var string Specifies the sms verification code.
     */
    public $Code;
    ...
    /**
     * @param string $Purpose Captcha target, currently supported: rebind super administrator account, BindSuperAdmin; trial version business upgrade verification, ChannelUpdateVerify.
     * @param string $PhoneNumber Specifies the mobile number as the super admin account.
     * @param string $Code Specifies the sms verification code.
