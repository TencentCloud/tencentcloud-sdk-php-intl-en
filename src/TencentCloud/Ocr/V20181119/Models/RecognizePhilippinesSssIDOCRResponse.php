 ...
 * @method TextDetectionResult getLicenseNumber() Obtain The license number (SSSID number).
 * @method void setLicenseNumber(TextDetectionResult $LicenseNumber) Set The license number (SSSID number).
...
class RecognizePhilippinesSssIDOCRResponse extends AbstractModel
{
    ...
    /**
     * @var TextDetectionResult The license number (SSSID number).
     */
     ...
     * @param TextDetectionResult $LicenseNumber The license number (SSSID number).
