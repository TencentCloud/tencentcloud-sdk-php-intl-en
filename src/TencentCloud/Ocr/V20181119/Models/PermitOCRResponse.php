 ...
 * @method string getPortraitImage() Obtain base64 of the avatar image
 * @method void setPortraitImage(string $PortraitImage) Set base64 of the avatar image
...
class PermitOCRResponse extends AbstractModel
{
    ...
    /**
     * @var string base64 of the avatar image
     */
...
-9109 This capability is not enabled.
     ...
     * @param string $PortraitImage base64 of the avatar image
