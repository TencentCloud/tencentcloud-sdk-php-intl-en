 ...
 * @method string getShipToAddress() Obtain <p>Shipping address of the waybill in the business system</p>
 * @method void setShipToAddress(string $ShipToAddress) Set <p>Shipping address of the waybill in the business system</p>
 */
class PODAuditAIRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>Shipping address of the waybill in the business system</p>
     */
     ...
     * @param string $ShipToAddress <p>Shipping address of the waybill in the business system</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ShipToAddress",$param) and $param["ShipToAddress"] !== null) {
            $this->ShipToAddress = $param["ShipToAddress"];
        }
    }
}
