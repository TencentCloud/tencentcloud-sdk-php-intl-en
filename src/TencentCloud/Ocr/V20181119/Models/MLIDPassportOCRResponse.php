 ...
 * @method boolean getIsComplete() Obtain complete or not
 * @method void setIsComplete(boolean $IsComplete) Set complete or not
...
-9109 This capability is not enabled.
     ...
     * @param boolean $IsComplete complete or not
