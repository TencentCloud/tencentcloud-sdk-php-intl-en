 ...
 * @method array getWarnCardInfos() Obtain Warning information for the document. This field applies only to international site requests and will return an empty array for domestic site requests. Valid warning codes: 
 ...
 * @method void setWarnCardInfos(array $WarnCardInfos) Set Warning information for the document. This field applies only to international site requests and will return an empty array for domestic site requests. Valid warning codes: 
-9101 (incomplete card border), 
-9102 (photocopied document), 
-9103 (re-photographed document), -9104 (PS-altered document), 
-9107 (reflective document), 
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var array Warning information for the document. This field applies only to international site requests and will return an empty array for domestic site requests. Valid warning codes: 
-9101 (incomplete card border), 
-9102 (photocopied document), 
-9103 (re-photographed document), -9104 (PS-altered document), 
-9107 (reflective document), 
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param array $WarnCardInfos Warning information for the document. This field applies only to international site requests and will return an empty array for domestic site requests. Valid warning codes: 
-9101 (incomplete card border), 
-9102 (photocopied document), 
-9103 (re-photographed document), -9104 (PS-altered document), 
-9107 (reflective document), 
