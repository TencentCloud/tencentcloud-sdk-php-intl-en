 ...
 * @method boolean getIsComplete() Obtain The card information field complete or not
true: complete; false: incomplete
 * @method void setIsComplete(boolean $IsComplete) Set The card information field complete or not
true: complete; false: incomplete
...
-9109 This capability is not enabled.
    ...
    /**
     * @var boolean The card information field complete or not
true: complete; false: incomplete
     */
    public $IsComplete;
...
-9109 This capability is not enabled.
     ...
     * @param boolean $IsComplete The card information field complete or not
true: complete; false: incomplete
