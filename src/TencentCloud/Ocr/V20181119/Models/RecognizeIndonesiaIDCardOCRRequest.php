 ...
 * @method string getScene() Obtain The scene, which defaults to `V1`.
Valid values:
V1
V2
 * @method void setScene(string $Scene) Set The scene, which defaults to `V1`.
Valid values:
V1
V2
 */
...
For a non-Tencent Cloud URL, the download speed and stability may be affected.
    ...
    /**
     * @var string The scene, which defaults to `V1`.
Valid values:
V1
V2
     */
...
For a non-Tencent Cloud URL, the download speed and stability may be affected.
     ...
     * @param string $Scene The scene, which defaults to `V1`.
Valid values:
V1
V2
     */
