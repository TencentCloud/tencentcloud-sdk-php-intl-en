 ...
 * @method string getPhoto() Obtain The portraitImage.
 * @method void setPhoto(string $Photo) Set The portraitImage.
 * @method string getProvinsi() Obtain The province.
 * @method void setProvinsi(string $Provinsi) Set The province.
 * @method string getKota() Obtain The city.
...
-9109 This capability is not enabled.
     ...
     * @param string $Photo The portraitImage.
     * @param string $Provinsi The province.
