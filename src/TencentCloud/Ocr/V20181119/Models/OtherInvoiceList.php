 ...
 *
 * @method array getOtherInvoiceItemList() Obtain List
 * @method void setOtherInvoiceItemList(array $OtherInvoiceItemList) Set List
 */
class OtherInvoiceList extends AbstractModel
{
    ...
    /**
     * @param array $OtherInvoiceItemList List
     */
