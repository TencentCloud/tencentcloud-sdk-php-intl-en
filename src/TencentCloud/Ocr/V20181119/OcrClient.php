 ...
 * @method Models\RecognizeMacaoIDCardOCRResponse RecognizeMacaoIDCardOCR(Models\RecognizeMacaoIDCardOCRRequest $req) This API is used to recognize key fields on the photo side of a Hong Kong (China) identity card, including name in Chinese, name in English, telecode for name, date of birth, gender, document symbol, date of the first issue, date of the last receipt, identity card number, and permanent residency attribute. 
