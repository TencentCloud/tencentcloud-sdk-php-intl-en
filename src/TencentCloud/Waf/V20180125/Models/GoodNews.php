 ...
 * @method GoodsDetailNew getGoodsDetail() Obtain Product Detail
 * @method void setGoodsDetail(GoodsDetailNew $GoodsDetail) Set Product Detail
...
class GoodNews extends AbstractModel
{
    ...
    /**
     * @var GoodsDetailNew Product Detail
     */
    public $GoodsDetail;
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param GoodsDetailNew $GoodsDetail Product Detail
