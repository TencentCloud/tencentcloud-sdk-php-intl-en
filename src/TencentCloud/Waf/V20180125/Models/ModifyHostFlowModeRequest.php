 ...
 * @method integer getFlowMode() Obtain WAF traffic mode
0: mirror mode (default)
1: cleaning mode
 * @method void setFlowMode(integer $FlowMode) Set WAF traffic mode
0: mirror mode (default)
1: cleaning mode
...
1: cleaning mode
     ...
     * @param integer $FlowMode WAF traffic mode
0: mirror mode (default)
1: cleaning mode
