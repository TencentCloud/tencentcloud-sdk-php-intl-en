...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method integer getRuleId() Obtain Operated RuleId
 * @method void setRuleId(integer $RuleId) Set Operated RuleId
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param integer $RuleId Operated RuleId
