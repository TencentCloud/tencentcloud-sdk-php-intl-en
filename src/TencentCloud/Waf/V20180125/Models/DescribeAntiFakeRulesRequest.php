 ...
 * @method string getBy() Obtain Currently supports sorting by TS
 * @method void setBy(string $By) Set Currently supports sorting by TS
 */
class DescribeAntiFakeRulesRequest extends AbstractModel
{
    ...
    /**
     * @var string Currently supports sorting by TS
     */
    public $By;
     ...
     * @param string $By Currently supports sorting by TS
     */
