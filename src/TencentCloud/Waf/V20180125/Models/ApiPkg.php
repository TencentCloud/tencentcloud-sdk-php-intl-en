...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method integer getIsAPISecurityTrial() Obtain API security 7-day trial flag. 1 for trial. 0 for no trial.

Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setIsAPISecurityTrial(integer $IsAPISecurityTrial) Set API security 7-day trial flag. 1 for trial. 0 for no trial.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var integer API security 7-day trial flag. 1 for trial. 0 for no trial.
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param integer $IsAPISecurityTrial API security 7-day trial flag. 1 for trial. 0 for no trial.
