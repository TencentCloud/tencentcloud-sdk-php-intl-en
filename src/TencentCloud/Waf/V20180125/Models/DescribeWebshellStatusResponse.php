 ...
 *
 * @method string getDomain() Obtain Webshell domain
 * @method void setDomain(string $Domain) Set Webshell domain
...
class DescribeWebshellStatusResponse extends AbstractModel
{
    ...
    /**
     * @param string $Domain Webshell domain
