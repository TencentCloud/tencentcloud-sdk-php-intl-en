 ...
 * @method Coupon getCoupon() Obtain <p>The coupon associated with the promotion</p>
 * @method void setCoupon(Coupon $Coupon) Set <p>The coupon associated with the promotion</p>
 * @method CreditPoint getPoint() Obtain <p>The point associated with the promotion</p>
 * @method void setPoint(CreditPoint $Point) Set <p>The point associated with the promotion</p>
 * @method Result getResult() Obtain <p>The result of participating the promotion</p>
 * @method void setResult(Result $Result) Set <p>The result of participating the promotion</p>
 * @method array getCust() Obtain <p>The custom parameters agreed with RCE. An array of objects in K:V format. e.g.[{"Key": "ApproverName", "Value": "bob"},{"Key":"ApproverPhone","Value": "+86131***85678"}]</p>
 * @method void setCust(array $Cust) Set <p>The custom parameters agreed with RCE. An array of objects in K:V format. e.g.[{"Key": "ApproverName", "Value": "bob"},{"Key":"ApproverPhone","Value": "+86131***85678"}]</p>
 */
class AddPromotionEvent extends AbstractModel
{
    ...
    /**
     * @var Coupon <p>The coupon associated with the promotion</p>
     */
    public $Coupon;

    /**
     * @var CreditPoint <p>The point associated with the promotion</p>
     */
    public $Point;

    /**
     * @var Result <p>The result of participating the promotion</p>
     */
    public $Result;

    /**
     * @var array <p>The custom parameters agreed with RCE. An array of objects in K:V format. e.g.[{"Key": "ApproverName", "Value": "bob"},{"Key":"ApproverPhone","Value": "+86131***85678"}]</p>
     */
    public $Cust;
     ...
     * @param Coupon $Coupon <p>The coupon associated with the promotion</p>
     * @param CreditPoint $Point <p>The point associated with the promotion</p>
     * @param Result $Result <p>The result of participating the promotion</p>
     * @param array $Cust <p>The custom parameters agreed with RCE. An array of objects in K:V format. e.g.[{"Key": "ApproverName", "Value": "bob"},{"Key":"ApproverPhone","Value": "+86131***85678"}]</p>
     */
