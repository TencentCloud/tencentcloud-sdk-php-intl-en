 ...
 * @method integer getLuckyDrawCount() Obtain <p>Number of lucky draw</p><p>Unit: count</p>
 * @method void setLuckyDrawCount(integer $LuckyDrawCount) Set <p>Number of lucky draw</p><p>Unit: count</p>
 * @method string getLuckyDrawType() Obtain <p>Type of lucky draw</p>
 * @method void setLuckyDrawType(string $LuckyDrawType) Set <p>Type of lucky draw</p>
...
class LuckyDrawEvent extends AbstractModel
{
    ...
    /**
     * @var integer <p>Number of lucky draw</p><p>Unit: count</p>
     */
    public $LuckyDrawCount;

    /**
     * @var string <p>Type of lucky draw</p>
     */
     ...
     * @param integer $LuckyDrawCount <p>Number of lucky draw</p><p>Unit: count</p>
     * @param string $LuckyDrawType <p>Type of lucky draw</p>
