 ...
 * @method string getDeviceToken() Obtain <p>The token provided by the SDK integrated in your web site or application</p>
 * @method void setDeviceToken(string $DeviceToken) Set <p>The token provided by the SDK integrated in your web site or application</p>
 ...
 * @method EventDetail getEventDetail() Obtain <p>Event details, import corresponding event information based on the event code you input</p>
 * @method void setEventDetail(EventDetail $EventDetail) Set <p>Event details, import corresponding event information based on the event code you input</p>
...
class ReportEventRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>The token provided by the SDK integrated in your web site or application</p>
     */
    public $DeviceToken;
    ...
    /**
     * @var EventDetail <p>Event details, import corresponding event information based on the event code you input</p>
     */
    public $EventDetail;
     ...
     * @param string $DeviceToken <p>The token provided by the SDK integrated in your web site or application</p>
     * @param string $UserIp <p>User client IP address (IPv4 or IPv6)</p>
     * @param EventDetail $EventDetail <p>Event details, import corresponding event information based on the event code you input</p>
