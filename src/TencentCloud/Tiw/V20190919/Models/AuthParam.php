 ...
 * @method string getUserSig() Obtain Signature corresponding to the user ID.
 * @method void setUserSig(string $UserSig) Set Signature corresponding to the user ID.
 */
class AuthParam extends AbstractModel
{
    ...
    /**
     * @var string Signature corresponding to the user ID.
     */
    public $UserSig;
     ...
     * @param string $UserSig Signature corresponding to the user ID.
     */
