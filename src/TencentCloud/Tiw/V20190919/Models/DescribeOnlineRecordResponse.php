 ...
 * @method string getReplayUrl() Obtain Playback URL, must be used with a signaling player. This field is only applicable to video generation mode
Note: This field may return null, indicating that no valid value can be retrieved.
Example value: http://replayurl
 * @method void setReplayUrl(string $ReplayUrl) Set Playback URL, must be used with a signaling player. This field is only applicable to video generation mode
Note: This field may return null, indicating that no valid value can be retrieved.
Example value: http://replayurl
...
- FINISHED: the recorded video has been processed and uploaded, and the recording result is generated.
    ...
    /**
     * @var string Playback URL, must be used with a signaling player. This field is only applicable to video generation mode
Note: This field may return null, indicating that no valid value can be retrieved.
Example value: http://replayurl
     */
    public $ReplayUrl;
...
- FINISHED: the recorded video has been processed and uploaded, and the recording result is generated.
     ...
     * @param string $ReplayUrl Playback URL, must be used with a signaling player. This field is only applicable to video generation mode
Note: This field may return null, indicating that no valid value can be retrieved.
Example value: http://replayurl
