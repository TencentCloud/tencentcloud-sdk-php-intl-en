 ...
 * @method string getTaskId() Obtain ID of the recording task to stop
 * @method void setTaskId(string $TaskId) Set ID of the recording task to stop
 */
class StopOnlineRecordRequest extends AbstractModel
{
    ...
    /**
     * @var string ID of the recording task to stop
     */
    public $TaskId;

    /**
     * @param integer $SdkAppId SdkAppId of the customer
     * @param string $TaskId ID of the recording task to stop
     */
