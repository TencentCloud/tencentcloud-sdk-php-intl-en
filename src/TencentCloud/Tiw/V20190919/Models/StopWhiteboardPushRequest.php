 ...
 * @method string getTaskId() Obtain ID of the whiteboard push task to be stopped.
 * @method void setTaskId(string $TaskId) Set ID of the whiteboard push task to be stopped.
 */
class StopWhiteboardPushRequest extends AbstractModel
{
    ...
    /**
     * @var string ID of the whiteboard push task to be stopped.
     */
    public $TaskId;

    /**
     * @param integer $SdkAppId SdkAppId of the whiteboard application.
     * @param string $TaskId ID of the whiteboard push task to be stopped.
     */
