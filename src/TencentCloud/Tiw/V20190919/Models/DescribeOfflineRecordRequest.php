 ...
 * @method string getTaskId() Obtain ID of the offline recording task.
 * @method void setTaskId(string $TaskId) Set ID of the offline recording task.
 */
class DescribeOfflineRecordRequest extends AbstractModel
{
    ...
    /**
     * @var string ID of the offline recording task.
     */
    public $TaskId;

    /**
     * @param integer $SdkAppId SdkAppId of the whiteboard application.
     * @param string $TaskId ID of the offline recording task.
     */
