 ...
 * @method string getTaskId() Obtain Unique ID of the document transcoding task
 * @method void setTaskId(string $TaskId) Set Unique ID of the document transcoding task
 */
class DescribeTranscodeRequest extends AbstractModel
{
    ...
    /**
     * @var string Unique ID of the document transcoding task
     */
    public $TaskId;

    /**
     * @param integer $SdkAppId SdkAppId of the customer
     * @param string $TaskId Unique ID of the document transcoding task
     */
