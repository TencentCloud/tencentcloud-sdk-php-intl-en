 ...
 * @method string getTaskId() Obtain ID of the resumed real-time recording task
 * @method void setTaskId(string $TaskId) Set ID of the resumed real-time recording task
 */
class ResumeOnlineRecordRequest extends AbstractModel
{
    ...
    /**
     * @var string ID of the resumed real-time recording task
     */
    public $TaskId;

    /**
     * @param integer $SdkAppId SdkAppId of the customer
     * @param string $TaskId ID of the resumed real-time recording task
     */
