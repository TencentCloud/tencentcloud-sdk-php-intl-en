 ...
 * @method string getTaskId() Obtain ID of the recording video generation task.
 * @method void setTaskId(string $TaskId) Set ID of the recording video generation task.
 */
class DescribeVideoGenerationTaskRequest extends AbstractModel
{
    ...
    /**
     * @var string ID of the recording video generation task.
     */
    public $TaskId;

    /**
     * @param integer $SdkAppId SdkAppId of the whiteboard application.
     * @param string $TaskId ID of the recording video generation task.
     */
