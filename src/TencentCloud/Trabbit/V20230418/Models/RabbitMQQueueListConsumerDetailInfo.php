 ...
 *
 * @method integer getConsumersNumber() Obtain Number of consumers.
 * @method void setConsumersNumber(integer $ConsumersNumber) Set Number of consumers.
 */
class RabbitMQQueueListConsumerDetailInfo extends AbstractModel
{
    ...
    /**
     * @param integer $ConsumersNumber Number of consumers.
     */
