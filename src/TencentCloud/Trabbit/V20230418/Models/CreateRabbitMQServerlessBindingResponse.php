 ...
 *
 * @method string getInstanceId() Obtain <p>Queue name</p>
 * @method void setInstanceId(string $InstanceId) Set <p>Queue name</p>
...
class CreateRabbitMQServerlessBindingResponse extends AbstractModel
{
    ...
    /**
     * @param string $InstanceId <p>Queue name</p>
