 ...
 *
 * @method array getResultList() Obtain AI session analysis result.
 * @method void setResultList(array $ResultList) Set AI session analysis result.
...
{
    /**
     * @var array AI session analysis result.
     */
    public $ResultList;
    ...
    /**
     * @param array $ResultList AI session analysis result.
