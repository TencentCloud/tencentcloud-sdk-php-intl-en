 ...
 *
 * @method array getFailedFileList() Obtain List of failed uploads
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setFailedFileList(array $FailedFileList) Set List of failed uploads
Note: This field may return null, indicating that no valid values can be obtained.
 * @method array getSuccessFileList() Obtain List of successful uploads
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setSuccessFileList(array $SuccessFileList) Set List of successful uploads
Note: This field may return null, indicating that no valid values can be obtained.
...
{
    /**
     * @var array List of failed uploads
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $FailedFileList;

    /**
     * @var array List of successful uploads
Note: This field may return null, indicating that no valid values can be obtained.
     */
    ...
    /**
     * @param array $FailedFileList List of failed uploads
Note: This field may return null, indicating that no valid values can be obtained.
     * @param array $SuccessFileList List of successful uploads
Note: This field may return null, indicating that no valid values can be obtained.
