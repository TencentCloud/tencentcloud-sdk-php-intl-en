 ...
 * @method integer getState() Obtain Task status 0 initial 1 running 2 completed 3 ending 4 terminated 5 suspended.
 * @method void setState(integer $State) Set Task status 0 initial 1 running 2 completed 3 ending 4 terminated 5 suspended.
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var integer Task status 0 initial 1 running 2 completed 3 ending 4 terminated 5 suspended.
     */
    public $State;
...
Note: this field may return null, indicating that no valid values can be obtained.
     ...
     * @param integer $State Task status 0 initial 1 running 2 completed 3 ending 4 terminated 5 suspended.
