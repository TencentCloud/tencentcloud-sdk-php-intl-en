 ...
 * @method array getSkillGroupIds() Obtain Bound skill group list.
 * @method void setSkillGroupIds(array $SkillGroupIds) Set Bound skill group list.
 * @method string getRelation() Obtain Bound agent email.
 * @method void setRelation(string $Relation) Set Bound agent email.
 */
class CreateExtensionRequest extends AbstractModel
{
     ...
     * @param array $SkillGroupIds Bound skill group list.
     * @param string $Relation Bound agent email.
     */
