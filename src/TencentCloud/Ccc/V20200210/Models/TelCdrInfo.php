 ...
 * @method integer getCallType() Obtain Call Type: 1. Voice outbound call 2. Voice Inbound call 3. Audio Inbound 5 Predictive Dialing Call 6. Internal Call between Staff
 * @method void setCallType(integer $CallType) Set Call Type: 1. Voice outbound call 2. Voice Inbound call 3. Audio Inbound 5 Predictive Dialing Call 6. Internal Call between Staff
 ...
 * @method string getEndStatusString() Obtain Refers to the EndStatus field.
 * @method void setEndStatusString(string $EndStatusString) Set Refers to the EndStatus field.
...
class TelCdrInfo extends AbstractModel
{
    ...
    /**
     * @var integer Call Type: 1. Voice outbound call 2. Voice Inbound call 3. Audio Inbound 5 Predictive Dialing Call 6. Internal Call between Staff
     */
    public $CallType;
...
English version please go international site (https://www.tencentcloud.com/document/product/1229/71847?lang=en).
    ...
    /**
     * @var string Refers to the EndStatus field.
     */
...
No record (offline asr generation is not enabled or no package is available).
     ...
     * @param integer $CallType Call Type: 1. Voice outbound call 2. Voice Inbound call 3. Audio Inbound 5 Predictive Dialing Call 6. Internal Call between Staff
...
English version please go international site (https://www.tencentcloud.com/document/product/1229/71847?lang=en).
     ...
     * @param string $EndStatusString Refers to the EndStatus field.
