 ...
 * @method integer getPageSize() Obtain Pagination size, upper limit 100.
 * @method void setPageSize(integer $PageSize) Set Pagination size, upper limit 100.
...
class DescribeAIAgentInfoListRequest extends AbstractModel
{
    ...
    /**
     * @var integer Pagination size, upper limit 100.
     */
    public $PageSize;
     ...
     * @param integer $PageSize Pagination size, upper limit 100.
