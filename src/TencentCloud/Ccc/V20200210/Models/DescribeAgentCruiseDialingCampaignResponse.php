 ...
 * @method integer getCalledCalleeCount() Obtain Number of called parties
 * @method void setCalledCalleeCount(integer $CalledCalleeCount) Set Number of called parties
...
class DescribeAgentCruiseDialingCampaignResponse extends AbstractModel
{
     ...
     * @param integer $CalledCalleeCount Number of called parties
