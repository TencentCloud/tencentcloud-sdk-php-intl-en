 ...
 *
 * @method array getIngress() Obtain Inbound rules.
 * @method void setIngress(array $Ingress) Set Inbound rules.
 * @method array getEgress() Obtain Outbound rules.
 * @method void setEgress(array $Egress) Set Outbound rules.
 */
class NetworkAclEntrySet extends AbstractModel
{
    ...
    /**
     * @param array $Ingress Inbound rules.
     * @param array $Egress Outbound rules.
     */
