 ...
 *
 * @method NetworkAcl getNetworkAcl() Obtain Network ACL instance
 * @method void setNetworkAcl(NetworkAcl $NetworkAcl) Set Network ACL instance
...
{
    /**
     * @var NetworkAcl Network ACL instance
     */
    public $NetworkAcl;
    ...
    /**
     * @param NetworkAcl $NetworkAcl Network ACL instance
