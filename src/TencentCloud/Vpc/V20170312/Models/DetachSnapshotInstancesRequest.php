 ...
 * @method array getInstances() Obtain Information of instances
 * @method void setInstances(array $Instances) Set Information of instances
 */
class DetachSnapshotInstancesRequest extends AbstractModel
{
    ...
    /**
     * @var array Information of instances
     */
    public $Instances;

    /**
     * @param string $SnapshotPolicyId Snapshot policy IDs
     * @param array $Instances Information of instances
     */
