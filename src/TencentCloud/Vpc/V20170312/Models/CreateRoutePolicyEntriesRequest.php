 ...
 * @method array getRoutePolicyEntrySet() Obtain Route reception policy entry list.
 * @method void setRoutePolicyEntrySet(array $RoutePolicyEntrySet) Set Route reception policy entry list.
 */
class CreateRoutePolicyEntriesRequest extends AbstractModel
{
    ...
    /**
     * @var array Route reception policy entry list.
     */
    public $RoutePolicyEntrySet;

    /**
     * @param string $RoutePolicyId Specifies the instance ID of the route reception policy.
     * @param array $RoutePolicyEntrySet Route reception policy entry list.
     */
