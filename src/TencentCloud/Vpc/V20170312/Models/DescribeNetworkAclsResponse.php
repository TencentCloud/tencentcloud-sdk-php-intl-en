 ...
 *
 * @method array getNetworkAclSet() Obtain List of instance details.
 * @method void setNetworkAclSet(array $NetworkAclSet) Set List of instance details.
...
class DescribeNetworkAclsResponse extends AbstractModel
{
    ...
    /**
     * @param array $NetworkAclSet List of instance details.
