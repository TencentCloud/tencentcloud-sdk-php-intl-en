 ...
 * @method integer getTotalCount() Obtain Number of objects that meet the condition.
 * @method void setTotalCount(integer $TotalCount) Set Number of objects that meet the condition.
...
class DescribeVpnGatewayCcnRoutesResponse extends AbstractModel
{
    ...
    /**
     * @var integer Number of objects that meet the condition.
     */
    public $TotalCount;
     ...
     * @param integer $TotalCount Number of objects that meet the condition.
