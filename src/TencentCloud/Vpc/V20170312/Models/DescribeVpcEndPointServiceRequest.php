 ...
 * @method array getEndPointServiceIds() Obtain Endpoint service ID
 * @method void setEndPointServiceIds(array $EndPointServiceIds) Set Endpoint service ID
 */
...
<li>service-instance-id - String - (Filter condition) Unique real server ID in the format of `lb-xxx`.</li>
     ...
     * @param array $EndPointServiceIds Endpoint service ID
     */
