...
/**
 * @method string getInstanceId() 获取The ID of the CVM instance to be queried.
 * @method void setInstanceId(string $InstanceId) 设置The ID of the CVM instance to be queried.
 */
