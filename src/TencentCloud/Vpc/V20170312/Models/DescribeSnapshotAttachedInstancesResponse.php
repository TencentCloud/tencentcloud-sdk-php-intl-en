 ...
 *
 * @method array getInstanceSet() Obtain List of instances
 * @method void setInstanceSet(array $InstanceSet) Set List of instances
...
class DescribeSnapshotAttachedInstancesResponse extends AbstractModel
{
    ...
    /**
     * @param array $InstanceSet List of instances
