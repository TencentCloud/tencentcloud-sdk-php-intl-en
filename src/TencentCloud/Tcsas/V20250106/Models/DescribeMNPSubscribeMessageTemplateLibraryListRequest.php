 ...
 * @method integer getQueryType() Obtain <p>Subscription message template type. Valid values: 2: One-time message; 3: Long-term subscription message.</p>
 * @method void setQueryType(integer $QueryType) Set <p>Subscription message template type. Valid values: 2: One-time message; 3: Long-term subscription message.</p>
 * @method integer getOffset() Obtain <p>Pagination offset.</p>
 * @method void setOffset(integer $Offset) Set <p>Pagination offset.</p>
 * @method string getQueryStr() Obtain <p>Search keyword.</p>
 * @method void setQueryStr(string $QueryStr) Set <p>Search keyword.</p>
 */
class DescribeMNPSubscribeMessageTemplateLibraryListRequest extends AbstractModel
{
     ...
     * @param integer $QueryType <p>Subscription message template type. Valid values: 2: One-time message; 3: Long-term subscription message.</p>
     * @param integer $Offset <p>Pagination offset.</p>
     * @param string $QueryStr <p>Search keyword.</p>
     */
