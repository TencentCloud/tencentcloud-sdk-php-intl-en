 ...
 * @method string getKeyword() Obtain Search keyword (role name).
 * @method void setKeyword(string $Keyword) Set Search keyword (role name).
...
class DescribeRoleListRequest extends AbstractModel
{
    ...
    /**
     * @var string Search keyword (role name).
     */
    public $Keyword;
     ...
     * @param string $Keyword Search keyword (role name).
