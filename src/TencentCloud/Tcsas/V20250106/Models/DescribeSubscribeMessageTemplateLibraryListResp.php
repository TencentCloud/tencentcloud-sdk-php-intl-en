 ...
 * @method array getDataList() Obtain <p>Subscription message template library list.</p>
 * @method void setDataList(array $DataList) Set <p>Subscription message template library list.</p>
 */
class DescribeSubscribeMessageTemplateLibraryListResp extends AbstractModel
{
    ...
    /**
     * @var array <p>Subscription message template library list.</p>
     */
    public $DataList;

    /**
     * @param integer $TotalCount <p>Total count.</p>
     * @param array $DataList <p>Subscription message template library list.</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("DataList",$param) and $param["DataList"] !== null) {
            ...
            foreach ($param["DataList"] as $key => $value){
                $obj = new DescribeSubscribeMessageTemplateLibraryInfoResp();
