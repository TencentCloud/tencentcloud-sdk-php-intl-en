 ...
 *
 * @method string getARPPu() Obtain ARPPU. Calculated as: paying revenue / paying users * 100%.
 * @method void setARPPu(string $ARPPu) Set ARPPU. Calculated as: paying revenue / paying users * 100%.
 ...
 * @method string getNewPaidUseRatio() Obtain New paying user ratio. Calculated as: NewUserNum / OrderUserNum * 100%.
 * @method void setNewPaidUseRatio(string $NewPaidUseRatio) Set New paying user ratio. Calculated as: NewUserNum / OrderUserNum * 100%.
 ...
 * @method integer getUpdateTime() Obtain Last modified time (timestamp in seconds).
 * @method void setUpdateTime(integer $UpdateTime) Set Last modified time (timestamp in seconds).
 */
class MNGPaymentOverview extends AbstractModel
{
    /**
     * @var string ARPPU. Calculated as: paying revenue / paying users * 100%.
     */
    public $ARPPu;
    ...
    /**
     * @var string New paying user ratio. Calculated as: NewUserNum / OrderUserNum * 100%.
     */
    ...
    /**
     * @var integer Last modified time (timestamp in seconds).
     */
    public $UpdateTime;

    /**
     * @param string $ARPPu ARPPU. Calculated as: paying revenue / paying users * 100%.
     * @param string $DataTime Data time in YYYYMMDD format.
     * @param string $NewPaidUseRatio New paying user ratio. Calculated as: NewUserNum / OrderUserNum * 100%.
     ...
     * @param integer $UpdateTime Last modified time (timestamp in seconds).
     */
