 ...
 * @method MNPSubscribeMessageTemplateDetailResp getTemplateInfo() Obtain <p>Subscription message template information.</p>
 * @method void setTemplateInfo(MNPSubscribeMessageTemplateDetailResp $TemplateInfo) Set <p>Subscription message template information.</p>
 */
class DescribeMNPSubscribeMessageTemplateDetailResp extends AbstractModel
{
    ...
    /**
     * @var MNPSubscribeMessageTemplateDetailResp <p>Subscription message template information.</p>
     */
    public $TemplateInfo;
     ...
     * @param MNPSubscribeMessageTemplateDetailResp $TemplateInfo <p>Subscription message template information.</p>
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("TemplateInfo",$param) and $param["TemplateInfo"] !== null) {
            $this->TemplateInfo = new MNPSubscribeMessageTemplateDetailResp();
