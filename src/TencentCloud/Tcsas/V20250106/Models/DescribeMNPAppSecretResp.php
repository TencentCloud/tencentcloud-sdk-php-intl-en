 ...
 *
 * @method integer getSecretStatus() Obtain <p>Mini program secret key status. Valid values: 0: Not generated; 1: Active; 2: Frozen; 3: Reset.</p>
 * @method void setSecretStatus(integer $SecretStatus) Set <p>Mini program secret key status. Valid values: 0: Not generated; 1: Active; 2: Frozen; 3: Reset.</p>
...
{
    /**
     * @var integer <p>Mini program secret key status. Valid values: 0: Not generated; 1: Active; 2: Frozen; 3: Reset.</p>
     */
    public $SecretStatus;
    ...
    /**
     * @param integer $SecretStatus <p>Mini program secret key status. Valid values: 0: Not generated; 1: Active; 2: Frozen; 3: Reset.</p>
