 ...
 * @method string getScheme() Obtain Superapp scheme.
 * @method void setScheme(string $Scheme) Set Superapp scheme.
 */
class DescribeApplicationResp extends AbstractModel
{
     ...
     * @param string $Scheme Superapp scheme.
     */
