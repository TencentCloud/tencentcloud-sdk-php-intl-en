 ...
 * @method string getKeyword() Obtain <p>Subscription message template library keyword.</p>
 * @method void setKeyword(string $Keyword) Set <p>Subscription message template library keyword.</p>
 ...
 * @method array getKeywordList() Obtain <p>Subscription message template library keyword multilingual list.</p>
 * @method void setKeywordList(array $KeywordList) Set <p>Subscription message template library keyword multilingual list.</p>
 * @method array getDefaultValueList() Obtain <p>Subscription message template library keywords in multiple languages.</p>
 * @method void setDefaultValueList(array $DefaultValueList) Set <p>Subscription message template library keywords in multiple languages.</p>
 */
class DescribeMNGSubscribeMessageTemplateLibraryKeywordData extends AbstractModel
{
    ...
    /**
     * @var string <p>Subscription message template library keyword.</p>
     */
    public $Keyword;
    ...
    /**
     * @var array <p>Subscription message template library keyword multilingual list.</p>
     */
    public $KeywordList;

    /**
     * @var array <p>Subscription message template library keywords in multiple languages.</p>
     */
    public $DefaultValueList;

    /**
     * @param string $KeywordId <p>Subscription message template library keyword ID.</p>
     * @param string $Keyword <p>Subscription message template library keyword.</p>
     ...
     * @param array $KeywordList <p>Subscription message template library keyword multilingual list.</p>
     * @param array $DefaultValueList <p>Subscription message template library keywords in multiple languages.</p>
     */
