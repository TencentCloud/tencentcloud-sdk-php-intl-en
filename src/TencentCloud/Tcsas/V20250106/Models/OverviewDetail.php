 ...
 * @method string getMNPName() Obtain Name
 * @method void setMNPName(string $MNPName) Set Name
 * @method string getMNPType() Obtain Category
 * @method void setMNPType(string $MNPType) Set Category
...
class OverviewDetail extends AbstractModel
{
     ...
     * @param string $MNPName Name
     * @param string $MNPType Category
