 ...
 * @method array getTemplateTitleI18nList() Obtain <p>Template title in multiple languages.</p>
 * @method void setTemplateTitleI18nList(array $TemplateTitleI18nList) Set <p>Template title in multiple languages.</p>
 ...
 * @method array getKeywordI18nList() Obtain <p>Template keyword in multiple languages.</p>
 * @method void setKeywordI18nList(array $KeywordI18nList) Set <p>Template keyword in multiple languages.</p>
...
class DescribeMNPSubscribeMessageTemplateInfoResp extends AbstractModel
{
     ...
     * @param array $TemplateTitleI18nList <p>Template title in multiple languages.</p>
     ...
     * @param array $KeywordI18nList <p>Template keyword in multiple languages.</p>
