 ...
 * @method array getKeywords() Obtain <p>Subscription message template keyword.</p>
 * @method void setKeywords(array $Keywords) Set <p>Subscription message template keyword.</p>
...
class CreateMNPSubscribeMessageTemplateRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>Subscription message template keyword.</p>
     */
    public $Keywords;
     ...
     * @param array $Keywords <p>Subscription message template keyword.</p>
