 ...
 * @method array getDefaultValueList() Obtain <p>Subscription message template library keyword default value list.</p>
 * @method void setDefaultValueList(array $DefaultValueList) Set <p>Subscription message template library keyword default value list.</p>
 */
class DescribeMNGSubscribeMessageTemplateLibraryKeywordInfoResp extends AbstractModel
{
    ...
    /**
     * @var array <p>Subscription message template library keyword default value list.</p>
     */
     ...
     * @param array $DefaultValueList <p>Subscription message template library keyword default value list.</p>
     */
