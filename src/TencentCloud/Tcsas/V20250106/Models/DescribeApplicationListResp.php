 ...
 * @method array getDataList() Obtain Superapp list data.
 * @method void setDataList(array $DataList) Set Superapp list data.
 */
class DescribeApplicationListResp extends AbstractModel
{
    ...
    /**
     * @var array Superapp list data.
     */
    public $DataList;

    /**
     * @param integer $TotalCount Total number of entries.
     * @param array $DataList Superapp list data.
     */
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("DataList",$param) and $param["DataList"] !== null) {
            ...
            foreach ($param["DataList"] as $key => $value){
                $obj = new DescribeApplicationListData();
