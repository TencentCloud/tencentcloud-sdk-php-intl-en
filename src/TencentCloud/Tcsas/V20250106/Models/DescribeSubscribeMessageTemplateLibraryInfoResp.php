 ...
 * @method string getKeywords() Obtain <p>Keywords.</p>
 * @method void setKeywords(string $Keywords) Set <p>Keywords.</p>
 * @method array getKeywordI18nList() Obtain <p>Subscription message keyword in multiple languages.</p>
 * @method void setKeywordI18nList(array $KeywordI18nList) Set <p>Subscription message keyword in multiple languages.</p>
...
class DescribeSubscribeMessageTemplateLibraryInfoResp extends AbstractModel
{
    ...
    /**
     * @var string <p>Keywords.</p>
     */
    public $Keywords;

    /**
     * @var array <p>Subscription message keyword in multiple languages.</p>
     */
     ...
     * @param string $Keywords <p>Keywords.</p>
     * @param array $KeywordI18nList <p>Subscription message keyword in multiple languages.</p>
