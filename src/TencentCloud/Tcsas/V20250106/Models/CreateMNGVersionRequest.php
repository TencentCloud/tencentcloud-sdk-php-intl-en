 ...
 * @method string getFileUrl() Obtain <p>URL of the mini game file exported from the IDE and uploaded to the file server.<p>
 * @method void setFileUrl(string $FileUrl) Set <p>URL of the mini game file exported from the IDE and uploaded to the file server.<p>
 ...
 * @method integer getVersionType() Obtain <p>Version type. Valid values: 1: Debug version; 2: Development version.</p> Default value: 2.</p>
 * @method void setVersionType(integer $VersionType) Set <p>Version type. Valid values: 1: Debug version; 2: Development version.</p> Default value: 2.</p>
...
class CreateMNGVersionRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>URL of the mini game file exported from the IDE and uploaded to the file server.<p>
     */
    public $FileUrl;
    ...
    /**
     * @var integer <p>Version type. Valid values: 1: Debug version; 2: Development version.</p> Default value: 2.</p>
     */
    public $VersionType;
     ...
     * @param string $FileUrl <p>URL of the mini game file exported from the IDE and uploaded to the file server.<p>
     * @param string $PlatformId <p>Platform ID.</p>
     * @param string $MNPVersionIntro <p>Version description.</p>
     * @param integer $VersionType <p>Version type. Valid values: 1: Debug version; 2: Development version.</p> Default value: 2.</p>
