 ...
 * @method Models\DescribeApplicationMNPListResponse DescribeApplicationMNPList(Models\DescribeApplicationMNPListRequest $req) This API is used to retrieve a list of the mini programs or mini games associated with a superapp.
 ...
 * @method Models\DescribeMNGCategoryResponse DescribeMNGCategory(Models\DescribeMNGCategoryRequest $req) This API is used to query the list of mini game types.
 ...
 * @method Models\DescribeMNGPreviewResponse DescribeMNGPreview(Models\DescribeMNGPreviewRequest $req) This API is used to query the mini game preview details.
 * @method Models\DescribeMNGReleasedVersionHistoryResponse DescribeMNGReleasedVersionHistory(Models\DescribeMNGReleasedVersionHistoryRequest $req) This API is used to query the released mini game versions.
 ...
 * @method Models\DescribeMNGSensitiveAPIPermissionApprovalResponse DescribeMNGSensitiveAPIPermissionApproval(Models\DescribeMNGSensitiveAPIPermissionApprovalRequest $req) This API is used to query the details of a sensitive API permission request for a mini game.
 * @method Models\DescribeMNGSensitiveAPIPermissionListResponse DescribeMNGSensitiveAPIPermissionList(Models\DescribeMNGSensitiveAPIPermissionListRequest $req) This API is used to query the list of sensitive APIs that available to the mini game.
 * @method Models\DescribeMNGVersionResponse DescribeMNGVersion(Models\DescribeMNGVersionRequest $req) This API is used to query the creation result of a mini game version.
 ...
 * @method Models\DescribeMNPAllStageVersionsResponse DescribeMNPAllStageVersions(Models\DescribeMNPAllStageVersionsRequest $req) This API is used to query the mini program version information.
 ...
 * @method Models\DescribeMNPMAULineChartResponse DescribeMNPMAULineChart(Models\DescribeMNPMAULineChartRequest $req) This API is used to retrieve the mini program monthly active user data in a line chart format.
