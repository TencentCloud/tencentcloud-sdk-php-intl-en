 ...
 * @method Models\DeleteApplicationResponse DeleteApplication(Models\DeleteApplicationRequest $req) This API is used to delete a superapp.
 ...
 * @method Models\DescribeApplicationConfigInfosResponse DescribeApplicationConfigInfos(Models\DescribeApplicationConfigInfosRequest $req) This API is used to query the superapp configuration information.
 * @method Models\DescribeApplicationListResponse DescribeApplicationList(Models\DescribeApplicationListRequest $req) This API is used to query a list of superapps.
 * @method Models\DescribeApplicationMNPListResponse DescribeApplicationMNPList(Models\DescribeApplicationMNPListRequest $req) This API is used to query the mini program or mini game list associated with a superapp.
 * @method Models\DescribeApplicationSensitiveAPIListResponse DescribeApplicationSensitiveAPIList(Models\DescribeApplicationSensitiveAPIListRequest $req) This API is used to query a list of superapp sensitive APIs.
 ...
 * @method Models\DescribeGlobalOverviewDataSummaryResponse DescribeGlobalOverviewDataSummary(Models\DescribeGlobalOverviewDataSummaryRequest $req) This API is used to query the data summary for the global overview.
 ...
 * @method Models\DescribeMNGReleasedVersionHistoryResponse DescribeMNGReleasedVersionHistory(Models\DescribeMNGReleasedVersionHistoryRequest $req) This API is used to query the release version history of a mini game.
