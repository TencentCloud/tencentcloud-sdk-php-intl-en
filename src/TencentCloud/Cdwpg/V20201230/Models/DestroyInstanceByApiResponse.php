 ...
 *
 * @method string getFlowId() Obtain Destroy  process ID.
 * @method void setFlowId(string $FlowId) Set Destroy  process ID.
...
class DestroyInstanceByApiResponse extends AbstractModel
{
    ...
    /**
     * @param string $FlowId Destroy  process ID.
