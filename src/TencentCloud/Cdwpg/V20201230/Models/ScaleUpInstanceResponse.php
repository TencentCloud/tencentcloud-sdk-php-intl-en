 ...
 * @method string getErrorMsg() Obtain Specific error.
 * @method void setErrorMsg(string $ErrorMsg) Set Specific error.
...
class ScaleUpInstanceResponse extends AbstractModel
{
     ...
     * @param string $ErrorMsg Specific error.
