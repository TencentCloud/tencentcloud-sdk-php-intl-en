 ...
 *
 * @method array getRegionList() Obtain CVM type region list
 * @method void setRegionList(array $RegionList) Set CVM type region list
...
{
    /**
     * @var array CVM type region list
     */
    public $RegionList;
    ...
    /**
     * @param array $RegionList CVM type region list
