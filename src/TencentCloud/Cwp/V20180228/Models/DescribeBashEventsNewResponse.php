 ...
 * @method array getList() Obtain High-risk command event list
 * @method void setList(array $List) Set High-risk command event list
...
class DescribeBashEventsNewResponse extends AbstractModel
{
    ...
    /**
     * @var array High-risk command event list
     */
    public $List;
     ...
     * @param array $List High-risk command event list
