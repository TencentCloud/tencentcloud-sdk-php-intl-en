 ...
 * @method integer getTodayCount() Obtain Number of new key-value pairs today
 * @method void setTodayCount(integer $TodayCount) Set Number of new key-value pairs today
 */
class VulOverview extends AbstractModel
{
     ...
     * @param integer $TodayCount Number of new key-value pairs today
     */
