 ...
 * @method boolean getStoppingAll() Obtain whether all tasks are being stopped (true: yes)
 * @method void setStoppingAll(boolean $StoppingAll) Set whether all tasks are being stopped (true: yes)
 ...
 * @method array getPatchInfo() Obtain Scan info when scanning kb separately
 * @method void setPatchInfo(array $PatchInfo) Set Scan info when scanning kb separately
...
class DescribeScanTaskDetailsResponse extends AbstractModel
{
    ...
    /**
     * @var boolean whether all tasks are being stopped (true: yes)
     */
    public $StoppingAll;
    ...
    /**
     * @var array Scan info when scanning kb separately
     */
    public $PatchInfo;
     ...
     * @param boolean $StoppingAll whether all tasks are being stopped (true: yes)
     * @param integer $VulCount Number of vulnerabilities scanned
     * @param array $PatchInfo Scan info when scanning kb separately
