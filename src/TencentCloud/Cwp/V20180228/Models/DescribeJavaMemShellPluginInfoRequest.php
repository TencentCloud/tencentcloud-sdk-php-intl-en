 ...
 * @method array getFilters() Obtain Filter Criteria: Exact match of Pid, fuzzy match of MainClass
 * @method void setFilters(array $Filters) Set Filter Criteria: Exact match of Pid, fuzzy match of MainClass
...
class DescribeJavaMemShellPluginInfoRequest extends AbstractModel
{
    ...
    /**
     * @var array Filter Criteria: Exact match of Pid, fuzzy match of MainClass
     */
    public $Filters;
     ...
     * @param array $Filters Filter Criteria: Exact match of Pid, fuzzy match of MainClass
