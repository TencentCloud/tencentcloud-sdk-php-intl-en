 ...
 * @method integer getGeneralVersionNum() Obtain Number of lightweight editions
 * @method void setGeneralVersionNum(integer $GeneralVersionNum) Set Number of lightweight editions
...
class DescribeVersionStatisticsResponse extends AbstractModel
{
    ...
    /**
     * @var integer Number of lightweight editions
     */
     ...
     * @param integer $GeneralVersionNum Number of lightweight editions
