 ...
 * @method boolean getShowRuleRemark() Obtain Whether to display the description column: true-yes, false-no
 * @method void setShowRuleRemark(boolean $ShowRuleRemark) Set Whether to display the description column: true-yes, false-no
...
class DescribeBaselineRuleResponse extends AbstractModel
{
    ...
    /**
     * @var boolean Whether to display the description column: true-yes, false-no
     */
     ...
     * @param boolean $ShowRuleRemark Whether to display the description column: true-yes, false-no
