 ...
 *
 * @method array getFilters() Obtain <li>HostId - string - required: no - host ID</li>
 ...
 * @method void setFilters(array $Filters) Set <li>HostId - string - required: no - host ID</li>
<li>RuleId - int64 - required: no - rule ID</li>
<li>PolicyId - int64 - required: no - policy ID</li>
<li>ItemName - string - required: no - item name</li>
<li>DetectStatus - int - required: no - detection status</li>
 ...
 * @method string getBy() Obtain Sorting column: [HostCount|FirstTime|LastTime]
 * @method void setBy(string $By) Set Sorting column: [HostCount|FirstTime|LastTime]
 */
class DescribeBaselineItemDetectListRequest extends AbstractModel
{
    /**
     * @var array <li>HostId - string - required: no - host ID</li>
<li>RuleId - int64 - required: no - rule ID</li>
<li>PolicyId - int64 - required: no - policy ID</li>
<li>ItemName - string - required: no - item name</li>
<li>DetectStatus - int - required: no - detection status</li>
...
<li>EndTime - string - required: no - end time</li>
    ...
    /**
     * @var string Sorting column: [HostCount|FirstTime|LastTime]
     */
    public $By;

    /**
     * @param array $Filters <li>HostId - string - required: no - host ID</li>
<li>RuleId - int64 - required: no - rule ID</li>
<li>PolicyId - int64 - required: no - policy ID</li>
<li>ItemName - string - required: no - item name</li>
<li>DetectStatus - int - required: no - detection status</li>
...
<li>EndTime - string - required: no - end time</li>
     ...
     * @param string $By Sorting column: [HostCount|FirstTime|LastTime]
     */
