 ...
 * @method string getLatestEndTime() Obtain Latest synchronization end time
 * @method void setLatestEndTime(string $LatestEndTime) Set Latest synchronization end time
...
class SyncMachinesResponse extends AbstractModel
{
    ...
    /**
     * @var string Latest synchronization end time
     */
     ...
     * @param string $LatestEndTime Latest synchronization end time
