 ...
 * @method string getBy() Obtain Optional sorting columns
 * @method void setBy(string $By) Set Optional sorting columns
 */
...
<li>EndTime - string - required: no - end time</li>
    ...
    /**
     * @var string Optional sorting columns
     */
    public $By;
...
<li>EndTime - string - required: no - end time</li>
     ...
     * @param string $By Optional sorting columns
     */
