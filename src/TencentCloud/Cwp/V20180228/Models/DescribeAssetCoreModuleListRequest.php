 ...
 * @method string getBy() Obtain Sorting method [Size|FirstTime|ProcessCount|ModuleCount]
 * @method void setBy(string $By) Set Sorting method [Size|FirstTime|ProcessCount|ModuleCount]
 */
...
<li>User - string - required: no - user</li>
    ...
    /**
     * @var string Sorting method [Size|FirstTime|ProcessCount|ModuleCount]
     */
    public $By;
...
<li>User - string - required: no - user</li>
     ...
     * @param string $By Sorting method [Size|FirstTime|ProcessCount|ModuleCount]
     */
