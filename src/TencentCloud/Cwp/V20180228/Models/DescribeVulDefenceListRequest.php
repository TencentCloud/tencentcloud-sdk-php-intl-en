 ...
 *
 * @method array getFilters() Obtain Filtering criteria: Level; Keywords
 * @method void setFilters(array $Filters) Set Filtering criteria: Level; Keywords
 ...
 * @method string getBy() Obtain Sorting column (strictly equal): PublishTime for release time
 * @method void setBy(string $By) Set Sorting column (strictly equal): PublishTime for release time
 */
class DescribeVulDefenceListRequest extends AbstractModel
{
    /**
     * @var array Filtering criteria: Level; Keywords
     */
    public $Filters;
    ...
    /**
     * @var string Sorting column (strictly equal): PublishTime for release time
     */
    public $By;

    /**
     * @param array $Filters Filtering criteria: Level; Keywords
     ...
     * @param string $By Sorting column (strictly equal): PublishTime for release time
     */
