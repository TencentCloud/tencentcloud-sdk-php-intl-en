 ...
 *
 * @method string getExpireDate() Obtain Token expiration time
 * @method void setExpireDate(string $ExpireDate) Set Token expiration time
 */
class DescribeAgentInstallationTokenRequest extends AbstractModel
{
    /**
     * @var string Token expiration time
     */
    public $ExpireDate;

    /**
     * @param string $ExpireDate Token expiration time
     */
