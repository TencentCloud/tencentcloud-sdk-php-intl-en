 ...
 * @method string getId() Obtain Kernel module ID
 * @method void setId(string $Id) Set Kernel module ID
 */
class DescribeAssetCoreModuleInfoRequest extends AbstractModel
{
     ...
     * @param string $Id Kernel module ID
     */
