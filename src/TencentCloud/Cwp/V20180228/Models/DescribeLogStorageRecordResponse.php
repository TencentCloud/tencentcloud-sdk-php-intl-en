 ...
 *
 * @method array getRecords() Obtain Storage record.
 * @method void setRecords(array $Records) Set Storage record.
...
class DescribeLogStorageRecordResponse extends AbstractModel
{
    ...
    /**
     * @param array $Records Storage record.
