 ...
 * @method integer getIsDisabled() Obtain Enabling status: [0: ON | 1: Off]
 * @method void setIsDisabled(integer $IsDisabled) Set Enabling status: [0: ON | 1: Off]
 */
class ModifyWebHookRuleStatusRequest extends AbstractModel
{
    ...
    /**
     * @var integer Enabling status: [0: ON | 1: Off]
     */
    public $IsDisabled;

    /**
     * @param integer $Id Rule ID
     * @param integer $IsDisabled Enabling status: [0: ON | 1: Off]
     */
