 ...
 *
 * @method array getFilters() Obtain <li>PolicyType - int - required: no - policy type</li>
 ...
 * @method void setFilters(array $Filters) Set <li>PolicyType - int - required: no - policy type</li>
<li>PolicyName - string - required: no - policy name</li>
<li>Domain - string - required: no - domain name (URL encoding and then Base64 encoding on the domain name)</li>
<li>PolicyAction - int - required: no - policy action</li>
<li>IsEnabled - int - required: no - whether the policy is enabled</li>
 ...
 * @method string getBy() Obtain Sorting column: [HostScope|UpdateTime]
 * @method void setBy(string $By) Set Sorting column: [HostScope|UpdateTime]
 */
class DescribeRiskDnsPolicyListRequest extends AbstractModel
{
    /**
     * @var array <li>PolicyType - int - required: no - policy type</li>
<li>PolicyName - string - required: no - policy name</li>
<li>Domain - string - required: no - domain name (URL encoding and then Base64 encoding on the domain name)</li>
<li>PolicyAction - int - required: no - policy action</li>
<li>IsEnabled - int - required: no - whether the policy is enabled</li>
    ...
    /**
     * @var string Sorting column: [HostScope|UpdateTime]
     */
    public $By;

    /**
     * @param array $Filters <li>PolicyType - int - required: no - policy type</li>
<li>PolicyName - string - required: no - policy name</li>
<li>Domain - string - required: no - domain name (URL encoding and then Base64 encoding on the domain name)</li>
<li>PolicyAction - int - required: no - policy action</li>
<li>IsEnabled - int - required: no - whether the policy is enabled</li>
     ...
     * @param string $By Sorting column: [HostScope|UpdateTime]
     */
