 ...
 *
 * @method array getFilters() Obtain Filter criteria: InstanceID, IP, MachineName host name fuzzy query, Type, Status for precise match, CreateBeginTime, CreateEndTime time period
 * @method void setFilters(array $Filters) Set Filter criteria: InstanceID, IP, MachineName host name fuzzy query, Type, Status for precise match, CreateBeginTime, CreateEndTime time period
...
{
    /**
     * @var array Filter criteria: InstanceID, IP, MachineName host name fuzzy query, Type, Status for precise match, CreateBeginTime, CreateEndTime time period
     */
    public $Filters;
    ...
    /**
     * @param array $Filters Filter criteria: InstanceID, IP, MachineName host name fuzzy query, Type, Status for precise match, CreateBeginTime, CreateEndTime time period
