 ...
 * @method string getBy() Obtain Sorting column: [UpdateTime].
 * @method void setBy(string $By) Set Sorting column: [UpdateTime].
 */
class DescribeShellPolicyListRequest extends AbstractModel
{
    ...
    /**
     * @var string Sorting column: [UpdateTime].
     */
    public $By;
     ...
     * @param string $By Sorting column: [UpdateTime].
     */
