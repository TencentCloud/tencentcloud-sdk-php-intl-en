 ...
 * @method array getList() Obtain Inspection report list
 * @method void setList(array $List) Set Inspection report list
...
class DescribeMonthInspectionReportResponse extends AbstractModel
{
    ...
    /**
     * @var array Inspection report list
     */
    public $List;
     ...
     * @param array $List Inspection report list
