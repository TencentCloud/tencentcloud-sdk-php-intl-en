 ...
 *
 * @method integer getSchedule() Obtain Progress
 * @method void setSchedule(integer $Schedule) Set Progress
 * @method array getList() Obtain Bound Task Details
 * @method void setList(array $List) Set Bound Task Details
...
class DescribeLicenseBindScheduleResponse extends AbstractModel
{
    ...
    /**
     * @param integer $Schedule Progress
     * @param array $List Bound Task Details
