 ...
 * @method array getList() Obtain Authorization quantity list information
 * @method void setList(array $List) Set Authorization quantity list information
...
class DescribeLicenseListResponse extends AbstractModel
{
    ...
    /**
     * @var array Authorization quantity list information
     */
    public $List;
     ...
     * @param array $List Authorization quantity list information
