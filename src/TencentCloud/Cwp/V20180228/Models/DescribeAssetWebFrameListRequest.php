 ...
 * @method string getBy() Obtain Sorting method: [FirstTime|JarCount]
 * @method void setBy(string $By) Set Sorting method: [FirstTime|JarCount]
 */
...
<li>Os -String required: no - operating system (value of DescribeMachineOsList)</li>
    ...
    /**
     * @var string Sorting method: [FirstTime|JarCount]
     */
    public $By;
...
<li>Os -String required: no - operating system (value of DescribeMachineOsList)</li>
     ...
     * @param string $By Sorting method: [FirstTime|JarCount]
     */
