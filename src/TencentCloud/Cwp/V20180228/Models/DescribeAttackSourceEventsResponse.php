 ...
 * @method array getList() Obtain Attack tracing event list
 * @method void setList(array $List) Set Attack tracing event list
...
class DescribeAttackSourceEventsResponse extends AbstractModel
{
    ...
    /**
     * @var array Attack tracing event list
     */
    public $List;
     ...
     * @param array $List Attack tracing event list
