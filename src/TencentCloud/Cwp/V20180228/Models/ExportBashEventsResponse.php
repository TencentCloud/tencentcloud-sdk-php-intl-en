 ...
 *
 * @method string getDownloadUrl() Obtain Export file download link
 * @method void setDownloadUrl(string $DownloadUrl) Set Export file download link
...
{
    /**
     * @var string Export file download link
     */
    public $DownloadUrl;
    ...
    /**
     * @param string $DownloadUrl Export file download link
