 ...
 * @method array getList() Obtain Security manager data
 * @method void setList(array $List) Set Security manager data
...
class DescribeExpertServiceListResponse extends AbstractModel
{
    ...
    /**
     * @var array Security manager data
     */
    public $List;
     ...
     * @param array $List Security manager data
