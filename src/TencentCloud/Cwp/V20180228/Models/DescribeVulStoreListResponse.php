 ...
 * @method void setRemaining(integer $Remaining) Set Remaining Searches for Today
 * @method integer getFreeSearchTimes() Obtain Free Search Count
 * @method void setFreeSearchTimes(integer $FreeSearchTimes) Set Free Search Count
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var integer Remaining Searches for Today
     */
    public $Remaining;

    /**
     * @var integer Free Search Count
     */
