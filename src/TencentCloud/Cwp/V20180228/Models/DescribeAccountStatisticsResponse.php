 ...
 *
 * @method integer getTotalCount() Obtain Total number of account statistics list records
 * @method void setTotalCount(integer $TotalCount) Set Total number of account statistics list records
...
{
    /**
     * @var integer Total number of account statistics list records
     */
    public $TotalCount;
    ...
    /**
     * @param integer $TotalCount Total number of account statistics list records
