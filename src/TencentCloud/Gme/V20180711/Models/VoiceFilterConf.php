...
/**
 * @method string getStatus() 获取Phrase filtering status. Valid values: open, close
 * @method void setStatus(string $Status) 设置Phrase filtering status. Valid values: open, close
 */
