 ...
 *
 * @method integer getBizId() Obtain App ID, automatically generated by the backend.
 * @method void setBizId(integer $BizId) Set App ID, automatically generated by the backend.
 * @method string getAppName() Obtain App name, the input of `AppName`.
 * @method void setAppName(string $AppName) Set App name, the input of `AppName`.
 ...
 * @method string getSecretKey() Obtain App key, used to initialize GME SDK.
 * @method void setSecretKey(string $SecretKey) Set App key, used to initialize GME SDK.
...
{
    /**
     * @var integer App ID, automatically generated by the backend.
     */
    public $BizId;

    /**
     * @var string App name, the input of `AppName`.
     */
    public $AppName;
    ...
    /**
     * @var string App key, used to initialize GME SDK.
     */
    public $SecretKey;
    ...
    /**
     * @param integer $BizId App ID, automatically generated by the backend.
     * @param string $AppName App name, the input of `AppName`.
     * @param integer $ProjectId Project ID, the input of `ProjectId`.
     * @param string $SecretKey App key, used to initialize GME SDK.
