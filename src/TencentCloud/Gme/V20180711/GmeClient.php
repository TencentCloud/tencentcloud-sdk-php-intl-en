 ...
 * @method Models\DescribeApplicationDataResponse DescribeApplicationData(Models\DescribeApplicationDataRequest $req) This API (DescribeApplicationData) is used to query usage data details within 90 days.
