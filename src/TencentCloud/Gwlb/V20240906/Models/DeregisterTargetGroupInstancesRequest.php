 ...
 * @method array getTargetGroupInstances() Obtain Information on server to be unbound.
 * @method void setTargetGroupInstances(array $TargetGroupInstances) Set Information on server to be unbound.
 */
class DeregisterTargetGroupInstancesRequest extends AbstractModel
{
    ...
    /**
     * @var array Information on server to be unbound.
     */
    public $TargetGroupInstances;

    /**
     * @param string $TargetGroupId Target group ID.
     * @param array $TargetGroupInstances Information on server to be unbound.
     */
