 ...
 * @method string getLoadBalancerName() Obtain GWLB instance name. It supports 1-60 characters, including letters, digits, Chinese characters, "-", "_", and ".". If left blank, it will be automatically generated by default.
 * @method void setLoadBalancerName(string $LoadBalancerName) Set GWLB instance name. It supports 1-60 characters, including letters, digits, Chinese characters, "-", "_", and ".". If left blank, it will be automatically generated by default.
...
class CreateGatewayLoadBalancerRequest extends AbstractModel
{
    ...
    /**
     * @var string GWLB instance name. It supports 1-60 characters, including letters, digits, Chinese characters, "-", "_", and ".". If left blank, it will be automatically generated by default.
     */
     ...
     * @param string $LoadBalancerName GWLB instance name. It supports 1-60 characters, including letters, digits, Chinese characters, "-", "_", and ".". If left blank, it will be automatically generated by default.
