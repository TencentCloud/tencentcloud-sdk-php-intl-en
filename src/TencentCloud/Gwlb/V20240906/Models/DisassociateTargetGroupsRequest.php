 ...
 *
 * @method array getAssociations() Obtain List of target groups to unbind.
 * @method void setAssociations(array $Associations) Set List of target groups to unbind.
 */
class DisassociateTargetGroupsRequest extends AbstractModel
{
    /**
     * @var array List of target groups to unbind.
     */
    public $Associations;

    /**
     * @param array $Associations List of target groups to unbind.
     */
