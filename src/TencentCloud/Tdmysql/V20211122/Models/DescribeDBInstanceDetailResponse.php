 ...
 * @method string getExpireAt() Obtain 
 * @method void setExpireAt(string $ExpireAt) Set 
 * @method string getIsolatedAt() Obtain 
 * @method void setIsolatedAt(string $IsolatedAt) Set 
 ...
 * @method integer getDiskUsage() Obtain 
 * @method void setDiskUsage(integer $DiskUsage) Set 
 ...
 * @method string getEncryptionKmsRegion() Obtain <p>Real use kms region for subsequent call to kms service</p>
 * @method void setEncryptionKmsRegion(string $EncryptionKmsRegion) Set <p>Real use kms region for subsequent call to kms service</p>
...
class DescribeDBInstanceDetailResponse extends AbstractModel
{
    ...
    /**
     * @var string <p>Real use kms region for subsequent call to kms service</p>
     */
     ...
     * @param string $EncryptionKmsRegion <p>Real use kms region for subsequent call to kms service</p>
