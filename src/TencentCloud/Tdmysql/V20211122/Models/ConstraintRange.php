 ...
 * @method string getMax() Obtain Specifies the maximum value when the constraint type is section.
 * @method void setMax(string $Max) Set Specifies the maximum value when the constraint type is section.
 */
class ConstraintRange extends AbstractModel
{
    ...
    /**
     * @var string Specifies the maximum value when the constraint type is section.
     */
    public $Max;

    /**
     * @param string $Min Minimum value when the constraint type is section.
     * @param string $Max Specifies the maximum value when the constraint type is section.
     */
