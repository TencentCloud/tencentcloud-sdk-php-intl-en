 ...
 *
 * @method array getGroups() Obtain Security group description.
 * @method void setGroups(array $Groups) Set Security group description.
...
{
    /**
     * @var array Security group description.
     */
    public $Groups;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @param array $Groups Security group description.
