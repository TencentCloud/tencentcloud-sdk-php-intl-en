 ...
 * @method string getCreateTime() Obtain CreationTime, time format: yyyy-mm-dd hh:mm:ss.
 * @method void setCreateTime(string $CreateTime) Set CreationTime, time format: yyyy-mm-dd hh:mm:ss.
...
class SecurityGroup extends AbstractModel
{
    ...
    /**
     * @var string CreationTime, time format: yyyy-mm-dd hh:mm:ss.
     */
    public $CreateTime;
     ...
     * @param string $CreateTime CreationTime, time format: yyyy-mm-dd hh:mm:ss.
