 ...
 * @method string getNewBackupName() Obtain <P>Backup notes.</p>
 * @method void setNewBackupName(string $NewBackupName) Set <P>Backup notes.</p>
 */
class ModifyDBSBackupSetCommentRequest extends AbstractModel
{
     ...
     * @param string $NewBackupName <P>Backup notes.</p>
     */
