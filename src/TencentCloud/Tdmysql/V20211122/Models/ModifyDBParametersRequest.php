 ...
 *
 * @method string getInstanceId() Obtain Instance ID, for example: tdsql3-ow728lmc.
 * @method void setInstanceId(string $InstanceId) Set Instance ID, for example: tdsql3-ow728lmc.
...
{
    /**
     * @var string Instance ID, for example: tdsql3-ow728lmc.
     */
    public $InstanceId;
    ...
    /**
     * @param string $InstanceId Instance ID, for example: tdsql3-ow728lmc.
