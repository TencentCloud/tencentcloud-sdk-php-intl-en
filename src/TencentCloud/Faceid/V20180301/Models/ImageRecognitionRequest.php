 ...
 * @method string getName() Obtain <p>Name. For Chinese, please use UTF-8 encode.</p>
 * @method void setName(string $Name) Set <p>Name. For Chinese, please use UTF-8 encode.</p>
 ...
 * @method Encryption getEncryption() Obtain <p>Sensitive data encryption information. Users with encryption requirements for incoming information (name, identity card number) can use this parameter. For details, please click the left-side link.</p>
 * @method void setEncryption(Encryption $Encryption) Set <p>Sensitive data encryption information. Users with encryption requirements for incoming information (name, identity card number) can use this parameter. For details, please click the left-side link.</p>
 */
class ImageRecognitionRequest extends AbstractModel
{
    ...
    /**
     * @var string <p>Name. For Chinese, please use UTF-8 encode.</p>
     */
    public $Name;
    ...
    /**
     * @var Encryption <p>Sensitive data encryption information. Users with encryption requirements for incoming information (name, identity card number) can use this parameter. For details, please click the left-side link.</p>
     */
    public $Encryption;

    /**
     * @param string $IdCard <p>Identity card number</p>
     * @param string $Name <p>Name. For Chinese, please use UTF-8 encode.</p>
     ...
     * @param Encryption $Encryption <p>Sensitive data encryption information. Users with encryption requirements for incoming information (name, identity card number) can use this parameter. For details, please click the left-side link.</p>
     */
