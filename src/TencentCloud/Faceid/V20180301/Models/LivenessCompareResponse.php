 ...
 * @method array getBestFrameList() Obtain Best screenshot list.
Returned only when multiple best screenshots are configured to be returned.
 * @method void setBestFrameList(array $BestFrameList) Set Best screenshot list.
Returned only when multiple best screenshots are configured to be returned.
...
class LivenessCompareResponse extends AbstractModel
{
    ...
    /**
     * @var array Best screenshot list.
Returned only when multiple best screenshots are configured to be returned.
     */
     ...
     * @param array $BestFrameList Best screenshot list.
Returned only when multiple best screenshots are configured to be returned.
