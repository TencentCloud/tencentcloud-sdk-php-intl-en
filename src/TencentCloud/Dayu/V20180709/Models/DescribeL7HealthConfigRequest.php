 ...
 * @method array getRuleIdList() Obtain Rule ID array. To export the health check configurations of all rules, leave this field empty or enter an empty array;
 * @method void setRuleIdList(array $RuleIdList) Set Rule ID array. To export the health check configurations of all rules, leave this field empty or enter an empty array;
 */
class DescribeL7HealthConfigRequest extends AbstractModel
{
    ...
    /**
     * @var array Rule ID array. To export the health check configurations of all rules, leave this field empty or enter an empty array;
     */
    public $RuleIdList;
     ...
     * @param array $RuleIdList Rule ID array. To export the health check configurations of all rules, leave this field empty or enter an empty array;
     */
