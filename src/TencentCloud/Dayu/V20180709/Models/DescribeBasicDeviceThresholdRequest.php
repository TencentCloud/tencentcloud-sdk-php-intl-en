 ...
 * @method integer getBasicCheckFlag() Obtain Validity check. Valid value: 1
 * @method void setBasicCheckFlag(integer $BasicCheckFlag) Set Validity check. Valid value: 1
...
class DescribeBasicDeviceThresholdRequest extends AbstractModel
{
    ...
    /**
     * @var integer Validity check. Valid value: 1
     */
     ...
     * @param integer $BasicCheckFlag Validity check. Valid value: 1
