 ...
 * @method L4RuleEntry getRule() Obtain Forwarding rule.
 * @method void setRule(L4RuleEntry $Rule) Set Forwarding rule.
 */
class ModifyNewL4RuleRequest extends AbstractModel
{
    ...
    /**
     * @var L4RuleEntry Forwarding rule.
     */
    public $Rule;
     ...
     * @param L4RuleEntry $Rule Forwarding rule.
     */
