 ...
 * @method string getCaseName() Obtain Policy scenario name string. Length limit: 64
 * @method void setCaseName(string $CaseName) Set Policy scenario name string. Length limit: 64
 ...
 * @method string getUdpSportEnd() Obtain UDP end port. Value range: (0, 65535). It must be greater than or equal to the UDP start port.
 * @method void setUdpSportEnd(string $UdpSportEnd) Set UDP end port. Value range: (0, 65535). It must be greater than or equal to the UDP start port.
 * @method string getHasAbroad() Obtain Whether there are customers outside China. Valid values: [no, yes]
 * @method void setHasAbroad(string $HasAbroad) Set Whether there are customers outside China. Valid values: [no, yes]
 ...
 * @method string getTcpFootprint() Obtain Fixed feature code of TCP payload. Max string length: 512
 * @method void setTcpFootprint(string $TcpFootprint) Set Fixed feature code of TCP payload. Max string length: 512
 * @method string getUdpFootprint() Obtain Fixed feature code of UDP payload. Max string length: 512
 * @method void setUdpFootprint(string $UdpFootprint) Set Fixed feature code of UDP payload. Max string length: 512
 * @method array getWebApiUrl() Obtain Web application API URL
 * @method void setWebApiUrl(array $WebApiUrl) Set Web application API URL
 * @method string getMinTcpPackageLen() Obtain Minimum length of TCP packet. Value range: (0, 1500)
 * @method void setMinTcpPackageLen(string $MinTcpPackageLen) Set Minimum length of TCP packet. Value range: (0, 1500)
 * @method string getMaxTcpPackageLen() Obtain Maximum length of TCP packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of TCP packet
 * @method void setMaxTcpPackageLen(string $MaxTcpPackageLen) Set Maximum length of TCP packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of TCP packet
 * @method string getMinUdpPackageLen() Obtain Minimum length of UDP packet. Value range: (0, 1500)
 * @method void setMinUdpPackageLen(string $MinUdpPackageLen) Set Minimum length of UDP packet. Value range: (0, 1500)
 * @method string getMaxUdpPackageLen() Obtain Maximum length of UDP packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of UDP packet
 * @method void setMaxUdpPackageLen(string $MaxUdpPackageLen) Set Maximum length of UDP packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of UDP packet
 * @method string getHasVPN() Obtain Whether there are applications using VPN. Valid values: [no, yes]
 * @method void setHasVPN(string $HasVPN) Set Whether there are applications using VPN. Valid values: [no, yes]
 * @method string getTcpPortList() Obtain TCP port list. You can enter a single port, or a port range. Format: 80,443,700-800,53,1000-3000.
 * @method void setTcpPortList(string $TcpPortList) Set TCP port list. You can enter a single port, or a port range. Format: 80,443,700-800,53,1000-3000.
 * @method string getUdpPortList() Obtain UDP port list. You can enter a single port, or a port range. Format: 80,443,700-800,53,1000-3000.
 * @method void setUdpPortList(string $UdpPortList) Set UDP port list. You can enter a single port, or a port range. Format: 80,443,700-800,53,1000-3000.
 */
class CreateDDoSPolicyCaseRequest extends AbstractModel
{
    ...
    /**
     * @var string Policy scenario name string. Length limit: 64
     */
    public $CaseName;
    ...
    /**
     * @var string UDP end port. Value range: (0, 65535). It must be greater than or equal to the UDP start port.
     */
    public $UdpSportEnd;

    /**
     * @var string Whether there are customers outside China. Valid values: [no, yes]
     */
    public $HasAbroad;
    ...
    /**
     * @var string Fixed feature code of TCP payload. Max string length: 512
     */
    public $TcpFootprint;

    /**
     * @var string Fixed feature code of UDP payload. Max string length: 512
     */
    public $UdpFootprint;

    /**
     * @var array Web application API URL
     */
    public $WebApiUrl;

    /**
     * @var string Minimum length of TCP packet. Value range: (0, 1500)
     */
    public $MinTcpPackageLen;

    /**
     * @var string Maximum length of TCP packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of TCP packet
     */
    public $MaxTcpPackageLen;

    /**
     * @var string Minimum length of UDP packet. Value range: (0, 1500)
     */
    public $MinUdpPackageLen;

    /**
     * @var string Maximum length of UDP packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of UDP packet
     */
    public $MaxUdpPackageLen;

    /**
     * @var string Whether there are applications using VPN. Valid values: [no, yes]
     */
    public $HasVPN;

    /**
     * @var string TCP port list. You can enter a single port, or a port range. Format: 80,443,700-800,53,1000-3000.
     */
    public $TcpPortList;

    /**
     * @var string UDP port list. You can enter a single port, or a port range. Format: 80,443,700-800,53,1000-3000.
     */
    public $UdpPortList;
     ...
     * @param string $CaseName Policy scenario name string. Length limit: 64
     ...
     * @param string $UdpSportEnd UDP end port. Value range: (0, 65535). It must be greater than or equal to the UDP start port.
     * @param string $HasAbroad Whether there are customers outside China. Valid values: [no, yes]
     ...
     * @param string $TcpFootprint Fixed feature code of TCP payload. Max string length: 512
     * @param string $UdpFootprint Fixed feature code of UDP payload. Max string length: 512
     * @param array $WebApiUrl Web application API URL
     * @param string $MinTcpPackageLen Minimum length of TCP packet. Value range: (0, 1500)
     * @param string $MaxTcpPackageLen Maximum length of TCP packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of TCP packet
     * @param string $MinUdpPackageLen Minimum length of UDP packet. Value range: (0, 1500)
     * @param string $MaxUdpPackageLen Maximum length of UDP packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of UDP packet
     * @param string $HasVPN Whether there are applications using VPN. Valid values: [no, yes]
     * @param string $TcpPortList TCP port list. You can enter a single port, or a port range. Format: 80,443,700-800,53,1000-3000.
     * @param string $UdpPortList UDP port list. You can enter a single port, or a port range. Format: 80,443,700-800,53,1000-3000.
     */
