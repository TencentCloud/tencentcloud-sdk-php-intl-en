 ...
 *
 * @method array getInsurePacks() Obtain Guarantee package list
 * @method void setInsurePacks(array $InsurePacks) Set Guarantee package list
...
{
    /**
     * @var array Guarantee package list
     */
    public $InsurePacks;
    ...
    /**
     * @param array $InsurePacks Guarantee package list
