 ...
 * @method string getDDoSLevel() Obtain Protection level. Valid values: [low,middle,high]
 * @method void setDDoSLevel(string $DDoSLevel) Set Protection level. Valid values: [low,middle,high]
...
class ModifyDDoSLevelResponse extends AbstractModel
{
    ...
    /**
     * @var string Protection level. Valid values: [low,middle,high]
     */
    public $DDoSLevel;
     ...
     * @param string $DDoSLevel Protection level. Valid values: [low,middle,high]
