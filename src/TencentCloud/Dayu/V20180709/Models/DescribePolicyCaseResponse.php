 ...
 *
 * @method array getCaseList() Obtain Policy scenario list
 * @method void setCaseList(array $CaseList) Set Policy scenario list
...
{
    /**
     * @var array Policy scenario list
     */
    public $CaseList;
    ...
    /**
     * @param array $CaseList Policy scenario list
