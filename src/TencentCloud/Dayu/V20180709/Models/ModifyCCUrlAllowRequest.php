 ...
 * @method void setUrlList(array $UrlList) Set URL array. URL format:
http://domain name/cgi
https://domain name/cgi
 ...
 * @method string getRuleId() Obtain HTTPS layer-7 forwarding rule ID (which is optional and can be obtained from the layer-7 forwarding rule API). This field is required only when adding a rule and `Protocol` is `https`;
If `Method` is `delete`, this field can be left empty;
 * @method void setRuleId(string $RuleId) Set HTTPS layer-7 forwarding rule ID (which is optional and can be obtained from the layer-7 forwarding rule API). This field is required only when adding a rule and `Protocol` is `https`;
If `Method` is `delete`, this field can be left empty;
 */
class ModifyCCUrlAllowRequest extends AbstractModel
{
    ...
    /**
     * @var array URL array. URL format:
http://domain name/cgi
https://domain name/cgi
     */
    public $UrlList;
    ...
    /**
     * @var string HTTPS layer-7 forwarding rule ID (which is optional and can be obtained from the layer-7 forwarding rule API). This field is required only when adding a rule and `Protocol` is `https`;
If `Method` is `delete`, this field can be left empty;
     */
    public $RuleId;
...
https://domain name/cgi
     ...
     * @param string $RuleId HTTPS layer-7 forwarding rule ID (which is optional and can be obtained from the layer-7 forwarding rule API). This field is required only when adding a rule and `Protocol` is `https`;
If `Method` is `delete`, this field can be left empty;
     */
