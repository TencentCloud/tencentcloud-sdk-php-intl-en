 ...
 *
 * @method integer getAlarmType() Obtain Alarm threshold type. 1: inbound traffic, 2: cleansed traffic
 * @method void setAlarmType(integer $AlarmType) Set Alarm threshold type. 1: inbound traffic, 2: cleansed traffic
...
{
    /**
     * @var integer Alarm threshold type. 1: inbound traffic, 2: cleansed traffic
     */
    public $AlarmType;
    ...
    /**
     * @param integer $AlarmType Alarm threshold type. 1: inbound traffic, 2: cleansed traffic
