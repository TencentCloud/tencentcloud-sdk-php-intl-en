 ...
 *
 * @method array getKeyList() Obtain Watermark key list
 * @method void setKeyList(array $KeyList) Set Watermark key list
...
class ModifyDDoSWaterKeyResponse extends AbstractModel
{
    ...
    /**
     * @param array $KeyList Watermark key list
