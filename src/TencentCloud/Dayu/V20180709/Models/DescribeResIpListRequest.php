 ...
 * @method array getIdList() Obtain Resource ID. If this field is left empty, it means to get all resources IP of the current user
 * @method void setIdList(array $IdList) Set Resource ID. If this field is left empty, it means to get all resources IP of the current user
 */
class DescribeResIpListRequest extends AbstractModel
{
    ...
    /**
     * @var array Resource ID. If this field is left empty, it means to get all resources IP of the current user
     */
    public $IdList;
     ...
     * @param array $IdList Resource ID. If this field is left empty, it means to get all resources IP of the current user
     */
