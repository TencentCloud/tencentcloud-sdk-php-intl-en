 ...
 * @method CCPolicy getPolicy() Obtain Details of the CC protection policy
 * @method void setPolicy(CCPolicy $Policy) Set Details of the CC protection policy
 */
class CreateCCSelfDefinePolicyRequest extends AbstractModel
{
    ...
    /**
     * @var CCPolicy Details of the CC protection policy
     */
    public $Policy;
     ...
     * @param CCPolicy $Policy Details of the CC protection policy
     */
