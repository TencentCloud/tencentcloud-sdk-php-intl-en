 ...
 * @method string getMethod() Obtain get (read AI protection status), set (modify AI protection status);
 * @method void setMethod(string $Method) Set get (read AI protection status), set (modify AI protection status);
 * @method string getDDoSAI() Obtain AI protection status, which is required if `Method` is `set`. Valid values: [on, off].
 * @method void setDDoSAI(string $DDoSAI) Set AI protection status, which is required if `Method` is `set`. Valid values: [on, off].
 */
class ModifyDDoSAIStatusRequest extends AbstractModel
{
    ...
    /**
     * @var string get (read AI protection status), set (modify AI protection status);
     */
    public $Method;

    /**
     * @var string AI protection status, which is required if `Method` is `set`. Valid values: [on, off].
     */
    public $DDoSAI;
     ...
     * @param string $Method get (read AI protection status), set (modify AI protection status);
     * @param string $DDoSAI AI protection status, which is required if `Method` is `set`. Valid values: [on, off].
     */
