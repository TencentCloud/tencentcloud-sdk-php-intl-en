 ...
 * @method string getName() Obtain Instance name. Length limit: 32 characters
 * @method void setName(string $Name) Set Instance name. Length limit: 32 characters
 */
class CreateInstanceNameRequest extends AbstractModel
{
    ...
    /**
     * @var string Instance name. Length limit: 32 characters
     */
    public $Name;
     ...
     * @param string $Name Instance name. Length limit: 32 characters
     */
