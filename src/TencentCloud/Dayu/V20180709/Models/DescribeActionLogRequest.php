 ...
 * @method string getFilter() Obtain Search value, which can only be resource ID or user `UIN`
 * @method void setFilter(string $Filter) Set Search value, which can only be resource ID or user `UIN`
...
class DescribeActionLogRequest extends AbstractModel
{
    ...
    /**
     * @var string Search value, which can only be resource ID or user `UIN`
     */
    public $Filter;
     ...
     * @param string $Filter Search value, which can only be resource ID or user `UIN`
