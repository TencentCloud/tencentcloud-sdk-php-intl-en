 ...
 * @method string getValueType() 获取Parameter type: Integer
 * @method void setValueType(string $ValueType) 设置Parameter type: Integer
 ...
 * @method string getMin() 获取Minimum value of a parameter
 * @method void setMin(string $Min) 设置Minimum value of a parameter
 * @method string getMax() 获取Maximum value of a parameter
 * @method void setMax(string $Max) 设置Maximum value of a parameter
