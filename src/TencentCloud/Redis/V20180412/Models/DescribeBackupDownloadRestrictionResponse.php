 ...
 * @method array getLimitIp() Obtain VPC ID of the custom backup file download address, which will be displayed if `LimitType` is `Customize`.
 * @method void setLimitIp(array $LimitIp) Set VPC ID of the custom backup file download address, which will be displayed if `LimitType` is `Customize`.
...
- `NotIn`: Download is not allowed for the custom IP.
     ...
     * @param array $LimitIp VPC ID of the custom backup file download address, which will be displayed if `LimitType` is `Customize`.
