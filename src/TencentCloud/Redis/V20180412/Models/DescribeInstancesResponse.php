...
/**
 * @method integer getTotalCount() 获取Number of instances
 * @method void setTotalCount(integer $TotalCount) 设置Number of instances
 * @method array getInstanceSet() 获取List of instance details
 * @method void setInstanceSet(array $InstanceSet) 设置List of instance details
