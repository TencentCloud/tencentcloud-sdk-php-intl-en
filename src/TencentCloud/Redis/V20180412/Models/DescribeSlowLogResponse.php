 ...
 * @method array getInstanceSlowlogDetail() Obtain Due to the naming irregularity of this parameter. It is recommended to use the parameter InstanceSlowLogDetail instead. Details of slow queries.
 * @method void setInstanceSlowlogDetail(array $InstanceSlowlogDetail) Set Due to the naming irregularity of this parameter. It is recommended to use the parameter InstanceSlowLogDetail instead. Details of slow queries.
...
class DescribeSlowLogResponse extends AbstractModel
{
    ...
    /**
     * @var array Due to the naming irregularity of this parameter. It is recommended to use the parameter InstanceSlowLogDetail instead. Details of slow queries.
     */
     ...
     * @param array $InstanceSlowlogDetail Due to the naming irregularity of this parameter. It is recommended to use the parameter InstanceSlowLogDetail instead. Details of slow queries.
