...
/**
 * @method integer getTotalCount() 获取Total number of slow logs
 * @method void setTotalCount(integer $TotalCount) 设置Total number of slow logs
 * @method array getInstanceSlowlogDetail() 获取Slow log details
 * @method void setInstanceSlowlogDetail(array $InstanceSlowlogDetail) 设置Slow log details
