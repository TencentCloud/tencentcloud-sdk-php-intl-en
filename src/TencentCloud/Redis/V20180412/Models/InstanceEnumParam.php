 ...
 * @method string getValueType() 获取Parameter type: Enum
 * @method void setValueType(string $ValueType) 设置Parameter type: Enum
 ...
 * @method array getEnumValue() 获取Value range of a parameter
 * @method void setEnumValue(array $EnumValue) 设置Value range of a parameter
...
class InstanceEnumParam extends AbstractModel
{
     ...
     * @param array $EnumValue Value range of a parameter
