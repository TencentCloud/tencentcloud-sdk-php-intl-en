 ...
 * @method array getTendisSlowLogDetail() Obtain Slow query details
 * @method void setTendisSlowLogDetail(array $TendisSlowLogDetail) Set Slow query details
...
class DescribeTendisSlowLogResponse extends AbstractModel
{
     ...
     * @param array $TendisSlowLogDetail Slow query details
