 ...
 * @method Models\DescribeSmsSignListResponse DescribeSmsSignList(Models\DescribeSmsSignListRequest $req) This API is used to query the status of SMS signatures.
 ...
 * @method Models\SendMultiGlobalSmsResponse SendMultiGlobalSms(Models\SendMultiGlobalSmsRequest $req) This API is used to send Global SMS messages in batches. Compared with the SendSms API, it supports sending SMS messages with different content to multiple phone numbers in a single request and allows specifying different SenderIds.
