 ...
 * @method integer getStatusCode() Obtain Signature application status. Valid values: 0: approved; 1: under review.
-1: application rejected or failed.
 * @method void setStatusCode(integer $StatusCode) Set Signature application status. Valid values: 0: approved; 1: under review.
-1: application rejected or failed.
...
class DescribeSignListStatus extends AbstractModel
{
    ...
    /**
     * @var integer Signature application status. Valid values: 0: approved; 1: under review.
-1: application rejected or failed.
     */
    public $StatusCode;
     ...
     * @param integer $StatusCode Signature application status. Valid values: 0: approved; 1: under review.
-1: application rejected or failed.
