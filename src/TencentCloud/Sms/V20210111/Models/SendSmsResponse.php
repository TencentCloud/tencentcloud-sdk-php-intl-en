 ...
 *
 * @method array getSendStatusSet() Obtain SMS send status.
 * @method void setSendStatusSet(array $SendStatusSet) Set SMS send status.
...
class SendSmsResponse extends AbstractModel
{
    ...
    /**
     * @param array $SendStatusSet SMS send status.
