...
Note: this field may return null, indicating that no valid value was found.
 * @method string getInternetServiceProvider() Obtain Describes the line type. For details, refer to [EIP Product Overview](https://intl.cloud.tencent.com/document/product/1199/41646?from_cn_redirect=1). default value: `BGP`.
 ...
 * @method void setInternetServiceProvider(string $InternetServiceProvider) Set Describes the line type. For details, refer to [EIP Product Overview](https://intl.cloud.tencent.com/document/product/1199/41646?from_cn_redirect=1). default value: `BGP`.
 ...
 * @method boolean getIsKeepEIP() Obtain Whether to delete the bound EIP when the instance is destroyed.
 ...
 * @method void setIsKeepEIP(boolean $IsKeepEIP) Set Whether to delete the bound EIP when the instance is destroyed.
...
Note: this field may return null, indicating that no valid value was found.
    ...
    /**
     * @var string Describes the line type. For details, refer to [EIP Product Overview](https://intl.cloud.tencent.com/document/product/1199/41646?from_cn_redirect=1). default value: `BGP`.
...
<li> WanIP: Ordinary public IP address. </li> <li> HighQualityEIP: High Quality EIP is supported only in Singapore and Hong Kong. </li> <li> AntiDDoSEIP: Anti-DDoS IP is supported only in specific regions. For details, see [EIP Product Overview](https://cloud.tencent.com/document/product/1199/41646). </li> Specify the type of public IPv4 address to assign a public IPv4 address to the resource. Premium IP and Anti-DDoS IP features are gradually released in select regions. For usage, [submit a ticket for consultation](https://console.cloud.tencent.com/workorder/category).
    ...
    /**
     * @var boolean Whether to delete the bound EIP when the instance is destroyed.
...
Note: this field may return null, indicating that no valid value was found.
     * @param string $InternetServiceProvider Describes the line type. For details, refer to [EIP Product Overview](https://intl.cloud.tencent.com/document/product/1199/41646?from_cn_redirect=1). default value: `BGP`.
...
<li> WanIP: Ordinary public IP address. </li> <li> HighQualityEIP: High Quality EIP is supported only in Singapore and Hong Kong. </li> <li> AntiDDoSEIP: Anti-DDoS IP is supported only in specific regions. For details, see [EIP Product Overview](https://cloud.tencent.com/document/product/1199/41646). </li> Specify the type of public IPv4 address to assign a public IPv4 address to the resource. Premium IP and Anti-DDoS IP features are gradually released in select regions. For usage, [submit a ticket for consultation](https://console.cloud.tencent.com/workorder/category).
     ...
     * @param boolean $IsKeepEIP Whether to delete the bound EIP when the instance is destroyed.
