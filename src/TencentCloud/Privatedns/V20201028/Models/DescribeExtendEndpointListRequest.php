 ...
 * @method array getFilters() Obtain Filter parameters. Valid values: EndpointName, EndpointId.
 * @method void setFilters(array $Filters) Set Filter parameters. Valid values: EndpointName, EndpointId.
 */
class DescribeExtendEndpointListRequest extends AbstractModel
{
    ...
    /**
     * @var array Filter parameters. Valid values: EndpointName, EndpointId.
     */
    public $Filters;
     ...
     * @param array $Filters Filter parameters. Valid values: EndpointName, EndpointId.
     */
