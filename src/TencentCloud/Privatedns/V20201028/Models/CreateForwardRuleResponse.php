 ...
 * @method string getRuleType() Obtain Forwarding rule type.
 * @method void setRuleType(string $RuleType) Set Forwarding rule type.
...
class CreateForwardRuleResponse extends AbstractModel
{
    ...
    /**
     * @var string Forwarding rule type.
     */
    public $RuleType;
     ...
     * @param string $RuleType Forwarding rule type.
