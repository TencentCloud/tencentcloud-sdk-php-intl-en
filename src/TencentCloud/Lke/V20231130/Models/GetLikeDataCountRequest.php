 ...
 * @method integer getType() Obtain Message source (1. shared from user end, 2. chat api).
 * @method void setType(integer $Type) Set Message source (1. shared from user end, 2. chat api).
...
class GetLikeDataCountRequest extends AbstractModel
{
    ...
    /**
     * @var integer Message source (1. shared from user end, 2. chat api).
     */
    public $Type;
     ...
     * @param integer $Type Message source (1. shared from user end, 2. chat api).
