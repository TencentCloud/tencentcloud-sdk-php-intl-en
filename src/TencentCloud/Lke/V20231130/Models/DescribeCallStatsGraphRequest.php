 ...
 * @method string getLoginSubAccountUin() Obtain Log in to user's root sub-account (required in integrator mode).
 * @method void setLoginSubAccountUin(string $LoginSubAccountUin) Set Log in to user's root sub-account (required in integrator mode).
...
class DescribeCallStatsGraphRequest extends AbstractModel
{
    ...
    /**
     * @var string Log in to user's root sub-account (required in integrator mode).
     */
    ...
    /**
     * @var array Filter sub-scenarios (used in document parsing scenarios).
     */
    public $SubScenes;
