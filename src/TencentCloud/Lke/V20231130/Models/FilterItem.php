 ...
 * 
 *
 * @method string getFilterKey() Obtain 
 * @method void setFilterKey(string $FilterKey) Set 
 * @method array getFilterValue() Obtain 
 * @method void setFilterValue(array $FilterValue) Set 
 */
