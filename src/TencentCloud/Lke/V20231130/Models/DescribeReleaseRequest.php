 ...
 * @method string getReleaseBizId() Obtain Release details.
 * @method void setReleaseBizId(string $ReleaseBizId) Set Release details.
 */
class DescribeReleaseRequest extends AbstractModel
{
    ...
    /**
     * @var string Release details.
     */
    public $ReleaseBizId;

    /**
     * @param string $BotBizId Application ID.
     * @param string $ReleaseBizId Release details.
     */
