 ...
 * @method array getActions() Obtain Status (1: newly-added; 2: modified; 3: deleted).
 * @method void setActions(array $Actions) Set Status (1: newly-added; 2: modified; 3: deleted).
 * @method array getReleaseStatus() Obtain Release status (4: release successful; 5: release failed).
 * @method void setReleaseStatus(array $ReleaseStatus) Set Release status (4: release successful; 5: release failed).
 */
class ListReleaseQAPreviewRequest extends AbstractModel
{
    ...
    /**
     * @var array Status (1: newly-added; 2: modified; 3: deleted).
     */
    public $Actions;

    /**
     * @var array Release status (4: release successful; 5: release failed).
     */
     ...
     * @param array $Actions Status (1: newly-added; 2: modified; 3: deleted).
     * @param array $ReleaseStatus Release status (4: release successful; 5: release failed).
     */
