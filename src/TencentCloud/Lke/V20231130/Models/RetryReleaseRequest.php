 ...
 * @method string getReleaseBizId() Obtain Release business id.
 * @method void setReleaseBizId(string $ReleaseBizId) Set Release business id.
 */
class RetryReleaseRequest extends AbstractModel
{
    ...
    /**
     * @var string Release business id.
     */
    public $ReleaseBizId;

    /**
     * @param string $BotBizId Robot ID.
     * @param string $ReleaseBizId Release business id.
     */
