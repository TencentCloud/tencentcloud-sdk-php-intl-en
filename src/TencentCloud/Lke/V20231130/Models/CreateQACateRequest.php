 ...
 * @method string getParentBizId() Obtain Parent business id. pass the string "0" when creating a top-level category.
 * @method void setParentBizId(string $ParentBizId) Set Parent business id. pass the string "0" when creating a top-level category.
...
class CreateQACateRequest extends AbstractModel
{
    ...
    /**
     * @var string Parent business id. pass the string "0" when creating a top-level category.
     */
    public $ParentBizId;
     ...
     * @param string $ParentBizId Parent business id. pass the string "0" when creating a top-level category.
