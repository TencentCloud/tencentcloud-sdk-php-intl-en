 ...
 * @method boolean getIsDownload() Obtain Downloadable or not. This parameter is only valid when `IsRefer` is **true** and `ReferUrlType` is 0.
 * @method void setIsDownload(boolean $IsDownload) Set Downloadable or not. This parameter is only valid when `IsRefer` is **true** and `ReferUrlType` is 0.
 * @method array getDuplicateFileHandles() Obtain Duplicate document processing method; match the first eligible method in sequence for processing.
 * @method void setDuplicateFileHandles(array $DuplicateFileHandles) Set Duplicate document processing method; match the first eligible method in sequence for processing.
 * @method string getSplitRule() Obtain # Custom Splitting Rules
 ...
 * @method void setSplitRule(string $SplitRule) Set # Custom Splitting Rules
The request parameter is a **JSON Object**. Refer to the API sample value for the specific format. It contains the following core fields:
...
|------------|------|-------------|
| `table_style` | String | Specifies the output format of table content. Available values:<br> `"html"`: Return as HTML table, suitable for web page display.<br> `"md"`: Return as Markdown table syntax, suitable for documents and Markdown rendering environments. |
 * @method UpdatePeriodInfo getUpdatePeriodInfo() Obtain Document update frequency. Default value 0 means no update.
 * @method void setUpdatePeriodInfo(UpdatePeriodInfo $UpdatePeriodInfo) Set Document update frequency. Default value 0 means no update.
 * @method integer getEnableScope() Obtain Document Effective Scope:
1 - Not effective;
 ...
 * @method void setEnableScope(integer $EnableScope) Set Document Effective Scope:
1 - Not effective;
2 - Effective only in development scope;
3 - Effective only in release scope;
4 - Effective in both development and release scopes.
...
When the value is 1, the weburl field cannot be empty; otherwise, it will not take effect.
    ...
    /**
     * @var boolean Downloadable or not. This parameter is only valid when `IsRefer` is **true** and `ReferUrlType` is 0.
     */
    public $IsDownload;

    /**
     * @var array Duplicate document processing method; match the first eligible method in sequence for processing.
     */
    public $DuplicateFileHandles;

    /**
     * @var string # Custom Splitting Rules
The request parameter is a **JSON Object**. Refer to the API sample value for the specific format. It contains the following core fields:
...
| `table_style` | String | Specifies the output format of table content. Available values:<br> `"html"`: Return as HTML table, suitable for web page display.<br> `"md"`: Return as Markdown table syntax, suitable for documents and Markdown rendering environments. |
    ...
    /**
     * @var UpdatePeriodInfo Document update frequency. Default value 0 means no update.
     */
    public $UpdatePeriodInfo;

    /**
     * @var integer Document Effective Scope:
1 - Not effective;
2 - Effective only in development scope;
3 - Effective only in release scope;
4 - Effective in both development and release scopes.
...
When the value is 1, the weburl field cannot be empty; otherwise, it will not take effect.
     ...
     * @param boolean $IsDownload Downloadable or not. This parameter is only valid when `IsRefer` is **true** and `ReferUrlType` is 0.
     * @param array $DuplicateFileHandles Duplicate document processing method; match the first eligible method in sequence for processing.
     * @param string $SplitRule # Custom Splitting Rules
The request parameter is a **JSON Object**. Refer to the API sample value for the specific format. It contains the following core fields:
...
|------------|------|-------------|
| `table_style` | String | Specifies the output format of table content. Available values:<br> `"html"`: Return as HTML table, suitable for web page display.<br> `"md"`: Return as Markdown table syntax, suitable for documents and Markdown rendering environments. |
     * @param UpdatePeriodInfo $UpdatePeriodInfo Document update frequency. Default value 0 means no update.
     * @param integer $EnableScope Document Effective Scope:
1 - Not effective;
2 - Effective only in development scope;
3 - Effective only in release scope;
4 - Effective in both development and release scopes.
