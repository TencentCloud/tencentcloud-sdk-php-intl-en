 ...
 *
 * @method array getAppBizIds() Obtain Application id array.
 * @method void setAppBizIds(array $AppBizIds) Set Application id array.
 */
class DescribeKnowledgeUsagePieGraphRequest extends AbstractModel
{
    /**
     * @var array Application id array.
     */
    public $AppBizIds;

    /**
     * @param array $AppBizIds Application id array.
     */
