 ...
 *
 * @method boolean getIsExist() Obtain Whether it exists.
 * @method void setIsExist(boolean $IsExist) Set Whether it exists.
...
class CheckAttributeLabelExistResponse extends AbstractModel
{
    ...
    /**
     * @param boolean $IsExist Whether it exists.
