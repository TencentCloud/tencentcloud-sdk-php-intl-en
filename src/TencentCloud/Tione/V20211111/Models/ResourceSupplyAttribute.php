 ...
 * 
 *
 * @method string getSupplyType() Obtain 
 * @method void setSupplyType(string $SupplyType) Set 
 * @method string getClusterType() Obtain 
 * @method void setClusterType(string $ClusterType) Set 
 */
