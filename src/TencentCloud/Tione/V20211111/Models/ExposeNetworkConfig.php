 ...
 * 
 *
 * @method SSHConfig getSSHConfig() Obtain 
 * @method void setSSHConfig(SSHConfig $SSHConfig) Set 
 * @method ExposePortConfig getExposePortConfig() Obtain 
 * @method void setExposePortConfig(ExposePortConfig $ExposePortConfig) Set 
 */
class ExposeNetworkConfig extends AbstractModel
{
    ...
    /**
     * @var ExposePortConfig 
     */
    public $ExposePortConfig;

    /**
     * @param SSHConfig $SSHConfig 
     * @param ExposePortConfig $ExposePortConfig 
     */
