 ...
 *
 * @method integer getVolumeSizeInGB() Obtain Storage size.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setVolumeSizeInGB(integer $VolumeSizeInGB) Set Storage size.
Note: This field may return null, indicating that no valid values can be obtained.
 */
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @param integer $VolumeSizeInGB Storage size.
Note: This field may return null, indicating that no valid values can be obtained.
     */
