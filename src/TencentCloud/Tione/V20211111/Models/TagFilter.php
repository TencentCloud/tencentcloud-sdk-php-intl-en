 ...
 * @method array getTagValues() Obtain Multiple tag values.
 * @method void setTagValues(array $TagValues) Set Multiple tag values.
 */
class TagFilter extends AbstractModel
{
    ...
    /**
     * @var array Multiple tag values.
     */
    public $TagValues;

    /**
     * @param string $TagKey Tag key.
     * @param array $TagValues Multiple tag values.
     */
