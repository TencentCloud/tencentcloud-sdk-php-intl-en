 ...
 * @method string getFileID() Obtain Offline log file ID
 * @method void setFileID(string $FileID) Set Offline log file ID
 */
class DeleteOfflineLogRecordRequest extends AbstractModel
{
    ...
    /**
     * @var string Offline log file ID
     */
    public $FileID;

    /**
     * @param string $ProjectKey Unique project key for reporting
     * @param string $FileID Offline log file ID
     */
