 ...
 * @method string getPackageType() Obtain Obtaining package.
 * @method void setPackageType(string $PackageType) Set Obtaining package.
...
class DescribeDataSetUrlStatisticsV2Request extends AbstractModel
{
    ...
    /**
     * @var string allcount: performance view. data: mini program. component: related to mini program. day: 14-day data. nettype: network or platform view. performance: top page performance view. version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: ISP view, region view, browser view, and so on.
     */
    public $Type;
     ...
     * @param string $PackageType Obtaining package.
