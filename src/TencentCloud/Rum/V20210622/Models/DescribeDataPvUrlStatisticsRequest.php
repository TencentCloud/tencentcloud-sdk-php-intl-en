 ...
 * @method string getType() Obtain Type: "allcount", "falls", "samp", "version", "ext3", "nettype", "platform", "isp", "region", "device", "browser", "ext1", "ext2"
 * @method void setType(string $Type) Set Type: "allcount", "falls", "samp", "version", "ext3", "nettype", "platform", "isp", "region", "device", "browser", "ext1", "ext2"
...
class DescribeDataPvUrlStatisticsRequest extends AbstractModel
{
    ...
    /**
     * @var string Type: "allcount", "falls", "samp", "version", "ext3", "nettype", "platform", "isp", "region", "device", "browser", "ext1", "ext2"
     */
    public $Type;
     ...
     * @param string $Type Type: "allcount", "falls", "samp", "version", "ext3", "nettype", "platform", "isp", "region", "device", "browser", "ext1", "ext2"
