 ...
 * @method string getUrl() Obtain Key value of the custom speed test
 * @method void setUrl(string $Url) Set Key value of the custom speed test
...
class DescribeDataCustomUrlRequest extends AbstractModel
{
    ...
    /**
     * @var string `top`: top resources view; `allcount`: performance view; `day`: 14-day data; `condition`: condition list; `pagepv`: PV view; `area`: request speed distribution; `nettype`/`version`/`platform`/`isp`/`region`/`device`/`browser`/`ext1`/`ext2`/`ext3`/`ret`/`status`/`from`/`url`/`env`: network/platform view; version view; device view; ISP view; region view; browser view; custom view, and so on.
     */
    public $Type;
    ...
    /**
     * @var string Key value of the custom speed test
     */
    public $Url;
     ...
     * @param string $Type `top`: top resources view; `allcount`: performance view; `day`: 14-day data; `condition`: condition list; `pagepv`: PV view; `area`: request speed distribution; `nettype`/`version`/`platform`/`isp`/`region`/`device`/`browser`/`ext1`/`ext2`/`ext3`/`ret`/`status`/`from`/`url`/`env`: network/platform view; version view; device view; ISP view; region view; browser view; custom view, and so on.
     ...
     * @param string $Url Key value of the custom speed test
