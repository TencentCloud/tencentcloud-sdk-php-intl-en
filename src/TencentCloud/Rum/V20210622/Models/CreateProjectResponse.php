 ...
 * @method string getKey() Obtain Unique project key
 * @method void setKey(string $Key) Set Unique project key
...
class CreateProjectResponse extends AbstractModel
{
     ...
     * @param string $Key Unique project key
