 ...
 * @method string getUrl() Obtain Value of the custom speed test key.
 * @method void setUrl(string $Url) Set Value of the custom speed test key.
...
class DescribeDataCustomUrlV2Request extends AbstractModel
{
    ...
    /**
     * @var string top: top resource view. allcount: performance view. day: 14-day data. condition: condition list. pagepv: performance view. area: request speed distribution. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
     */
    public $Type;
    ...
    /**
     * @var string Value of the custom speed test key.
     */
    public $Url;
     ...
     * @param string $Type top: top resource view. allcount: performance view. day: 14-day data. condition: condition list. pagepv: performance view. area: request speed distribution. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
     ...
     * @param string $Url Value of the custom speed test key.
