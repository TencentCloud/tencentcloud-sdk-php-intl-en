 ...
 * @method string getUniqueID() Obtain Unique user identifier (uin or aid)
 * @method void setUniqueID(string $UniqueID) Set Unique user identifier (uin or aid)
 */
class DeleteOfflineLogConfigRequest extends AbstractModel
{
    ...
    /**
     * @var string Unique user identifier (uin or aid)
     */
    public $UniqueID;

    /**
     * @param string $ProjectKey Unique project key for reporting
     * @param string $UniqueID Unique user identifier (uin or aid)
     */
