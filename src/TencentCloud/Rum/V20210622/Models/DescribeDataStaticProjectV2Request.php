 ...
 * @method string getCostType() Obtain Duration calculation.
 * @method void setCostType(string $CostType) Set Duration calculation.
 * @method array getUrl() Obtain Source.
 * @method void setUrl(array $Url) Set Source.
...
class DescribeDataStaticProjectV2Request extends AbstractModel
{
    ...
    /**
     * @var string allcount: performance view. day: 14-day data. condition: condition list. area: request speed distribution. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
     */
    public $Type;
    ...
    /**
     * @var string Duration calculation.
     */
    public $CostType;
