 ...
 * @method boolean getWebVitals() Obtain Indicates whether to return webvitals data.
 * @method void setWebVitals(boolean $WebVitals) Set Indicates whether to return webvitals data.
...
class DescribeDataPerformancePageV2Request extends AbstractModel
{
    ...
    /**
     * @var boolean Indicates whether to return webvitals data.
     */
    public $WebVitals;
     ...
     * @param boolean $WebVitals Indicates whether to return webvitals data.
