 ...
 * @method integer getStartTime() Obtain Timestamp
 * @method void setStartTime(integer $StartTime) Set Timestamp
 * @method integer getEndTime() Obtain Timestamp
 * @method void setEndTime(integer $EndTime) Set Timestamp
 */
