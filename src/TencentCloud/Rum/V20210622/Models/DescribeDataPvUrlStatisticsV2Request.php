 ...
 * @method string getNetType() Obtain Network type (1, 2, 3, 4, 5, or 100). 1 indicates Wi-Fi. 2 indicates 2G. 3 indicates 3G. 4 indicates 4G. 5 indicates 5G. 6 indicates 6G. 100 indicates unknown.
 * @method void setNetType(string $NetType) Set Network type (1, 2, 3, 4, 5, or 100). 1 indicates Wi-Fi. 2 indicates 2G. 3 indicates 3G. 4 indicates 4G. 5 indicates 5G. 6 indicates 6G. 100 indicates unknown.
 ...
 * @method integer getGroupByType() Obtain Parameter value enumeration for group by. 1: 1 minute. 2: 5 minutes. 3: 30 minutes. 4: 1 hour.
 5:1d
 * @method void setGroupByType(integer $GroupByType) Set Parameter value enumeration for group by. 1: 1 minute. 2: 5 minutes. 3: 30 minutes. 4: 1 hour.
 5:1d
 * @method integer getIsNewData() Obtain 1: Queries Zhiyan.
0: Uses the old logic, which is removed. Do not use this value.
 * @method void setIsNewData(integer $IsNewData) Set 1: Queries Zhiyan.
0: Uses the old logic, which is removed. Do not use this value.
...
class DescribeDataPvUrlStatisticsV2Request extends AbstractModel
{
    ...
    /**
     * @var string allcount: performance view. day: 14-day data. vp: performance. ckuv: UV. ckpv: PV. condition: condition list. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
     */
    public $Type;
    ...
    /**
     * @var string Network type (1, 2, 3, 4, 5, or 100). 1 indicates Wi-Fi. 2 indicates 2G. 3 indicates 3G. 4 indicates 4G. 5 indicates 5G. 6 indicates 6G. 100 indicates unknown.
     */
    public $NetType;
    ...
    /**
     * @var integer Parameter value enumeration for group by. 1: 1 minute. 2: 5 minutes. 3: 30 minutes. 4: 1 hour.
 5:1d
     */
    public $GroupByType;

    /**
     * @var integer 1: Queries Zhiyan.
0: Uses the old logic, which is removed. Do not use this value.
     */
    public $IsNewData;
     ...
     * @param string $NetType Network type (1, 2, 3, 4, 5, or 100). 1 indicates Wi-Fi. 2 indicates 2G. 3 indicates 3G. 4 indicates 4G. 5 indicates 5G. 6 indicates 6G. 100 indicates unknown.
     ...
     * @param integer $GroupByType Parameter value enumeration for group by. 1: 1 minute. 2: 5 minutes. 3: 30 minutes. 4: 1 hour.
 5:1d
     * @param integer $IsNewData 1: Queries Zhiyan.
0: Uses the old logic, which is removed. Do not use this value.
