 ...
 * @method array getRecordSet() Obtain Array of record IDs
 * @method void setRecordSet(array $RecordSet) Set Array of record IDs
...
class DescribeOfflineLogRecordsResponse extends AbstractModel
{
     ...
     * @param array $RecordSet Array of record IDs
