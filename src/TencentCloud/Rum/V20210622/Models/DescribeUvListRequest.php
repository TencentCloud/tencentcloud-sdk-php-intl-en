 ...
 * @method string getDimension() Obtain Get day:d min:m
 * @method void setDimension(string $Dimension) Set Get day:d min:m
 */
class DescribeUvListRequest extends AbstractModel
{
     ...
     * @param string $Dimension Get day:d min:m
     */
