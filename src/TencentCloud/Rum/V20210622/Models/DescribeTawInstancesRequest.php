 ...
 * @method integer getIsDemo() Obtain Whether it is in the demo mode. `1`: Yes; `2`: No.
 * @method void setIsDemo(integer $IsDemo) Set Whether it is in the demo mode. `1`: Yes; `2`: No.
 */
class DescribeTawInstancesRequest extends AbstractModel
{
    ...
    /**
     * @var integer Whether it is in the demo mode. `1`: Yes; `2`: No.
     * @deprecated
     */
    public $IsDemo;
     ...
     * @param integer $IsDemo Whether it is in the demo mode. `1`: Yes; `2`: No.
     */
