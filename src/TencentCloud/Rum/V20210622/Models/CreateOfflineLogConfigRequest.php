 ...
 * @method string getUniqueID() Obtain Unique identifier of the user to be listened on (`aid` or `uin`)
 * @method void setUniqueID(string $UniqueID) Set Unique identifier of the user to be listened on (`aid` or `uin`)
 */
class CreateOfflineLogConfigRequest extends AbstractModel
{
    ...
    /**
     * @var string Unique identifier of the user to be listened on (`aid` or `uin`)
     */
    public $UniqueID;

    /**
     * @param string $ProjectKey Unique project key for reporting
     * @param string $UniqueID Unique identifier of the user to be listened on (`aid` or `uin`)
     */
