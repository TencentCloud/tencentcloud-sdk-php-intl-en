 ...
 * @method BinlogItem getBinlogFileInfo() Obtain <p>Binlog file information</p>
 * @method void setBinlogFileInfo(BinlogItem $BinlogFileInfo) Set <p>Binlog file information</p>
 */
class DescribeBinlogListByVaultItem extends AbstractModel
{
    ...
    /**
     * @var BinlogItem <p>Binlog file information</p>
     */
     ...
     * @param BinlogItem $BinlogFileInfo <p>Binlog file information</p>
     */
