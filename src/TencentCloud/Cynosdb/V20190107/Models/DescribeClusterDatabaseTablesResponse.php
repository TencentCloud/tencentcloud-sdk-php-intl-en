 ...
 * @method array getTables() Obtain Database table list.
 * @method void setTables(array $Tables) Set Database table list.
...
class DescribeClusterDatabaseTablesResponse extends AbstractModel
{
     ...
     * @param array $Tables Database table list.
