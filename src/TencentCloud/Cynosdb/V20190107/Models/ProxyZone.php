 ...
 *
 * @method string getProxyNodeZone() Obtain AZ u200dof the proxy node
 * @method void setProxyNodeZone(string $ProxyNodeZone) Set AZ u200dof the proxy node
...
{
    /**
     * @var string AZ u200dof the proxy node
     */
    ...
    /**
     * @param string $ProxyNodeZone AZ u200dof the proxy node
