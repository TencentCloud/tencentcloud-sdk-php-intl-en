...
Note: this field may return null, indicating that no valid values can be obtained.
 * @method array getDealNames() Obtain Refund order ID
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setDealNames(array $DealNames) Set Refund order ID
Note: this field may return null, indicating that no valid values can be obtained.
...
Note: this field may return null, indicating that no valid values can be obtained.
     * @param array $DealNames Refund order ID
Note: this field may return null, indicating that no valid values can be obtained.
