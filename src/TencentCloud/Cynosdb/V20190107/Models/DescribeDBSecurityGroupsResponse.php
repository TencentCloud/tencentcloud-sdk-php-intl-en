 ...
 *
 * @method array getGroups() Obtain Security group information
 * @method void setGroups(array $Groups) Set Security group information
...
class DescribeDBSecurityGroupsResponse extends AbstractModel
{
    ...
    /**
     * @param array $Groups Security group information
