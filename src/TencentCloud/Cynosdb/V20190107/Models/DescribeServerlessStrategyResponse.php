 ...
 * @method string getAutoArchive() Obtain Whether archiving is enabled. Optional range</p><li>yes</li><li>no</li>Default value: yes</p>
 * @method void setAutoArchive(string $AutoArchive) Set Whether archiving is enabled. Optional range</p><li>yes</li><li>no</li>Default value: yes</p>
...
no
    ...
    /**
     * @var string Whether archiving is enabled. Optional range</p><li>yes</li><li>no</li>Default value: yes</p>
     */
    public $AutoArchive;
...
no
     ...
     * @param string $AutoArchive Whether archiving is enabled. Optional range</p><li>yes</li><li>no</li>Default value: yes</p>
