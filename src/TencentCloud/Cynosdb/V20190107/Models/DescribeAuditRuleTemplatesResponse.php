 ...
 * @method array getItems() Obtain Rule template detail list.
 * @method void setItems(array $Items) Set Rule template detail list.
...
class DescribeAuditRuleTemplatesResponse extends AbstractModel
{
    ...
    /**
     * @var array Rule template detail list.
     */
    public $Items;
     ...
     * @param array $Items Rule template detail list.
