 ...
 *
 * @method string getFileContent() Obtain File detail.
 * @method void setFileContent(string $FileContent) Set File detail.
...
class ExportResourcePackageDeductDetailsResponse extends AbstractModel
{
    ...
    /**
     * @param string $FileContent File detail.
