 ...
 * @method void setClusterIds(array $ClusterIds) Set Cluster ID list (this field is no longer maintained. please use the dealNames field to get cluster ids via the DescribeResourcesByDealName api.).
...
class CreateIntegrateClusterResponse extends AbstractModel
{
    ...
    /**
     * @var array Resource ID list (this field is no longer maintained. please use the dealNames field and the query API DescribeResourcesByDealName to obtain resource ids).
     */
    public $ResourceIds;

    /**
     * @var array Cluster ID list (this field is no longer maintained. please use the dealNames field to get cluster ids via the DescribeResourcesByDealName api.).
     */
    public $ClusterIds;
