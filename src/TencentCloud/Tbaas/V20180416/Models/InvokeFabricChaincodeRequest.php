 ...
 * @method boolean getWithAsyncResult() Obtain Whether to execute asynchronously. if so, use the transaction TxID in the return value to query the execution result.
 * @method void setWithAsyncResult(boolean $WithAsyncResult) Set Whether to execute asynchronously. if so, use the transaction TxID in the return value to query the execution result.
 */
class InvokeFabricChaincodeRequest extends AbstractModel
{
    ...
    /**
     * @var boolean Whether to execute asynchronously. if so, use the transaction TxID in the return value to query the execution result.
     */
     ...
     * @param boolean $WithAsyncResult Whether to execute asynchronously. if so, use the transaction TxID in the return value to query the execution result.
     */
