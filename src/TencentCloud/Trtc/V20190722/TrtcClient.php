...
/**
 * @method Models\CreatePictureResponse CreatePicture(Models\CreatePictureRequest $req) This API is used to upload an image.
 ...
 * @method Models\DeletePictureResponse DeletePicture(Models\DeletePictureRequest $req) This API is used to delete an image.
 ...
 * @method Models\DescribePictureResponse DescribePicture(Models\DescribePictureRequest $req) This API is used to query the parameters of an image.
 ...
 * @method Models\ModifyPictureResponse ModifyPicture(Models\ModifyPictureRequest $req) This API is used to modify the parameters of an image.
