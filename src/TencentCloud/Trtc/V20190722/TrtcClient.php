...
/**
 * @method Models\CreatePictureResponse CreatePicture(Models\CreatePictureRequest $req) This API is no longer used, and an error will occur if you call it. To use the feature provided by this API, please see [Console Guide > Application Management > Material Management](https://intl.cloud.tencent.com/document/product/647/50769?from_cn_redirect=1).
 ...
 * @method Models\DeletePictureResponse DeletePicture(Models\DeletePictureRequest $req) This API is no longer used, and an error will occur if you call it. To use the feature provided by this API, please see [Console Guide > Application Management > Material Management](https://intl.cloud.tencent.com/document/product/647/50769?from_cn_redirect=1).
 ...
 * @method Models\DescribePictureResponse DescribePicture(Models\DescribePictureRequest $req) This API is no longer used, and an error will occur if you call it. To use the feature provided by this API, please see [Console Guide > Application Management > Material Management](https://intl.cloud.tencent.com/document/product/647/50769?from_cn_redirect=1).
 ...
 * @method Models\ModifyPictureResponse ModifyPicture(Models\ModifyPictureRequest $req) This API is no longer used, and an error will occur if you call it. To use the feature provided by this API, please see [Console Guide > Application Management > Material Management](https://intl.cloud.tencent.com/document/product/647/50769?from_cn_redirect=1).
