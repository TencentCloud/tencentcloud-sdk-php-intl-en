 ...
 * @method Models\DeleteCloudTranscriptionResponse DeleteCloudTranscription(Models\DeleteCloudTranscriptionRequest $req) This API is used to terminate the transcription task after successful activation.
 ...
 * @method Models\DescribeCloudTranscriptionResponse DescribeCloudTranscription(Models\DescribeCloudTranscriptionRequest $req) This API is used to query the transcription status after starting a transcription task. It is effective only when the transcription task is in process. Querying after termination will return an error.
 ...
 * @method Models\QueryAIMessageListResponse QueryAIMessageList(Models\QueryAIMessageListRequest $req) input a task ID to query the list of AI conversation context information.
 ...
 * @method Models\StartWebRecordResponse StartWebRecord(Models\StartWebRecordRequest $req) This API is used to trigger a page recording task. Specify parameters such as the recording URL, recording resolution, and recording result storage in the API parameter.
