 ...
 * @method string getTaskId() Obtain Unique ID of the cloud moderation task, which is returned after the task is started.
 * @method void setTaskId(string $TaskId) Set Unique ID of the cloud moderation task, which is returned after the task is started.
 */
class DescribeCloudModerationRequest extends AbstractModel
{
    ...
    /**
     * @var string Unique ID of the cloud moderation task, which is returned after the task is started.
     */
    public $TaskId;

    /**
     * @param integer $SdkAppId SDKAppId of TRTC, which is the same as the SDKAppId corresponding to the recording room.
     * @param string $TaskId Unique ID of the cloud moderation task, which is returned after the task is started.
     */
