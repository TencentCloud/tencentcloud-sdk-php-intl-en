 ...
 *
 * @method integer getTotal() Obtain Total number of users whose information will be returned
 * @method void setTotal(integer $Total) Set Total number of users whose information will be returned
...
{
    /**
     * @var integer Total number of users whose information will be returned
     */
    public $Total;
...
Note: this field may return `null`, indicating that no valid value was found.
    ...
    /**
     * @param integer $Total Total number of users whose information will be returned
