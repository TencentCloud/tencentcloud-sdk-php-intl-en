 ...
 * @method integer getVadSilenceTime() Obtain The time for speech recognition vad is in the range of 240-2000, the default value is 1000, and the unit is ms. A smaller value will make speech recognition sentence segmentation faster.
 * @method void setVadSilenceTime(integer $VadSilenceTime) Set The time for speech recognition vad is in the range of 240-2000, the default value is 1000, and the unit is ms. A smaller value will make speech recognition sentence segmentation faster.
 */
...
**Note:** If the language you need is not listed, please contact our technical support team.
    ...
    /**
     * @var integer The time for speech recognition vad is in the range of 240-2000, the default value is 1000, and the unit is ms. A smaller value will make speech recognition sentence segmentation faster.
     */
...
**Note:** If the language you need is not listed, please contact our technical support team.
     ...
     * @param integer $VadSilenceTime The time for speech recognition vad is in the range of 240-2000, the default value is 1000, and the unit is ms. A smaller value will make speech recognition sentence segmentation faster.
     */
