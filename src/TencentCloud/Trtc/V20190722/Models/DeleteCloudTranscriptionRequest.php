 ...
 * @method string getTaskId() Obtain The unique Id of the task will be returned upon success.
 * @method void setTaskId(string $TaskId) Set The unique Id of the task will be returned upon success.
 */
class DeleteCloudTranscriptionRequest extends AbstractModel
{
    ...
    /**
     * @var string The unique Id of the task will be returned upon success.
     */
    public $TaskId;

    /**
     * @param integer $SdkAppId SDKAppId of TRTC, which is the same as the SDKAppId of the room being transcribed.
     * @param string $TaskId The unique Id of the task will be returned upon success.
     */
