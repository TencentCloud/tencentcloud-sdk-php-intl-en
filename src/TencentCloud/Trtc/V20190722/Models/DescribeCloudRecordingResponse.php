 ...
 *
 * @method string getTaskId() Obtain The unique ID of the recording task.
 * @method void setTaskId(string $TaskId) Set The unique ID of the recording task.
 * @method string getStatus() Obtain The status of the on-cloud recording task.
Idle: The task is idle.
InProgress: The task is in progress.
Exited: The task is being ended.
 * @method void setStatus(string $Status) Set The status of the on-cloud recording task.
Idle: The task is idle.
InProgress: The task is in progress.
Exited: The task is being ended.
 * @method array getStorageFileList() Obtain The information of the recording files.
...
{
    /**
     * @var string The unique ID of the recording task.
     */
    public $TaskId;

    /**
     * @var string The status of the on-cloud recording task.
Idle: The task is idle.
InProgress: The task is in progress.
Exited: The task is being ended.
     */
    ...
    /**
     * @var array The information of the recording files.
Note: This field may return `null`, indicating that no valid values can be obtained.
     */
    ...
    /**
     * @param string $TaskId The unique ID of the recording task.
     * @param string $Status The status of the on-cloud recording task.
Idle: The task is idle.
InProgress: The task is in progress.
Exited: The task is being ended.
