 ...
 *
 * @method string getContent() Obtain Request the content of LLM.
 * @method void setContent(string $Content) Set Request the content of LLM.
...
{
    /**
     * @var string Request the content of LLM.
     */
    public $Content;
    ...
    /**
     * @param string $Content Request the content of LLM.
