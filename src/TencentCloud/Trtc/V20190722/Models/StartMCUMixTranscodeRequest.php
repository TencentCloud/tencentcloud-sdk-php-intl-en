 ...
 * @method OutputParams getOutputParams() Obtain On-Cloud MixTranscoding output control parameters.
 * @method void setOutputParams(OutputParams $OutputParams) Set On-Cloud MixTranscoding output control parameters.
...
class StartMCUMixTranscodeRequest extends AbstractModel
{
    ...
    /**
     * @var OutputParams On-Cloud MixTranscoding output control parameters.
     */
    public $OutputParams;
