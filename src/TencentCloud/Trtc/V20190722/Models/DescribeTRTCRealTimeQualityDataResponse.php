 ...
 *
 * @method TRTCDataResult getData() Obtain TRTC Real- Time Monitoring output parameters
 * @method void setData(TRTCDataResult $Data) Set TRTC Real- Time Monitoring output parameters
...
{
    /**
     * @var TRTCDataResult TRTC Real- Time Monitoring output parameters
     */
    public $Data;
    ...
    /**
     * @param TRTCDataResult $Data TRTC Real- Time Monitoring output parameters
