 ...
 * Deduction details.
 *
 * @method string getIssueType() Obtain Deduction item type. Valid values: availability, maintainability, performance, and reliability.
 * @method void setIssueType(string $IssueType) Set Deduction item type. Valid values: availability, maintainability, performance, and reliability.
...
{
    /**
     * @var string Deduction item type. Valid values: availability, maintainability, performance, and reliability.
     */
    public $IssueType;
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @param string $IssueType Deduction item type. Valid values: availability, maintainability, performance, and reliability.
