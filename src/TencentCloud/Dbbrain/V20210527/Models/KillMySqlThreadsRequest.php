 ...
 * @method array getThreads() Obtain The ID list of MySQL sessions to be killed. This parameter is used in the “Prepare” stage.
 * @method void setThreads(array $Threads) Set The ID list of MySQL sessions to be killed. This parameter is used in the “Prepare” stage.
...
class KillMySqlThreadsRequest extends AbstractModel
{
    ...
    /**
     * @var array The ID list of MySQL sessions to be killed. This parameter is used in the “Prepare” stage.
     */
    public $Threads;
     ...
     * @param array $Threads The ID list of MySQL sessions to be killed. This parameter is used in the “Prepare” stage.
