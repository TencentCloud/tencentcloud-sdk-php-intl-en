 ...
 * @method integer getAsyncRequestId() Obtain Health report task ID, which can be queried through `DescribeDBDiagReportTasks`.
 * @method void setAsyncRequestId(integer $AsyncRequestId) Set Health report task ID, which can be queried through `DescribeDBDiagReportTasks`.
...
class CreateDBDiagReportUrlRequest extends AbstractModel
{
    ...
    /**
     * @var integer Health report task ID, which can be queried through `DescribeDBDiagReportTasks`.
     */
     ...
     * @param integer $AsyncRequestId Health report task ID, which can be queried through `DescribeDBDiagReportTasks`.
