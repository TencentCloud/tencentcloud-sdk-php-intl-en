 ...
 *
 * @method ProcessStatistic getProcessStatistics() Obtain Real-time session statistics.
 * @method void setProcessStatistics(ProcessStatistic $ProcessStatistics) Set Real-time session statistics.
...
{
    /**
     * @var ProcessStatistic Real-time session statistics.
     */
    ...
    /**
     * @param ProcessStatistic $ProcessStatistics Real-time session statistics.
