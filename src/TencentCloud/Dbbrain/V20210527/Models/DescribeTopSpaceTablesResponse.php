 ...
 * @method integer getTimestamp() Obtain Timestamp (in seconds) of tablespace data collection points
 * @method void setTimestamp(integer $Timestamp) Set Timestamp (in seconds) of tablespace data collection points
...
class DescribeTopSpaceTablesResponse extends AbstractModel
{
    ...
    /**
     * @var integer Timestamp (in seconds) of tablespace data collection points
     */
    public $Timestamp;
     ...
     * @param integer $Timestamp Timestamp (in seconds) of tablespace data collection points
