 ...
 * @method array getContactPerson() Obtain Contact ID. Either `ContactPerson` or `ContactGroup` should be passed in.
 * @method void setContactPerson(array $ContactPerson) Set Contact ID. Either `ContactPerson` or `ContactGroup` should be passed in.
 * @method array getContactGroup() Obtain Contact group ID. Either `ContactPerson` or `ContactGroup` should be passed in.
 * @method void setContactGroup(array $ContactGroup) Set Contact group ID. Either `ContactPerson` or `ContactGroup` should be passed in.
 */
class MailConfiguration extends AbstractModel
{
    ...
    /**
     * @var array Contact ID. Either `ContactPerson` or `ContactGroup` should be passed in.
     */
    public $ContactPerson;

    /**
     * @var array Contact group ID. Either `ContactPerson` or `ContactGroup` should be passed in.
     */
    public $ContactGroup;
     ...
     * @param array $ContactPerson Contact ID. Either `ContactPerson` or `ContactGroup` should be passed in.
     * @param array $ContactGroup Contact group ID. Either `ContactPerson` or `ContactGroup` should be passed in.
     */
