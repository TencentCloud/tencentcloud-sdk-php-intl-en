 ...
 * @method array getNames() Obtain Array of contact names. Fuzzy search is supported.
 * @method void setNames(array $Names) Set Array of contact names. Fuzzy search is supported.
 */
class DescribeAllUserContactRequest extends AbstractModel
{
    ...
    /**
     * @var array Array of contact names. Fuzzy search is supported.
     */
    public $Names;

    /**
     * @param string $Product Service type, which is fixed to `mysql`.
     * @param array $Names Array of contact names. Fuzzy search is supported.
     */
