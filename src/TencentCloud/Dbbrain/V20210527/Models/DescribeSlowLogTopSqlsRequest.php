 ...
 * @method void setOrderBy(string $OrderBy) Set Sorting order. Valid values: `ASC` (ascending), `DESC` (descending). Default value: `DESC`.
...
class DescribeSlowLogTopSqlsRequest extends AbstractModel
{
    ...
    /**
     * @var string Sorting key. Valid values: `QueryTime`, `ExecTimes`, `RowsSent`, `LockTime`, `RowsExamined`. Default value: `QueryTime`.
     */
    public $SortBy;
