 ...
 * @method array getContactPerson() Obtain Array of contact IDs to receive email.
 * @method void setContactPerson(array $ContactPerson) Set Array of contact IDs to receive email.
 * @method array getContactGroup() Obtain Array of contact group IDs to receive email.
 * @method void setContactGroup(array $ContactGroup) Set Array of contact group IDs to receive email.
...
class CreateDBDiagReportTaskRequest extends AbstractModel
{
    ...
    /**
     * @var array Array of contact IDs to receive email.
     */
    public $ContactPerson;

    /**
     * @var array Array of contact group IDs to receive email.
     */
    public $ContactGroup;
     ...
     * @param array $ContactPerson Array of contact IDs to receive email.
     * @param array $ContactGroup Array of contact group IDs to receive email.
