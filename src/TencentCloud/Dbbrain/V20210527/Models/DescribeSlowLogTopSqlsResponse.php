 ...
 * @method array getRows() Obtain List of top slow SQL statements
 * @method void setRows(array $Rows) Set List of top slow SQL statements
...
class DescribeSlowLogTopSqlsResponse extends AbstractModel
{
    ...
    /**
     * @var array List of top slow SQL statements
     */
    public $Rows;
     ...
     * @param array $Rows List of top slow SQL statements
