 ...
 * @method string getIssueType() Obtain Diagnosis item type. Valid values: availability, maintainability, performance, and reliability.
 * @method void setIssueType(string $IssueType) Set Diagnosis item type. Valid values: availability, maintainability, performance, and reliability.
...
class ScoreItem extends AbstractModel
{
    ...
    /**
     * @var string Diagnosis item type. Valid values: availability, maintainability, performance, and reliability.
     */
    public $IssueType;
     ...
     * @param string $IssueType Diagnosis item type. Valid values: availability, maintainability, performance, and reliability.
