 ...
 * @method array getInstanceIds() Obtain Array of instance IDs, which is used to filter the task list of the specified instance.
 * @method void setInstanceIds(array $InstanceIds) Set Array of instance IDs, which is used to filter the task list of the specified instance.
 * @method array getSources() Obtain Source that triggers the task. Valid values: `DAILY_INSPECTION` (instance inspection), `SCHEDULED` (scheduled task), and `MANUAL` (manual trigger).
 * @method void setSources(array $Sources) Set Source that triggers the task. Valid values: `DAILY_INSPECTION` (instance inspection), `SCHEDULED` (scheduled task), and `MANUAL` (manual trigger).
 ...
 * @method string getTaskStatuses() Obtain Task status. Valid values: `created` (created), `chosen` (to be executed), `running` (being executed), `failed` (failed), and `finished` (completed).
 * @method void setTaskStatuses(string $TaskStatuses) Set Task status. Valid values: `created` (created), `chosen` (to be executed), `running` (being executed), `failed` (failed), and `finished` (completed).
...
class DescribeDBDiagReportTasksRequest extends AbstractModel
{
    ...
    /**
     * @var array Array of instance IDs, which is used to filter the task list of the specified instance.
     */
    public $InstanceIds;

    /**
     * @var array Source that triggers the task. Valid values: `DAILY_INSPECTION` (instance inspection), `SCHEDULED` (scheduled task), and `MANUAL` (manual trigger).
     */
    public $Sources;
    ...
    /**
     * @var string Task status. Valid values: `created` (created), `chosen` (to be executed), `running` (being executed), `failed` (failed), and `finished` (completed).
     */
    public $TaskStatuses;
     ...
     * @param array $InstanceIds Array of instance IDs, which is used to filter the task list of the specified instance.
     * @param array $Sources Source that triggers the task. Valid values: `DAILY_INSPECTION` (instance inspection), `SCHEDULED` (scheduled task), and `MANUAL` (manual trigger).
     ...
     * @param string $TaskStatuses Task status. Valid values: `created` (created), `chosen` (to be executed), `running` (being executed), `failed` (failed), and `finished` (completed).
