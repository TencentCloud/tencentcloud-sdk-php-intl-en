 ...
 * @method array getInstanceIds() Obtain Array of instance IDs, which is used to filter the task list of a specified instance.
 * @method void setInstanceIds(array $InstanceIds) Set Array of instance IDs, which is used to filter the task list of a specified instance.
...
class DescribeDBDiagReportTasksRequest extends AbstractModel
{
    ...
    /**
     * @var array Array of instance IDs, which is used to filter the task list of a specified instance.
     */
    public $InstanceIds;
     ...
     * @param array $InstanceIds Array of instance IDs, which is used to filter the task list of a specified instance.
