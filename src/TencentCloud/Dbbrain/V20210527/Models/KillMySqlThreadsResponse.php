 ...
 *
 * @method array getThreads() Obtain List of IDs of the MySQL sessions that have been killed.
 * @method void setThreads(array $Threads) Set List of IDs of the MySQL sessions that have been killed.
...
{
    /**
     * @var array List of IDs of the MySQL sessions that have been killed.
     */
    public $Threads;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @param array $Threads List of IDs of the MySQL sessions that have been killed.
