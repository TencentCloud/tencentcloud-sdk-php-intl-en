 ...
 * @method float getQueryTimeRatio() Obtain Ratio of total duration in %
 * @method void setQueryTimeRatio(float $QueryTimeRatio) Set Ratio of total duration in %
 * @method float getLockTimeRatio() Obtain Ratio of total SQL lock wait time in %
 * @method void setLockTimeRatio(float $LockTimeRatio) Set Ratio of total SQL lock wait time in %
...
class SlowLogTopSqlItem extends AbstractModel
{
    ...
    /**
     * @var float Ratio of total duration in %
     */
    public $QueryTimeRatio;

    /**
     * @var float Ratio of total SQL lock wait time in %
     */
     ...
     * @param float $QueryTimeRatio Ratio of total duration in %
     * @param float $LockTimeRatio Ratio of total SQL lock wait time in %
