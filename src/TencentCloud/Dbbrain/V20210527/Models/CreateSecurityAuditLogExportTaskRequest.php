 ...
 * @method array getDangerLevels() Obtain Log risk level list. Valid values: 0 (no risk), 1 (low risk), 2 (medium risk), 3 (high risk).
 * @method void setDangerLevels(array $DangerLevels) Set Log risk level list. Valid values: 0 (no risk), 1 (low risk), 2 (medium risk), 3 (high risk).
 */
class CreateSecurityAuditLogExportTaskRequest extends AbstractModel
{
    ...
    /**
     * @var array Log risk level list. Valid values: 0 (no risk), 1 (low risk), 2 (medium risk), 3 (high risk).
     */
    public $DangerLevels;
     ...
     * @param array $DangerLevels Log risk level list. Valid values: 0 (no risk), 1 (low risk), 2 (medium risk), 3 (high risk).
     */
