 ...
 * @method integer getEventsTotalCount() Obtain Total number of exceptions.
 * @method void setEventsTotalCount(integer $EventsTotalCount) Set Total number of exceptions.
 * @method integer getHealthScore() Obtain Health score.
 * @method void setHealthScore(integer $HealthScore) Set Health score.
 * @method string getHealthLevel() Obtain Health level, such as `HEALTH`, `SUB_HEALTH`, `RISK`, and `HIGH_RISK`.
 * @method void setHealthLevel(string $HealthLevel) Set Health level, such as `HEALTH`, `SUB_HEALTH`, `RISK`, and `HIGH_RISK`.
 */
class HealthScoreInfo extends AbstractModel
{
    ...
    /**
     * @var string Health level, such as `HEALTH`, `SUB_HEALTH`, `RISK`, and `HIGH_RISK`.
     */
    public $HealthLevel;

    /**
     * @param array $IssueTypes Exception details.
     * @param integer $EventsTotalCount Total number of exceptions.
     * @param integer $HealthScore Health score.
     * @param string $HealthLevel Health level, such as `HEALTH`, `SUB_HEALTH`, `RISK`, and `HIGH_RISK`.
     */
