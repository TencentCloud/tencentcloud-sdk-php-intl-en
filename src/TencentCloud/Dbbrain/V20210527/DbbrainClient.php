 ...
 * @method Models\DescribeProxyProcessStatisticsResponse DescribeProxyProcessStatistics(Models\DescribeProxyProcessStatisticsRequest $req) This API is used to get the session statistics of the current instance. Note that this API can be called only in certain environments.
