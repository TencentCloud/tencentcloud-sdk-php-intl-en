 ...
 * @method MonitorFloatMetricSeriesData getSeriesData() Obtain Monitoring metric data in a unit of time interval.
 * @method void setSeriesData(MonitorFloatMetricSeriesData $SeriesData) Set Monitoring metric data in a unit of time interval.
 */
class TableSpaceTimeSeries extends AbstractModel
{
    ...
    /**
     * @var MonitorFloatMetricSeriesData Monitoring metric data in a unit of time interval.
     */
    public $SeriesData;
     ...
     * @param MonitorFloatMetricSeriesData $SeriesData Monitoring metric data in a unit of time interval.
     */
