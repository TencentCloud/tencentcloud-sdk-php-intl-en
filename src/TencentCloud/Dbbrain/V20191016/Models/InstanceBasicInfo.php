 ...
 * @method integer getVport() Obtain Private network port of the instance.
 * @method void setVport(integer $Vport) Set Private network port of the instance.
 * @method string getProduct() Obtain Instance product.
 * @method void setProduct(string $Product) Set Instance product.
...
class InstanceBasicInfo extends AbstractModel
{
    ...
    /**
     * @var integer Private network port of the instance.
     */
    public $Vport;

    /**
     * @var string Instance product.
     */
    public $Product;
     ...
     * @param integer $Vport Private network port of the instance.
     * @param string $Product Instance product.
