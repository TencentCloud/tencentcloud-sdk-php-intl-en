 ...
 * @method integer getLimit() Obtain Pagination parameter indicating the number of entries for each page.
 * @method void setLimit(integer $Limit) Set Pagination parameter indicating the number of entries for each page.
...
class DescribeDiagDBInstancesRequest extends AbstractModel
{
    ...
    /**
     * @var integer Pagination parameter indicating the number of entries for each page.
     */
    public $Limit;
     ...
     * @param integer $Limit Pagination parameter indicating the number of entries for each page.
