 ...
 * @method MonitorMetricSeriesData getSeriesData() Obtain Monitoring metric data in a unit of time interval.
 * @method void setSeriesData(MonitorMetricSeriesData $SeriesData) Set Monitoring metric data in a unit of time interval.
 */
class SchemaSpaceTimeSeries extends AbstractModel
{
    ...
    /**
     * @var MonitorMetricSeriesData Monitoring metric data in a unit of time interval.
     */
    public $SeriesData;

    /**
     * @param string $TableSchema Database name
     * @param MonitorMetricSeriesData $SeriesData Monitoring metric data in a unit of time interval.
     */
