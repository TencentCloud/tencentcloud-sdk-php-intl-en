 ...
 * @method integer getAsyncRequestId() Obtain The health report task ID, which can be queried through `DescribeDBDiagReportTasks`.
 * @method void setAsyncRequestId(integer $AsyncRequestId) Set The health report task ID, which can be queried through `DescribeDBDiagReportTasks`.
...
class CreateDBDiagReportUrlRequest extends AbstractModel
{
    ...
    /**
     * @var integer The health report task ID, which can be queried through `DescribeDBDiagReportTasks`.
     */
     ...
     * @param integer $AsyncRequestId The health report task ID, which can be queried through `DescribeDBDiagReportTasks`.
