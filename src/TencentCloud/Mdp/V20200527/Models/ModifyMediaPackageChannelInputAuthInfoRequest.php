 ...
 * @method string getActionType() Obtain Authentication configuration type. Valid values: CLOSE, UPDATE.
CLOSE: disable authentication.
UPDATE: update authentication.
 * @method void setActionType(string $ActionType) Set Authentication configuration type. Valid values: CLOSE, UPDATE.
CLOSE: disable authentication.
UPDATE: update authentication.
 */
class ModifyMediaPackageChannelInputAuthInfoRequest extends AbstractModel
{
    ...
    /**
     * @var string Authentication configuration type. Valid values: CLOSE, UPDATE.
CLOSE: disable authentication.
UPDATE: update authentication.
     */
    public $ActionType;
     ...
     * @param string $ActionType Authentication configuration type. Valid values: CLOSE, UPDATE.
CLOSE: disable authentication.
UPDATE: update authentication.
     */
