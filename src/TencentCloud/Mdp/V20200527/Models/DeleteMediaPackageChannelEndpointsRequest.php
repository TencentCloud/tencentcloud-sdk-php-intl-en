 ...
 * @method array getUrls() Obtain The list of endpoint URLs.
 * @method void setUrls(array $Urls) Set The list of endpoint URLs.
 */
class DeleteMediaPackageChannelEndpointsRequest extends AbstractModel
{
    ...
    /**
     * @var array The list of endpoint URLs.
     */
    public $Urls;

    /**
     * @param string $Id Channel ID.
     * @param array $Urls The list of endpoint URLs.
     */
