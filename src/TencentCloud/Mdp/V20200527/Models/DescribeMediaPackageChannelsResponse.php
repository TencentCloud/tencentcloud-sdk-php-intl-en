 ...
 *
 * @method array getInfos() Obtain The list of channel outputs.
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setInfos(array $Infos) Set The list of channel outputs.
Note: this field may return null, indicating that no valid values can be obtained.
 * @method integer getPageNum() Obtain Page number.
 * @method void setPageNum(integer $PageNum) Set Page number.
 * @method integer getPageSize() Obtain The size of each page.
 * @method void setPageSize(integer $PageSize) Set The size of each page.
...
{
    /**
     * @var array The list of channel outputs.
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public $Infos;
    ...
    /**
     * @param array $Infos The list of channel outputs.
Note: this field may return null, indicating that no valid values can be obtained.
     * @param integer $PageNum Page number.
     * @param integer $PageSize The size of each page.
