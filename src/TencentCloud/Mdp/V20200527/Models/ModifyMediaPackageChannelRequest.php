 ...
 * @method string getProtocol() Obtain The channel protocol after modification. Valid values: HLS, DASH.
 * @method void setProtocol(string $Protocol) Set The channel protocol after modification. Valid values: HLS, DASH.
 */
class ModifyMediaPackageChannelRequest extends AbstractModel
{
    ...
    /**
     * @var string The channel protocol after modification. Valid values: HLS, DASH.
     */
    public $Protocol;
     ...
     * @param string $Protocol The channel protocol after modification. Valid values: HLS, DASH.
     */
