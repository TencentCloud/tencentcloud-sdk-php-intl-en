 ...
 * @method integer getGatewayType() Obtain Gateway type. 0: public cloud gateway; 1: private gateway.
 * @method void setGatewayType(integer $GatewayType) Set Gateway type. 0: public cloud gateway; 1: private gateway.
...
class GetFlowStatisticByRegionRequest extends AbstractModel
{
    ...
    /**
     * @var integer Gateway type. 0: public cloud gateway; 1: private gateway.
     */
    public $GatewayType;
     ...
     * @param integer $GatewayType Gateway type. 0: public cloud gateway; 1: private gateway.
