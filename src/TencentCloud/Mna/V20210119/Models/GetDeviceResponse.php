 ...
 *
 * @method DeviceDetails getDeviceDetails() Obtain device details
 * @method void setDeviceDetails(DeviceDetails $DeviceDetails) Set device details
...
class GetDeviceResponse extends AbstractModel
{
    ...
    /**
     * @param DeviceDetails $DeviceDetails device details
