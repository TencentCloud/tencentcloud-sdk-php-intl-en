 ...
 * @method string getDescription() Obtain Interconnection rule description
 * @method void setDescription(string $Description) Set Interconnection rule description
 */
class L3ConnInfo extends AbstractModel
{
    ...
    /**
     * @var string Interconnection rule description
     */
    public $Description;
     ...
     * @param string $Description Interconnection rule description
     */
