 ...
 * @method array getDeviceList() Obtain Device name list. Used for querying traffic volume across devices. When this field is enabled, DeviceId can be "-1".
 * @method void setDeviceList(array $DeviceList) Set Device name list. Used for querying traffic volume across devices. When this field is enabled, DeviceId can be "-1".
 */
class GetFlowStatisticByNameRequest extends AbstractModel
{
    ...
    /**
     * @var array Device name list. Used for querying traffic volume across devices. When this field is enabled, DeviceId can be "-1".
     */
    public $DeviceList;
     ...
     * @param array $DeviceList Device name list. Used for querying traffic volume across devices. When this field is enabled, DeviceId can be "-1".
     */
