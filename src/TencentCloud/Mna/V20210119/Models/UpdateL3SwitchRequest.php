 ...
 * @method boolean getEnable() Obtain Interconnection rule switch
 * @method void setEnable(boolean $Enable) Set Interconnection rule switch
 */
class UpdateL3SwitchRequest extends AbstractModel
{
    ...
    /**
     * @var boolean Interconnection rule switch
     */
    public $Enable;

    /**
     * @param string $L3ConnId Interconnection rule ID
     * @param boolean $Enable Interconnection rule switch
     */
