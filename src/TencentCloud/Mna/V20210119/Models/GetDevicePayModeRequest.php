 ...
 *
 * @method array getDeviceIdList() Obtain Device ID list
 * @method void setDeviceIdList(array $DeviceIdList) Set Device ID list
 */
class GetDevicePayModeRequest extends AbstractModel
{
    /**
     * @var array Device ID list
     */
    public $DeviceIdList;

    /**
     * @param array $DeviceIdList Device ID list
     */
