 ...
 *
 * @method string getGroupId() Obtain The group ID. You cannot remove members from a merged group.
 * @method void setGroupId(string $GroupId) Set The group ID. You cannot remove members from a merged group.
...
{
    /**
     * @var string The group ID. You cannot remove members from a merged group.
     */
    public $GroupId;
    ...
    /**
     * @param string $GroupId The group ID. You cannot remove members from a merged group.
