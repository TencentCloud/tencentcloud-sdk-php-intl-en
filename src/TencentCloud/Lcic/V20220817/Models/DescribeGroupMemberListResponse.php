 ...
 * @method array getMemberIds() Obtain The user IDs of the members.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setMemberIds(array $MemberIds) Set The user IDs of the members.
Note: This field may return null, indicating that no valid values can be obtained.
...
class DescribeGroupMemberListResponse extends AbstractModel
{
    ...
    /**
     * @var array The user IDs of the members.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $MemberIds;
     ...
     * @param array $MemberIds The user IDs of the members.
Note: This field may return null, indicating that no valid values can be obtained.
