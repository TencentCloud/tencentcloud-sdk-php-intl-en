 ...
 *
 * @method integer getSchoolId() Obtain The school ID.
 * @method void setSchoolId(integer $SchoolId) Set The school ID.
 ...
 * @method string getOwner() Obtain The user ID of the courseware owner. If you do not specify this parameter, all courseware under the school ID will be returned.
 * @method void setOwner(string $Owner) Set The user ID of the courseware owner. If you do not specify this parameter, all courseware under the school ID will be returned.
...
class DescribeDocumentsRequest extends AbstractModel
{
    ...
    /**
     * @var string The user ID of the courseware owner. If you do not specify this parameter, all courseware under the school ID will be returned.
     */
    public $Owner;
     ...
     * @param string $Owner The user ID of the courseware owner. If you do not specify this parameter, all courseware under the school ID will be returned.
