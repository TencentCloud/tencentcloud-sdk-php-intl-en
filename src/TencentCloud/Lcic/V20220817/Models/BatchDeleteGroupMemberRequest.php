 ...
 * @method array getMemberIds() Obtain The users to remove. Array length limit: 256.
 * @method void setMemberIds(array $MemberIds) Set The users to remove. Array length limit: 256.
 */
class BatchDeleteGroupMemberRequest extends AbstractModel
{
    ...
    /**
     * @var array The users to remove. Array length limit: 256.
     */
    public $MemberIds;
     ...
     * @param array $MemberIds The users to remove. Array length limit: 256.
     */
