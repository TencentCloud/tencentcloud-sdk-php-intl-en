 ...
 * @method array getMemberRecords() Obtain The user list.
 * @method void setMemberRecords(array $MemberRecords) Set The user list.
...
class DescribeCurrentMemberListResponse extends AbstractModel
{
     ...
     * @param array $MemberRecords The user list.
