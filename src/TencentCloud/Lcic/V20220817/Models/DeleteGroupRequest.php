 ...
 *
 * @method array getGroupIds() Obtain The IDs of the groups to delete.
 * @method void setGroupIds(array $GroupIds) Set The IDs of the groups to delete.
...
{
    /**
     * @var array The IDs of the groups to delete.
     */
    public $GroupIds;
    ...
    /**
     * @param array $GroupIds The IDs of the groups to delete.
