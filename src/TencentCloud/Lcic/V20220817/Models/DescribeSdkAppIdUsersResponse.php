 ...
 * @method array getUsers() Obtain The information of the users.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setUsers(array $Users) Set The information of the users.
Note: This field may return null, indicating that no valid values can be obtained.
...
class DescribeSdkAppIdUsersResponse extends AbstractModel
{
    ...
    /**
     * @var array The information of the users.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Users;
     ...
     * @param array $Users The information of the users.
Note: This field may return null, indicating that no valid values can be obtained.
