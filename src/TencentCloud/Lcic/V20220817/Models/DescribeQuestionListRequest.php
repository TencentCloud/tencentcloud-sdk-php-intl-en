 ...
 * @method integer getLimit() Obtain The page to return records from. Pagination starts from 1, which is also the default value of this parameter.
 * @method void setLimit(integer $Limit) Set The page to return records from. Pagination starts from 1, which is also the default value of this parameter.
 */
class DescribeQuestionListRequest extends AbstractModel
{
     ...
     * @param integer $Limit The page to return records from. Pagination starts from 1, which is also the default value of this parameter.
     */
