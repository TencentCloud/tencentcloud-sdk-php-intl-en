 ...
 * Project list data
 *
 * @method array getList() Obtain Array.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setList(array $List) Set Array.
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method integer getTotalPages() Obtain 1
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setTotalPages(integer $TotalPages) Set 1
Note: This field may return null, indicating that no valid values can be obtained.
 */
