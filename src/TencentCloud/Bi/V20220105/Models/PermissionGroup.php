 ...
 *
 * @method string getModuleGroup() Obtain Group name.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setModuleGroup(string $ModuleGroup) Set Group name.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method array getComponents() Obtain Permission list.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setComponents(array $Components) Set Permission list.
Note: This field may return null, indicating that no valid values can be obtained.
 */
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @param string $ModuleGroup Group name.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param array $Components Permission list.
Note: This field may return null, indicating that no valid values can be obtained.
     */
