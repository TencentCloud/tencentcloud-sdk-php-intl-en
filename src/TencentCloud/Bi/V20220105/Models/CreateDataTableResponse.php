...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method IdDTO getData() Obtain Returned data table id on success
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setData(IdDTO $Data) Set Returned data table id on success
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getExtra() Obtain Additional Information
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setExtra(string $Extra) Set Additional Information
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getMsg() Obtain Error prompt
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setMsg(string $Msg) Set Error prompt
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var IdDTO Returned data table id on success
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Data;
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param IdDTO $Data Returned data table id on success
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $Extra Additional Information
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $Msg Error prompt
Note: This field may return null, indicating that no valid values can be obtained.
