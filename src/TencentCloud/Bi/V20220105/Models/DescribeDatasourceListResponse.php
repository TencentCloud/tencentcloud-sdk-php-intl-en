...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method DatasourceInfoData getData() Obtain List details.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setData(DatasourceInfoData $Data) Set List details.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getExtra() Obtain Information.
 * @method void setExtra(string $Extra) Set Information.
 * @method string getMsg() Obtain Information.
 * @method void setMsg(string $Msg) Set Information.
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var DatasourceInfoData List details.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Data;
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param DatasourceInfoData $Data List details.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $Extra Information.
