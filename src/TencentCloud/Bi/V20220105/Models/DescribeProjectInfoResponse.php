...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getExtra() Obtain ""
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setExtra(string $Extra) Set ""
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getMsg() Obtain ""
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setMsg(string $Msg) Set ""
Note: This field may return null, indicating that no valid values can be obtained.
 * @method Project getData() Obtain Project details.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setData(Project $Data) Set Project details.
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $Msg ""
Note: This field may return null, indicating that no valid values can be obtained.
     * @param Project $Data Project details.
Note: This field may return null, indicating that no valid values can be obtained.
