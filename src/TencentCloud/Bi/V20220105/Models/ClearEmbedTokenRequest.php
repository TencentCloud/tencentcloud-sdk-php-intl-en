 ...
 * @method string getUserCorpId() Obtain Host Account ID
 * @method void setUserCorpId(string $UserCorpId) Set Host Account ID
 * @method string getScope() Obtain panel , page
 * @method void setScope(string $Scope) Set panel , page
...
class ClearEmbedTokenRequest extends AbstractModel
{
     ...
     * @param string $UserCorpId Host Account ID
