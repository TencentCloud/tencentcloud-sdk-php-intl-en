 ...
 *
 * @method integer getTotal() Obtain Total items
 * @method void setTotal(integer $Total) Set Total items
 * @method array getResults() Obtain Result list
 * @method void setResults(array $Results) Set Result list
