 ...
 *
 * @method float getRequestCpu() Obtain Minimum number of CPU cores
 * @method void setRequestCpu(float $RequestCpu) Set Minimum number of CPU cores
 * @method float getLimitCpu() Obtain Maximum number of CPU cores
 * @method void setLimitCpu(float $LimitCpu) Set Maximum number of CPU cores
...
{
    /**
     * @var float Minimum number of CPU cores
     */
    public $RequestCpu;
    ...
    /**
     * @param float $RequestCpu Minimum number of CPU cores
     * @param float $LimitCpu Maximum number of CPU cores
