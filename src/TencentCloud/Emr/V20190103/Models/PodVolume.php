 ...
 *
 * @method string getVolumeType() Obtain Storage type. Valid values: "pvc", "hostpath".
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setVolumeType(string $VolumeType) Set Storage type. Valid values: "pvc", "hostpath".
Note: this field may return null, indicating that no valid values can be obtained.
...
{
    /**
     * @var string Storage type. Valid values: "pvc", "hostpath".
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public $VolumeType;
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @param string $VolumeType Storage type. Valid values: "pvc", "hostpath".
Note: this field may return null, indicating that no valid values can be obtained.
