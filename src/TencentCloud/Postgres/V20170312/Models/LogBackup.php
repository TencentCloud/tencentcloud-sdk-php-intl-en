 ...
 * @method string getBackupMethod() Obtain Specifies the backup method. valid values: physical - physical backup, logical - logical backup.
 * @method void setBackupMethod(string $BackupMethod) Set Specifies the backup method. valid values: physical - physical backup, logical - logical backup.
 * @method string getBackupMode() Obtain Backup mode. enumeration value, manual - manual backup; automatic - automatic backup.
 * @method void setBackupMode(string $BackupMode) Set Backup mode. enumeration value, manual - manual backup; automatic - automatic backup.
...
class LogBackup extends AbstractModel
{
    ...
    /**
     * @var string Specifies the backup method. valid values: physical - physical backup, logical - logical backup.
     */
    public $BackupMethod;

    /**
     * @var string Backup mode. enumeration value, manual - manual backup; automatic - automatic backup.
     */
    public $BackupMode;
     ...
     * @param string $BackupMethod Specifies the backup method. valid values: physical - physical backup, logical - logical backup.
     * @param string $BackupMode Backup mode. enumeration value, manual - manual backup; automatic - automatic backup.
