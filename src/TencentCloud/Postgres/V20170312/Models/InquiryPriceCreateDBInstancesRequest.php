 ...
 * @method integer getPid() Obtain Billing ID, which can be obtained through the `Pid` field in the returned value of the `DescribeProductConfig` API.
 * @method void setPid(integer $Pid) Set Billing ID, which can be obtained through the `Pid` field in the returned value of the `DescribeProductConfig` API.
...
class InquiryPriceCreateDBInstancesRequest extends AbstractModel
{
    ...
    /**
     * @var integer Billing ID, which can be obtained through the `Pid` field in the returned value of the `DescribeProductConfig` API.
     */
    public $Pid;
     ...
     * @param integer $Pid Billing ID, which can be obtained through the `Pid` field in the returned value of the `DescribeProductConfig` API.
