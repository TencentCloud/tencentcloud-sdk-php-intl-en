 ...
 * @method array getXlogList() Obtain Xlog list
 * @method void setXlogList(array $XlogList) Set Xlog list
...
{
    /**
     * @var integer Number of date entries returned this time.
     */
    public $TotalCount;
     ...
     * @param array $XlogList Xlog list
