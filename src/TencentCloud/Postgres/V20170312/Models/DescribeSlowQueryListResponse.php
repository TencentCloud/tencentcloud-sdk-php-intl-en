 ...
 * @method array getDurationAnalysis() Obtain Describes the segmented analysis results of the duration of the queried slow logs.
 * @method void setDurationAnalysis(array $DurationAnalysis) Set Describes the segmented analysis results of the duration of the queried slow logs.
...
class DescribeSlowQueryListResponse extends AbstractModel
{
    ...
    /**
     * @var array Describes the segmented analysis results of the duration of the queried slow logs.
     */
     ...
     * @param array $DurationAnalysis Describes the segmented analysis results of the duration of the queried slow logs.
