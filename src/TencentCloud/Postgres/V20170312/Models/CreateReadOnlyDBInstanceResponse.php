 ...
 * @method string getBillingParameters() Obtain BillingParameters specifies the parameters for product order placement. the output has a value only when billingparameters is provided.
 * @method void setBillingParameters(string $BillingParameters) Set BillingParameters specifies the parameters for product order placement. the output has a value only when billingparameters is provided.
...
class CreateReadOnlyDBInstanceResponse extends AbstractModel
{
    ...
    /**
     * @var string BillingParameters specifies the parameters for product order placement. the output has a value only when billingparameters is provided.
     */
     ...
     * @param string $BillingParameters BillingParameters specifies the parameters for product order placement. the output has a value only when billingparameters is provided.
