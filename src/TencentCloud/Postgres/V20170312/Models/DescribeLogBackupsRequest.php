 ...
 * @method string getOrderBy() Obtain Sorting field, supports StartTime, FinishTime, and Size. default value: StartTime.
 * @method void setOrderBy(string $OrderBy) Set Sorting field, supports StartTime, FinishTime, and Size. default value: StartTime.
...
db-instance-status: filter by instance status (in string format). valid values refer to the DBInstanceStatus field in the DBInstance structure (https://www.tencentcloud.com/document/api/409/16778?from_cn_redirect=1#DBInstance).
    ...
    /**
     * @var string Sorting field, supports StartTime, FinishTime, and Size. default value: StartTime.
     */
    public $OrderBy;
...
db-instance-status: filter by instance status (in string format). valid values refer to the DBInstanceStatus field in the DBInstance structure (https://www.tencentcloud.com/document/api/409/16778?from_cn_redirect=1#DBInstance).
     ...
     * @param string $OrderBy Sorting field, supports StartTime, FinishTime, and Size. default value: StartTime.
