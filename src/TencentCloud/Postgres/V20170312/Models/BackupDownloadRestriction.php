 ...
 * @method array getIpSet() Obtain Whether it is allowed to download IP list of the backup files.
 * @method void setIpSet(array $IpSet) Set Whether it is allowed to download IP list of the backup files.
 */
class BackupDownloadRestriction extends AbstractModel
{
    ...
    /**
     * @var array Whether it is allowed to download IP list of the backup files.
     */
    public $IpSet;
     ...
     * @param array $IpSet Whether it is allowed to download IP list of the backup files.
     */
