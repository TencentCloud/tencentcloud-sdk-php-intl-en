 ...
 * @method string getDatabaseOwner() Obtain New owner of the database. obtain through the api [DescribeAccounts](https://www.tencentcloud.com/document/product/409/18109).
 * @method void setDatabaseOwner(string $DatabaseOwner) Set New owner of the database. obtain through the api [DescribeAccounts](https://www.tencentcloud.com/document/product/409/18109).
 */
class ModifyDatabaseOwnerRequest extends AbstractModel
{
    ...
    /**
     * @var string New owner of the database. obtain through the api [DescribeAccounts](https://www.tencentcloud.com/document/product/409/18109).
     */
     ...
     * @param string $DatabaseOwner New owner of the database. obtain through the api [DescribeAccounts](https://www.tencentcloud.com/document/product/409/18109).
     */
