 ...
 * @method string getRoleName() Obtain Role name, fuzzy search
 * @method void setRoleName(string $RoleName) Set Role name, fuzzy search
...
class DescribeRocketMQRolesRequest extends AbstractModel
{
    ...
    /**
     * @var string Role name, fuzzy search
     */
    public $RoleName;
     ...
     * @param string $RoleName Role name, fuzzy search
