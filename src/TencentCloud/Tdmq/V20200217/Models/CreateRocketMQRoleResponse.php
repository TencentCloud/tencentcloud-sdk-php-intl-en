 ...
 * @method string getRemark() Obtain Specifies the remark description.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setRemark(string $Remark) Set Specifies the remark description.
Note: This field may return null, indicating that no valid values can be obtained.
...
class CreateRocketMQRoleResponse extends AbstractModel
{
    ...
    /**
     * @var string Specifies the remark description.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Remark;
     ...
     * @param string $Remark Specifies the remark description.
Note: This field may return null, indicating that no valid values can be obtained.
