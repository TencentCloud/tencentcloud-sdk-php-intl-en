 ...
 *
 * @method string getTopicName() Obtain Topic name is unique under the same account in a single region. Topic name can only contain letters, numbers, "-", and "_", with a maximum of 64 characters. It cannot be modified after creation and is case-insensitive.
 * @method void setTopicName(string $TopicName) Set Topic name is unique under the same account in a single region. Topic name can only contain letters, numbers, "-", and "_", with a maximum of 64 characters. It cannot be modified after creation and is case-insensitive.
 ...
 * @method void setFilterType(integer $FilterType) Set Used to specify the message match policy for the topic. 1: tag match policy (default value); 2: routing match policy.
...
{
    /**
     * @var string Topic name is unique under the same account in a single region. Topic name can only contain letters, numbers, "-", and "_", with a maximum of 64 characters. It cannot be modified after creation and is case-insensitive.
     */
    public $TopicName;
    ...
    /**
     * @var integer Used to specify the message match policy for the topic. 1: tag match policy (default value); 2: routing match policy.
     */
    public $FilterType;
    ...
    /**
     * @param string $TopicName Topic name is unique under the same account in a single region. Topic name can only contain letters, numbers, "-", and "_", with a maximum of 64 characters. It cannot be modified after creation and is case-insensitive.
