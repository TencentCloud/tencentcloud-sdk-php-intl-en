 ...
 * @method array getEnvironmentRoleSets() Obtain Role-based license list
 * @method void setEnvironmentRoleSets(array $EnvironmentRoleSets) Set Role-based license list
...
class DescribeRocketMQEnvironmentRolesResponse extends AbstractModel
{
    ...
    /**
     * @var array Role-based license list
     */
     ...
     * @param array $EnvironmentRoleSets Role-based license list
