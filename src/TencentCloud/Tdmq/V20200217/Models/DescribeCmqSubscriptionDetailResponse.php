 ...
 * @method array getSubscriptionSet() Obtain Set of subscription attributes
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setSubscriptionSet(array $SubscriptionSet) Set Set of subscription attributes
Note: this field may return null, indicating that no valid values can be obtained.
...
class DescribeCmqSubscriptionDetailResponse extends AbstractModel
{
    ...
    /**
     * @var array Set of subscription attributes
Note: this field may return null, indicating that no valid values can be obtained.
     */
     ...
     * @param array $SubscriptionSet Set of subscription attributes
Note: this field may return null, indicating that no valid values can be obtained.
