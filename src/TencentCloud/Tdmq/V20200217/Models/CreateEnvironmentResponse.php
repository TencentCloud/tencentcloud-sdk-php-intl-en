 ...
 * @method boolean getSubscriptionExpirationTimeEnable() Obtain Offline subscription automatic expiration cleanup time
 * @method void setSubscriptionExpirationTimeEnable(boolean $SubscriptionExpirationTimeEnable) Set Offline subscription automatic expiration cleanup time
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var boolean Offline subscription automatic expiration cleanup time
     */
...
Note: this field may return null, indicating that no valid values can be obtained.
     ...
     * @param boolean $SubscriptionExpirationTimeEnable Offline subscription automatic expiration cleanup time
