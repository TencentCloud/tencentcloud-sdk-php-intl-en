 ...
 * @method array getTopicMsgLogSets() Obtain Message List
 * @method void setTopicMsgLogSets(array $TopicMsgLogSets) Set Message List
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param array $TopicMsgLogSets Message List
