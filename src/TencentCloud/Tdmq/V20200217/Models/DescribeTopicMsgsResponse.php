 ...
 * @method array getTopicMsgLogSets() Obtain Message log list.
 * @method void setTopicMsgLogSets(array $TopicMsgLogSets) Set Message log list.
...
class DescribeTopicMsgsResponse extends AbstractModel
{
     ...
     * @param array $TopicMsgLogSets Message log list.
