 ...
 * @method RocketMQClusterRecentStats getClusterStats() Obtain Cluster recent usage, about to be deprecated. Use TCOP to obtain related data.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setClusterStats(RocketMQClusterRecentStats $ClusterStats) Set Cluster recent usage, about to be deprecated. Use TCOP to obtain related data.
Note: This field may return null, indicating that no valid values can be obtained.
...
class DescribeRocketMQClusterResponse extends AbstractModel
{
    ...
    /**
     * @var RocketMQClusterRecentStats Cluster recent usage, about to be deprecated. Use TCOP to obtain related data.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $ClusterStats;
     ...
     * @param RocketMQClusterRecentStats $ClusterStats Cluster recent usage, about to be deprecated. Use TCOP to obtain related data.
Note: This field may return null, indicating that no valid values can be obtained.
