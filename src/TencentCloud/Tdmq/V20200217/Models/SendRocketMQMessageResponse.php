 ...
 *
 * @method boolean getResult() Obtain Message sending result
 * @method void setResult(boolean $Result) Set Message sending result
...
{
    /**
     * @var boolean Message sending result
     */
    public $Result;
...
Note: u200dThis field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @param boolean $Result Message sending result
