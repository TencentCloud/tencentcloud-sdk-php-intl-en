 ...
 *
 * @method Cluster getClusterSet() Obtain Cluster details
 * @method void setClusterSet(Cluster $ClusterSet) Set Cluster details
...
class DescribeClusterDetailResponse extends AbstractModel
{
    ...
    /**
     * @param Cluster $ClusterSet Cluster details
