...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method array getConsumerLogSets() Obtain Consumption log.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setConsumerLogSets(array $ConsumerLogSets) Set Consumption log.
Note: This field may return null, indicating that no valid values can be obtained.
 */
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param array $ConsumerLogSets Consumption log.
Note: This field may return null, indicating that no valid values can be obtained.
     */
