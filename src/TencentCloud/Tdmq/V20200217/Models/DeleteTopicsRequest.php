 ...
 *
 * @method array getTopicSets() Obtain Set of topics. Up to 20 topics can be deleted at a time.
 * @method void setTopicSets(array $TopicSets) Set Set of topics. Up to 20 topics can be deleted at a time.
...
{
    /**
     * @var array Set of topics. Up to 20 topics can be deleted at a time.
     */
    public $TopicSets;
    ...
    /**
     * @param array $TopicSets Set of topics. Up to 20 topics can be deleted at a time.
