...
class RewindCmqQueueRequest extends AbstractModel
{
    ...
    /**
     * @var integer After this time is configured, the `(Batch)receiveMessage` API will consume the messages received after this timestamp in the order in which they are produced.
     */
