 ...
 * @method string getType() Obtain Topic type. Valid values: Normal, GlobalOrder, PartitionedOrder.
 * @method void setType(string $Type) Set Topic type. Valid values: Normal, GlobalOrder, PartitionedOrder.
...
class CreateRocketMQTopicRequest extends AbstractModel
{
    ...
    /**
     * @var string Topic type. Valid values: Normal, GlobalOrder, PartitionedOrder.
     */
    public $Type;
     ...
     * @param string $Type Topic type. Valid values: Normal, GlobalOrder, PartitionedOrder.
