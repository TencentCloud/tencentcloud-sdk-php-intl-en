 ...
 * @method string getRemark() Obtain Remarks, within 128 characters.
 * @method void setRemark(string $Remark) Set Remarks, within 128 characters.
 * @method integer getTopicType() Obtain 0: standard message.
Global sequential message.
2: local ordered messages.
Specifies the retry queue.
4: dead letter queue.
 * @method void setTopicType(integer $TopicType) Set 0: standard message.
Global sequential message.
2: local ordered messages.
Specifies the retry queue.
4: dead letter queue.
...
class CreateTopicResponse extends AbstractModel
{
    ...
    /**
     * @var string Remarks, within 128 characters.
     */
    public $Remark;

    /**
     * @var integer 0: standard message.
Global sequential message.
2: local ordered messages.
Specifies the retry queue.
4: dead letter queue.
     ...
     * @param string $Remark Remarks, within 128 characters.
     * @param integer $TopicType 0: standard message.
Global sequential message.
2: local ordered messages.
Specifies the retry queue.
4: dead letter queue.
