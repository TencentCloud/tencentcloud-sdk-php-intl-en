 ...
 * @method RocketMQInstanceConfig getInstanceConfig() Obtain Cluster configuration
 * @method void setInstanceConfig(RocketMQInstanceConfig $InstanceConfig) Set Cluster configuration
...
class DescribeRocketMQVipInstanceDetailResponse extends AbstractModel
{
    ...
    /**
     * @var RocketMQInstanceConfig Cluster configuration
     */
     ...
     * @param RocketMQInstanceConfig $InstanceConfig Cluster configuration
