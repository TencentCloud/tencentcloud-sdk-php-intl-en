 ...
 *
 * @method string getDealName() Obtain <p>Sub-order number</p>
 * @method void setDealName(string $DealName) Set <p>Sub-order number</p>
 * @method string getBigDealId() Obtain <p>Order ID</p>
 * @method void setBigDealId(string $BigDealId) Set <p>Order ID</p>
...
{
    /**
     * @var string <p>Sub-order number</p>
     */
    public $DealName;
    ...
    /**
     * @param string $DealName <p>Sub-order number</p>
     * @param string $BigDealId <p>Order ID</p>
