 ...
 * @method string getPartSegmentationInfo() Obtain Component segmentation data;
 ...
 * @method void setPartSegmentationInfo(string $PartSegmentationInfo) Set Component segmentation data;
Output format: {"MeshName_part_1": {"face_ids": [1,2,3..], "color": "#FF805C"}}
Here, face_idsis an integer array representing a set of face IDs for the segment, and colorspecifies the display color.
...
Example value: RUN
    ...
    /**
     * @var string Component segmentation data;
Output format: {"MeshName_part_1": {"face_ids": [1,2,3..], "color": "#FF805C"}}
Here, face_idsis an integer array representing a set of face IDs for the segment, and colorspecifies the display color.
     */
...
Example value: RUN
     ...
     * @param string $PartSegmentationInfo Component segmentation data;
Output format: {"MeshName_part_1": {"face_ids": [1,2,3..], "color": "#FF805C"}}
Here, face_idsis an integer array representing a set of face IDs for the segment, and colorspecifies the display color.
