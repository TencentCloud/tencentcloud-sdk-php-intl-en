 ...
 *
 * @method string getCfwInsId() Obtain Firewall instance ID
 * @method void setCfwInsId(string $CfwInsId) Set Firewall instance ID
...
class CreateNatFwInstanceResponse extends AbstractModel
{
    ...
    /**
     * @param string $CfwInsId Firewall instance ID
