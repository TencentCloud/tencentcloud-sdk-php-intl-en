 ...
 * @method array getData() Obtain Access control list data
 * @method void setData(array $Data) Set Access control list data
...
class DescribeAcListsResponse extends AbstractModel
{
    ...
    /**
     * @var array Access control list data
     */
    public $Data;
...
Note: This field may return `null`, indicating that no valid value was found.
     ...
     * @param array $Data Access control list data
