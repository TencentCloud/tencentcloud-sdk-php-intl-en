...
Note: This field may return `null`, indicating that no valid value was found.
 * @method integer getStatus() Obtain Status value. 0: success; 1: scanning; others: failed
 * @method void setStatus(integer $Status) Set Status value. 0: success; 1: scanning; others: failed
...
Note: This field may return `null`, indicating that no valid value was found.
    ...
    /**
     * @var integer Status value. 0: success; 1: scanning; others: failed
     */
    public $Status;
...
Note: This field may return `null`, indicating that no valid value was found.
     * @param integer $Status Status value. 0: success; 1: scanning; others: failed
