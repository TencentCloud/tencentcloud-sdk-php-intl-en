 ...
 * @method integer getTotal() Obtain Total number of results, which is used for pagination.
 * @method void setTotal(integer $Total) Set Total number of results, which is used for pagination.
...
class DescribeBlockIgnoreListResponse extends AbstractModel
{
    ...
    /**
     * @var integer Total number of results, which is used for pagination.
     */
    public $Total;
     ...
     * @param integer $Total Total number of results, which is used for pagination.
