 ...
 * @method array getFaceIds() Obtain List of IDs of the faces to be deleted
 * @method void setFaceIds(array $FaceIds) Set List of IDs of the faces to be deleted
 */
class DeleteFaceRequest extends AbstractModel
{
    ...
    /**
     * @var array List of IDs of the faces to be deleted
     */
    public $FaceIds;

    /**
     * @param string $PersonId Person ID
     * @param array $FaceIds List of IDs of the faces to be deleted
     */
