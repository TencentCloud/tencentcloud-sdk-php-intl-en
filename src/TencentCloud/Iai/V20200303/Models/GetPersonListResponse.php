 ...
 *
 * @method array getPersonInfos() Obtain Returned person information
 * @method void setPersonInfos(array $PersonInfos) Set Returned person information
 * @method integer getPersonNum() Obtain Number of persons in the group
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setPersonNum(integer $PersonNum) Set Number of persons in the group
Note: this field may return null, indicating that no valid values can be obtained.
 * @method integer getFaceNum() Obtain Number of faces in the group
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setFaceNum(integer $FaceNum) Set Number of faces in the group
Note: this field may return null, indicating that no valid values can be obtained.
...
{
    /**
     * @var array Returned person information
     */
    public $PersonInfos;

    /**
     * @var integer Number of persons in the group
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public $PersonNum;

    /**
     * @var integer Number of faces in the group
Note: this field may return null, indicating that no valid values can be obtained.
     */
    public $FaceNum;
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @param array $PersonInfos Returned person information
     * @param integer $PersonNum Number of persons in the group
Note: this field may return null, indicating that no valid values can be obtained.
     * @param integer $FaceNum Number of faces in the group
Note: this field may return null, indicating that no valid values can be obtained.
