 ...
 *
 * @method array getGroupIds() Obtain List of groups to be searched in. Up to 60 groups are supported.
 * @method void setGroupIds(array $GroupIds) Set List of groups to be searched in. Up to 60 groups are supported.
...
{
    /**
     * @var array List of groups to be searched in. Up to 60 groups are supported.
     */
    public $GroupIds;
...
If the image quality does not meet the requirement, the returned result will prompt that the detected image quality is unsatisfactory.
    ...
    /**
     * @param array $GroupIds List of groups to be searched in. Up to 60 groups are supported.
