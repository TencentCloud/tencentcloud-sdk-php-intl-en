 ...
 * @method Models\DetectFaceSimilarityResponse DetectFaceSimilarity(Models\DetectFaceSimilarityRequest $req) This API is used to perform similarity comparison between human faces in two images and return the facial similarity score.
