 ...
 *
 * @method string getClusterId() Obtain The ID of the cluster where table group tags need to be modified
 * @method void setClusterId(string $ClusterId) Set The ID of the cluster where table group tags need to be modified
 * @method string getTableGroupId() Obtain The ID of the table group whose tags need to be modified
 * @method void setTableGroupId(string $TableGroupId) Set The ID of the table group whose tags need to be modified
...
{
    /**
     * @var string The ID of the cluster where table group tags need to be modified
     */
    public $ClusterId;

    /**
     * @var string The ID of the table group whose tags need to be modified
     */
    public $TableGroupId;
    ...
    /**
     * @param string $ClusterId The ID of the cluster where table group tags need to be modified
     * @param string $TableGroupId The ID of the table group whose tags need to be modified
