 ...
 *
 * @method integer getRestProxyStatus() Obtain RestProxy status. Valid values: 0 (disabled), 1 (enabling), 2 (enabled), 3 (disabling).
 * @method void setRestProxyStatus(integer $RestProxyStatus) Set RestProxy status. Valid values: 0 (disabled), 1 (enabling), 2 (enabled), 3 (disabling).
...
{
    /**
     * @var integer RestProxy status. Valid values: 0 (disabled), 1 (enabling), 2 (enabled), 3 (disabling).
     */
    ...
    /**
     * @param integer $RestProxyStatus RestProxy status. Valid values: 0 (disabled), 1 (enabling), 2 (enabled), 3 (disabling).
