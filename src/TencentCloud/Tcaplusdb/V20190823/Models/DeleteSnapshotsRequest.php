 ...
 * @method array getSelectedTables() Obtain The list of snapshots to delete
 * @method void setSelectedTables(array $SelectedTables) Set The list of snapshots to delete
 */
class DeleteSnapshotsRequest extends AbstractModel
{
    ...
    /**
     * @var array The list of snapshots to delete
     */
    public $SelectedTables;

    /**
     * @param string $ClusterId The ID of the cluster where the table resides
     * @param array $SelectedTables The list of snapshots to delete
     */
