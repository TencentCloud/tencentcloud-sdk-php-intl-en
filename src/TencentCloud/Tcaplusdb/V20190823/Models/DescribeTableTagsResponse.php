 ...
 * @method array getRows() Obtain The information list of table tags
 * @method void setRows(array $Rows) Set The information list of table tags
...
class DescribeTableTagsResponse extends AbstractModel
{
    ...
    /**
     * @var array The information list of table tags
     */
    public $Rows;
     ...
     * @param array $Rows The information list of table tags
