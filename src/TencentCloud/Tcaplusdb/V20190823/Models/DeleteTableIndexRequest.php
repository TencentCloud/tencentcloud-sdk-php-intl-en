 ...
 * @method array getSelectedTables() Obtain The list of tables whose global indexes need to be deleted
 * @method void setSelectedTables(array $SelectedTables) Set The list of tables whose global indexes need to be deleted
 */
class DeleteTableIndexRequest extends AbstractModel
{
    ...
    /**
     * @var array The list of tables whose global indexes need to be deleted
     */
    public $SelectedTables;

    /**
     * @param string $ClusterId ID of the cluster where the table resides
     * @param array $SelectedTables The list of tables whose global indexes need to be deleted
     */
