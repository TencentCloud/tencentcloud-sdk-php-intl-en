 ...
 * @method integer getMachineNum() Obtain Machine quantity
 * @method void setMachineNum(integer $MachineNum) Set Machine quantity
 */
class MachineInfo extends AbstractModel
{
    ...
    /**
     * @var integer Machine quantity
     */
    public $MachineNum;

    /**
     * @param string $MachineType Machine type
     * @param integer $MachineNum Machine quantity
     */
