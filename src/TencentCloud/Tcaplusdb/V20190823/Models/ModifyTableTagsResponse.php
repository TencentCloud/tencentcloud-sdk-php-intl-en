 ...
 * @method array getTableResults() Obtain Returned results
 * @method void setTableResults(array $TableResults) Set Returned results
...
class ModifyTableTagsResponse extends AbstractModel
{
     ...
     * @param array $TableResults Returned results
