 ...
 * @method array getSelectedTables() Obtain The list of tables for which data subscription will be enabled
 * @method void setSelectedTables(array $SelectedTables) Set The list of tables for which data subscription will be enabled
 */
class SetTableDataFlowRequest extends AbstractModel
{
    ...
    /**
     * @var array The list of tables for which data subscription will be enabled
     */
    public $SelectedTables;

    /**
     * @param string $ClusterId The ID of the cluster where the tables reside
     * @param array $SelectedTables The list of tables for which data subscription will be enabled
     */
