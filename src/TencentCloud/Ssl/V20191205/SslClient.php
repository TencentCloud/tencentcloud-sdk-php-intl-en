 ...
 * @method Models\CheckCertificateDomainVerificationResponse CheckCertificateDomainVerification(Models\CheckCertificateDomainVerificationRequest $req) Check the domain validation result of the cert
 ...
 * @method Models\DescribeCertificateBindResourceTaskDetailResponse DescribeCertificateBindResourceTaskDetail(Models\DescribeCertificateBindResourceTaskDetailRequest $req) Query the task result of CreateCertificateBindResourceSyncTask, return the asynchronous task result of binding cloud resources with the certificate, support the following cloud resources: clb, cdn, waf, live, vod, ddos, tke, apigateway, tcb, teo (edgeOne), cos, gaap, mqtt, scf, tdmq.
 ...
 * @method Models\ModifyCertificatesExpiringNotificationSwitchResponse ModifyCertificatesExpiringNotificationSwitch(Models\ModifyCertificatesExpiringNotificationSwitchRequest $req) Modify to ignore certificate expiration notifications. Enable or disable certificate expiration notifications.
 ...
 * @method Models\RevokeCertificateResponse RevokeCertificate(Models\RevokeCertificateRequest $req) This API is used to revoke certificate.
 ...
 * @method Models\UploadUpdateCertificateInstanceResponse UploadUpdateCertificateInstance(Models\UploadUpdateCertificateInstanceRequest $req) This API requires contacting support to be whitelisted for use, and it only supports updating CLB resources related to certificates. This API is used to update certificate content (certificate ID unchanged) and update associated Tencent Cloud resources. This is an asynchronous API. After calling, a DeployRecordId of 0 indicates that the task is in progress. Repeatedly request this API, and when DeployRecordId is greater than 0, it means the task has been successfully created. If the task is not successfully created, an exception will be thrown.
 * @method Models\UploadUpdateCertificateRecordRetryResponse UploadUpdateCertificateRecordRetry(Models\UploadUpdateCertificateRecordRetryRequest $req) Cloud Resource Update (Certificate ID Unchanged) Deployment Retry Record.
 * @method Models\UploadUpdateCertificateRecordRollbackResponse UploadUpdateCertificateRecordRollback(Models\UploadUpdateCertificateRecordRollbackRequest $req) This API is used to roll back the full task when cloud resource update succeeds with unchanged certificate ID.
 */
