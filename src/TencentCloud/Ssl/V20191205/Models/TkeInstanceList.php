 ...
 * @method array getInstanceList() Obtain The list of TKE instances.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setInstanceList(array $InstanceList) Set The list of TKE instances.
Note: This field may return null, indicating that no valid values can be obtained.
...
class TkeInstanceList extends AbstractModel
{
    ...
    /**
     * @var array The list of TKE instances.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $InstanceList;

    /**
     * @var integer The total number of TKE instances in this region.	
     */
    public $TotalCount;
