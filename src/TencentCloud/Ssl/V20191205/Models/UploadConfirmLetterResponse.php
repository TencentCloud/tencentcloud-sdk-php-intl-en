 ...
 * @method boolean getIsSuccess() Obtain Whether the operation is successful
 * @method void setIsSuccess(boolean $IsSuccess) Set Whether the operation is successful
