 ...
 *
 * @method array getCertificateIds() Obtain Certificate ID list.
 * @method void setCertificateIds(array $CertificateIds) Set Certificate ID list.
...
class ModifyCertificatesExpiringNotificationSwitchResponse extends AbstractModel
{
    ...
    /**
     * @param array $CertificateIds Certificate ID list.
