 ...
 * @method array getInstanceList() Obtain The list of CLB instances.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setInstanceList(array $InstanceList) Set The list of CLB instances.
Note: This field may return null, indicating that no valid values can be obtained.
...
class ClbInstanceList extends AbstractModel
{
    ...
    /**
     * @var array The list of CLB instances.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $InstanceList;
     ...
     * @param array $InstanceList The list of CLB instances.
Note: This field may return null, indicating that no valid values can be obtained.
