 ...
 * @method array getServerCertIdList() Obtain Server certificate list
 * @method void setServerCertIdList(array $ServerCertIdList) Set Server certificate list
 * @method array getCaCertIdList() Obtain Certificate list
 * @method void setCaCertIdList(array $CaCertIdList) Set Certificate list
 */
class MQTTInstanceDetail extends AbstractModel
{
    ...
    /**
     * @var array Server certificate list
     */
    public $ServerCertIdList;

    /**
     * @var array Certificate list
     */
    public $CaCertIdList;
     ...
     * @param array $ServerCertIdList Server certificate list
     * @param array $CaCertIdList Certificate list
     */
