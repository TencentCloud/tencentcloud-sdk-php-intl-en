 ...
 * @method integer getTimeSpan() Obtain Certificate validity period. Currently, you can only purchase 1-year certificates.
 * @method void setTimeSpan(integer $TimeSpan) Set Certificate validity period. Currently, you can only purchase 1-year certificates.
 */
class CreateCertificateRequest extends AbstractModel
{
    ...
    /**
     * @var integer Certificate validity period. Currently, you can only purchase 1-year certificates.
     */
    public $TimeSpan;
     ...
     * @param integer $TimeSpan Certificate validity period. Currently, you can only purchase 1-year certificates.
     */
