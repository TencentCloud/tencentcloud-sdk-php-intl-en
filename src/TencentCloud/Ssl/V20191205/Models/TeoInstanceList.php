 ...
 *
 * @method array getInstanceList() Obtain The list of EDGEONE instances.	
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setInstanceList(array $InstanceList) Set The list of EDGEONE instances.	
Note: This field may return null, indicating that no valid values can be obtained.
 * @method integer getTotalCount() Obtain The total number of EDGEONE instances.	
 * @method void setTotalCount(integer $TotalCount) Set The total number of EDGEONE instances.	
...
{
    /**
     * @var array The list of EDGEONE instances.	
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $InstanceList;

    /**
     * @var integer The total number of EDGEONE instances.	
     */
    public $TotalCount;
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @param array $InstanceList The list of EDGEONE instances.	
Note: This field may return null, indicating that no valid values can be obtained.
     * @param integer $TotalCount The total number of EDGEONE instances.	
