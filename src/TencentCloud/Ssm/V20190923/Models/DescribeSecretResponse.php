 ...
 * @method integer getSecretType() Obtain 0: custom secret; 1: database credential; 2: SSH key secret; 3: cloud API key (AKSK) secret (To use this function, you need to contact the cloud assistant to activate the allowlist separately); 4: Redis secret.Note: This field may return `null`, indicating no valid value can be obtained.
 * @method void setSecretType(integer $SecretType) Set 0: custom secret; 1: database credential; 2: SSH key secret; 3: cloud API key (AKSK) secret (To use this function, you need to contact the cloud assistant to activate the allowlist separately); 4: Redis secret.Note: This field may return `null`, indicating no valid value can be obtained.
...
class DescribeSecretResponse extends AbstractModel
{
    ...
    /**
     * @var integer 0: custom secret; 1: database credential; 2: SSH key secret; 3: cloud API key (AKSK) secret (To use this function, you need to contact the cloud assistant to activate the allowlist separately); 4: Redis secret.Note: This field may return `null`, indicating no valid value can be obtained.
     */
    public $SecretType;
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param integer $SecretType 0: custom secret; 1: database credential; 2: SSH key secret; 3: cloud API key (AKSK) secret (To use this function, you need to contact the cloud assistant to activate the allowlist separately); 4: Redis secret.Note: This field may return `null`, indicating no valid value can be obtained.
