 ...
 * @method string getPath() Obtain Directory absolute path.
 * @method void setPath(string $Path) Set Directory absolute path.
 ...
 * @method string getTargetPath() Obtain Target path.
 * @method void setTargetPath(string $TargetPath) Set Target path.
 */
class CheckResult extends AbstractModel
{
    ...
    /**
     * @var string Directory absolute path.
     */
    public $Path;
