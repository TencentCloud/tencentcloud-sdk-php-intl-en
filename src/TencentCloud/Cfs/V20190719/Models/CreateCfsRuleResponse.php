 ...
 * @method string getAuthClientIp() Obtain Client IP
 * @method void setAuthClientIp(string $AuthClientIp) Set Client IP
 * @method string getRWPermission() Obtain Read & write permissions
 * @method void setRWPermission(string $RWPermission) Set Read & write permissions
...
class CreateCfsRuleResponse extends AbstractModel
{
    ...
    /**
     * @var string Read & write permissions
     */
    public $RWPermission;
     ...
     * @param string $AuthClientIp Client IP
     * @param string $RWPermission Read & write permissions
