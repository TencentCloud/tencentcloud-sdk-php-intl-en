 ...
 *
 * @method integer getTotalCount() Obtain Total number of migration tasks.
 * @method void setTotalCount(integer $TotalCount) Set Total number of migration tasks.
...
{
    /**
     * @var integer Total number of migration tasks.
     */
    public $TotalCount;
    ...
    /**
     * @param integer $TotalCount Total number of migration tasks.
