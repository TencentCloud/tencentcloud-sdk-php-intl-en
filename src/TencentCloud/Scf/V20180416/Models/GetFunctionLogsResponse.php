 ...
 * @method LogSearchContext getSearchContext() Obtain Parameter on the log service page
...
class GetFunctionLogsResponse extends AbstractModel
{
    ...
    /**
     * @var LogSearchContext Parameter on the log service page
     */
     ...
     * @param LogSearchContext $SearchContext Parameter on the log service page
