 ...
 *
 * @method array getLayerVersions() Obtain Layer version list
 * @method void setLayerVersions(array $LayerVersions) Set Layer version list
...
class ListLayerVersionsResponse extends AbstractModel
{
    ...
    /**
     * @param array $LayerVersions Layer version list
