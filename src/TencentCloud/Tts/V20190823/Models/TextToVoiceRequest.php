 ...
 * @method integer getSegmentRate() Obtain Segmentation rate. Valid range: [0,1,2]; default value: `0`. The higher the value, the lower the rate, and the easier the segmentation. It is recommended not to change this parameter to ensure better synthesis quality.
 * @method void setSegmentRate(integer $SegmentRate) Set Segmentation rate. Valid range: [0,1,2]; default value: `0`. The higher the value, the lower the rate, and the easier the segmentation. It is recommended not to change this parameter to ensure better synthesis quality.
 */
...
<li>101056-zhilin (Dongbei dialect)</li>
    ...
    /**
     * @var integer Segmentation rate. Valid range: [0,1,2]; default value: `0`. The higher the value, the lower the rate, and the easier the segmentation. It is recommended not to change this parameter to ensure better synthesis quality.
     */
    public $SegmentRate;
...
<li>101056-zhilin (Dongbei dialect)</li>
     ...
     * @param integer $SegmentRate Segmentation rate. Valid range: [0,1,2]; default value: `0`. The higher the value, the lower the rate, and the easier the segmentation. It is recommended not to change this parameter to ensure better synthesis quality.
     */
