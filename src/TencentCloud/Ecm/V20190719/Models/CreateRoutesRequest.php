 ...
 * @method array getRoutes() Obtain Routing policy object to be created.
 * @method void setRoutes(array $Routes) Set Routing policy object to be created.
 */
class CreateRoutesRequest extends AbstractModel
{
    ...
    /**
     * @var array Routing policy object to be created.
     */
    public $Routes;

    /**
     * @param string $RouteTableId Route table instance ID.
     * @param array $Routes Routing policy object to be created.
     */
