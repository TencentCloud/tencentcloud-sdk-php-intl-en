 ...
 * @method array getRouteTableSet() Obtain List of route tables
Note: this field may return null, indicating that no valid values can be obtained.
 * @method void setRouteTableSet(array $RouteTableSet) Set List of route tables
Note: this field may return null, indicating that no valid values can be obtained.
...
class DescribeRouteTablesResponse extends AbstractModel
{
    ...
    /**
     * @var array List of route tables
Note: this field may return null, indicating that no valid values can be obtained.
     */
     ...
     * @param array $RouteTableSet List of route tables
Note: this field may return null, indicating that no valid values can be obtained.
