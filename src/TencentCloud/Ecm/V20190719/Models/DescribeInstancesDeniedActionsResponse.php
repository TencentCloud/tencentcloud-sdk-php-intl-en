 ...
 *
 * @method array getInstanceOperatorSet() Obtain Prohibited operations for the instance
 * @method void setInstanceOperatorSet(array $InstanceOperatorSet) Set Prohibited operations for the instance
...
class DescribeInstancesDeniedActionsResponse extends AbstractModel
{
    ...
    /**
     * @param array $InstanceOperatorSet Prohibited operations for the instance
