 ...
 *
 * @method SecurityGroupLimitSet getSecurityGroupLimitSet() Obtain Security group quota limit.
 * @method void setSecurityGroupLimitSet(SecurityGroupLimitSet $SecurityGroupLimitSet) Set Security group quota limit.
...
{
    /**
     * @var SecurityGroupLimitSet Security group quota limit.
     */
    ...
    /**
     * @param SecurityGroupLimitSet $SecurityGroupLimitSet Security group quota limit.
