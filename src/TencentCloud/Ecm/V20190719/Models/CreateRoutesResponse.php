 ...
 *
 * @method integer getTotalCount() Obtain Number of added instances.
 * @method void setTotalCount(integer $TotalCount) Set Number of added instances.
...
{
    /**
     * @var integer Number of added instances.
     */
    public $TotalCount;
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @param integer $TotalCount Number of added instances.
