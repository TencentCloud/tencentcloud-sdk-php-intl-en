 ...
 *
 * @method array getImageIDSet() Obtain List of image IDs.
 * @method void setImageIDSet(array $ImageIDSet) Set List of image IDs.
 */
class DeleteImageRequest extends AbstractModel
{
    ...
    /**
     * @param array $ImageIDSet List of image IDs.
     */
