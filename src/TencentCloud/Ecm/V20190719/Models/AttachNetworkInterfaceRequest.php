 ...
 * @method string getInstanceId() Obtain Instance ID, such as `ein-r8hr2upy`.
 * @method void setInstanceId(string $InstanceId) Set Instance ID, such as `ein-r8hr2upy`.
...
class AttachNetworkInterfaceRequest extends AbstractModel
{
    ...
    /**
     * @var string Instance ID, such as `ein-r8hr2upy`.
     */
    public $InstanceId;
     ...
     * @param string $InstanceId Instance ID, such as `ein-r8hr2upy`.
