 ...
 *
 * @method array getSecurityGroupAssociationStatisticsSet() Obtain Statistics on the instances associated with the security group.
 * @method void setSecurityGroupAssociationStatisticsSet(array $SecurityGroupAssociationStatisticsSet) Set Statistics on the instances associated with the security group.
...
{
    /**
     * @var array Statistics on the instances associated with the security group.
     */
    ...
    /**
     * @param array $SecurityGroupAssociationStatisticsSet Statistics on the instances associated with the security group.
