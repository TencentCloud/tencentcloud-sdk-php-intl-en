 ...
 *
 * @method MountPoint getMountPoint() Obtain Mount point
 * @method void setMountPoint(MountPoint $MountPoint) Set Mount point
...
class DescribeMountPointResponse extends AbstractModel
{
    ...
    /**
     * @param MountPoint $MountPoint Mount point
