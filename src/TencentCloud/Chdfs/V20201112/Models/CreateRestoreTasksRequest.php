 ...
 * @method array getRestoreTasks() Obtain Multiple restoration tasks (up to 10)
 * @method void setRestoreTasks(array $RestoreTasks) Set Multiple restoration tasks (up to 10)
 */
class CreateRestoreTasksRequest extends AbstractModel
{
    ...
    /**
     * @var array Multiple restoration tasks (up to 10)
     */
    public $RestoreTasks;

    /**
     * @param string $FileSystemId File system ID
     * @param array $RestoreTasks Multiple restoration tasks (up to 10)
     */
