 ...
 *
 * @method array getRestoreTasks() Obtain List of restoration tasks
 * @method void setRestoreTasks(array $RestoreTasks) Set List of restoration tasks
...
{
    /**
     * @var array List of restoration tasks
     */
    public $RestoreTasks;
    ...
    /**
     * @param array $RestoreTasks List of restoration tasks
