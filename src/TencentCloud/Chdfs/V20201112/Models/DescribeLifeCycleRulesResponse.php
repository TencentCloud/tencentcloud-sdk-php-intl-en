 ...
 *
 * @method array getLifeCycleRules() Obtain List of lifecycle rules
 * @method void setLifeCycleRules(array $LifeCycleRules) Set List of lifecycle rules
...
{
    /**
     * @var array List of lifecycle rules
     */
    ...
    /**
     * @param array $LifeCycleRules List of lifecycle rules
