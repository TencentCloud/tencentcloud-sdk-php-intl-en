...
class Application extends AbstractModel
{
    ...
    /**
     * @var string Delivery form of the application. Value range: PACKAGE, LOCAL, which refer to remotely stored software package and local compute environment, respectively.
     */
    public $DeliveryForm;
