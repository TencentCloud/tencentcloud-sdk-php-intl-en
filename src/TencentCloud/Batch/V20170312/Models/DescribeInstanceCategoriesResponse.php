...
/**
 * @method array getInstanceCategorySet() 获取List of CVM instance categories
 * @method void setInstanceCategorySet(array $InstanceCategorySet) 设置List of CVM instance categories
