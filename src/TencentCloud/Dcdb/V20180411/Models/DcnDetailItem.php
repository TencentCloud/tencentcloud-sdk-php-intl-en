...
class DcnDetailItem extends AbstractModel
{
    ...
    /**
     * @var integer Instance type. Valid values: `1` (dedicated primary instance), `2` (non-dedicated primary instance), `3` (non-dedicated disaster recovery instance), and `4` (dedicated disaster recovery instance).
     */
    public $InstanceType;
