 ...
 * @method integer getShardId() Obtain Numeric ID of a shard (this field is obsolete and should not be depended on)
 * @method void setShardId(integer $ShardId) Set Numeric ID of a shard (this field is obsolete and should not be depended on)
 * @method integer getPid() Obtain ProductID
 * @method void setPid(integer $Pid) Set ProductID
...
Note: this field may return null, indicating that no valid values can be obtained.
 * @method string getShardMasterZone() Obtain Master AZ of a shard
Note: this field may return null, indicating that no valid values can be obtained.
...
class DCDBShardInfo extends AbstractModel
{
    ...
    /**
     * @var integer Numeric ID of a shard (this field is obsolete and should not be depended on)
     */
    public $ShardId;
...
Note: this field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var string Master AZ of a shard
Note: this field may return null, indicating that no valid values can be obtained.
     */
