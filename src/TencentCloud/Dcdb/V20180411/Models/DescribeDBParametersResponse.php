 ...
 * @method array getParams() Obtain Requests the current parameter values of the database
 * @method void setParams(array $Params) Set Requests the current parameter values of the database
...
class DescribeDBParametersResponse extends AbstractModel
{
    ...
    /**
     * @var array Requests the current parameter values of the database
     */
    public $Params;
     ...
     * @param array $Params Requests the current parameter values of the database
