 ...
 * @method string getShardId() Obtain The ID of the shard where the node resides
 * @method void setShardId(string $ShardId) Set The ID of the shard where the node resides
 */
class BriefNodeInfo extends AbstractModel
{
    ...
    /**
     * @var string The ID of the shard where the node resides
     */
    public $ShardId;
     ...
     * @param string $ShardId The ID of the shard where the node resides
     */
