 ...
 *
 * @method array getData() Obtain Domain name data
 * @method void setData(array $Data) Set Domain name data
...
class DescribeEcdnDomainStatisticsResponse extends AbstractModel
{
    ...
    /**
     * @param array $Data Domain name data
