 ...
 * @method integer getLimit() Obtain Number of domain names per page. Default value: 100. Maximum value: 1000.
 * @method void setLimit(integer $Limit) Set Number of domain names per page. Default value: 100. Maximum value: 1000.
...
class DescribeDomainsRequest extends AbstractModel
{
    ...
    /**
     * @var integer Number of domain names per page. Default value: 100. Maximum value: 1000.
     */
    public $Limit;
     ...
     * @param integer $Limit Number of domain names per page. Default value: 100. Maximum value: 1000.
