 ...
 *
 * @method WebEventData getData() Obtain Web attack event data
 * @method void setData(WebEventData $Data) Set Web attack event data
 ...
 * @method string getMsg() Obtain Returned data
 * @method void setMsg(string $Msg) Set Returned data
...
{
    /**
     * @var WebEventData Web attack event data
     */
    public $Data;
    ...
    /**
     * @param WebEventData $Data Web attack event data
     * @param integer $Status Status. 1: failed; 0: succeeded
     * @param string $Msg Returned data
