 ...
 * @method string getStatus() Obtain DNSSEC status. Valid values:
- `enabled`: Enabled
- `disabled`: Disabled
 * @method void setStatus(string $Status) Set DNSSEC status. Valid values:
- `enabled`: Enabled
- `disabled`: Disabled
 * @method DnssecInfo getDnssec() Obtain 
 * @method void setDnssec(DnssecInfo $Dnssec) Set 
...
class DescribeDnssecResponse extends AbstractModel
{
    ...
    /**
     * @var string DNSSEC status. Valid values:
- `enabled`: Enabled
- `disabled`: Disabled
     */
    public $Status;
     ...
     * @param string $Status DNSSEC status. Valid values:
- `enabled`: Enabled
- `disabled`: Disabled
     * @param DnssecInfo $Dnssec 
