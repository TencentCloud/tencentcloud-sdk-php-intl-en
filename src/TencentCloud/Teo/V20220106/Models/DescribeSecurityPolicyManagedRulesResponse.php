 ...
 *
 * @method integer getCount() Obtain Number of rules returned
 * @method void setCount(integer $Count) Set Number of rules returned
...
{
    /**
     * @var integer Number of rules returned
     */
    public $Count;
    ...
    /**
     * @param integer $Count Number of rules returned
