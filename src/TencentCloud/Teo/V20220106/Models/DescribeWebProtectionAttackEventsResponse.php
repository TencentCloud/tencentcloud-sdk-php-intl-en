 ...
 *
 * @method CCInterceptEventData getData() Obtain DDoS attack event data
 * @method void setData(CCInterceptEventData $Data) Set DDoS attack event data
...
{
    /**
     * @var CCInterceptEventData DDoS attack event data
     */
    public $Data;
    ...
    /**
     * @param CCInterceptEventData $Data DDoS attack event data
