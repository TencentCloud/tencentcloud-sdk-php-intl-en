 ...
 * @method string getStatus() Obtain CNAME acceleration status.
- `enabled`: Enabled
- `disabled`: Disabled
 * @method void setStatus(string $Status) Set CNAME acceleration status.
- `enabled`: Enabled
- `disabled`: Disabled
...
class ModifyZoneCnameSpeedUpResponse extends AbstractModel
{
    ...
    /**
     * @var string CNAME acceleration status.
- `enabled`: Enabled
- `disabled`: Disabled
     */
    public $Status;
     ...
     * @param string $Status CNAME acceleration status.
- `enabled`: Enabled
- `disabled`: Disabled
