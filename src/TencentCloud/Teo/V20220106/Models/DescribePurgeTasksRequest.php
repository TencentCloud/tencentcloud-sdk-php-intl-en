 ...
 * @method string getType() Obtain Type of the purging task
 * @method void setType(string $Type) Set Type of the purging task
 ...
 * @method string getTarget() Obtain Queries content
 * @method void setTarget(string $Target) Set Queries content
 */
class DescribePurgeTasksRequest extends AbstractModel
{
    ...
    /**
     * @var string Type of the purging task
     */
    public $Type;
...
`processing`, `success`, `failed`, `timeout` and `invalid`
    ...
    /**
     * @var string Queries content
     */
    public $Target;

    /**
     * @param string $JobId Task ID
     * @param string $Type Type of the purging task
...
`processing`, `success`, `failed`, `timeout` and `invalid`
     ...
     * @param string $Target Queries content
     */
