 ...
 * Custom name servers
 *
 * @method string getSwitch() Obtain Whether to enable the custom name server
`on`: Enable
`off`: Disable
 * @method void setSwitch(string $Switch) Set Whether to enable the custom name server
`on`: Enable
`off`: Disable
...
{
    /**
     * @var string Whether to enable the custom name server
`on`: Enable
`off`: Disable
     */
    public $Switch;
    ...
    /**
     * @param string $Switch Whether to enable the custom name server
`on`: Enable
`off`: Disable
