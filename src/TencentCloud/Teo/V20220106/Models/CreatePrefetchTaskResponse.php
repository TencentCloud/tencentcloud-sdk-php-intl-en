 ...
 * @method array getFailedList() Obtain List of failed tasks
Note: This field may return `null`, indicating that no valid value can be obtained.
 * @method void setFailedList(array $FailedList) Set List of failed tasks
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class CreatePrefetchTaskResponse extends AbstractModel
{
    ...
    /**
     * @var array List of failed tasks
Note: This field may return `null`, indicating that no valid value can be obtained.
     */
    public $FailedList;
     ...
     * @param array $FailedList List of failed tasks
Note: This field may return `null`, indicating that no valid value can be obtained.
