 ...
 *
 * @method array getRegionId() Obtain Region information
Note: This field may return `null`, indicating that no valid value can be obtained.
 * @method void setRegionId(array $RegionId) Set Region information
Note: This field may return `null`, indicating that no valid value can be obtained.
...
Note: This field may return `null`, indicating that no valid value can be obtained.
    ...
    /**
     * @param array $RegionId Region information
Note: This field may return `null`, indicating that no valid value can be obtained.
