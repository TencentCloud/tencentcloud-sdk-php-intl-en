 ...
 *
 * @method array getStatus() Obtain List of CNAME statuses
 * @method void setStatus(array $Status) Set List of CNAME statuses
...
class DescribeCnameStatusResponse extends AbstractModel
{
    ...
    /**
     * @param array $Status List of CNAME statuses
