 ...
 * @method array getEntityList() Obtain List of available shipping entities.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setEntityList(array $EntityList) Set List of available shipping entities.
Note: This field may return null, indicating that no valid values can be obtained.
...
class DescribeAddableEntityListResponse extends AbstractModel
{
    ...
    /**
     * @var array List of available shipping entities.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $EntityList;
     ...
     * @param array $EntityList List of available shipping entities.
Note: This field may return null, indicating that no valid values can be obtained.
