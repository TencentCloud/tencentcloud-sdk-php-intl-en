 ...
 * @method string getHost() Obtain The subdomain name to test.
 * @method void setHost(string $Host) Set The subdomain name to test.
 */
class CreateSpeedTestingRequest extends AbstractModel
{
    ...
    /**
     * @var string The subdomain name to test.
     */
    public $Host;

    /**
     * @param string $ZoneId The site ID.
     * @param string $Host The subdomain name to test.
     */
