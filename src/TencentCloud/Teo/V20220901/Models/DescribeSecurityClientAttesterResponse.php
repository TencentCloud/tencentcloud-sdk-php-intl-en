 ...
 *
 * @method integer getTotalCount() Obtain Total number of authentication options.
 * @method void setTotalCount(integer $TotalCount) Set Total number of authentication options.
...
{
    /**
     * @var integer Total number of authentication options.
     */
    public $TotalCount;
    ...
    /**
     * @param integer $TotalCount Total number of authentication options.
