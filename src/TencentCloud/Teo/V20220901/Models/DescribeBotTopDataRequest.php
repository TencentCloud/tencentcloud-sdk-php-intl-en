 ...
 * @method integer getLimit() Obtain Queries the top rows of data. Maximum value: 1000. Top 10 rows of data will be queried if this field is not specified.
 * @method void setLimit(integer $Limit) Set Queries the top rows of data. Maximum value: 1000. Top 10 rows of data will be queried if this field is not specified.
...
<li>`bot_cipRequestNum_region`: Top-ranked client IPs by bot requests.</li>
    ...
    /**
     * @var integer Queries the top rows of data. Maximum value: 1000. Top 10 rows of data will be queried if this field is not specified.
     */
    public $Limit;
...
<li>`bot_cipRequestNum_region`: Top-ranked client IPs by bot requests.</li>
     ...
     * @param integer $Limit Queries the top rows of data. Maximum value: 1000. Top 10 rows of data will be queried if this field is not specified.
