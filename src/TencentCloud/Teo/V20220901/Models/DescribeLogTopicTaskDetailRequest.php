 ...
 *
 * @method string getTopicId() Obtain ID of the shipping task.
 * @method void setTopicId(string $TopicId) Set ID of the shipping task.
...
{
    /**
     * @var string ID of the shipping task.
     */
    public $TopicId;
    ...
    /**
     * @param string $TopicId ID of the shipping task.
