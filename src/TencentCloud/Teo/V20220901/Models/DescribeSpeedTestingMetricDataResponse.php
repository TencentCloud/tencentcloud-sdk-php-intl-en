 ...
 *
 * @method SpeedTestingMetricData getSpeedTestingMetricData() Obtain The site test metrics.
 * @method void setSpeedTestingMetricData(SpeedTestingMetricData $SpeedTestingMetricData) Set The site test metrics.
...
{
    /**
     * @var SpeedTestingMetricData The site test metrics.
     */
    ...
    /**
     * @param SpeedTestingMetricData $SpeedTestingMetricData The site test metrics.
