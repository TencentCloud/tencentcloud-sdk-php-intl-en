 ...
 * @method string getEntityType() Obtain The type. Values:
<li>`domain`: Layer-7 subdomain name</li>
<li>`application`: Layer-4 proxy name</li>
 * @method void setEntityType(string $EntityType) Set The type. Values:
<li>`domain`: Layer-7 subdomain name</li>
<li>`application`: Layer-4 proxy name</li>
 */
...
<li>`application`: Layer-4 proxy name</li>
     ...
     * @param string $EntityType The type. Values:
<li>`domain`: Layer-7 subdomain name</li>
<li>`application`: Layer-4 proxy name</li>
     */
