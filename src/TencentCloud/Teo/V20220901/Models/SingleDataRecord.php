 ...
 * @method array getTypeValue() Obtain Value of the metric under the query dimension.
 * @method void setTypeValue(array $TypeValue) Set Value of the metric under the query dimension.
 */
class SingleDataRecord extends AbstractModel
{
    ...
    /**
     * @var array Value of the metric under the query dimension.
     */
    public $TypeValue;

    /**
     * @param string $TypeKey The query dimension value.
     * @param array $TypeValue Value of the metric under the query dimension.
     */
