 ...
 * @method SecurityPolicy getSecurityPolicy() Obtain Security policy configuration. recommend using for Web exception rules, custom policies, rate rules, managed rules, and Bot management configuration. supports configuring security policies with expression grammar.
 * @method void setSecurityPolicy(SecurityPolicy $SecurityPolicy) Set Security policy configuration. recommend using for Web exception rules, custom policies, rate rules, managed rules, and Bot management configuration. supports configuring security policies with expression grammar.
...
class ModifySecurityPolicyRequest extends AbstractModel
{
    ...
    /**
     * @var SecurityPolicy Security policy configuration. recommend using for Web exception rules, custom policies, rate rules, managed rules, and Bot management configuration. supports configuring security policies with expression grammar.
     */
     ...
     * @param SecurityPolicy $SecurityPolicy Security policy configuration. recommend using for Web exception rules, custom policies, rate rules, managed rules, and Bot management configuration. supports configuring security policies with expression grammar.
