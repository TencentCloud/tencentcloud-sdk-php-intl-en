...
<li>`custom`: Custom</li>
Note: This field may return null, indicating that no valid values can be obtained.
 * @method integer getTypeId() Obtain ID of the rule type.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setTypeId(integer $TypeId) Set ID of the rule type.
Note: This field may return null, indicating that no valid values can be obtained.
 */
...
<li>`custom`: Custom</li>
Note: This field may return null, indicating that no valid values can be obtained.
     * @param integer $TypeId ID of the rule type.
Note: This field may return null, indicating that no valid values can be obtained.
     */
