 ...
 * @method array getTimingDataRecords() Obtain Time series data list for origin-pull data.
 * @method void setTimingDataRecords(array $TimingDataRecords) Set Time series data list for origin-pull data.
...
class DescribeTimingL7OriginPullDataResponse extends AbstractModel
{
    ...
    /**
     * @var array Time series data list for origin-pull data.
     */
     ...
     * @param array $TimingDataRecords Time series data list for origin-pull data.
