 ...
 * @method array getFilters() Obtain Filter criteria. The upper limit for Filters.Values is 20. The detailed filter criteria are as follows:
 ...
 * @method void setFilters(array $Filters) Set Filter criteria. The upper limit for Filters.Values is 20. The detailed filter criteria are as follows:
<li>page-id: Filter by page ID;</li>
<li>name: Filter by page name;</li>
<li>description: Filter by page description;</li>
<li>content-type: Filter by page type.</li>
...
class DescribeCustomErrorPagesRequest extends AbstractModel
{
    ...
    /**
     * @var array Filter criteria. The upper limit for Filters.Values is 20. The detailed filter criteria are as follows:
<li>page-id: Filter by page ID;</li>
<li>name: Filter by page name;</li>
<li>description: Filter by page description;</li>
<li>content-type: Filter by page type.</li>
     ...
     * @param array $Filters Filter criteria. The upper limit for Filters.Values is 20. The detailed filter criteria are as follows:
<li>page-id: Filter by page ID;</li>
<li>name: Filter by page name;</li>
<li>description: Filter by page description;</li>
<li>content-type: Filter by page type.</li>
