 ...
 *
 * @method array getData() Obtain The list of web log data.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setData(array $Data) Set The list of web log data.
Note: This field may return null, indicating that no valid values can be obtained.
...
{
    /**
     * @var array The list of web log data.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Data;
    ...
    /**
     * @param array $Data The list of web log data.
Note: This field may return null, indicating that no valid values can be obtained.
