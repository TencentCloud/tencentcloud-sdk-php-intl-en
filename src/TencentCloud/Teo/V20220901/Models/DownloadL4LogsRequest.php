 ...
 * @method array getProxyIds() Obtain List of L4 proxy IDs.
 * @method void setProxyIds(array $ProxyIds) Set List of L4 proxy IDs.
...
class DownloadL4LogsRequest extends AbstractModel
{
    ...
    /**
     * @var array List of L4 proxy IDs.
     */
    public $ProxyIds;
     ...
     * @param array $ProxyIds List of L4 proxy IDs.
