 ...
 * @method array getMetricNames() Obtain Metrics to query. Values:
 ...
 * @method void setMetricNames(array $MetricNames) Set Metrics to query. Values:
<li>`ccRate_interceptNum`: Requests restricted by the rate limiting rules;</li>
<li>`ccAcl_interceptNum`: Requests restricted by the custom rules.</li>
...
class DescribeWebProtectionDataRequest extends AbstractModel
{
    ...
    /**
     * @var array Metrics to query. Values:
<li>`ccRate_interceptNum`: Requests restricted by the rate limiting rules;</li>
<li>`ccAcl_interceptNum`: Requests restricted by the custom rules.</li>
     */
    public $MetricNames;
...
<li>`mainland`: Chinese mainland.</li>If this field is not specified, the data storage region will be determined based on the user’s location.
     ...
     * @param array $MetricNames Metrics to query. Values:
<li>`ccRate_interceptNum`: Requests restricted by the rate limiting rules;</li>
<li>`ccAcl_interceptNum`: Requests restricted by the custom rules.</li>
