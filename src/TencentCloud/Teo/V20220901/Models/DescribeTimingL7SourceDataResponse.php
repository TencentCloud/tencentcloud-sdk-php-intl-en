 ...
 * @method array getTimingDataRecords() Obtain List of time series traffic data.
Note: This field may return `null`, indicating that no valid value can be obtained.
 * @method void setTimingDataRecords(array $TimingDataRecords) Set List of time series traffic data.
Note: This field may return `null`, indicating that no valid value can be obtained.
...
class DescribeTimingL7SourceDataResponse extends AbstractModel
{
    ...
    /**
     * @var array List of time series traffic data.
Note: This field may return `null`, indicating that no valid value can be obtained.
     */
     ...
     * @param array $TimingDataRecords List of time series traffic data.
Note: This field may return `null`, indicating that no valid value can be obtained.
