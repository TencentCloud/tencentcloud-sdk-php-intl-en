 ...
 *
 * @method integer getTotalCount() Obtain Total number of API services.	
 * @method void setTotalCount(integer $TotalCount) Set Total number of API services.	
...
{
    /**
     * @var integer Total number of API services.	
     */
    public $TotalCount;
    ...
    /**
     * @param integer $TotalCount Total number of API services.	
