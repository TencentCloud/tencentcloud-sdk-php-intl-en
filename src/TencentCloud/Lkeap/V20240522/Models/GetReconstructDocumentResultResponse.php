 ...
 * @method DocumentUsage getUsage() Obtain Amount of document parsing task.
 * @method void setUsage(DocumentUsage $Usage) Set Amount of document parsing task.
 * @method ErrorInfo getError() Obtain Error message for failed document parsing task. When a document parsing task fails, a specific error message will be returned.
 * @method void setError(ErrorInfo $Error) Set Error message for failed document parsing task. When a document parsing task fails, a specific error message will be returned.
...
-WaitExecute: pending execution.
    ...
    /**
     * @var DocumentUsage Amount of document parsing task.
     */
    public $Usage;

    /**
     * @var ErrorInfo Error message for failed document parsing task. When a document parsing task fails, a specific error message will be returned.
     */
    public $Error;
...
-WaitExecute: pending execution.
     ...
     * @param DocumentUsage $Usage Amount of document parsing task.
     * @param ErrorInfo $Error Error message for failed document parsing task. When a document parsing task fails, a specific error message will be returned.
