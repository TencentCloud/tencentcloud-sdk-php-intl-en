 ...
 * @method array getOperations() Obtain Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setOperations(array $Operations) Set Note: This field may return null, indicating that no valid values can be obtained.
...
class DescribeInstanceOperationsResponse extends AbstractModel
{
     ...
     * @param array $Operations Note: This field may return null, indicating that no valid values can be obtained.
