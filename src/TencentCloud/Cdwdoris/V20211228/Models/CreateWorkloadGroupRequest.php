 ...
 * @method WorkloadGroupConfig getWorkloadGroup() Obtain Resource group configuration
 * @method void setWorkloadGroup(WorkloadGroupConfig $WorkloadGroup) Set Resource group configuration
 */
class CreateWorkloadGroupRequest extends AbstractModel
{
    ...
    /**
     * @var WorkloadGroupConfig Resource group configuration
     */
    public $WorkloadGroup;

    /**
     * @param string $InstanceId Cluster ID	
     * @param WorkloadGroupConfig $WorkloadGroup Resource group configuration
     */
