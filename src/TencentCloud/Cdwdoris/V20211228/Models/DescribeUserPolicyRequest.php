 ...
 * @method string getWhiteHost() Obtain You can specify one IP address or specify a percent sign (%) to indicate no limit.
 * @method void setWhiteHost(string $WhiteHost) Set You can specify one IP address or specify a percent sign (%) to indicate no limit.
 */
class DescribeUserPolicyRequest extends AbstractModel
{
    ...
    /**
     * @var string You can specify one IP address or specify a percent sign (%) to indicate no limit.
     */
    public $WhiteHost;
     ...
     * @param string $WhiteHost You can specify one IP address or specify a percent sign (%) to indicate no limit.
     */
