 ...
 * @method DataBaseAuditRecord getSlowQueryRecords() Obtain Record list
 * @method void setSlowQueryRecords(DataBaseAuditRecord $SlowQueryRecords) Set Record list
...
class DescribeDatabaseAuditRecordsResponse extends AbstractModel
{
    ...
    /**
     * @var DataBaseAuditRecord Record list
     */
     ...
     * @param DataBaseAuditRecord $SlowQueryRecords Record list
