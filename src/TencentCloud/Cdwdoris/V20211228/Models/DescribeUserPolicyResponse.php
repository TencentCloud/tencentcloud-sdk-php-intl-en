 ...
 * @method array getPermissions() Obtain Permission configuration information associated with different hosts
 * @method void setPermissions(array $Permissions) Set Permission configuration information associated with different hosts
...
class DescribeUserPolicyResponse extends AbstractModel
{
    ...
    /**
     * @var array Permission configuration information associated with different hosts
     */
    public $Permissions;
     ...
     * @param array $Permissions Permission configuration information associated with different hosts
