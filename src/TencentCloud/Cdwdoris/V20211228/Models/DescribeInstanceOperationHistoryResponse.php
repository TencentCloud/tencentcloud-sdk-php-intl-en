 ...
 * @method array getOperations() Obtain Specific data of operation records
 * @method void setOperations(array $Operations) Set Specific data of operation records
...
class DescribeInstanceOperationHistoryResponse extends AbstractModel
{
    ...
    /**
     * @var array Specific data of operation records
     */
    public $Operations;
     ...
     * @param array $Operations Specific data of operation records
