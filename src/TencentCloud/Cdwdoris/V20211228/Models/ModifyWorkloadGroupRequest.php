 ...
 * @method WorkloadGroupConfig getWorkloadGroup() Obtain Modified resource group information
 * @method void setWorkloadGroup(WorkloadGroupConfig $WorkloadGroup) Set Modified resource group information
 */
class ModifyWorkloadGroupRequest extends AbstractModel
{
    ...
    /**
     * @var WorkloadGroupConfig Modified resource group information
     */
    public $WorkloadGroup;

    /**
     * @param string $InstanceId Cluster ID
     * @param WorkloadGroupConfig $WorkloadGroup Modified resource group information
     */
