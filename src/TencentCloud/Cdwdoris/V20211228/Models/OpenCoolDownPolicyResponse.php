 ...
 * @method string getQueryDocument() Obtain Returned information
 * @method void setQueryDocument(string $QueryDocument) Set Returned information
...
class OpenCoolDownPolicyResponse extends AbstractModel
{
     ...
     * @param string $QueryDocument Returned information
