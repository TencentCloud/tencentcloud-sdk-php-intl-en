 ...
 * @method string getWorkloadGroupName() Obtain Resource group name to be deleted
 * @method void setWorkloadGroupName(string $WorkloadGroupName) Set Resource group name to be deleted
 */
class DeleteWorkloadGroupRequest extends AbstractModel
{
    ...
    /**
     * @var string Resource group name to be deleted
     */
    public $WorkloadGroupName;

    /**
     * @param string $InstanceId Cluster ID
     * @param string $WorkloadGroupName Resource group name to be deleted
     */
