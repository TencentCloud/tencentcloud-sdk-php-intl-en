 ...
 * @method integer getBackUpJobId() Obtain Backup instance ID to be canceled
 * @method void setBackUpJobId(integer $BackUpJobId) Set Backup instance ID to be canceled
 */
class CancelBackupJobRequest extends AbstractModel
{
    ...
    /**
     * @var integer Backup instance ID to be canceled
     */
    public $BackUpJobId;

    /**
     * @param string $InstanceId Cluster ID
     * @param integer $BackUpJobId Backup instance ID to be canceled
     */
