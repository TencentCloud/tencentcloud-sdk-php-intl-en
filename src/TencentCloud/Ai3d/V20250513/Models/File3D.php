 ...
 * @method string getUrl() Obtain File Url (valid for 24 hours).
 * @method void setUrl(string $Url) Set File Url (valid for 24 hours).
 * @method string getPreviewImageUrl() Obtain Preview image Url.
 * @method void setPreviewImageUrl(string $PreviewImageUrl) Set Preview image Url.
 */
class File3D extends AbstractModel
{
    ...
    /**
     * @var string File Url (valid for 24 hours).
     */
    public $Url;

    /**
     * @var string Preview image Url.
     */
    public $PreviewImageUrl;

    /**
     * @param string $Type Specifies the file format.
     * @param string $Url File Url (valid for 24 hours).
