 ...
 * @method string getDb() Obtain Specific name of database to be queried
 * @method void setDb(string $Db) Set Specific name of database to be queried
 * @method string getOrderBy() Obtain Sort by metric. Valid values: query_time_sum, query_count
...
class DescribeDBSlowLogsRequest extends AbstractModel
{
    ...
    /**
     * @var string Specific name of database to be queried
     */
    public $Db;

    /**
     * @var string Sort by metric. Valid values: query_time_sum, query_count
     */
    public $OrderBy;
