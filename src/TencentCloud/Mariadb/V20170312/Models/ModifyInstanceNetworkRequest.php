 ...
 * @method string getVpcId() Obtain VpcId, ID of the desired VPC network.
 * @method void setVpcId(string $VpcId) Set VpcId, ID of the desired VPC network.
 * @method string getSubnetId() Obtain SubnetId, subnet ID of the desired VPC network.
 * @method void setSubnetId(string $SubnetId) Set SubnetId, subnet ID of the desired VPC network.
...
class ModifyInstanceNetworkRequest extends AbstractModel
{
    ...
    /**
     * @var string VpcId, ID of the desired VPC network.
     */
    public $VpcId;

    /**
     * @var string SubnetId, subnet ID of the desired VPC network.
     */
    public $SubnetId;
     ...
     * @param string $VpcId VpcId, ID of the desired VPC network.
     * @param string $SubnetId SubnetId, subnet ID of the desired VPC network.
