 ...
 * @method string getUrlPrefix() Obtain File download link path prefix
 * @method void setUrlPrefix(string $UrlPrefix) Set File download link path prefix
...
class DescribeBackupFilesResponse extends AbstractModel
{
    ...
    /**
     * @var string File download link path prefix
     */
    public $UrlPrefix;
     ...
     * @param string $UrlPrefix File download link path prefix
