 ...
 * @method integer getDays() Obtain Retention days up to 30
 * @method void setDays(integer $Days) Set Retention days up to 30
 */
class ModifyLogFileRetentionPeriodRequest extends AbstractModel
{
    ...
    /**
     * @var integer Retention days up to 30
     */
    public $Days;

    /**
     * @param string $InstanceId Instance ID in the format of `tdsql-ow728lmc`.
     * @param integer $Days Retention days up to 30
     */
