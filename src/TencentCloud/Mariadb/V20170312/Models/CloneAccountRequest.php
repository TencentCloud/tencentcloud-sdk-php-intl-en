 ...
 * @method string getDstDesc() Obtain Description of target account
 * @method void setDstDesc(string $DstDesc) Set Description of target account
 */
class CloneAccountRequest extends AbstractModel
{
    ...
    /**
     * @var string Description of target account
     */
    public $DstDesc;
     ...
     * @param string $DstDesc Description of target account
     */
