 ...
 * @method array getFiles() Obtain Information such as `uri`, `length`, and `mtime` (modification time)
 * @method void setFiles(array $Files) Set Information such as `uri`, `length`, and `mtime` (modification time)
...
class DescribeDBLogFilesResponse extends AbstractModel
{
    ...
    /**
     * @var array Information such as `uri`, `length`, and `mtime` (modification time)
     */
    public $Files;
     ...
     * @param array $Files Information such as `uri`, `length`, and `mtime` (modification time)
