 ...
 * @method array getInstances() Obtain Instance details list
 * @method void setInstances(array $Instances) Set Instance details list
...
class DescribeDBInstancesResponse extends AbstractModel
{
    ...
    /**
     * @var array Instance details list
     */
    public $Instances;
     ...
     * @param array $Instances Instance details list
