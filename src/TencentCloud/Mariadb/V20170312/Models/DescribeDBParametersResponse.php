 ...
 * @method array getParams() Obtain Requests the current parameter values of database
 * @method void setParams(array $Params) Set Requests the current parameter values of database
...
class DescribeDBParametersResponse extends AbstractModel
{
    ...
    /**
     * @var array Requests the current parameter values of database
     */
    public $Params;
     ...
     * @param array $Params Requests the current parameter values of database
