 ...
 * @method string getSetValue() Obtain Previously set value, which is the same as `value` after the parameter takes effect.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setSetValue(string $SetValue) Set Previously set value, which is the same as `value` after the parameter takes effect.
Note: This field may return null, indicating that no valid values can be obtained.
...
class ParamDesc extends AbstractModel
{
    ...
    /**
     * @var string Previously set value, which is the same as `value` after the parameter takes effect.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $SetValue;
...
true: yes.
     ...
     * @param string $SetValue Previously set value, which is the same as `value` after the parameter takes effect.
Note: This field may return null, indicating that no valid values can be obtained.
