 ...
 * @method string getEndBackupTime() Obtain End time of daily backup window in the format of `mm:ss`, such as 23:59
 * @method void setEndBackupTime(string $EndBackupTime) Set End time of daily backup window in the format of `mm:ss`, such as 23:59
 */
class ModifyBackupTimeRequest extends AbstractModel
{
    ...
    /**
     * @var string End time of daily backup window in the format of `mm:ss`, such as 23:59
     */
     ...
     * @param string $EndBackupTime End time of daily backup window in the format of `mm:ss`, such as 23:59
     */
