...
class Deal extends AbstractModel
{
    ...
    /**
     * @var integer ID of the associated process, which can be used to query the process execution status.
     */
    public $FlowId;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var integer Payment mode. Valid values: 0 (postpaid), 1 (prepaid)
     */
    public $PayMode;
