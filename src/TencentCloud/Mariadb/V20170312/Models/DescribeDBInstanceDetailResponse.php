 ...
 * @method string getPayMode() Obtain Billing mode. Valid values: `prepaid` (yearly/monthly subscription), `postpaid` (pay-as-you-go).
 * @method void setPayMode(string $PayMode) Set Billing mode. Valid values: `prepaid` (yearly/monthly subscription), `postpaid` (pay-as-you-go).
 ...
 * @method integer getIsDcnStrongSyncSupported() Obtain <p>Whether strong-sync DCN is supported</p>
 * @method void setIsDcnStrongSyncSupported(integer $IsDcnStrongSyncSupported) Set <p>Whether strong-sync DCN is supported</p>
 * @method integer getIsDcnSwitchSupported() Obtain <p>Whether DCN switching is supported</p>
 * @method void setIsDcnSwitchSupported(integer $IsDcnSwitchSupported) Set <p>Whether DCN switching is supported</p>
 * @method string getProxyVersion() Obtain <p>Proxy version</p>
 * @method void setProxyVersion(string $ProxyVersion) Set <p>Proxy version</p>
 * @method string getCpuType() Obtain <p>CPU type. Examples: Intel/AMD for Intel, Hygon for Hygon.</p>
 * @method void setCpuType(string $CpuType) Set <p>CPU type. Examples: Intel/AMD for Intel, Hygon for Hygon.</p>
 * @method integer getProtectedProperty() Obtain <p>Deletion protection flag. 1: Deletion protection enabled, 0: Deletion protection disabled.</p>
 * @method void setProtectedProperty(integer $ProtectedProperty) Set <p>Deletion protection flag. 1: Deletion protection enabled, 0: Deletion protection disabled.</p>
 * @method integer getFlowId() Obtain <p>Flow ID, which identifies the ongoing asynchronous task of the instance.</p>
 * @method void setFlowId(integer $FlowId) Set <p>Flow ID, which identifies the ongoing asynchronous task of the instance.</p>
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var integer <p>Whether strong-sync DCN is supported</p>
     */
    public $IsDcnStrongSyncSupported;

    /**
     * @var integer <p>Whether DCN switching is supported</p>
     */
    public $IsDcnSwitchSupported;

    /**
     * @var string <p>Proxy version</p>
     */
    public $ProxyVersion;

    /**
     * @var string <p>CPU type. Examples: Intel/AMD for Intel, Hygon for Hygon.</p>
     */
    public $CpuType;

    /**
     * @var integer <p>Deletion protection flag. 1: Deletion protection enabled, 0: Deletion protection disabled.</p>
     */
    public $ProtectedProperty;

    /**
     * @var integer <p>Flow ID, which identifies the ongoing asynchronous task of the instance.</p>
     */
    public $FlowId;
     ...
     * @param string $PayMode Billing mode. Valid values: `prepaid` (yearly/monthly subscription), `postpaid` (pay-as-you-go).
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param integer $IsDcnStrongSyncSupported <p>Whether strong-sync DCN is supported</p>
     * @param integer $IsDcnSwitchSupported <p>Whether DCN switching is supported</p>
     * @param string $ProxyVersion <p>Proxy version</p>
     * @param string $CpuType <p>CPU type. Examples: Intel/AMD for Intel, Hygon for Hygon.</p>
     * @param integer $ProtectedProperty <p>Deletion protection flag. 1: Deletion protection enabled, 0: Deletion protection disabled.</p>
     * @param integer $FlowId <p>Flow ID, which identifies the ongoing asynchronous task of the instance.</p>
