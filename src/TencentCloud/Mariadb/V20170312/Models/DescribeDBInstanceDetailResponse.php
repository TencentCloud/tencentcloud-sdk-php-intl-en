 ...
 * @method integer getIsDcnStrongSyncSupported() Obtain 
 * @method void setIsDcnStrongSyncSupported(integer $IsDcnStrongSyncSupported) Set 
 * @method integer getIsDcnSwitchSupported() Obtain 
 * @method void setIsDcnSwitchSupported(integer $IsDcnSwitchSupported) Set 
 * @method string getProxyVersion() Obtain 
 * @method void setProxyVersion(string $ProxyVersion) Set 
 * @method string getCpuType() Obtain 
 * @method void setCpuType(string $CpuType) Set 
 * @method integer getProtectedProperty() Obtain 
 * @method void setProtectedProperty(integer $ProtectedProperty) Set 
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param integer $IsDcnStrongSyncSupported 
     * @param integer $IsDcnSwitchSupported 
     * @param string $ProxyVersion 
     * @param string $CpuType 
     * @param integer $ProtectedProperty 
