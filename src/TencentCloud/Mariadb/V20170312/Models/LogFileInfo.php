 ...
 *
 * @method integer getMtime() Obtain Last modified time of log
 * @method void setMtime(integer $Mtime) Set Last modified time of log
...
{
    /**
     * @var integer Last modified time of log
     */
    public $Mtime;
    ...
    /**
     * @param integer $Mtime Last modified time of log
