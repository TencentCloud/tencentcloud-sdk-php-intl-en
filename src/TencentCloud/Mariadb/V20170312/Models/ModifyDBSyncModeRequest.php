 ...
 *
 * @method string getInstanceId() Obtain ID of the instance for which to modify the sync mode. The ID is in the format of `tdsql-ow728lmc`.
 * @method void setInstanceId(string $InstanceId) Set ID of the instance for which to modify the sync mode. The ID is in the format of `tdsql-ow728lmc`.
...
{
    /**
     * @var string ID of the instance for which to modify the sync mode. The ID is in the format of `tdsql-ow728lmc`.
     */
    public $InstanceId;
    ...
    /**
     * @param string $InstanceId ID of the instance for which to modify the sync mode. The ID is in the format of `tdsql-ow728lmc`.
