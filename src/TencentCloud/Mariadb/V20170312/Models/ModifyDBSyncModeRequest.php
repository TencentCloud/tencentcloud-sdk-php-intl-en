 ...
 *
 * @method string getInstanceId() Obtain ID of an instance for which to modify the sync mode. The ID is in the format of tdsql-ow728lmc.
 * @method void setInstanceId(string $InstanceId) Set ID of an instance for which to modify the sync mode. The ID is in the format of tdsql-ow728lmc.
...
{
    /**
     * @var string ID of an instance for which to modify the sync mode. The ID is in the format of tdsql-ow728lmc.
     */
    public $InstanceId;
    ...
    /**
     * @param string $InstanceId ID of an instance for which to modify the sync mode. The ID is in the format of tdsql-ow728lmc.
