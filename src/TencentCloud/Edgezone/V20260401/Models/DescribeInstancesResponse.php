 ...
 *
 * @method array getInstanceSet() Obtain Instance detail list
 * @method void setInstanceSet(array $InstanceSet) Set Instance detail list
...
{
    /**
     * @var array Instance detail list
     */
    public $InstanceSet;
    ...
    /**
     * @param array $InstanceSet Instance detail list
