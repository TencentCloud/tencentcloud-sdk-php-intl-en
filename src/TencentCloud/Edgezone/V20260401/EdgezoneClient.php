 ...
 * @method Models\CreateEdgeNodeServiceResponse CreateEdgeNodeService(Models\CreateEdgeNodeServiceRequest $req) Enable the billing service for edge nodes.
