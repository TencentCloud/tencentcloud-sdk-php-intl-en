 ...
 *
 * @method RuleInfo getRuleInfo() Obtain Rule information
 * @method void setRuleInfo(RuleInfo $RuleInfo) Set Rule information
...
class CreateRuleResponse extends AbstractModel
{
    ...
    /**
     * @param RuleInfo $RuleInfo Rule information
