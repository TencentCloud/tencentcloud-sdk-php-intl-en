...
OPEN: Public network attribute. INTERNAL: Intranet attribute. For a CLB with intranet attribute, you can bind EIP for public network access. For details, see the EIP document.
 * @method integer getForward() Obtain Load balancer type identifier. 1: CLB; 0: Classic CLB.
 * @method void setForward(integer $Forward) Set Load balancer type identifier. 1: CLB; 0: Classic CLB.
 * @method string getDomain() Obtain The domain name of the Cloud Load Balancer instance. This field is only provided by public network-based and domain name-based CLB instances. It is being gradually phased out. We recommend using LoadBalancerDomain instead.
 * @method void setDomain(string $Domain) Set The domain name of the Cloud Load Balancer instance. This field is only provided by public network-based and domain name-based CLB instances. It is being gradually phased out. We recommend using LoadBalancerDomain instead.
 ...
 * @method boolean getSnat() Obtain Private network Classic CLB instances before December 2016 had SNAT enabled.
 * @method void setSnat(boolean $Snat) Set Private network Classic CLB instances before December 2016 had SNAT enabled.
 ...
 * @method string getLog() Obtain User-enabled log information. Only public network CLB instances that have an HTTP or HTTPS listener can generate logs.
 * @method void setLog(string $Log) Set User-enabled log information. Only public network CLB instances that have an HTTP or HTTPS listener can generate logs.
 ...
 * @method string getVipIsp() Obtain ISP of the load balancer IP. Value ranges from BGP to CUCC.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setVipIsp(string $VipIsp) Set ISP of the load balancer IP. Value ranges from BGP to CUCC.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method ZoneInfo getMasterZone() Obtain Primary AZ.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setMasterZone(ZoneInfo $MasterZone) Set Primary AZ.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method array getBackupZoneSet() Obtain standby availability zone
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setBackupZoneSet(array $BackupZoneSet) Set standby availability zone
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getExpireTime() Obtain Expiration Time of the CLB instance
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setExpireTime(string $ExpireTime) Set Expiration Time of the CLB instance
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getChargeType() Obtain Billing type of the Cloud Load Balancer instance, PREPAID: Monthly Subscription, POSTPAID_BY_HOUR: Pay-As-You-Go
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setChargeType(string $ChargeType) Set Billing type of the Cloud Load Balancer instance, PREPAID: Monthly Subscription, POSTPAID_BY_HOUR: Pay-As-You-Go
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method LBChargePrepaid getPrepaidAttributes() Obtain Reserved field.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setPrepaidAttributes(LBChargePrepaid $PrepaidAttributes) Set Reserved field.
Note: This field may return null, indicating that no valid values can be obtained.
 ...
 * @method string getAddressIPv6() Obtain IPv6 address of the CLB instance
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setAddressIPv6(string $AddressIPv6) Set IPv6 address of the CLB instance
Note: This field may return null, indicating that no valid values can be obtained.
 ...
 * @method string getIPv6Mode() Obtain This field is meaningful when the IP address version is IPv6. IPv6Nat64 | IPv6FullChain
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setIPv6Mode(string $IPv6Mode) Set This field is meaningful when the IP address version is IPv6. IPv6Nat64 | IPv6FullChain
Note: This field may return null, indicating that no valid values can be obtained.
 * @method boolean getSnatPro() Obtain Is SnatPro enabled?
 * @method void setSnatPro(boolean $SnatPro) Set Is SnatPro enabled?
 * @method array getSnatIps() Obtain After enabling SnatPro load balancing, the SnatIp list.
 * @method void setSnatIps(array $SnatIps) Set After enabling SnatPro load balancing, the SnatIp list.
 ...
 * @method string getIsBlockTime() Obtain Blocking or unblocking time
 * @method void setIsBlockTime(string $IsBlockTime) Set Blocking or unblocking time
 ...
 * @method string getClusterTag() Obtain Layer-7 exclusive tag.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setClusterTag(string $ClusterTag) Set Layer-7 exclusive tag.
Note: This field may return null, indicating that no valid values can be obtained.
 ...
 * @method array getZones() Obtain VPC-based private network CLB. AZ where the rule is in proximity access mode
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setZones(array $Zones) Set VPC-based private network CLB. AZ where the rule is in proximity access mode
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getNfvInfo() Obtain Whether CLB is NFV. Empty: No; l7nfv: NFV for layer 7.
 * @method void setNfvInfo(string $NfvInfo) Set Whether CLB is NFV. Empty: No; l7nfv: NFV for layer 7.
 ...
 * @method integer getExclusive() Obtain Whether the instance type is exclusive type. 1: Dedicated instance. 0: Non-dedicated instance.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setExclusive(integer $Exclusive) Set Whether the instance type is exclusive type. 1: Dedicated instance. 0: Non-dedicated instance.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method integer getTargetCount() Obtain Number of bound backend services.
 * @method void setTargetCount(integer $TargetCount) Set Number of bound backend services.
 * @method string getAssociateEndpoint() Obtain Endpoint Id associated with the CLB instance.
 * @method void setAssociateEndpoint(string $AssociateEndpoint) Set Endpoint Id associated with the CLB instance.
...
OPEN: Public network attribute. INTERNAL: Intranet attribute. For a CLB with intranet attribute, you can bind EIP for public network access. For details, see the EIP document.
    ...
    /**
     * @var integer Load balancer type identifier. 1: CLB; 0: Classic CLB.
     */
    public $Forward;

    /**
     * @var string The domain name of the Cloud Load Balancer instance. This field is only provided by public network-based and domain name-based CLB instances. It is being gradually phased out. We recommend using LoadBalancerDomain instead.
     */
    public $Domain;
...
0: creating, 1: normal operation.
    ...
    /**
     * @var boolean Private network Classic CLB instances before December 2016 had SNAT enabled.
     */
    public $Snat;
    ...
    /**
     * @var string User-enabled log information. Only public network CLB instances that have an HTTP or HTTPS listener can generate logs.
     */
    public $Log;
    ...
    /**
     * @var string ISP of the load balancer IP. Value ranges from BGP to CUCC.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $VipIsp;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var array standby availability zone
Note: This field may return null, indicating that no valid values can be obtained.
     */
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var string Expiration Time of the CLB instance
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $ExpireTime;

    /**
     * @var string Billing type of the Cloud Load Balancer instance, PREPAID: Monthly Subscription, POSTPAID_BY_HOUR: Pay-As-You-Go
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $ChargeType;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var string IPv6 address of the CLB instance
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $AddressIPv6;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var string This field is meaningful when the IP address version is IPv6. IPv6Nat64 | IPv6FullChain
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $IPv6Mode;

    /**
     * @var boolean Is SnatPro enabled?
     */
    public $SnatPro;

    /**
     * @var array After enabling SnatPro load balancing, the SnatIp list.
     */
    public $SnatIps;
    ...
    /**
     * @var string Blocking or unblocking time
     */
    public $IsBlockTime;
    ...
    /**
     * @var string Layer-7 exclusive tag.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $ClusterTag;
    ...
    /**
     * @var array VPC-based private network CLB. AZ where the rule is in proximity access mode
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Zones;

    /**
     * @var string Whether CLB is NFV. Empty: No; l7nfv: NFV for layer 7.
     */
    public $NfvInfo;
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var integer Whether the instance type is exclusive type. 1: Dedicated instance. 0: Non-dedicated instance.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Exclusive;

    /**
     * @var integer Number of bound backend services.
     */
    public $TargetCount;

    /**
     * @var string Endpoint Id associated with the CLB instance.
     */
...
OPEN: Public network attribute. INTERNAL: Intranet attribute. For a CLB with intranet attribute, you can bind EIP for public network access. For details, see the EIP document.
     * @param integer $Forward Load balancer type identifier. 1: CLB; 0: Classic CLB.
     * @param string $Domain The domain name of the Cloud Load Balancer instance. This field is only provided by public network-based and domain name-based CLB instances. It is being gradually phased out. We recommend using LoadBalancerDomain instead.
...
0: creating, 1: normal operation.
     ...
     * @param boolean $Snat Private network Classic CLB instances before December 2016 had SNAT enabled.
     * @param integer $Isolation 0: Not isolated; 1: Isolated.
     * @param string $Log User-enabled log information. Only public network CLB instances that have an HTTP or HTTPS listener can generate logs.
     ...
     * @param string $VipIsp ISP of the load balancer IP. Value ranges from BGP to CUCC.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param ZoneInfo $MasterZone Primary AZ.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param array $BackupZoneSet standby availability zone
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $IsolatedTime CLB instance isolation time
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $ExpireTime Expiration Time of the CLB instance
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $ChargeType Billing type of the Cloud Load Balancer instance, PREPAID: Monthly Subscription, POSTPAID_BY_HOUR: Pay-As-You-Go
Note: This field may return null, indicating that no valid values can be obtained.
     * @param InternetAccessible $NetworkAttributes CLB instance network attributes
Note: This field may return null, indicating that no valid values can be obtained.
     * @param LBChargePrepaid $PrepaidAttributes Reserved field.
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param string $AddressIPv6 IPv6 address of the CLB instance
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param string $IPv6Mode This field is meaningful when the IP address version is IPv6. IPv6Nat64 | IPv6FullChain
Note: This field may return null, indicating that no valid values can be obtained.
     * @param boolean $SnatPro Is SnatPro enabled?
     * @param array $SnatIps After enabling SnatPro load balancing, the SnatIp list.
     ...
     * @param string $IsBlockTime Blocking or unblocking time
     * @param boolean $LocalBgp Whether the IP type is Local BGP
     * @param string $ClusterTag Layer-7 exclusive tag.
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param array $Zones VPC-based private network CLB. AZ where the rule is in proximity access mode
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $NfvInfo Whether CLB is NFV. Empty: No; l7nfv: NFV for layer 7.
...
Note: This field may return null, indicating that no valid values can be obtained.
     ...
     * @param integer $Exclusive Whether the instance type is exclusive type. 1: Dedicated instance. 0: Non-dedicated instance.
Note: This field may return null, indicating that no valid values can be obtained.
     * @param integer $TargetCount Number of bound backend services.
     * @param string $AssociateEndpoint Endpoint Id associated with the CLB instance.
