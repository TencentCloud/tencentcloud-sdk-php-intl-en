...
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getUrl() Obtain URL of the forwarding rule
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setUrl(string $Url) Set URL of the forwarding rule
Note: This field may return null, indicating that no valid values can be obtained.
 * @method string getRuleId() Obtain Advanced routing rule ID
 * @method void setRuleId(string $RuleId) Set Advanced routing rule ID
 * @method array getTargets() Obtain Health check status of the backend service bound to this rule
 * @method void setTargets(array $Targets) Set Health check status of the backend service bound to this rule
 */
...
Note: This field may return null, indicating that no valid values can be obtained.
    ...
    /**
     * @var string URL of the forwarding rule
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Url;
    ...
    /**
     * @var array Health check status of the backend service bound to this rule
     */
    public $Targets;
...
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $Url URL of the forwarding rule
Note: This field may return null, indicating that no valid values can be obtained.
     * @param string $RuleId Advanced routing rule ID
     * @param array $Targets Health check status of the backend service bound to this rule
     */
