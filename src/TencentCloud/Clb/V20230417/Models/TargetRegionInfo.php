 ...
 * @method string getVpcId() Obtain Network of the target. For VPC, the format is vpc-abcd1234. For a basic network, the value is 0.
 * @method void setVpcId(string $VpcId) Set Network of the target. For VPC, the format is vpc-abcd1234. For a basic network, the value is 0.
...
class TargetRegionInfo extends AbstractModel
{
    ...
    /**
     * @var string Network of the target. For VPC, the format is vpc-abcd1234. For a basic network, the value is 0.
     */
    public $VpcId;
     ...
     * @param string $VpcId Network of the target. For VPC, the format is vpc-abcd1234. For a basic network, the value is 0.
