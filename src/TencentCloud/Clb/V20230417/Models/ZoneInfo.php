 ...
 * @method string getZoneRegion() Obtain Region of the availability zone, such as ap-guangzhou.
 * @method void setZoneRegion(string $ZoneRegion) Set Region of the availability zone, such as ap-guangzhou.
 * @method boolean getLocalZone() Obtain Whether the availability zone is a local availability zone. For example, false.
 * @method void setLocalZone(boolean $LocalZone) Set Whether the availability zone is a local availability zone. For example, false.
 * @method boolean getEdgeZone() Obtain Whether the availability zone is an edge availability zone. For example, false.
 * @method void setEdgeZone(boolean $EdgeZone) Set Whether the availability zone is an edge availability zone. For example, false.
 */
class ZoneInfo extends AbstractModel
{
    ...
    /**
     * @var string Region of the availability zone, such as ap-guangzhou.
     */
    public $ZoneRegion;

    /**
     * @var boolean Whether the availability zone is a local availability zone. For example, false.
     */
    public $LocalZone;

    /**
     * @var boolean Whether the availability zone is an edge availability zone. For example, false.
     */
    public $EdgeZone;
     ...
     * @param string $ZoneRegion Region of the availability zone, such as ap-guangzhou.
     * @param boolean $LocalZone Whether the availability zone is a local availability zone. For example, false.
     * @param boolean $EdgeZone Whether the availability zone is an edge availability zone. For example, false.
     */
