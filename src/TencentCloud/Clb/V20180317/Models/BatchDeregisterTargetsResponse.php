 ...
 * @method string getMessage() Obtain Failed to unbind error reason information.
 * @method void setMessage(string $Message) Set Failed to unbind error reason information.
...
class BatchDeregisterTargetsResponse extends AbstractModel
{
    ...
    /**
     * @var string Failed to unbind error reason information.
     */
    public $Message;
     ...
     * @param string $Message Failed to unbind error reason information.
