 ...
 *
 * @method array getLoadBalancers() Obtain <p>CLB list.</p>
 * @method void setLoadBalancers(array $LoadBalancers) Set <p>CLB list.</p>
...
class DescribeTargetHealthResponse extends AbstractModel
{
    ...
    /**
     * @param array $LoadBalancers <p>CLB list.</p>
