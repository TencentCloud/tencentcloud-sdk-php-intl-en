 ...
 *
 * @method array getLoadBalancers() Obtain LoadBalancer list.
 * @method void setLoadBalancers(array $LoadBalancers) Set LoadBalancer list.
...
class DescribeTargetHealthResponse extends AbstractModel
{
    ...
    /**
     * @param array $LoadBalancers LoadBalancer list.
