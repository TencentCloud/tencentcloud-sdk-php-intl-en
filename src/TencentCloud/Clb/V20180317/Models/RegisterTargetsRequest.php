 ...
 * @method array getTargets() 获取List of real servers to be bound. Array length limit: 20
 * @method void setTargets(array $Targets) 设置List of real servers to be bound. Array length limit: 20
 ...
 * @method string getDomain() 获取Target forwarding rule domain name. This parameter does not take effect if LocationId is specified
 * @method void setDomain(string $Domain) 设置Target forwarding rule domain name. This parameter does not take effect if LocationId is specified
 * @method string getUrl() 获取Target forwarding rule URL. This parameter does not take effect if LocationId is specified
 * @method void setUrl(string $Url) 设置Target forwarding rule URL. This parameter does not take effect if LocationId is specified
 */
