...
/**
 * @method array getLoadBalancerIds() 获取Array of unique CLB instance IDs.
 * @method void setLoadBalancerIds(array $LoadBalancerIds) 设置Array of unique CLB instance IDs.
