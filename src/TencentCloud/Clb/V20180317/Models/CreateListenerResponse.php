...
/**
 * @method array getListenerIds() 获取Array of unique IDs of the created listeners
 * @method void setListenerIds(array $ListenerIds) 设置Array of unique IDs of the created listeners
...
{
    /**
     * @var array Array of unique IDs of the created listeners
     */
    public $ListenerIds;
