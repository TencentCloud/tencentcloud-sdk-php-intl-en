 ...
 *
 * @method string getLoadBalancerId() Obtain 负载均衡唯一性Id，如lb-12345678
 * @method void setLoadBalancerId(string $LoadBalancerId) Set 负载均衡唯一性Id，如lb-12345678
 * @method array getSnatIps() Obtain 添加SnatIp信息，可指定Ip申请，或者指定子网自动申请
 * @method void setSnatIps(array $SnatIps) Set 添加SnatIp信息，可指定Ip申请，或者指定子网自动申请
 */
