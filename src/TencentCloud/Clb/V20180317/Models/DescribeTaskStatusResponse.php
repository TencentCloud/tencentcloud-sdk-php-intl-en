...
Note: this field may return `null`, indicating that no valid values can be obtained.
 * @method string getMessage() Obtain Auxiliary description information, such as failure cause.
Note: This field may return null, indicating that no valid values can be obtained.
 * @method void setMessage(string $Message) Set Auxiliary description information, such as failure cause.
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    /**
     * @var string Auxiliary description information, such as failure cause.
Note: This field may return null, indicating that no valid values can be obtained.
     */
    public $Message;
...
Note: this field may return `null`, indicating that no valid values can be obtained.
     * @param string $Message Auxiliary description information, such as failure cause.
Note: This field may return null, indicating that no valid values can be obtained.
