...
Default value: -1, which indicates no limit.
 * @method integer getIdleConnectTimeout() Obtain Idle connection timeout, in seconds. This parameter applies only to TCP listeners. Default value: 900. Value range: 300–900 for shared instances and dedicated instances and 300–1980 for LCU-supported instances. To set a value greater than 2000, [submit a ticket for application](https://console.cloud.tencent.com/workorder/category). The maximum value can be 3600.
 * @method void setIdleConnectTimeout(integer $IdleConnectTimeout) Set Idle connection timeout, in seconds. This parameter applies only to TCP listeners. Default value: 900. Value range: 300–900 for shared instances and dedicated instances and 300–1980 for LCU-supported instances. To set a value greater than 2000, [submit a ticket for application](https://console.cloud.tencent.com/workorder/category). The maximum value can be 3600.
 * @method boolean getProxyProtocol() Obtain 
 * @method void setProxyProtocol(boolean $ProxyProtocol) Set 
 * @method boolean getSnatEnable() Obtain Whether to enable SNAT. True: enable SNAT; False: do not enable SNAT.
 * @method void setSnatEnable(boolean $SnatEnable) Set Whether to enable SNAT. True: enable SNAT; False: do not enable SNAT.
...
Default value: -1, which indicates no limit.
    ...
    /**
     * @var integer Idle connection timeout, in seconds. This parameter applies only to TCP listeners. Default value: 900. Value range: 300–900 for shared instances and dedicated instances and 300–1980 for LCU-supported instances. To set a value greater than 2000, [submit a ticket for application](https://console.cloud.tencent.com/workorder/category). The maximum value can be 3600.
     */
    ...
    /**
     * @var boolean Whether to enable SNAT. True: enable SNAT; False: do not enable SNAT.
     */
    public $SnatEnable;
...
Default value: -1, which indicates no limit.
     * @param integer $IdleConnectTimeout Idle connection timeout, in seconds. This parameter applies only to TCP listeners. Default value: 900. Value range: 300–900 for shared instances and dedicated instances and 300–1980 for LCU-supported instances. To set a value greater than 2000, [submit a ticket for application](https://console.cloud.tencent.com/workorder/category). The maximum value can be 3600.
     * @param boolean $ProxyProtocol 
     * @param boolean $SnatEnable Whether to enable SNAT. True: enable SNAT; False: do not enable SNAT.
