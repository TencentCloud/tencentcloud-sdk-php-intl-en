 ...
 * @method Models\DeleteSecurityPolicyResponse DeleteSecurityPolicy(Models\DeleteSecurityPolicyRequest $req) This API is used to delete a public network access allowlist policy of an instance.
