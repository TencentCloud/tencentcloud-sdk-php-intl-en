 ...
 *
 * @method array getJobs() Obtain List of GC jobs
 * @method void setJobs(array $Jobs) Set List of GC jobs
...
class DescribeGCJobsResponse extends AbstractModel
{
    ...
    /**
     * @param array $Jobs List of GC jobs
