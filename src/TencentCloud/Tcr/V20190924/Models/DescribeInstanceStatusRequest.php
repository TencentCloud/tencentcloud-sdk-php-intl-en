 ...
 *
 * @method array getRegistryIds() Obtain Array of instance IDs
 * @method void setRegistryIds(array $RegistryIds) Set Array of instance IDs
 */
class DescribeInstanceStatusRequest extends AbstractModel
{
    ...
    /**
     * @param array $RegistryIds Array of instance IDs
     */
