 ...
 * @method boolean getIsPublic() Obtain Access level. Valid values: True: Public; False: Private.
 * @method void setIsPublic(boolean $IsPublic) Set Access level. Valid values: True: Public; False: Private.
 */
class ModifyNamespaceRequest extends AbstractModel
{
    ...
    /**
     * @var boolean Access level. Valid values: True: Public; False: Private.
     */
    public $IsPublic;
     ...
     * @param boolean $IsPublic Access level. Valid values: True: Public; False: Private.
     */
