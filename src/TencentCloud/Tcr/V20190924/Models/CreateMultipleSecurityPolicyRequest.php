 ...
 * @method array getSecurityGroupPolicySet() Obtain Security group policy
 * @method void setSecurityGroupPolicySet(array $SecurityGroupPolicySet) Set Security group policy
 */
class CreateMultipleSecurityPolicyRequest extends AbstractModel
{
    ...
    /**
     * @var array Security group policy
     */
    public $SecurityGroupPolicySet;

    /**
     * @param string $RegistryId Instance ID
     * @param array $SecurityGroupPolicySet Security group policy
     */
