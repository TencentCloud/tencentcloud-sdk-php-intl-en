 ...
 * @method string getTokenId() Obtain Access credential ID
 * @method void setTokenId(string $TokenId) Set Access credential ID
 */
class DeleteInstanceTokenRequest extends AbstractModel
{
    ...
    /**
     * @var string Access credential ID
     */
    public $TokenId;

    /**
     * @param string $RegistryId Instance ID
     * @param string $TokenId Access credential ID
     */
