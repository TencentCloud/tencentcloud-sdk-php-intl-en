 ...
 * @method integer getExpiresAt() Obtain Expiry time of the custom account (timestamp, in milliseconds)
 * @method void setExpiresAt(integer $ExpiresAt) Set Expiry time of the custom account (timestamp, in milliseconds)
...
class CreateCustomAccountRequest extends AbstractModel
{
    ...
    /**
     * @var integer Expiry time of the custom account (timestamp, in milliseconds)
     */
    public $ExpiresAt;
     ...
     * @param integer $ExpiresAt Expiry time of the custom account (timestamp, in milliseconds)
