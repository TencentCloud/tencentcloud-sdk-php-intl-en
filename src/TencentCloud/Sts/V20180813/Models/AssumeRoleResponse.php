 ...
 *
 * @method Credentials getCredentials() Obtain Temporary security credentials
 * @method void setCredentials(Credentials $Credentials) Set Temporary security credentials
...
{
    /**
     * @var Credentials Temporary security credentials
     */
    public $Credentials;
    ...
    /**
     * @param Credentials $Credentials Temporary security credentials
