 ...
 * @method array getPriorities() Obtain Policy ID and priority.
 * @method void setPriorities(array $Priorities) Set Policy ID and priority.
 */
class UpdateAuthorizationPolicyPriorityRequest extends AbstractModel
{
    ...
    /**
     * @var array Policy ID and priority.
     */
    public $Priorities;
     ...
     * @param array $Priorities Policy ID and priority.
     */
