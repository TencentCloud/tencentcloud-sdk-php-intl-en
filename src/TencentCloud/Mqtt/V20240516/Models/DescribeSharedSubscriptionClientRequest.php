 ...
 * @method string getTopicFilter() Obtain Subscription expression.
 * @method void setTopicFilter(string $TopicFilter) Set Subscription expression.
 */
class DescribeSharedSubscriptionClientRequest extends AbstractModel
{
     ...
     * @param string $TopicFilter Subscription expression.
     */
