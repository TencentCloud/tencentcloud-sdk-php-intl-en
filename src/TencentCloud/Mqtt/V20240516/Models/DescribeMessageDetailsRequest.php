 ...
 * @method string getSubscription() Obtain Subscription expression.
 * @method void setSubscription(string $Subscription) Set Subscription expression.
 */
class DescribeMessageDetailsRequest extends AbstractModel
{
     ...
     * @param string $Subscription Subscription expression.
     */
