 ...
 * Fusion parameter
 *
 * @method ImageCodecParam getImageCodecParam() Obtain Image encoding parameter
 * @method void setImageCodecParam(ImageCodecParam $ImageCodecParam) Set Image encoding parameter
 */
class FuseParam extends AbstractModel
{
    /**
     * @var ImageCodecParam Image encoding parameter
     */
    public $ImageCodecParam;

    /**
     * @param ImageCodecParam $ImageCodecParam Image encoding parameter
     */
