 ...
 * @method Autoscaler getAutoscaler() Obtain Auto scaling policy
 * @method void setAutoscaler(Autoscaler $Autoscaler) Set Auto scaling policy
 */
class ModifyApplicationAutoscalerRequest extends AbstractModel
{
    ...
    /**
     * @var Autoscaler Auto scaling policy
     */
    public $Autoscaler;
     ...
     * @param Autoscaler $Autoscaler Auto scaling policy
     */
