 ...
 *
 * @method array getResult() Obtain Ingress array
Note: this field may return `null`, indicating that no valid values can be obtained.
 * @method void setResult(array $Result) Set Ingress array
Note: this field may return `null`, indicating that no valid values can be obtained.
...
Note: this field may return `null`, indicating that no valid values can be obtained.
    ...
    /**
     * @param array $Result Ingress array
Note: this field may return `null`, indicating that no valid values can be obtained.
