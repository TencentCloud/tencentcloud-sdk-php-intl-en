 ...
 * @method LogConfig getData() Obtain Log collector configuration
 * @method void setData(LogConfig $Data) Set Log collector configuration
...
class ModifyLogConfigRequest extends AbstractModel
{
    ...
    /**
     * @var LogConfig Log collector configuration
     */
    public $Data;
     ...
     * @param LogConfig $Data Log collector configuration
