...
/**
 * ModifyDspmIdentifyComplianceRuleLevelInfo request structure.
 *
 ...
 * @method integer getLevelId() Obtain <p>Level item id</p>
 * @method void setLevelId(integer $LevelId) Set <p>Level item id</p>
...
class ModifyDspmIdentifyComplianceRuleLevelInfoRequest extends AbstractModel
{
     ...
     * @param integer $LevelId <p>Level item id</p>
