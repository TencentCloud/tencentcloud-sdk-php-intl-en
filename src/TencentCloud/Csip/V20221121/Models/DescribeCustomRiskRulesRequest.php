...
/**
 * DescribeCustomRiskRules request structure.
 *
 * @method array getMemberId() Obtain <p>Group account member id</p>
 * @method void setMemberId(array $MemberId) Set <p>Group account member id</p>
 * @method array getFilters() Obtain <p>Filtered Content</p>
 * @method void setFilters(array $Filters) Set <p>Filtered Content</p>
...
class DescribeCustomRiskRulesRequest extends AbstractModel
{
    ...
    /**
     * @var array <p>Filtered Content</p>
     */
    public $Filters;
     ...
     * @param array $Filters <p>Filtered Content</p>
