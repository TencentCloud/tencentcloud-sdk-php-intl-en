...
/**
 * DeleteDspmIdentifyComplianceGroup request structure.
 *
 * @method array getIds() Obtain <p>Identification template ID set</p>
 * @method void setIds(array $Ids) Set <p>Identification template ID set</p>
...
{
    /**
     * @var array <p>Identification template ID set</p>
     */
    public $Ids;
    ...
    /**
     * @param array $Ids <p>Identification template ID set</p>
