 ...
 * @method array getJoinTypeLst() Obtain Joining method enumeration
 * @method void setJoinTypeLst(array $JoinTypeLst) Set Joining method enumeration
 * @method array getCloudTypeLst() Obtain Cloud service provider enumeration
 * @method void setCloudTypeLst(array $CloudTypeLst) Set Cloud service provider enumeration
...
class DescribeOrganizationUserInfoResponse extends AbstractModel
{
    ...
    /**
     * @var array Joining method enumeration
     */
    public $JoinTypeLst;

    /**
     * @var array Cloud service provider enumeration
     */
    public $CloudTypeLst;
     ...
     * @param array $JoinTypeLst Joining method enumeration
     * @param array $CloudTypeLst Cloud service provider enumeration
