 ...
 * @method ImageScanAssetTarget getTarget() Obtain <p>Scan target image filter configuration</p>
 * @method void setTarget(ImageScanAssetTarget $Target) Set <p>Scan target image filter configuration</p>
...
class ModifyImageRegistryTimedScanTaskConfigRequest extends AbstractModel
{
    ...
    /**
     * @var ImageScanAssetTarget <p>Scan target image filter configuration</p>
     */
    public $Target;
     ...
     * @param ImageScanAssetTarget $Target <p>Scan target image filter configuration</p>
