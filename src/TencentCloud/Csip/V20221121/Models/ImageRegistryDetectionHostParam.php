 ...
 *
 * @method string getInstanceUuid() Obtain <p>Host UUID.</p>
 * @method void setInstanceUuid(string $InstanceUuid) Set <p>Host UUID.</p>
...
class ImageRegistryDetectionHostParam extends AbstractModel
{
    ...
    /**
     * @param string $InstanceUuid <p>Host UUID.</p>
