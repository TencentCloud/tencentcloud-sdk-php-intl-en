...
/**
 * DeleteDspmIdentifyLevelGroup request structure.
 *
 * @method array getIds() Obtain <p>Level group id.</p>
 * @method void setIds(array $Ids) Set <p>Level group id.</p>
...
class DeleteDspmIdentifyLevelGroupRequest extends AbstractModel
{
    ...
    /**
     * @param array $Ids <p>Level group id.</p>
