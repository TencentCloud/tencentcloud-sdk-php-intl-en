...
/**
 * CreateDspmIdentifyRule request structure.
 *
 ...
 * @method integer getStatus() Obtain <p>Data item enablement status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
 * @method void setStatus(integer $Status) Set <p>Data item enablement status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
...
class CreateDspmIdentifyRuleRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>Data item enablement status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
     */
    public $Status;
     ...
     * @param integer $Status <p>Data item enablement status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
