...
/**
 * CreateCFGRiskPDFReportExportJob request structure.
 *
 ...
 * @method array getAssetTagIDs() Obtain <p>Asset tag ID</p>
 * @method void setAssetTagIDs(array $AssetTagIDs) Set <p>Asset tag ID</p>
 */
class CreateCFGRiskPDFReportExportJobRequest extends AbstractModel
{
     ...
     * @param array $AssetTagIDs <p>Asset tag ID</p>
     */
