...
/**
 * CreateRiskDetailExportJob request structure.
 *
 * @method string getRiskRuleId() Obtain Risk rule ID
 * @method void setRiskRuleId(string $RiskRuleId) Set Risk rule ID
...
class CreateRiskDetailExportJobRequest extends AbstractModel
{
    ...
    /**
     * @param string $RiskRuleId Risk rule ID
