 ...
 * @method array getClusterIDs() Obtain <p>Specify the cluster ID list</p>
 * @method void setClusterIDs(array $ClusterIDs) Set <p>Specify the cluster ID list</p>
...
class DescribeReverseShellSystemPolicyConfigResponse extends AbstractModel
{
    ...
    /**
     * @var array <p>Specify the cluster ID list</p>
     */
    public $ClusterIDs;
     ...
     * @param array $ClusterIDs <p>Specify the cluster ID list</p>
