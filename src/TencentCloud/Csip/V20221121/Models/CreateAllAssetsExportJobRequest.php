...
/**
 * CreateAllAssetsExportJob request structure.
 *
 ...
 * @method boolean getIsCloudHost() Obtain Whether to query the host list
 * @method void setIsCloudHost(boolean $IsCloudHost) Set Whether to query the host list
 */
class CreateAllAssetsExportJobRequest extends AbstractModel
{
    ...
    /**
     * @var boolean Whether to query the host list
     */
    public $IsCloudHost;
     ...
     * @param boolean $IsCloudHost Whether to query the host list
     */
