 ...
 *
 * @method string getOrderId() Obtain Corresponding Application id
 * @method void setOrderId(string $OrderId) Set Corresponding Application id
 ...
 * @method string getCreateTime() Obtain Correspond to the application creation time.
 * @method void setCreateTime(string $CreateTime) Set Correspond to the application creation time.
 */
class DspmApproverOrder extends AbstractModel
{
    /**
     * @var string Corresponding Application id
     */
    public $OrderId;
    ...
    /**
     * @var string Correspond to the application creation time.
     */
    public $CreateTime;

    /**
     * @param string $OrderId Corresponding Application id
     ...
     * @param string $CreateTime Correspond to the application creation time.
     */
