 ...
 * @method array getAssetMapInstanceTypeList() Obtain Mapping between asset types and instance types
 * @method void setAssetMapInstanceTypeList(array $AssetMapInstanceTypeList) Set Mapping between asset types and instance types
...
class DescribeCVMAssetsResponse extends AbstractModel
{
    ...
    /**
     * @var array Mapping between asset types and instance types
     */
     ...
     * @param array $AssetMapInstanceTypeList Mapping between asset types and instance types
