...
/**
 * DescribeImageExportJobList response structure.
 *
 * @method integer getTotalCount() Obtain <p>Total.</p>
 * @method void setTotalCount(integer $TotalCount) Set <p>Total.</p>
 * @method array getJobList() Obtain <p>Task List</p>
 * @method void setJobList(array $JobList) Set <p>Task List</p>
...
class DescribeImageExportJobListResponse extends AbstractModel
{
     ...
     * @param array $JobList <p>Task List</p>
