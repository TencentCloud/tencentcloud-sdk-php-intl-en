 ...
 * @method string getExceptionMessage() Obtain <p>Failure reason</p>
 * @method void setExceptionMessage(string $ExceptionMessage) Set <p>Failure reason</p>
 */
class LicenseUnbindFailedItem extends AbstractModel
{
     ...
     * @param string $ExceptionMessage <p>Failure reason</p>
     */
