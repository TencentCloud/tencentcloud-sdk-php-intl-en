 ...
 * @method boolean getExactMatch() Obtain <p>Whether to use fuzzy match. It will be handled by the front-end and can be ignored.</p>
 * @method void setExactMatch(boolean $ExactMatch) Set <p>Whether to use fuzzy match. It will be handled by the front-end and can be ignored.</p>
 */
class EDRFilters extends AbstractModel
{
    ...
    /**
     * @var boolean <p>Whether to use fuzzy match. It will be handled by the front-end and can be ignored.</p>
     */
    public $ExactMatch;
     ...
     * @param boolean $ExactMatch <p>Whether to use fuzzy match. It will be handled by the front-end and can be ignored.</p>
     */
