 ...
 * @method integer getParentCategoryID() Obtain <p>ID of the parent category in the baseline, for filtering detection items under the specified parent category.</p>
 * @method void setParentCategoryID(integer $ParentCategoryID) Set <p>ID of the parent category in the baseline, for filtering detection items under the specified parent category.</p>
...
class DescribeBaselineCategoryItemListRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>ID of the parent category in the baseline, for filtering detection items under the specified parent category.</p>
     */
     ...
     * @param integer $ParentCategoryID <p>ID of the parent category in the baseline, for filtering detection items under the specified parent category.</p>
