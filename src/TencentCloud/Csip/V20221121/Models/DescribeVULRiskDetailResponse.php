 ...
 * @method string getQuestionId() Obtain Q&A id of the assistant
 * @method void setQuestionId(string $QuestionId) Set Q&A id of the assistant
...
class DescribeVULRiskDetailResponse extends AbstractModel
{
    ...
    /**
     * @var string Q&A id of the assistant
     */
    public $QuestionId;
     ...
     * @param string $QuestionId Q&A id of the assistant
