 ...
 *
 * @method string getDictType() Obtain <p>Dictionary type (RootCategory: level-1 category, IdentifyRule: sensitive identification data item)</p>
 * @method void setDictType(string $DictType) Set <p>Dictionary type (RootCategory: level-1 category, IdentifyRule: sensitive identification data item)</p>
 * @method array getMemberId() Obtain <p>Group account member id</p>
 * @method void setMemberId(array $MemberId) Set <p>Group account member id</p>
 * @method array getFilters() Obtain <p>Filter criteria</p>
 * @method void setFilters(array $Filters) Set <p>Filter criteria</p>
...
{
    /**
     * @var string <p>Dictionary type (RootCategory: level-1 category, IdentifyRule: sensitive identification data item)</p>
     */
    public $DictType;
    ...
    /**
     * @param string $DictType <p>Dictionary type (RootCategory: level-1 category, IdentifyRule: sensitive identification data item)</p>
     * @param array $MemberId <p>Group account member id</p>
     * @param array $Filters <p>Filter criteria</p>
