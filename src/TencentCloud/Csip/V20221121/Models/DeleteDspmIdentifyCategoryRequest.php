...
/**
 * DeleteDspmIdentifyCategory request structure.
 *
 * @method array getIds() Obtain <p>Category ID set</p>
 * @method void setIds(array $Ids) Set <p>Category ID set</p>
...
class DeleteDspmIdentifyCategoryRequest extends AbstractModel
{
    ...
    /**
     * @param array $Ids <p>Category ID set</p>
