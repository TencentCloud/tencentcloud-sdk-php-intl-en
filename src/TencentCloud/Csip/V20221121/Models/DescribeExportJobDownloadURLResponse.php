 ...
 * @method string getExportStatus() Obtain Task status: RUNNING/SUCCESS/FAILURE
 * @method void setExportStatus(string $ExportStatus) Set Task status: RUNNING/SUCCESS/FAILURE
...
class DescribeExportJobDownloadURLResponse extends AbstractModel
{
    ...
    /**
     * @var string Task status: RUNNING/SUCCESS/FAILURE
     */
    public $ExportStatus;
     ...
     * @param string $ExportStatus Task status: RUNNING/SUCCESS/FAILURE
