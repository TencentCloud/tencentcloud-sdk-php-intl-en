...
/**
 * DescribeDspmAssetFieldList response structure.
 *
 * @method integer getTotalCount() Obtain Total number.
 * @method void setTotalCount(integer $TotalCount) Set Total number.
 * @method array getDataSet() Obtain Result set.
 * @method void setDataSet(array $DataSet) Set Result set.
...
class DescribeDspmAssetFieldListResponse extends AbstractModel
{
     ...
     * @param array $DataSet Result set.
