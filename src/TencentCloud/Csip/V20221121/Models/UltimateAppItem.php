 ...
 * @method boolean getIsUltimateVersion() Obtain <p>Whether it is the flagship edition.</p>
 * @method void setIsUltimateVersion(boolean $IsUltimateVersion) Set <p>Whether it is the flagship edition.</p>
 */
class UltimateAppItem extends AbstractModel
{
    ...
    /**
     * @var boolean <p>Whether it is the flagship edition.</p>
     */
    public $IsUltimateVersion;

    /**
     * @param integer $AppID <p>User AppID.</p>
     * @param boolean $IsUltimateVersion <p>Whether it is the flagship edition.</p>
     */
