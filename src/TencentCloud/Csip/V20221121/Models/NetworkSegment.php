 ...
 * Network segment
 *
 * @method string getSegment() Obtain <p>Network segment</p>
 * @method void setSegment(string $Segment) Set <p>Network segment</p>
...
{
    /**
     * @var string <p>Network segment</p>
     */
    public $Segment;
    ...
    /**
     * @param string $Segment <p>Network segment</p>
