...
/**
 * DescribeTagRuleAssets request structure.
 *
 ...
 * @method string getTaggingRule() Obtain Tagging policy
 * @method void setTaggingRule(string $TaggingRule) Set Tagging policy
 */
class DescribeTagRuleAssetsRequest extends AbstractModel
{
     ...
     * @param string $TaggingRule Tagging policy
     */
