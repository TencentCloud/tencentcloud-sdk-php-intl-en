 ...
 *
 * @method boolean getExist() Obtain <p>Whether connected to the mailbox</p>
 * @method void setExist(boolean $Exist) Set <p>Whether connected to the mailbox</p>
...
{
    /**
     * @var boolean <p>Whether connected to the mailbox</p>
     */
    public $Exist;
    ...
    /**
     * @param boolean $Exist <p>Whether connected to the mailbox</p>
