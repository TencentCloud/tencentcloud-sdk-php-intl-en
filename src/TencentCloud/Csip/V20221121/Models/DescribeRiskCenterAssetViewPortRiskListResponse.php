 ...
 * @method array getSuggestionLists() Obtain List of fix suggestions 
 * @method void setSuggestionLists(array $SuggestionLists) Set List of fix suggestions 
...
class DescribeRiskCenterAssetViewPortRiskListResponse extends AbstractModel
{
     ...
     * @param array $SuggestionLists List of fix suggestions 
