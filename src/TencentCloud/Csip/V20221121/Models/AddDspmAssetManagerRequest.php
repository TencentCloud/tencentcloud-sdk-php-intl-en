...
/**
 * AddDspmAssetManager request structure.
 *
 * @method array getIdentifyIds() Obtain Administrator UIN
 * @method void setIdentifyIds(array $IdentifyIds) Set Administrator UIN
...
class AddDspmAssetManagerRequest extends AbstractModel
{
    ...
    /**
     * @param array $IdentifyIds Administrator UIN
