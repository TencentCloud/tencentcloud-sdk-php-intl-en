...
/**
 * DeleteDspmShareUserData request structure.
 *
 * @method integer getDeleteDataAppId() Obtain User appid.
 * @method void setDeleteDataAppId(integer $DeleteDataAppId) Set User appid.
 */
class DeleteDspmShareUserDataRequest extends AbstractModel
{
    ...
    /**
     * @param integer $DeleteDataAppId User appid.
     */
