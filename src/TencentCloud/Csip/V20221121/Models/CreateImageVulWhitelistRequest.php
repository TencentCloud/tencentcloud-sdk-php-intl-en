...
/**
 * CreateImageVulWhitelist request structure.
 *
 * @method array getMemberId() Obtain <p>Group account member id</p>
 * @method void setMemberId(array $MemberId) Set <p>Group account member id</p>
 * @method array getPocId() Obtain <p>Vulnerability id</p>
 * @method void setPocId(array $PocId) Set <p>Vulnerability id</p>
...
class CreateImageVulWhitelistRequest extends AbstractModel
{
     ...
     * @param array $PocId <p>Vulnerability id</p>
