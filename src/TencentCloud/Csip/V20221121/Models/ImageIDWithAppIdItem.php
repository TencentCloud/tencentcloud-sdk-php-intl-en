 ...
 * @method string getImageID() Obtain <p>Container image ID</p>
 * @method void setImageID(string $ImageID) Set <p>Container image ID</p>
 */
class ImageIDWithAppIdItem extends AbstractModel
{
    ...
    /**
     * @var string <p>Container image ID</p>
     */
    public $ImageID;

    /**
     * @param integer $AppId <p>Account ID</p>
     * @param string $ImageID <p>Container image ID</p>
     */
