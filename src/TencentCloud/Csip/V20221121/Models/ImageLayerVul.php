 ...
 * @method integer getID() Obtain <p>Vulnerability record id</p>
 * @method void setID(integer $ID) Set <p>Vulnerability record id</p>
 * @method string getLayerId() Obtain <p>Image layer id</p>
 * @method void setLayerId(string $LayerId) Set <p>Image layer id</p>
 * @method string getFirstFoundTime() Obtain <p>First detected time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
 * @method void setFirstFoundTime(string $FirstFoundTime) Set <p>First detected time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
 ...
 * @method ImageVulBaseInfo getVulInfo() Obtain <p>Vulnerability information</p>
 * @method void setVulInfo(ImageVulBaseInfo $VulInfo) Set <p>Vulnerability information</p>
...
class ImageLayerVul extends AbstractModel
{
    ...
    /**
     * @var integer <p>Vulnerability record id</p>
     */
    public $ID;
    ...
    /**
     * @var string <p>First detected time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
     */
    ...
    /**
     * @var ImageVulBaseInfo <p>Vulnerability information</p>
     */
    public $VulInfo;
     ...
     * @param integer $ID <p>Vulnerability record id</p>
     * @param string $LayerId <p>Image layer id</p>
     * @param string $FirstFoundTime <p>First detected time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
     * @param string $LatestFoundTime <p>Last discovery time</p><p>Parameter format: YYYY-MM-DD hh:mm:ss</p>
     * @param ImageVulBaseInfo $VulInfo <p>Vulnerability information</p>
