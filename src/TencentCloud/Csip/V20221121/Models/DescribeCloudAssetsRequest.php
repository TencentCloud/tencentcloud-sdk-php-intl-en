...
/**
 * DescribeCloudAssets request structure.
 *
 ...
 * @method boolean getIsCloudHost() Obtain Whether to query host assets
 * @method void setIsCloudHost(boolean $IsCloudHost) Set Whether to query host assets
 */
class DescribeCloudAssetsRequest extends AbstractModel
{
    ...
    /**
     * @var boolean Whether to query host assets
     */
    public $IsCloudHost;
     ...
     * @param boolean $IsCloudHost Whether to query host assets
     */
