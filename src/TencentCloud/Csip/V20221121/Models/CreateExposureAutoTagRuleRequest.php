...
/**
 * CreateExposureAutoTagRule request structure.
 *
 ...
 * @method boolean getEnable() Obtain <p>Rule opening status</p>
 * @method void setEnable(boolean $Enable) Set <p>Rule opening status</p>
 ...
 * @method boolean getApplyNow() Obtain <p>Whether to execute the policy immediately</p>
 * @method void setApplyNow(boolean $ApplyNow) Set <p>Whether to execute the policy immediately</p>
 */
class CreateExposureAutoTagRuleRequest extends AbstractModel
{
    ...
    /**
     * @var boolean <p>Rule opening status</p>
     */
    public $Enable;
    ...
    /**
     * @var boolean <p>Whether to execute the policy immediately</p>
     */
    public $ApplyNow;
     ...
     * @param boolean $Enable <p>Rule opening status</p>
     * @param array $AssetTypes <p>Asset type</p>
     * @param array $Ports <p>Port</p>
     * @param array $OpenStatuses <p>Open status</p>
     * @param boolean $ApplyNow <p>Whether to execute the policy immediately</p>
     */
