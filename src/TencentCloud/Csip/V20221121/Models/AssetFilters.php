 ...
 * @method boolean getExactMatch() Obtain <p>Whether to enable fuzzy search</p>
 * @method void setExactMatch(boolean $ExactMatch) Set <p>Whether to enable fuzzy search</p>
 */
class AssetFilters extends AbstractModel
{
    ...
    /**
     * @var boolean <p>Whether to enable fuzzy search</p>
     */
    public $ExactMatch;
     ...
     * @param boolean $ExactMatch <p>Whether to enable fuzzy search</p>
     */
