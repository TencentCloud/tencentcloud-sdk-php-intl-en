 ...
 *
 * @method string getUserConf() Obtain <p>Weak password dictionary plaintext, an empty string is allowed to clear the configuration.</p>
 * @method void setUserConf(string $UserConf) Set <p>Weak password dictionary plaintext, an empty string is allowed to clear the configuration.</p>
...
{
    /**
     * @var string <p>Weak password dictionary plaintext, an empty string is allowed to clear the configuration.</p>
     */
    public $UserConf;
    ...
    /**
     * @param string $UserConf <p>Weak password dictionary plaintext, an empty string is allowed to clear the configuration.</p>
