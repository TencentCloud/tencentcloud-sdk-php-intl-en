 ...
 *
 * @method array getIds() Obtain <p>Data item id</p>
 * @method void setIds(array $Ids) Set <p>Data item id</p>
 * @method integer getStatus() Obtain <p>Data item status</p><p>Enumeration values:</p><ul><li>0: off</li><li>1: on</li></ul>
 * @method void setStatus(integer $Status) Set <p>Data item status</p><p>Enumeration values:</p><ul><li>0: off</li><li>1: on</li></ul>
...
{
    /**
     * @var array <p>Data item id</p>
     */
    public $Ids;

    /**
     * @var integer <p>Data item status</p><p>Enumeration values:</p><ul><li>0: off</li><li>1: on</li></ul>
     */
    public $Status;
    ...
    /**
     * @param array $Ids <p>Data item id</p>
     * @param integer $Status <p>Data item status</p><p>Enumeration values:</p><ul><li>0: off</li><li>1: on</li></ul>
