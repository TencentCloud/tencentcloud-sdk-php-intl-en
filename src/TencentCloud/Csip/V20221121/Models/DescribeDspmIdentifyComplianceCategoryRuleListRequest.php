...
/**
 * DescribeDspmIdentifyComplianceCategoryRuleList request structure.
 *
 ...
 * @method Filter getFilter() Obtain <p>Filter conditions.</p>
 * @method void setFilter(Filter $Filter) Set <p>Filter conditions.</p>
...
class DescribeDspmIdentifyComplianceCategoryRuleListRequest extends AbstractModel
{
    ...
    /**
     * @var Filter <p>Filter conditions.</p>
     */
    public $Filter;
     ...
     * @param Filter $Filter <p>Filter conditions.</p>
