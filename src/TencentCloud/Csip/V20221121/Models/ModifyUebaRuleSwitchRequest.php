 ...
 * @method boolean getStatus() Obtain Enabling status
 * @method void setStatus(boolean $Status) Set Enabling status
...
class ModifyUebaRuleSwitchRequest extends AbstractModel
{
     ...
     * @param boolean $Status Enabling status
