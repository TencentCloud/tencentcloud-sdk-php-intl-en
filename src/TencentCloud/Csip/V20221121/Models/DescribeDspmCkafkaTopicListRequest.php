...
/**
 * DescribeDspmCkafkaTopicList request structure.
 *
 * @method integer getVipType() Obtain CKafka instance access type.
 * @method void setVipType(integer $VipType) Set CKafka instance access type.
...
{
    /**
     * @var integer CKafka instance access type.
     */
    public $VipType;
    ...
    /**
     * @param integer $VipType CKafka instance access type.
