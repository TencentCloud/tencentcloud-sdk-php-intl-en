...
/**
 * DescribeDspmPersonApplyHistory request structure.
 *
 * @method string getSubject() Obtain Objects
 * @method void setSubject(string $Subject) Set Objects
