 ...
 * @method string getRiskInfluence() Obtain <p>Risk and damage</p>
 * @method void setRiskInfluence(string $RiskInfluence) Set <p>Risk and damage</p>
...
class DescribeRiskRuleDetailResponse extends AbstractModel
{
    ...
    /**
     * @var string <p>Risk and damage</p>
     */
     ...
     * @param string $RiskInfluence <p>Risk and damage</p>
