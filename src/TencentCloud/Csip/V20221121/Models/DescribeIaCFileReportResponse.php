 ...
 *
 * @method string getFile() Obtain <p>Detection file.</p>
 * @method void setFile(string $File) Set <p>Detection file.</p>
...
class DescribeIaCFileReportResponse extends AbstractModel
{
    ...
    /**
     * @param string $File <p>Detection file.</p>
