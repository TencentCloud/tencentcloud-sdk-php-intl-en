...
/**
 * ModifyCSIPRaspLicenseUnBinds request structure.
 *
 ...
 * @method boolean getIsAll() Obtain <p>Whether to unbind all bound RASP machines</p>
 * @method void setIsAll(boolean $IsAll) Set <p>Whether to unbind all bound RASP machines</p>
 */
class ModifyCSIPRaspLicenseUnBindsRequest extends AbstractModel
{
    ...
    /**
     * @var boolean <p>Whether to unbind all bound RASP machines</p>
     */
    public $IsAll;

    /**
     * @param array $InstanceIDs <p>Instance ID list to be unbound (can be omitted when IsAll=true)</p>
     * @param boolean $IsAll <p>Whether to unbind all bound RASP machines</p>
     */
