...
/**
 * ModifyDspmIdentifyComplianceGroupStatus request structure.
 *
 ...
 * @method integer getStatus() Obtain <p>Enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
 * @method void setStatus(integer $Status) Set <p>Enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
...
class ModifyDspmIdentifyComplianceGroupStatusRequest extends AbstractModel
{
    ...
    /**
     * @var integer <p>Enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
     */
    public $Status;
     ...
     * @param integer $Status <p>Enable status</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
