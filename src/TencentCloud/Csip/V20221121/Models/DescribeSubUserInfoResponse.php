 ...
 * @method array getOwnerAppIDLst() Obtain appid list of the main account
 * @method void setOwnerAppIDLst(array $OwnerAppIDLst) Set appid list of the main account
...
class DescribeSubUserInfoResponse extends AbstractModel
{
    ...
    /**
     * @var array appid list of the main account
     */
     ...
     * @param array $OwnerAppIDLst appid list of the main account
