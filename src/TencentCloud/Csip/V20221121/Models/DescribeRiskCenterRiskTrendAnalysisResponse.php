 ...
 *
 * @method array getData() Obtain Trend List
 * @method void setData(array $Data) Set Trend List
 * @method array getDateTypeLists() Obtain Date Type List
 * @method void setDateTypeLists(array $DateTypeLists) Set Date Type List
...
class DescribeRiskCenterRiskTrendAnalysisResponse extends AbstractModel
{
    ...
    /**
     * @param array $Data Trend List
     * @param array $DateTypeLists Date Type List
