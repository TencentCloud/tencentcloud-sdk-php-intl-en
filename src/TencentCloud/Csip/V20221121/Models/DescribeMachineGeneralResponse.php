 ...
 * @method integer getCompareYesterdayRiskMachineCnt() Obtain <p>Number of risky machines compared to yesterday</p>
 * @method void setCompareYesterdayRiskMachineCnt(integer $CompareYesterdayRiskMachineCnt) Set <p>Number of risky machines compared to yesterday</p>
 * @method integer getCompareYesterdayNotProtectMachineCnt() Obtain <p>Number of unprotected machines compared with yesterday</p>
 * @method void setCompareYesterdayNotProtectMachineCnt(integer $CompareYesterdayNotProtectMachineCnt) Set <p>Number of unprotected machines compared with yesterday</p>
 * @method integer getCompareYesterdayDeadlineMachineCnt() Obtain <p>Number of new machines about to expire compared with that yesterday</p>
 * @method void setCompareYesterdayDeadlineMachineCnt(integer $CompareYesterdayDeadlineMachineCnt) Set <p>Number of new machines about to expire compared with that yesterday</p>
 ...
 * @method integer getLHGeneralDiscountCnt() Obtain <p>Number of protected lightweight machines (Lighthouse machines)</p>
 * @method void setLHGeneralDiscountCnt(integer $LHGeneralDiscountCnt) Set <p>Number of protected lightweight machines (Lighthouse machines)</p>
 * @method integer getCompareYesterdayMachineCnt() Obtain <p>Number of new hosts compared to yesterday</p>
 * @method void setCompareYesterdayMachineCnt(integer $CompareYesterdayMachineCnt) Set <p>Number of new hosts compared to yesterday</p>
 * @method integer getMachineDestroyAfterOfflineHours() Obtain <p>Automatic cleanup time. Maximum: 720 hours. Minimum: 0. Default: 0. 0 means disabling</p>
 * @method void setMachineDestroyAfterOfflineHours(integer $MachineDestroyAfterOfflineHours) Set <p>Automatic cleanup time. Maximum: 720 hours. Minimum: 0. Default: 0. 0 means disabling</p>
 * @method array getCloudFrom() Obtain <p>Server type array</p>
 * @method void setCloudFrom(array $CloudFrom) Set <p>Server type array</p>
 ...
 * @method integer getBaiduCloudMachineCnt() Obtain <p>Baidu cloud service provider machine number</p>
 * @method void setBaiduCloudMachineCnt(integer $BaiduCloudMachineCnt) Set <p>Baidu cloud service provider machine number</p>
...
class DescribeMachineGeneralResponse extends AbstractModel
{
    ...
    /**
     * @var integer <p>Number of risky machines compared to yesterday</p>
     */
    public $CompareYesterdayRiskMachineCnt;

    /**
     * @var integer <p>Number of unprotected machines compared with yesterday</p>
     */
    public $CompareYesterdayNotProtectMachineCnt;

    /**
     * @var integer <p>Number of new machines about to expire compared with that yesterday</p>
     */
    ...
    /**
     * @var integer <p>Number of protected lightweight machines (Lighthouse machines)</p>
     */
    public $LHGeneralDiscountCnt;

    /**
     * @var integer <p>Number of new hosts compared to yesterday</p>
     */
    public $CompareYesterdayMachineCnt;

    /**
     * @var integer <p>Automatic cleanup time. Maximum: 720 hours. Minimum: 0. Default: 0. 0 means disabling</p>
     */
    public $MachineDestroyAfterOfflineHours;

    /**
     * @var array <p>Server type array</p>
     */
    public $CloudFrom;
    ...
    /**
     * @var integer <p>Baidu cloud service provider machine number</p>
     */
     ...
     * @param integer $CompareYesterdayRiskMachineCnt <p>Number of risky machines compared to yesterday</p>
     * @param integer $CompareYesterdayNotProtectMachineCnt <p>Number of unprotected machines compared with yesterday</p>
     * @param integer $CompareYesterdayDeadlineMachineCnt <p>Number of new machines about to expire compared with that yesterday</p>
     ...
     * @param integer $LHGeneralDiscountCnt <p>Number of protected lightweight machines (Lighthouse machines)</p>
     * @param integer $CompareYesterdayMachineCnt <p>Number of new hosts compared to yesterday</p>
     * @param integer $MachineDestroyAfterOfflineHours <p>Automatic cleanup time. Maximum: 720 hours. Minimum: 0. Default: 0. 0 means disabling</p>
     * @param array $CloudFrom <p>Server type array</p>
     ...
     * @param integer $BaiduCloudMachineCnt <p>Baidu cloud service provider machine number</p>
